...
const createAccessTokenInterceptor = (token) =>
  async function* (call, options) {
    var _a
    ;(_a = options.metadata) !== null && _a !== void 0
      ? _a
      : (options.metadata = new nice_grpc_1.Metadata())
...
const getUser =
  user_service_1.UserServiceDefinition.methods.getUserByID.requestType.fromPartial(
    {}
  )
...
class Zitadel {
  ...
  async execute() {
    ...
    const personalAccessToken = (0, exports.createAccessTokenInterceptor)(
      credentials.pat
    )
