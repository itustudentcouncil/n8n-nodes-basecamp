...
function createBaseBatchDeleteVersionsRequest(): BatchDeleteVersionsRequest {
  return { parent: "", names: [], validateOnly: false };
}

export const BatchDeleteVersionsRequest: MessageFns<BatchDeleteVersionsRequest> = {
  encode(message: BatchDeleteVersionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parent !== "") {
      writer.uint32(10).string(message.parent);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BatchDeleteVersionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBatchDeleteVersionsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BatchDeleteVersionsRequest {
    return {
      parent: isSet(object.parent) ? globalThis.String(object.parent) : "",
  ...
  toJSON(message: BatchDeleteVersionsRequest): unknown {
    const obj: any = {};
    if (message.parent !== "") {
      obj.parent = message.parent;
    }
  ...
  create(base?: DeepPartial<BatchDeleteVersionsRequest>): BatchDeleteVersionsRequest {
    return BatchDeleteVersionsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchDeleteVersionsRequest>): BatchDeleteVersionsRequest {
    const message = createBaseBatchDeleteVersionsRequest();
    message.parent = object.parent ?? "";
...
function createBaseBatchDeleteVersionsMetadata(): BatchDeleteVersionsMetadata {
  return { failedVersions: [] };
}

export const BatchDeleteVersionsMetadata: MessageFns<BatchDeleteVersionsMetadata> = {
  encode(message: BatchDeleteVersionsMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.failedVersions) {
      writer.uint32(18).string(v!);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BatchDeleteVersionsMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBatchDeleteVersionsMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
  ...
  fromJSON(object: any): BatchDeleteVersionsMetadata {
    return {
      failedVersions: globalThis.Array.isArray(object?.failedVersions)
        ? object.failedVersions.map((e: any) => globalThis.String(e))
        : [],
    };
  },

  toJSON(message: BatchDeleteVersionsMetadata): unknown {
    const obj: any = {};
    if (message.failedVersions?.length) {
      obj.failedVersions = message.failedVersions;
    }
    return obj;
  },

  create(base?: DeepPartial<BatchDeleteVersionsMetadata>): BatchDeleteVersionsMetadata {
    return BatchDeleteVersionsMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchDeleteVersionsMetadata>): BatchDeleteVersionsMetadata {
    const message = createBaseBatchDeleteVersionsMetadata();
    message.failedVersions = object.failedVersions?.map((e) => e) || [];
    return message;
  },
};
