...
export enum ContentLabelTypeEnum_ContentLabelType {
  ...
  SOCIAL_ISSUES = 17,
  /**
   * BRAND_SUITABILITY_CONTENT_FOR_FAMILIES - Content that's suitable for families to view together, including Made for
   * Kids videos on YouTube.
   */
  BRAND_SUITABILITY_CONTENT_FOR_FAMILIES = 18,
  /**
   * BRAND_SUITABILITY_GAMES_FIGHTING - Video games that simulate hand-to-hand fighting or combat with the use of
   * modern or medieval weapons.
   */
  BRAND_SUITABILITY_GAMES_FIGHTING = 19,
  /**
   * BRAND_SUITABILITY_GAMES_MATURE - Video games that feature mature content, such as violence, inappropriate
   * language, or sexual suggestiveness.
   */
  BRAND_SUITABILITY_GAMES_MATURE = 20,
  /**
   * BRAND_SUITABILITY_HEALTH_SENSITIVE - Health content that people might find sensitive or upsetting, such as
   * medical procedures or images and descriptions of various medical
   * conditions.
   */
  BRAND_SUITABILITY_HEALTH_SENSITIVE = 21,
  /**
   * BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED - Health content from sources that may provide accurate information but
   * aren't as commonly cited as other, more well-known sources.
   */
  BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED = 22,
  /**
   * BRAND_SUITABILITY_NEWS_RECENT - News content that's been recently announced, regardless of the themes or
   * people being reported on.
   */
  BRAND_SUITABILITY_NEWS_RECENT = 23,
  /**
   * BRAND_SUITABILITY_NEWS_SENSITIVE - News content that people might find sensitive or upsetting, such as
  ...
  /**
   * BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED - News content from sources that aren't featured on Google News or YouTube
   * News.
   */
  BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED = 25,
  /**
   * BRAND_SUITABILITY_POLITICS - Political content, such as political statements made by well-known
   * politicians, political elections, or events widely perceived to be
   * political in nature.
   */
  BRAND_SUITABILITY_POLITICS = 26,
  /**
   * BRAND_SUITABILITY_RELIGION - Content with religious themes, such as religious teachings or customs,
...
export function contentLabelTypeEnum_ContentLabelTypeFromJSON(object: any): ContentLabelTypeEnum_ContentLabelType {
  switch (object) {
    ...
    case 18:
    case "BRAND_SUITABILITY_CONTENT_FOR_FAMILIES":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_CONTENT_FOR_FAMILIES;
    case 19:
    case "BRAND_SUITABILITY_GAMES_FIGHTING":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_GAMES_FIGHTING;
    case 20:
    case "BRAND_SUITABILITY_GAMES_MATURE":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_GAMES_MATURE;
    case 21:
    case "BRAND_SUITABILITY_HEALTH_SENSITIVE":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_HEALTH_SENSITIVE;
    case 22:
    case "BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED;
    case 23:
    case "BRAND_SUITABILITY_NEWS_RECENT":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_NEWS_RECENT;
    case 24:
    case "BRAND_SUITABILITY_NEWS_SENSITIVE":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_NEWS_SENSITIVE;
    case 25:
    case "BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED;
    case 26:
    case "BRAND_SUITABILITY_POLITICS":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_POLITICS;
    case 27:
    case "BRAND_SUITABILITY_RELIGION":
      return ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_RELIGION;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function contentLabelTypeEnum_ContentLabelTypeToJSON(object: ContentLabelTypeEnum_ContentLabelType): string {
  switch (object) {
    ...
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_CONTENT_FOR_FAMILIES:
      return "BRAND_SUITABILITY_CONTENT_FOR_FAMILIES";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_GAMES_FIGHTING:
      return "BRAND_SUITABILITY_GAMES_FIGHTING";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_GAMES_MATURE:
      return "BRAND_SUITABILITY_GAMES_MATURE";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_HEALTH_SENSITIVE:
      return "BRAND_SUITABILITY_HEALTH_SENSITIVE";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED:
      return "BRAND_SUITABILITY_HEALTH_SOURCE_UNDETERMINED";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_NEWS_RECENT:
      return "BRAND_SUITABILITY_NEWS_RECENT";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_NEWS_SENSITIVE:
      return "BRAND_SUITABILITY_NEWS_SENSITIVE";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED:
      return "BRAND_SUITABILITY_NEWS_SOURCE_NOT_FEATURED";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_POLITICS:
      return "BRAND_SUITABILITY_POLITICS";
    case ContentLabelTypeEnum_ContentLabelType.BRAND_SUITABILITY_RELIGION:
      return "BRAND_SUITABILITY_RELIGION";
