...
export enum BiddingStrategyTypeEnum_BiddingStrategyType {
   ...
   */
  ENHANCED_CPC = 2,
  /** FIXED_CPM - Fixed CPM is a manual bidding strategy with a fixed CPM. */
  FIXED_CPM = 19,
  /**
  ...
  TARGET_CPM = 14,
  /**
   * TARGET_CPV - Target CPV is an automated bidding strategy that sets bids to optimize
...
export function biddingStrategyTypeEnum_BiddingStrategyTypeFromJSON(
  ...
  switch (object) {
    ...
    case 19:
    case "FIXED_CPM":
      return BiddingStrategyTypeEnum_BiddingStrategyType.FIXED_CPM;
    case 17:
    case "INVALID":
    ...
    case 20:
    case "TARGET_CPV":
      return BiddingStrategyTypeEnum_BiddingStrategyType.TARGET_CPV;
    case 15:
...
export function biddingStrategyTypeEnum_BiddingStrategyTypeToJSON(
  ...
  switch (object) {
    ...
    case BiddingStrategyTypeEnum_BiddingStrategyType.ENHANCED_CPC:
      return "ENHANCED_CPC";
    case BiddingStrategyTypeEnum_BiddingStrategyType.FIXED_CPM:
      return "FIXED_CPM";
    ...
    case BiddingStrategyTypeEnum_BiddingStrategyType.TARGET_CPM:
      return "TARGET_CPM";
    case BiddingStrategyTypeEnum_BiddingStrategyType.TARGET_CPV:
      return "TARGET_CPV";
