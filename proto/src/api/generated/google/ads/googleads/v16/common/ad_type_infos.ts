...
export interface DiscoveryVideoResponsiveAdInfo {
...
function createBaseDiscoveryMultiAssetAdInfo(): DiscoveryMultiAssetAdInfo {
  return {
    marketingImages: [],
    squareMarketingImages: [],
...
export const DiscoveryMultiAssetAdInfo: MessageFns<DiscoveryMultiAssetAdInfo> = {
  encode(message: DiscoveryMultiAssetAdInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.marketingImages) {
      AdImageAsset.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.squareMarketingImages) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DiscoveryMultiAssetAdInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDiscoveryMultiAssetAdInfo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DiscoveryMultiAssetAdInfo {
    return {
      marketingImages: globalThis.Array.isArray(object?.marketingImages)
        ? object.marketingImages.map((e: any) => AdImageAsset.fromJSON(e))
        : [],
  ...
  toJSON(message: DiscoveryMultiAssetAdInfo): unknown {
    const obj: any = {};
    if (message.marketingImages?.length) {
      obj.marketingImages = message.marketingImages.map((e) => AdImageAsset.toJSON(e));
    }
  ...
  create(base?: DeepPartial<DiscoveryMultiAssetAdInfo>): DiscoveryMultiAssetAdInfo {
    return DiscoveryMultiAssetAdInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DiscoveryMultiAssetAdInfo>): DiscoveryMultiAssetAdInfo {
    const message = createBaseDiscoveryMultiAssetAdInfo();
    message.marketingImages = object.marketingImages?.map((e) => AdImageAsset.fromPartial(e)) || [];
    message.squareMarketingImages = object.squareMarketingImages?.map((e) => AdImageAsset.fromPartial(e)) || [];
...
function createBaseDiscoveryCarouselAdInfo(): DiscoveryCarouselAdInfo {
  return {
    businessName: "",
    logoImage: undefined,
    headline: undefined,
...
export const DiscoveryCarouselAdInfo: MessageFns<DiscoveryCarouselAdInfo> = {
  encode(message: DiscoveryCarouselAdInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.businessName !== "") {
    ...
    for (const v of message.carouselCards) {
      AdDiscoveryCarouselCardAsset.encode(v!, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DiscoveryCarouselAdInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDiscoveryCarouselAdInfo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 6:
          ...
          message.carouselCards.push(AdDiscoveryCarouselCardAsset.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DiscoveryCarouselAdInfo {
    return {
      businessName: isSet(object.businessName) ? globalThis.String(object.businessName) : "",
      ...
      carouselCards: globalThis.Array.isArray(object?.carouselCards)
        ? object.carouselCards.map((e: any) => AdDiscoveryCarouselCardAsset.fromJSON(e))
        : [],
    };
  },

  toJSON(message: DiscoveryCarouselAdInfo): unknown {
    const obj: any = {};
    if (message.businessName !== "") {
      obj.businessName = message.businessName;
    }
    ...
    if (message.carouselCards?.length) {
      obj.carouselCards = message.carouselCards.map((e) => AdDiscoveryCarouselCardAsset.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<DiscoveryCarouselAdInfo>): DiscoveryCarouselAdInfo {
    return DiscoveryCarouselAdInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DiscoveryCarouselAdInfo>): DiscoveryCarouselAdInfo {
    const message = createBaseDiscoveryCarouselAdInfo();
    message.businessName = object.businessName ?? "";
    ...
    message.carouselCards = object.carouselCards?.map((e) => AdDiscoveryCarouselCardAsset.fromPartial(e)) || [];
    return message;
  },
};

function createBaseDiscoveryVideoResponsiveAdInfo(): DiscoveryVideoResponsiveAdInfo {
  return {
    headlines: [],
    longHeadlines: [],
    descriptions: [],
...
export const DiscoveryVideoResponsiveAdInfo: MessageFns<DiscoveryVideoResponsiveAdInfo> = {
  encode(message: DiscoveryVideoResponsiveAdInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.headlines) {
      AdTextAsset.encode(v!, writer.uint32(10).fork()).join();
    }
    for (const v of message.longHeadlines) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DiscoveryVideoResponsiveAdInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDiscoveryVideoResponsiveAdInfo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DiscoveryVideoResponsiveAdInfo {
    return {
      headlines: globalThis.Array.isArray(object?.headlines)
        ? object.headlines.map((e: any) => AdTextAsset.fromJSON(e))
        : [],
  ...
  toJSON(message: DiscoveryVideoResponsiveAdInfo): unknown {
    const obj: any = {};
    if (message.headlines?.length) {
      obj.headlines = message.headlines.map((e) => AdTextAsset.toJSON(e));
    }
  ...
  create(base?: DeepPartial<DiscoveryVideoResponsiveAdInfo>): DiscoveryVideoResponsiveAdInfo {
    return DiscoveryVideoResponsiveAdInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DiscoveryVideoResponsiveAdInfo>): DiscoveryVideoResponsiveAdInfo {
    const message = createBaseDiscoveryVideoResponsiveAdInfo();
    message.headlines = object.headlines?.map((e) => AdTextAsset.fromPartial(e)) || [];
    message.longHeadlines = object.longHeadlines?.map((e) => AdTextAsset.fromPartial(e)) || [];
    message.descriptions = object.descriptions?.map((e) => AdTextAsset.fromPartial(e)) || [];
