...
export interface FieldOperationMetadata {
  ...
  documentProgress:
    ...
    | undefined;
  /** The progress, in bytes, of this operation. */
  bytesProgress: Progress | undefined;
}
...
export const FieldOperationMetadata: MessageFns<FieldOperationMetadata> = {
  encode(message: FieldOperationMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.bytesProgress !== undefined) {
      Progress.encode(message.bytesProgress, writer.uint32(58).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.bytesProgress = Progress.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): FieldOperationMetadata {
    return {
      ...
      bytesProgress: isSet(object.bytesProgress) ? Progress.fromJSON(object.bytesProgress) : undefined,
    };
  },
  ...
  toJSON(message: FieldOperationMetadata): unknown {
    ...
    if (message.bytesProgress !== undefined) {
      obj.bytesProgress = Progress.toJSON(message.bytesProgress);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<FieldOperationMetadata>): FieldOperationMetadata {
    ...
    message.documentProgress = (object.documentProgress !== undefined && object.documentProgress !== null)
      ...
      : undefined;
    message.bytesProgress = (object.bytesProgress !== undefined && object.bytesProgress !== null)
      ? Progress.fromPartial(object.bytesProgress)
      : undefined;
    return message;
  },
};
