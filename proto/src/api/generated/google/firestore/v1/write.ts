...
function createBaseExistenceFilter(): ExistenceFilter {
  return { targetId: 0, count: 0, unchangedNames: undefined };
}
...
export const ExistenceFilter: MessageFns<ExistenceFilter> = {
  encode(message: ExistenceFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.unchangedNames !== undefined) {
      BloomFilter.encode(message.unchangedNames, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.unchangedNames = BloomFilter.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ExistenceFilter {
    return {
      ...
      unchangedNames: isSet(object.unchangedNames) ? BloomFilter.fromJSON(object.unchangedNames) : undefined,
    };
  },
  ...
  toJSON(message: ExistenceFilter): unknown {
    ...
    if (message.unchangedNames !== undefined) {
      obj.unchangedNames = BloomFilter.toJSON(message.unchangedNames);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ExistenceFilter>): ExistenceFilter {
    ...
    message.unchangedNames = (object.unchangedNames !== undefined && object.unchangedNames !== null)
      ? BloomFilter.fromPartial(object.unchangedNames)
      : undefined;
    return message;
  },
};
