...
import { AggregationResult } from "./aggregation_result.js";
import { DocumentMask, Precondition, TransactionOptions } from "./common.js";
import { Document } from "./document.js";
import { Cursor, StructuredAggregationQuery, StructuredQuery } from "./query.js";
...
export const RunQueryRequest: MessageFns<RunQueryRequest> = {
  encode(message: RunQueryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.explainOptions !== undefined) {
      ExplainOptions.encode(message.explainOptions, writer.uint32(82).fork()).join();
    }
    return writer;
  },
...
export const RunQueryResponse: MessageFns<RunQueryResponse> = {
  encode(message: RunQueryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.explainMetrics !== undefined) {
      ExplainMetrics.encode(message.explainMetrics, writer.uint32(90).fork()).join();
    }
    return writer;
  },
...
function createBaseRunAggregationQueryRequest(): RunAggregationQueryRequest {
  return {
    parent: "",
    structuredAggregationQuery: undefined,
    transaction: undefined,
    newTransaction: undefined,
    readTime: undefined,
    explainOptions: undefined,
...
export const RunAggregationQueryRequest: MessageFns<RunAggregationQueryRequest> = {
  encode(message: RunAggregationQueryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.structuredAggregationQuery !== undefined) {
      StructuredAggregationQuery.encode(message.structuredAggregationQuery, writer.uint32(18).fork()).join();
    }
    if (message.transaction !== undefined) {
      writer.uint32(34).bytes(message.transaction);
    }
    ...
    if (message.explainOptions !== undefined) {
      ExplainOptions.encode(message.explainOptions, writer.uint32(66).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.structuredAggregationQuery = StructuredAggregationQuery.decode(reader, reader.uint32());
          continue;
        case 4:
          if (tag !== 34) {
            break;
  ...
  fromJSON(object: any): RunAggregationQueryRequest {
    return {
      parent: isSet(object.parent) ? globalThis.String(object.parent) : "",
      structuredAggregationQuery: isSet(object.structuredAggregationQuery)
        ? StructuredAggregationQuery.fromJSON(object.structuredAggregationQuery)
        : undefined,
      transaction: isSet(object.transaction) ? Buffer.from(bytesFromBase64(object.transaction)) : undefined,
      newTransaction: isSet(object.newTransaction) ? TransactionOptions.fromJSON(object.newTransaction) : undefined,
      readTime: isSet(object.readTime) ? fromJsonTimestamp(object.readTime) : undefined,
  ...
  toJSON(message: RunAggregationQueryRequest): unknown {
    ...
    if (message.structuredAggregationQuery !== undefined) {
      obj.structuredAggregationQuery = StructuredAggregationQuery.toJSON(message.structuredAggregationQuery);
    }
    if (message.transaction !== undefined) {
      obj.transaction = base64FromBytes(message.transaction);
    }
  ...
  fromPartial(object: DeepPartial<RunAggregationQueryRequest>): RunAggregationQueryRequest {
    ...
    message.structuredAggregationQuery =
      (object.structuredAggregationQuery !== undefined && object.structuredAggregationQuery !== null)
        ? StructuredAggregationQuery.fromPartial(object.structuredAggregationQuery)
        : undefined;
    message.transaction = object.transaction ?? undefined;
    message.newTransaction = (object.newTransaction !== undefined && object.newTransaction !== null)
      ? TransactionOptions.fromPartial(object.newTransaction)
...
function createBaseRunAggregationQueryResponse(): RunAggregationQueryResponse {
  return { result: undefined, transaction: Buffer.alloc(0), readTime: undefined, explainMetrics: undefined };
}
...
export const RunAggregationQueryResponse: MessageFns<RunAggregationQueryResponse> = {
  encode(message: RunAggregationQueryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.result !== undefined) {
      AggregationResult.encode(message.result, writer.uint32(10).fork()).join();
    }
    if (message.transaction.length !== 0) {
      writer.uint32(18).bytes(message.transaction);
    }
    ...
    if (message.explainMetrics !== undefined) {
      ExplainMetrics.encode(message.explainMetrics, writer.uint32(82).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.result = AggregationResult.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  fromJSON(object: any): RunAggregationQueryResponse {
    return {
      result: isSet(object.result) ? AggregationResult.fromJSON(object.result) : undefined,
      transaction: isSet(object.transaction) ? Buffer.from(bytesFromBase64(object.transaction)) : Buffer.alloc(0),
      readTime: isSet(object.readTime) ? fromJsonTimestamp(object.readTime) : undefined,
      explainMetrics: isSet(object.explainMetrics) ? ExplainMetrics.fromJSON(object.explainMetrics) : undefined,
    };
  ...
  toJSON(message: RunAggregationQueryResponse): unknown {
    const obj: any = {};
    if (message.result !== undefined) {
      obj.result = AggregationResult.toJSON(message.result);
    }
    if (message.transaction.length !== 0) {
      obj.transaction = base64FromBytes(message.transaction);
    }
  ...
  fromPartial(object: DeepPartial<RunAggregationQueryResponse>): RunAggregationQueryResponse {
    ...
    message.result = (object.result !== undefined && object.result !== null)
      ? AggregationResult.fromPartial(object.result)
      : undefined;
    message.transaction = object.transaction ?? Buffer.alloc(0);
    message.readTime = object.readTime ?? undefined;
    message.explainMetrics = (object.explainMetrics !== undefined && object.explainMetrics !== null)
...
export const Target: MessageFns<Target> = {
  encode(message: Target, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.expectedCount !== undefined) {
      Int32Value.encode({ value: message.expectedCount! }, writer.uint32(98).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12:
          ...
          message.expectedCount = Int32Value.decode(reader, reader.uint32()).value;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Target {
    return {
      ...
      expectedCount: isSet(object.expectedCount) ? Number(object.expectedCount) : undefined,
    };
  },
  ...
  fromPartial(object: DeepPartial<Target>): Target {
    ...
    message.expectedCount = object.expectedCount ?? undefined;
    return message;
  },
};
...
function createBaseListCollectionIdsRequest(): ListCollectionIdsRequest {
  return { parent: "", pageSize: 0, pageToken: "", readTime: undefined };
}
...
export interface FirestoreServiceImplementation<CallContextExt = {}> {
  ...
  runAggregationQuery(
    ...
    context: CallContext & CallContextExt,
  ): ServerStreamingMethodResult<DeepPartial<RunAggregationQueryResponse>>;
  /**
   * Partitions a query by returning partition cursors that can be used to run
   * the query in parallel. The returned partition cursors are split points that
   * can be used by RunQuery as starting/end points for the query results.
...
export interface FirestoreClient<CallOptionsExt = {}> {
  ...
  runAggregationQuery(
    ...
    options?: CallOptions & CallOptionsExt,
  ): AsyncIterable<RunAggregationQueryResponse>;
  /**
   * Partitions a query by returning partition cursors that can be used to run
   * the query in parallel. The returned partition cursors are split points that
   * can be used by RunQuery as starting/end points for the query results.
