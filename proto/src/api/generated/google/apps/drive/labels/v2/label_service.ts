...
export const LabelServiceDefinition = {
  ...
  methods: {
    ...
    listLabels: {
      ...
      responseStream: false,
      options: {
        _unknownFields: { 578365826: [Buffer.from([12, 18, 10, 47, 118, 50, 47, 108, 97, 98, 101, 108, 115])] },
      },
    },
    /**
    ...
    getLabelLimits: {
      ...
      options: {
        _unknownFields: {
          578365826: [
            Buffer.from([18, 18, 16, 47, 118, 50, 47, 108, 105, 109, 105, 116, 115, 47, 108, 97, 98, 101, 108]),
          ],
        },
      },
    },
    ...
    createLabel: {
      ...
      options: {
        _unknownFields: {
          ...
          578365826: [
            Buffer.from([19, 58, 5, 108, 97, 98, 101, 108, 34, 10, 47, 118, 50, 47, 108, 97, 98, 101, 108, 115]),
          ],
        },
      },
    },
