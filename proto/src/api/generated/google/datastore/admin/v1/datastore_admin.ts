...
import {
  MigrationState,
  migrationStateFromJSON,
  migrationStateToJSON,
  MigrationStep,
  migrationStepFromJSON,
  migrationStepToJSON,
} from "./migration.js";
...
export function operationTypeFromJSON(object: any): OperationType {
  switch (object) {
    ...
    case 3:
    case "CREATE_INDEX":
      return OperationType.CREATE_INDEX;
    case 4:
    case "DELETE_INDEX":
      return OperationType.DELETE_INDEX;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function operationTypeToJSON(object: OperationType): string {
  switch (object) {
    ...
    case OperationType.CREATE_INDEX:
      return "CREATE_INDEX";
    case OperationType.DELETE_INDEX:
      return "DELETE_INDEX";
 ...
 */
export interface DatastoreFirestoreMigrationMetadata {
  /**
...
function createBaseCreateIndexRequest(): CreateIndexRequest {
  return { projectId: "", index: undefined };
}
...
function createBaseIndexOperationMetadata(): IndexOperationMetadata {
  return { common: undefined, progressEntities: undefined, indexId: "" };
}
...
function createBaseDatastoreFirestoreMigrationMetadata(): DatastoreFirestoreMigrationMetadata {
  return { migrationState: 0, migrationStep: 0 };
}

export const DatastoreFirestoreMigrationMetadata: MessageFns<DatastoreFirestoreMigrationMetadata> = {
  encode(message: DatastoreFirestoreMigrationMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.migrationState !== 0) {
      writer.uint32(8).int32(message.migrationState);
    }
    if (message.migrationStep !== 0) {
      writer.uint32(16).int32(message.migrationStep);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DatastoreFirestoreMigrationMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDatastoreFirestoreMigrationMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.migrationState = reader.int32() as any;
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.migrationStep = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DatastoreFirestoreMigrationMetadata {
    return {
      migrationState: isSet(object.migrationState) ? migrationStateFromJSON(object.migrationState) : 0,
      migrationStep: isSet(object.migrationStep) ? migrationStepFromJSON(object.migrationStep) : 0,
    };
  },

  toJSON(message: DatastoreFirestoreMigrationMetadata): unknown {
    const obj: any = {};
    if (message.migrationState !== 0) {
      obj.migrationState = migrationStateToJSON(message.migrationState);
    }
    if (message.migrationStep !== 0) {
      obj.migrationStep = migrationStepToJSON(message.migrationStep);
    }
    return obj;
  },

  create(base?: DeepPartial<DatastoreFirestoreMigrationMetadata>): DatastoreFirestoreMigrationMetadata {
    return DatastoreFirestoreMigrationMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DatastoreFirestoreMigrationMetadata>): DatastoreFirestoreMigrationMetadata {
    const message = createBaseDatastoreFirestoreMigrationMetadata();
    message.migrationState = object.migrationState ?? 0;
    message.migrationStep = object.migrationStep ?? 0;
    return message;
  },
};
