...
export const Model: MessageFns<Model> = {
  encode(message: Model, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.maxTemperature !== undefined) {
      writer.uint32(109).float(message.maxTemperature);
    }
  ...
  fromJSON(object: any): Model {
    return {
      ...
      maxTemperature: isSet(object.maxTemperature) ? globalThis.Number(object.maxTemperature) : undefined,
  ...
  toJSON(message: Model): unknown {
    ...
    if (message.maxTemperature !== undefined) {
      obj.maxTemperature = message.maxTemperature;
    }
    if (message.topP !== undefined) {
  ...
  fromPartial(object: DeepPartial<Model>): Model {
    ...
    message.maxTemperature = object.maxTemperature ?? undefined;
