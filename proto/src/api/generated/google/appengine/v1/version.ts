...
export function vpcAccessConnector_EgressSettingFromJSON(object: any): VpcAccessConnector_EgressSetting {
  switch (object) {
    case 0:
    case "EGRESS_SETTING_UNSPECIFIED":
      return VpcAccessConnector_EgressSetting.EGRESS_SETTING_UNSPECIFIED;
    case 1:
    case "ALL_TRAFFIC":
      return VpcAccessConnector_EgressSetting.ALL_TRAFFIC;
    case 2:
    case "PRIVATE_IP_RANGES":
      return VpcAccessConnector_EgressSetting.PRIVATE_IP_RANGES;
    case -1:
    case "UNRECOGNIZED":
    default:
      return VpcAccessConnector_EgressSetting.UNRECOGNIZED;
  }
}

export function vpcAccessConnector_EgressSettingToJSON(object: VpcAccessConnector_EgressSetting): string {
  switch (object) {
    case VpcAccessConnector_EgressSetting.EGRESS_SETTING_UNSPECIFIED:
      return "EGRESS_SETTING_UNSPECIFIED";
    case VpcAccessConnector_EgressSetting.ALL_TRAFFIC:
      return "ALL_TRAFFIC";
    case VpcAccessConnector_EgressSetting.PRIVATE_IP_RANGES:
      return "PRIVATE_IP_RANGES";
    case VpcAccessConnector_EgressSetting.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const VpcAccessConnector: MessageFns<VpcAccessConnector> = {
  encode(message: VpcAccessConnector, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.egressSetting !== 0) {
      writer.uint32(16).int32(message.egressSetting);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.egressSetting = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): VpcAccessConnector {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      egressSetting: isSet(object.egressSetting) ? vpcAccessConnector_EgressSettingFromJSON(object.egressSetting) : 0,
    };
  },
  ...
  toJSON(message: VpcAccessConnector): unknown {
    ...
    if (message.egressSetting !== 0) {
      obj.egressSetting = vpcAccessConnector_EgressSettingToJSON(message.egressSetting);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<VpcAccessConnector>): VpcAccessConnector {
    const message = createBaseVpcAccessConnector();
    message.name = object.name ?? "";
    message.egressSetting = object.egressSetting ?? 0;
    return message;
  },
};
