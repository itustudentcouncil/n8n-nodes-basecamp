...
export interface GetStreamThumbnailRequest {
...
function createBaseGetStreamThumbnailRequest(): GetStreamThumbnailRequest {
  return { stream: "", gcsObjectName: "", event: "", requestId: "" };
}

export const GetStreamThumbnailRequest: MessageFns<GetStreamThumbnailRequest> = {
  encode(message: GetStreamThumbnailRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.stream !== "") {
      writer.uint32(10).string(message.stream);
    }
    if (message.gcsObjectName !== "") {
      writer.uint32(18).string(message.gcsObjectName);
    }
    if (message.event !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetStreamThumbnailRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetStreamThumbnailRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.gcsObjectName = reader.string();
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): GetStreamThumbnailRequest {
    return {
      stream: isSet(object.stream) ? globalThis.String(object.stream) : "",
      gcsObjectName: isSet(object.gcsObjectName) ? globalThis.String(object.gcsObjectName) : "",
      event: isSet(object.event) ? globalThis.String(object.event) : "",
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
    };
  },

  toJSON(message: GetStreamThumbnailRequest): unknown {
    const obj: any = {};
    if (message.stream !== "") {
      obj.stream = message.stream;
    }
    if (message.gcsObjectName !== "") {
      obj.gcsObjectName = message.gcsObjectName;
    }
    if (message.event !== "") {
  ...
  create(base?: DeepPartial<GetStreamThumbnailRequest>): GetStreamThumbnailRequest {
    return GetStreamThumbnailRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetStreamThumbnailRequest>): GetStreamThumbnailRequest {
    const message = createBaseGetStreamThumbnailRequest();
    message.stream = object.stream ?? "";
    message.gcsObjectName = object.gcsObjectName ?? "";
...
export const StreamsServiceDefinition = {
  ...
  methods: {
    ...
    getStreamThumbnail: {
      ...
      requestType: GetStreamThumbnailRequest,
      requestStream: false,
      responseType: Operation,
      responseStream: false,
      options: {
...
export interface StreamsServiceClient<CallOptionsExt = {}> {
  ...
  /** Gets the thumbnail (image snapshot) of a single Stream. */
  getStreamThumbnail(
    request: DeepPartial<GetStreamThumbnailRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Operation>;
  /** Generate the JWT auth token required to get the stream HLS contents. */
  generateStreamHlsToken(
