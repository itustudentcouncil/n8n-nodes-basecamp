...
import { SearchResponse_Facet } from "./search_service.js";
...
export interface CompleteQueryResponse_AttributeResult {
  /** The list of suggestions for the attribute. */
  suggestions: string[];
}

export interface CompleteQueryResponse_AttributeResultsEntry {
  key: string;
  value: CompleteQueryResponse_AttributeResult | undefined;
}
...
function createBaseCompleteQueryResponse(): CompleteQueryResponse {
  return { completionResults: [], attributionToken: "", recentSearchResults: [], attributeResults: {} };
}
...
export const CompleteQueryResponse: MessageFns<CompleteQueryResponse> = {
  encode(message: CompleteQueryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.attributeResults).forEach(([key, value]) => {
      CompleteQueryResponse_AttributeResultsEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          const entry4 = CompleteQueryResponse_AttributeResultsEntry.decode(reader, reader.uint32());
          if (entry4.value !== undefined) {
            message.attributeResults[entry4.key] = entry4.value;
          }
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CompleteQueryResponse {
    return {
      ...
      recentSearchResults: globalThis.Array.isArray(object?.recentSearchResults)
        ...
        : [],
      attributeResults: isObject(object.attributeResults)
        ? Object.entries(object.attributeResults).reduce<{ [key: string]: CompleteQueryResponse_AttributeResult }>(
          (acc, [key, value]) => {
            acc[key] = CompleteQueryResponse_AttributeResult.fromJSON(value);
            return acc;
          },
          {},
        )
  ...
  toJSON(message: CompleteQueryResponse): unknown {
    ...
    if (message.attributeResults) {
      const entries = Object.entries(message.attributeResults);
      if (entries.length > 0) {
        obj.attributeResults = {};
        entries.forEach(([k, v]) => {
          obj.attributeResults[k] = CompleteQueryResponse_AttributeResult.toJSON(v);
        });
      }
    }
    return obj;
  ...
  fromPartial(object: DeepPartial<CompleteQueryResponse>): CompleteQueryResponse {
    ...
    message.attributeResults = Object.entries(object.attributeResults ?? {}).reduce<
      { [key: string]: CompleteQueryResponse_AttributeResult }
    >((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = CompleteQueryResponse_AttributeResult.fromPartial(value);
      }
      return acc;
    }, {});
    return message;
...
function createBaseCompleteQueryResponse_CompletionResult(): CompleteQueryResponse_CompletionResult {
  return { suggestion: "", attributes: {}, facets: [], totalProductCount: 0 };
}
...
export const CompleteQueryResponse_CompletionResult: MessageFns<CompleteQueryResponse_CompletionResult> = {
  encode(message: CompleteQueryResponse_CompletionResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.facets) {
      SearchResponse_Facet.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.totalProductCount !== 0) {
      writer.uint32(32).int32(message.totalProductCount);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.totalProductCount = reader.int32();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CompleteQueryResponse_CompletionResult {
    return {
      ...
      facets: globalThis.Array.isArray(object?.facets)
        ...
        : [],
      totalProductCount: isSet(object.totalProductCount) ? globalThis.Number(object.totalProductCount) : 0,
    };
  },
  ...
  toJSON(message: CompleteQueryResponse_CompletionResult): unknown {
    ...
    if (message.totalProductCount !== 0) {
      obj.totalProductCount = Math.round(message.totalProductCount);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<CompleteQueryResponse_CompletionResult>): CompleteQueryResponse_CompletionResult {
    ...
    message.totalProductCount = object.totalProductCount ?? 0;
    return message;
  },
};
...
function createBaseCompleteQueryResponse_AttributeResult(): CompleteQueryResponse_AttributeResult {
  return { suggestions: [] };
}

export const CompleteQueryResponse_AttributeResult: MessageFns<CompleteQueryResponse_AttributeResult> = {
  encode(message: CompleteQueryResponse_AttributeResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CompleteQueryResponse_AttributeResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCompleteQueryResponse_AttributeResult();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): CompleteQueryResponse_AttributeResult {
    return {
  ...
  toJSON(message: CompleteQueryResponse_AttributeResult): unknown {
    const obj: any = {};
  ...
  create(base?: DeepPartial<CompleteQueryResponse_AttributeResult>): CompleteQueryResponse_AttributeResult {
    return CompleteQueryResponse_AttributeResult.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CompleteQueryResponse_AttributeResult>): CompleteQueryResponse_AttributeResult {
    const message = createBaseCompleteQueryResponse_AttributeResult();
...
function createBaseCompleteQueryResponse_AttributeResultsEntry(): CompleteQueryResponse_AttributeResultsEntry {
  return { key: "", value: undefined };
}

export const CompleteQueryResponse_AttributeResultsEntry: MessageFns<CompleteQueryResponse_AttributeResultsEntry> = {
  encode(
    message: CompleteQueryResponse_AttributeResultsEntry,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    ...
    if (message.value !== undefined) {
      CompleteQueryResponse_AttributeResult.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CompleteQueryResponse_AttributeResultsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCompleteQueryResponse_AttributeResultsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.value = CompleteQueryResponse_AttributeResult.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CompleteQueryResponse_AttributeResultsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? CompleteQueryResponse_AttributeResult.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: CompleteQueryResponse_AttributeResultsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
    if (message.value !== undefined) {
      obj.value = CompleteQueryResponse_AttributeResult.toJSON(message.value);
    }
    return obj;
  },

  create(base?: DeepPartial<CompleteQueryResponse_AttributeResultsEntry>): CompleteQueryResponse_AttributeResultsEntry {
    return CompleteQueryResponse_AttributeResultsEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<CompleteQueryResponse_AttributeResultsEntry>,
  ): CompleteQueryResponse_AttributeResultsEntry {
    const message = createBaseCompleteQueryResponse_AttributeResultsEntry();
    message.key = object.key ?? "";
    message.value = (object.value !== undefined && object.value !== null)
      ? CompleteQueryResponse_AttributeResult.fromPartial(object.value)
      : undefined;
    return message;
  },
};
