...
import { FeatureSpec as FeatureSpec1 } from "./cloudauditlogging/cloudauditlogging.js";
import { MembershipSpec, MembershipState as MembershipState4 } from "./configmanagement/configmanagement.js";
import { MembershipState as MembershipState3 } from "./metering/metering.js";
import { FeatureSpec } from "./multiclusteringress/multiclusteringress.js";
import { FeatureState as FeatureState2, MembershipState } from "./servicemesh/servicemesh.js";
...
export interface CommonFeatureSpec {
  ...
  cloudauditlogging?: FeatureSpec1 | undefined;
}
...
function createBaseCommonFeatureSpec(): CommonFeatureSpec {
  return { multiclusteringress: undefined, cloudauditlogging: undefined };
}
...
export const CommonFeatureSpec: MessageFns<CommonFeatureSpec> = {
  encode(message: CommonFeatureSpec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.cloudauditlogging !== undefined) {
      FeatureSpec1.encode(message.cloudauditlogging, writer.uint32(866).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 108:
          ...
          message.cloudauditlogging = FeatureSpec1.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CommonFeatureSpec {
    return {
      multiclusteringress: isSet(object.multiclusteringress)
        ...
        : undefined,
      cloudauditlogging: isSet(object.cloudauditlogging) ? FeatureSpec1.fromJSON(object.cloudauditlogging) : undefined,
    };
  },
  ...
  toJSON(message: CommonFeatureSpec): unknown {
    ...
    if (message.cloudauditlogging !== undefined) {
      obj.cloudauditlogging = FeatureSpec1.toJSON(message.cloudauditlogging);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<CommonFeatureSpec>): CommonFeatureSpec {
    ...
    message.multiclusteringress = (object.multiclusteringress !== undefined && object.multiclusteringress !== null)
      ...
      : undefined;
    message.cloudauditlogging = (object.cloudauditlogging !== undefined && object.cloudauditlogging !== null)
      ? FeatureSpec1.fromPartial(object.cloudauditlogging)
      : undefined;
    return message;
  },
};
...
function createBaseCommonFeatureState(): CommonFeatureState {
  return { servicemesh: undefined, state: undefined };
}
...
export const CommonFeatureState: MessageFns<CommonFeatureState> = {
  encode(message: CommonFeatureState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.servicemesh !== undefined) {
      FeatureState2.encode(message.servicemesh, writer.uint32(802).fork()).join();
    }
    if (message.state !== undefined) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 100:
          ...
          message.servicemesh = FeatureState2.decode(reader, reader.uint32());
          continue;
        case 1:
          if (tag !== 10) {
            break;
  ...
  fromJSON(object: any): CommonFeatureState {
    return {
      servicemesh: isSet(object.servicemesh) ? FeatureState2.fromJSON(object.servicemesh) : undefined,
  ...
  toJSON(message: CommonFeatureState): unknown {
    const obj: any = {};
    if (message.servicemesh !== undefined) {
      obj.servicemesh = FeatureState2.toJSON(message.servicemesh);
    }
    if (message.state !== undefined) {
  ...
  fromPartial(object: DeepPartial<CommonFeatureState>): CommonFeatureState {
    const message = createBaseCommonFeatureState();
    message.servicemesh = (object.servicemesh !== undefined && object.servicemesh !== null)
      ? FeatureState2.fromPartial(object.servicemesh)
      : undefined;
    message.state = (object.state !== undefined && object.state !== null)
...
function createBaseMembershipFeatureState(): MembershipFeatureState {
  return { servicemesh: undefined, metering: undefined, configmanagement: undefined, state: undefined };
}
...
export const MembershipFeatureState: MessageFns<MembershipFeatureState> = {
  encode(message: MembershipFeatureState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.servicemesh !== undefined) {
      MembershipState.encode(message.servicemesh, writer.uint32(802).fork()).join();
    }
    if (message.metering !== undefined) {
      MembershipState3.encode(message.metering, writer.uint32(834).fork()).join();
    }
    if (message.configmanagement !== undefined) {
      MembershipState4.encode(message.configmanagement, writer.uint32(850).fork()).join();
    }
    if (message.state !== undefined) {
      FeatureState.encode(message.state, writer.uint32(10).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 100:
          ...
          message.servicemesh = MembershipState.decode(reader, reader.uint32());
          continue;
        case 104:
          if (tag !== 834) {
            break;
          ...
          message.metering = MembershipState3.decode(reader, reader.uint32());
          continue;
        case 106:
          if (tag !== 850) {
            break;
          ...
          message.configmanagement = MembershipState4.decode(reader, reader.uint32());
          continue;
        case 1:
          if (tag !== 10) {
            break;
  ...
  fromJSON(object: any): MembershipFeatureState {
    return {
      servicemesh: isSet(object.servicemesh) ? MembershipState.fromJSON(object.servicemesh) : undefined,
      metering: isSet(object.metering) ? MembershipState3.fromJSON(object.metering) : undefined,
      configmanagement: isSet(object.configmanagement) ? MembershipState4.fromJSON(object.configmanagement) : undefined,
      state: isSet(object.state) ? FeatureState.fromJSON(object.state) : undefined,
    };
  },
  ...
  toJSON(message: MembershipFeatureState): unknown {
    const obj: any = {};
    if (message.servicemesh !== undefined) {
      obj.servicemesh = MembershipState.toJSON(message.servicemesh);
    }
    if (message.metering !== undefined) {
      obj.metering = MembershipState3.toJSON(message.metering);
    }
    if (message.configmanagement !== undefined) {
      obj.configmanagement = MembershipState4.toJSON(message.configmanagement);
    }
    if (message.state !== undefined) {
      obj.state = FeatureState.toJSON(message.state);
    }
  ...
  fromPartial(object: DeepPartial<MembershipFeatureState>): MembershipFeatureState {
    const message = createBaseMembershipFeatureState();
    message.servicemesh = (object.servicemesh !== undefined && object.servicemesh !== null)
      ? MembershipState.fromPartial(object.servicemesh)
      : undefined;
    message.metering = (object.metering !== undefined && object.metering !== null)
      ? MembershipState3.fromPartial(object.metering)
      : undefined;
    message.configmanagement = (object.configmanagement !== undefined && object.configmanagement !== null)
      ? MembershipState4.fromPartial(object.configmanagement)
      : undefined;
    message.state = (object.state !== undefined && object.state !== null)
      ? FeatureState.fromPartial(object.state)
      : undefined;
