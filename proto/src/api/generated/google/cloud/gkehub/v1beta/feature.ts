...
import { MembershipSpec as MembershipSpec1, MembershipState } from "../servicemesh/v1beta/servicemesh.js";
import { MembershipSpec, MembershipState as MembershipState3 } from "./configmanagement/configmanagement.js";
import { MembershipState as MembershipState2 } from "./metering/metering.js";
import { FeatureSpec } from "./multiclusteringress/multiclusteringress.js";

export const protobufPackage = "google.cloud.gkehub.v1beta";
...
export interface MembershipFeatureSpec {
  ...
  mesh?: MembershipSpec1 | undefined;
}
...
function createBaseMembershipFeatureSpec(): MembershipFeatureSpec {
  return { configmanagement: undefined, mesh: undefined };
}
...
export const MembershipFeatureSpec: MessageFns<MembershipFeatureSpec> = {
  encode(message: MembershipFeatureSpec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.mesh !== undefined) {
      MembershipSpec1.encode(message.mesh, writer.uint32(930).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 116:
          ...
          message.mesh = MembershipSpec1.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): MembershipFeatureSpec {
    return {
      ...
      mesh: isSet(object.mesh) ? MembershipSpec1.fromJSON(object.mesh) : undefined,
    };
  },
  ...
  toJSON(message: MembershipFeatureSpec): unknown {
    ...
    if (message.mesh !== undefined) {
      obj.mesh = MembershipSpec1.toJSON(message.mesh);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<MembershipFeatureSpec>): MembershipFeatureSpec {
    ...
    message.mesh = (object.mesh !== undefined && object.mesh !== null)
      ? MembershipSpec1.fromPartial(object.mesh)
      : undefined;
    return message;
  },
};
...
export const MembershipFeatureState: MessageFns<MembershipFeatureState> = {
  encode(message: MembershipFeatureState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.metering !== undefined) {
      MembershipState2.encode(message.metering, writer.uint32(834).fork()).join();
    }
    if (message.configmanagement !== undefined) {
      MembershipState3.encode(message.configmanagement, writer.uint32(850).fork()).join();
    }
    if (message.state !== undefined) {
      FeatureState.encode(message.state, writer.uint32(10).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 104:
          ...
          message.metering = MembershipState2.decode(reader, reader.uint32());
          continue;
        case 106:
          if (tag !== 850) {
            break;
          ...
          message.configmanagement = MembershipState3.decode(reader, reader.uint32());
          continue;
        case 1:
          if (tag !== 10) {
            break;
  ...
  fromJSON(object: any): MembershipFeatureState {
    return {
      ...
      metering: isSet(object.metering) ? MembershipState2.fromJSON(object.metering) : undefined,
      configmanagement: isSet(object.configmanagement) ? MembershipState3.fromJSON(object.configmanagement) : undefined,
  ...
  toJSON(message: MembershipFeatureState): unknown {
    ...
    if (message.metering !== undefined) {
      obj.metering = MembershipState2.toJSON(message.metering);
    }
    if (message.configmanagement !== undefined) {
      obj.configmanagement = MembershipState3.toJSON(message.configmanagement);
    }
    if (message.state !== undefined) {
      obj.state = FeatureState.toJSON(message.state);
    }
  ...
  fromPartial(object: DeepPartial<MembershipFeatureState>): MembershipFeatureState {
    ...
    message.metering = (object.metering !== undefined && object.metering !== null)
      ? MembershipState2.fromPartial(object.metering)
      : undefined;
    message.configmanagement = (object.configmanagement !== undefined && object.configmanagement !== null)
      ? MembershipState3.fromPartial(object.configmanagement)
      : undefined;
    message.state = (object.state !== undefined && object.state !== null)
      ? FeatureState.fromPartial(object.state)
      : undefined;
