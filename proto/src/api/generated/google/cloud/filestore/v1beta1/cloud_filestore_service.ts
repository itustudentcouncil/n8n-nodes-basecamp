...
export const protobufPackage = "google.cloud.filestore.v1beta1";
...
export enum NfsExportOptions_SecurityFlavor {
  ...
  /**
   * AUTH_SYS - The user's UNIX user-id and group-ids are transferred "in the clear" (not
...
export function nfsExportOptions_SecurityFlavorFromJSON(object: any): NfsExportOptions_SecurityFlavor {
  switch (object) {
    case 0:
    case "SECURITY_FLAVOR_UNSPECIFIED":
      return NfsExportOptions_SecurityFlavor.SECURITY_FLAVOR_UNSPECIFIED;
    case 1:
    case "AUTH_SYS":
      return NfsExportOptions_SecurityFlavor.AUTH_SYS;
    case 2:
    case "KRB5":
      return NfsExportOptions_SecurityFlavor.KRB5;
    case 3:
    case "KRB5I":
      return NfsExportOptions_SecurityFlavor.KRB5I;
    case 4:
    case "KRB5P":
      return NfsExportOptions_SecurityFlavor.KRB5P;
    case -1:
    case "UNRECOGNIZED":
    default:
      return NfsExportOptions_SecurityFlavor.UNRECOGNIZED;
  }
}

export function nfsExportOptions_SecurityFlavorToJSON(object: NfsExportOptions_SecurityFlavor): string {
  switch (object) {
    case NfsExportOptions_SecurityFlavor.SECURITY_FLAVOR_UNSPECIFIED:
      return "SECURITY_FLAVOR_UNSPECIFIED";
    case NfsExportOptions_SecurityFlavor.AUTH_SYS:
      return "AUTH_SYS";
    case NfsExportOptions_SecurityFlavor.KRB5:
      return "KRB5";
    case NfsExportOptions_SecurityFlavor.KRB5I:
      return "KRB5I";
    case NfsExportOptions_SecurityFlavor.KRB5P:
      return "KRB5P";
    case NfsExportOptions_SecurityFlavor.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface DirectoryServicesConfig {
  ...
  managedActiveDirectory?: ManagedActiveDirectoryConfig | undefined;
}
...
export enum Instance_State {
  ...
  ERROR = 6,
  /**
   * RESTORING - The instance is restoring a snapshot or backup to an existing file share
...
export enum Instance_FileProtocol {
  /**
   * FILE_PROTOCOL_UNSPECIFIED - FILE_PROTOCOL_UNSPECIFIED serves a "not set" default value when
...
export function instance_FileProtocolFromJSON(object: any): Instance_FileProtocol {
  switch (object) {
    case 0:
    case "FILE_PROTOCOL_UNSPECIFIED":
      return Instance_FileProtocol.FILE_PROTOCOL_UNSPECIFIED;
    case 1:
    case "NFS_V3":
      return Instance_FileProtocol.NFS_V3;
    case 2:
    case "NFS_V4_1":
      return Instance_FileProtocol.NFS_V4_1;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Instance_FileProtocol.UNRECOGNIZED;
  }
}

export function instance_FileProtocolToJSON(object: Instance_FileProtocol): string {
  switch (object) {
    case Instance_FileProtocol.FILE_PROTOCOL_UNSPECIFIED:
      return "FILE_PROTOCOL_UNSPECIFIED";
    case Instance_FileProtocol.NFS_V3:
      return "NFS_V3";
    case Instance_FileProtocol.NFS_V4_1:
      return "NFS_V4_1";
    case Instance_FileProtocol.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function share_StateFromJSON(object: any): Share_State {
  switch (object) {
    case 0:
    case "STATE_UNSPECIFIED":
      return Share_State.STATE_UNSPECIFIED;
    case 1:
    case "CREATING":
      return Share_State.CREATING;
    case 3:
    case "READY":
      return Share_State.READY;
    case 4:
    case "DELETING":
      return Share_State.DELETING;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Share_State.UNRECOGNIZED;
  }
}

export function share_StateToJSON(object: Share_State): string {
  switch (object) {
    case Share_State.STATE_UNSPECIFIED:
      return "STATE_UNSPECIFIED";
    case Share_State.CREATING:
      return "CREATING";
    case Share_State.READY:
      return "READY";
    case Share_State.DELETING:
      return "DELETING";
    case Share_State.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export interface Share_LabelsEntry {
  key: string;
  value: string;
}
...
export const FileShareConfig: MessageFns<FileShareConfig> = {
  encode(message: FileShareConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.sourceBackup !== undefined) {
      writer.uint32(74).string(message.sourceBackup);
    }
    for (const v of message.nfsExportOptions) {
      NfsExportOptions.encode(v!, writer.uint32(66).fork()).join();
    }
    return writer;
  },
...
function createBaseNfsExportOptions(): NfsExportOptions {
  return { ipRanges: [], accessMode: 0, squashMode: 0, anonUid: Long.ZERO, anonGid: Long.ZERO, securityFlavors: [] };
}
...
export const NfsExportOptions: MessageFns<NfsExportOptions> = {
  encode(message: NfsExportOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.securityFlavors) {
      writer.int32(v);
    }
    writer.join();
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NfsExportOptions {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          if (tag === 48) {
            message.securityFlavors.push(reader.int32() as any);
  ...
  fromJSON(object: any): NfsExportOptions {
    return {
      ...
      securityFlavors: globalThis.Array.isArray(object?.securityFlavors)
        ? object.securityFlavors.map((e: any) => nfsExportOptions_SecurityFlavorFromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: NfsExportOptions): unknown {
    ...
    if (message.securityFlavors?.length) {
      obj.securityFlavors = message.securityFlavors.map((e) => nfsExportOptions_SecurityFlavorToJSON(e));
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<NfsExportOptions>): NfsExportOptions {
    ...
    message.anonGid = (object.anonGid !== undefined && object.anonGid !== null)
      ...
      : Long.ZERO;
    message.securityFlavors = object.securityFlavors?.map((e) => e) || [];
    return message;
  },
};

function createBaseManagedActiveDirectoryConfig(): ManagedActiveDirectoryConfig {
  return { domain: "", computer: "" };
}

export const ManagedActiveDirectoryConfig: MessageFns<ManagedActiveDirectoryConfig> = {
  encode(message: ManagedActiveDirectoryConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.domain !== "") {
      writer.uint32(10).string(message.domain);
    }
    if (message.computer !== "") {
      writer.uint32(18).string(message.computer);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ManagedActiveDirectoryConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseManagedActiveDirectoryConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ManagedActiveDirectoryConfig {
    return {
      domain: isSet(object.domain) ? globalThis.String(object.domain) : "",
      computer: isSet(object.computer) ? globalThis.String(object.computer) : "",
    };
  },

  toJSON(message: ManagedActiveDirectoryConfig): unknown {
    const obj: any = {};
    if (message.domain !== "") {
      obj.domain = message.domain;
    }
    if (message.computer !== "") {
      obj.computer = message.computer;
    }
    return obj;
  },

  create(base?: DeepPartial<ManagedActiveDirectoryConfig>): ManagedActiveDirectoryConfig {
    return ManagedActiveDirectoryConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ManagedActiveDirectoryConfig>): ManagedActiveDirectoryConfig {
    const message = createBaseManagedActiveDirectoryConfig();
...
function createBaseDirectoryServicesConfig(): DirectoryServicesConfig {
  return { managedActiveDirectory: undefined };
}

export const DirectoryServicesConfig: MessageFns<DirectoryServicesConfig> = {
  encode(message: DirectoryServicesConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.managedActiveDirectory !== undefined) {
      ManagedActiveDirectoryConfig.encode(message.managedActiveDirectory, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DirectoryServicesConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDirectoryServicesConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.managedActiveDirectory = ManagedActiveDirectoryConfig.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DirectoryServicesConfig {
    return {
      managedActiveDirectory: isSet(object.managedActiveDirectory)
        ? ManagedActiveDirectoryConfig.fromJSON(object.managedActiveDirectory)
        : undefined,
    };
  },

  toJSON(message: DirectoryServicesConfig): unknown {
    const obj: any = {};
    if (message.managedActiveDirectory !== undefined) {
      obj.managedActiveDirectory = ManagedActiveDirectoryConfig.toJSON(message.managedActiveDirectory);
    }
    return obj;
  },

  create(base?: DeepPartial<DirectoryServicesConfig>): DirectoryServicesConfig {
    return DirectoryServicesConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DirectoryServicesConfig>): DirectoryServicesConfig {
    const message = createBaseDirectoryServicesConfig();
    message.managedActiveDirectory =
      (object.managedActiveDirectory !== undefined && object.managedActiveDirectory !== null)
        ? ManagedActiveDirectoryConfig.fromPartial(object.managedActiveDirectory)
        : undefined;
    return message;
  },
};
...
function createBaseInstance(): Instance {
  return {
    ...
    kmsKeyName: "",
    suspensionReasons: [],
    maxCapacityGb: Long.ZERO,
    capacityStepSizeGb: Long.ZERO,
    maxShareCount: Long.ZERO,
    capacityGb: Long.ZERO,
    multiShareEnabled: false,
    protocol: 0,
    directoryServices: undefined,
  };
}
...
export const Instance: MessageFns<Instance> = {
  encode(message: Instance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    writer.join();
    if (!message.maxCapacityGb.equals(Long.ZERO)) {
      writer.uint32(128).int64(message.maxCapacityGb.toString());
    }
    if (!message.capacityStepSizeGb.equals(Long.ZERO)) {
      writer.uint32(136).int64(message.capacityStepSizeGb.toString());
    }
    if (!message.maxShareCount.equals(Long.ZERO)) {
      writer.uint32(144).int64(message.maxShareCount.toString());
    }
    if (!message.capacityGb.equals(Long.ZERO)) {
      writer.uint32(152).int64(message.capacityGb.toString());
    }
    if (message.multiShareEnabled !== false) {
      writer.uint32(160).bool(message.multiShareEnabled);
    }
    if (message.protocol !== 0) {
      writer.uint32(168).int32(message.protocol);
    }
    if (message.directoryServices !== undefined) {
      DirectoryServicesConfig.encode(message.directoryServices, writer.uint32(194).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 16:
          ...
          message.maxCapacityGb = Long.fromString(reader.int64().toString());
          continue;
        case 17:
          if (tag !== 136) {
            break;
          ...
          message.capacityStepSizeGb = Long.fromString(reader.int64().toString());
          continue;
        case 18:
          if (tag !== 144) {
            break;
          ...
          message.maxShareCount = Long.fromString(reader.int64().toString());
          continue;
        case 19:
          if (tag !== 152) {
            break;
        ...
        case 24:
          ...
          message.directoryServices = DirectoryServicesConfig.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Instance {
    return {
      ...
      suspensionReasons: globalThis.Array.isArray(object?.suspensionReasons)
        ...
        : [],
      maxCapacityGb: isSet(object.maxCapacityGb) ? Long.fromValue(object.maxCapacityGb) : Long.ZERO,
      capacityStepSizeGb: isSet(object.capacityStepSizeGb) ? Long.fromValue(object.capacityStepSizeGb) : Long.ZERO,
      maxShareCount: isSet(object.maxShareCount) ? Long.fromValue(object.maxShareCount) : Long.ZERO,
      capacityGb: isSet(object.capacityGb) ? Long.fromValue(object.capacityGb) : Long.ZERO,
      multiShareEnabled: isSet(object.multiShareEnabled) ? globalThis.Boolean(object.multiShareEnabled) : false,
      protocol: isSet(object.protocol) ? instance_FileProtocolFromJSON(object.protocol) : 0,
      directoryServices: isSet(object.directoryServices)
        ? DirectoryServicesConfig.fromJSON(object.directoryServices)
        : undefined,
    };
  },
  ...
  toJSON(message: Instance): unknown {
    ...
    if (!message.maxCapacityGb.equals(Long.ZERO)) {
      obj.maxCapacityGb = (message.maxCapacityGb || Long.ZERO).toString();
    }
    if (!message.capacityStepSizeGb.equals(Long.ZERO)) {
      obj.capacityStepSizeGb = (message.capacityStepSizeGb || Long.ZERO).toString();
    }
    if (!message.maxShareCount.equals(Long.ZERO)) {
      obj.maxShareCount = (message.maxShareCount || Long.ZERO).toString();
    }
    if (!message.capacityGb.equals(Long.ZERO)) {
      obj.capacityGb = (message.capacityGb || Long.ZERO).toString();
    }
    if (message.multiShareEnabled !== false) {
      obj.multiShareEnabled = message.multiShareEnabled;
    }
    if (message.protocol !== 0) {
      obj.protocol = instance_FileProtocolToJSON(message.protocol);
    }
    if (message.directoryServices !== undefined) {
      obj.directoryServices = DirectoryServicesConfig.toJSON(message.directoryServices);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Instance>): Instance {
    ...
    message.maxCapacityGb = (object.maxCapacityGb !== undefined && object.maxCapacityGb !== null)
      ? Long.fromValue(object.maxCapacityGb)
      : Long.ZERO;
    message.capacityStepSizeGb = (object.capacityStepSizeGb !== undefined && object.capacityStepSizeGb !== null)
      ? Long.fromValue(object.capacityStepSizeGb)
      : Long.ZERO;
    message.maxShareCount = (object.maxShareCount !== undefined && object.maxShareCount !== null)
      ? Long.fromValue(object.maxShareCount)
      : Long.ZERO;
    message.capacityGb = (object.capacityGb !== undefined && object.capacityGb !== null)
      ? Long.fromValue(object.capacityGb)
      : Long.ZERO;
    message.multiShareEnabled = object.multiShareEnabled ?? false;
    message.protocol = object.protocol ?? 0;
    message.directoryServices = (object.directoryServices !== undefined && object.directoryServices !== null)
      ? DirectoryServicesConfig.fromPartial(object.directoryServices)
      : undefined;
    return message;
  },
};
...
function createBaseRestoreInstanceRequest(): RestoreInstanceRequest {
  return { name: "", fileShare: "", sourceSnapshot: undefined, sourceBackup: undefined };
}
...
export const Snapshot: MessageFns<Snapshot> = {
  encode(message: Snapshot, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.filesystemUsedBytes.equals(Long.ZERO)) {
      writer.uint32(96).int64(message.filesystemUsedBytes.toString());
    }
    return writer;
  },
...
export const Share: MessageFns<Share> = {
  encode(message: Share, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.mountName !== "") {
      writer.uint32(18).string(message.mountName);
    }
    if (message.description !== "") {
      writer.uint32(26).string(message.description);
    }
    if (!message.capacityGb.equals(Long.ZERO)) {
      writer.uint32(32).int64(message.capacityGb.toString());
    }
    for (const v of message.nfsExportOptions) {
      NfsExportOptions.encode(v!, writer.uint32(42).fork()).join();
    }
    if (message.state !== 0) {
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      Share_LabelsEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).join();
    });
    if (message.backup !== undefined) {
      writer.uint32(74).string(message.backup);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          const entry8 = Share_LabelsEntry.decode(reader, reader.uint32());
  ...
  fromJSON(object: any): Share {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      mountName: isSet(object.mountName) ? globalThis.String(object.mountName) : "",
      description: isSet(object.description) ? globalThis.String(object.description) : "",
      capacityGb: isSet(object.capacityGb) ? Long.fromValue(object.capacityGb) : Long.ZERO,
      nfsExportOptions: globalThis.Array.isArray(object?.nfsExportOptions)
        ? object.nfsExportOptions.map((e: any) => NfsExportOptions.fromJSON(e))
        : [],
      state: isSet(object.state) ? share_StateFromJSON(object.state) : 0,
      createTime: isSet(object.createTime) ? fromJsonTimestamp(object.createTime) : undefined,
      labels: isObject(object.labels)
        ? Object.entries(object.labels).reduce<{ [key: string]: string }>((acc, [key, value]) => {
          acc[key] = String(value);
  ...
  toJSON(message: Share): unknown {
    ...
    if (message.mountName !== "") {
      obj.mountName = message.mountName;
    }
    if (message.description !== "") {
      obj.description = message.description;
    }
    ...
    if (message.state !== 0) {
      obj.state = share_StateToJSON(message.state);
    }
    if (message.createTime !== undefined) {
      obj.createTime = message.createTime.toISOString();
    }
  ...
  fromPartial(object: DeepPartial<Share>): Share {
    const message = createBaseShare();
    message.name = object.name ?? "";
    message.mountName = object.mountName ?? "";
    message.description = object.description ?? "";
    message.capacityGb = (object.capacityGb !== undefined && object.capacityGb !== null)
      ? Long.fromValue(object.capacityGb)
      : Long.ZERO;
...
function createBaseShare_LabelsEntry(): Share_LabelsEntry {
  return { key: "", value: "" };
}

export const Share_LabelsEntry: MessageFns<Share_LabelsEntry> = {
  encode(message: Share_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Share_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseShare_LabelsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Share_LabelsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: Share_LabelsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<Share_LabelsEntry>): Share_LabelsEntry {
    return Share_LabelsEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Share_LabelsEntry>): Share_LabelsEntry {
    const message = createBaseShare_LabelsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
function createBaseCreateShareRequest(): CreateShareRequest {
  return { parent: "", shareId: "", share: undefined };
}
...
export const CreateShareRequest: MessageFns<CreateShareRequest> = {
  ...
  create(base?: DeepPartial<CreateShareRequest>): CreateShareRequest {
    return CreateShareRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CreateShareRequest>): CreateShareRequest {
    const message = createBaseCreateShareRequest();
    message.parent = object.parent ?? "";
...
export const GetShareRequest: MessageFns<GetShareRequest> = {
  ...
  create(base?: DeepPartial<GetShareRequest>): GetShareRequest {
    return GetShareRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetShareRequest>): GetShareRequest {
    const message = createBaseGetShareRequest();
    message.name = object.name ?? "";
    return message;
  },
...
function createBaseDeleteShareRequest(): DeleteShareRequest {
  return { name: "" };
}

export const DeleteShareRequest: MessageFns<DeleteShareRequest> = {
  encode(message: DeleteShareRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteShareRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeleteShareRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DeleteShareRequest {
    return { name: isSet(object.name) ? globalThis.String(object.name) : "" };
  },

  toJSON(message: DeleteShareRequest): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create(base?: DeepPartial<DeleteShareRequest>): DeleteShareRequest {
    return DeleteShareRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DeleteShareRequest>): DeleteShareRequest {
    const message = createBaseDeleteShareRequest();
    message.name = object.name ?? "";
    return message;
  },
...
function createBaseListSharesRequest(): ListSharesRequest {
  return { parent: "", pageSize: 0, pageToken: "", orderBy: "", filter: "" };
}

export const ListSharesRequest: MessageFns<ListSharesRequest> = {
  encode(message: ListSharesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parent !== "") {
      writer.uint32(10).string(message.parent);
    }
    if (message.pageSize !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSharesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListSharesRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ListSharesRequest {
    return {
      parent: isSet(object.parent) ? globalThis.String(object.parent) : "",
      pageSize: isSet(object.pageSize) ? globalThis.Number(object.pageSize) : 0,
      pageToken: isSet(object.pageToken) ? globalThis.String(object.pageToken) : "",
  ...
  toJSON(message: ListSharesRequest): unknown {
    const obj: any = {};
    if (message.parent !== "") {
      obj.parent = message.parent;
    }
  ...
  create(base?: DeepPartial<ListSharesRequest>): ListSharesRequest {
    return ListSharesRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListSharesRequest>): ListSharesRequest {
    const message = createBaseListSharesRequest();
    message.parent = object.parent ?? "";
    message.pageSize = object.pageSize ?? 0;
    message.pageToken = object.pageToken ?? "";
...
function createBaseListSharesResponse(): ListSharesResponse {
  return { shares: [], nextPageToken: "", unreachable: [] };
}

export const ListSharesResponse: MessageFns<ListSharesResponse> = {
  encode(message: ListSharesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListSharesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListSharesResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.shares.push(Share.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  fromJSON(object: any): ListSharesResponse {
    return {
      shares: globalThis.Array.isArray(object?.shares) ? object.shares.map((e: any) => Share.fromJSON(e)) : [],
      nextPageToken: isSet(object.nextPageToken) ? globalThis.String(object.nextPageToken) : "",
      unreachable: globalThis.Array.isArray(object?.unreachable)
        ? object.unreachable.map((e: any) => globalThis.String(e))
        : [],
  ...
  toJSON(message: ListSharesResponse): unknown {
    const obj: any = {};
    if (message.shares?.length) {
      obj.shares = message.shares.map((e) => Share.toJSON(e));
    }
    if (message.nextPageToken !== "") {
      obj.nextPageToken = message.nextPageToken;
    }
  ...
  create(base?: DeepPartial<ListSharesResponse>): ListSharesResponse {
    return ListSharesResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListSharesResponse>): ListSharesResponse {
    const message = createBaseListSharesResponse();
    message.shares = object.shares?.map((e) => Share.fromPartial(e)) || [];
    message.nextPageToken = object.nextPageToken ?? "";
    message.unreachable = object.unreachable?.map((e) => e) || [];
    return message;
  },
...
function createBaseUpdateShareRequest(): UpdateShareRequest {
  return { share: undefined, updateMask: undefined };
}

export const UpdateShareRequest: MessageFns<UpdateShareRequest> = {
  encode(message: UpdateShareRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.share !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateShareRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateShareRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): UpdateShareRequest {
    return {
      share: isSet(object.share) ? Share.fromJSON(object.share) : undefined,
      updateMask: isSet(object.updateMask) ? FieldMask.unwrap(FieldMask.fromJSON(object.updateMask)) : undefined,
    };
  ...
  toJSON(message: UpdateShareRequest): unknown {
    const obj: any = {};
    if (message.share !== undefined) {
      obj.share = Share.toJSON(message.share);
    }
  ...
  create(base?: DeepPartial<UpdateShareRequest>): UpdateShareRequest {
    return UpdateShareRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateShareRequest>): UpdateShareRequest {
    const message = createBaseUpdateShareRequest();
    message.share = (object.share !== undefined && object.share !== null) ? Share.fromPartial(object.share) : undefined;
    message.updateMask = object.updateMask ?? undefined;
    return message;
...
export const CloudFilestoreManagerDefinition = {
  ...
  methods: {
    ...
    listShares: {
      name: "ListShares",
      requestType: ListSharesRequest,
      requestStream: false,
      responseType: ListSharesResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([6, 112, 97, 114, 101, 110, 116])],
    ...
    deleteShare: {
      name: "DeleteShare",
      requestType: DeleteShareRequest,
      requestStream: false,
      responseType: Operation,
      responseStream: false,
      options: {
    ...
    updateShare: {
      ...
      options: {
        _unknownFields: {
          ...
          8410: [Buffer.from([17, 115, 104, 97, 114, 101, 44, 117, 112, 100, 97, 116, 101, 95, 109, 97, 115, 107])],
          578365826: [
            Buffer.from([
              74,
              58,
...
export interface CloudFilestoreManagerServiceImplementation<CallContextExt = {}> {
  ...
  listShares(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListSharesResponse>>;
  /** Gets the details of a specific share. */
  getShare(request: GetShareRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Share>>;
  /** Creates a share. */
  createShare(request: CreateShareRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Operation>>;
  /** Deletes a share. */
  deleteShare(request: DeleteShareRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Operation>>;
  /** Updates the settings of a specific share. */
  updateShare(request: UpdateShareRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Operation>>;
}
...
export interface CloudFilestoreManagerClient<CallOptionsExt = {}> {
  ...
  /** Lists all shares for a specified instance. */
  listShares(
    request: DeepPartial<ListSharesRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ListSharesResponse>;
  /** Gets the details of a specific share. */
  getShare(request: DeepPartial<GetShareRequest>, options?: CallOptions & CallOptionsExt): Promise<Share>;
  /** Creates a share. */
  createShare(request: DeepPartial<CreateShareRequest>, options?: CallOptions & CallOptionsExt): Promise<Operation>;
  /** Deletes a share. */
  deleteShare(request: DeepPartial<DeleteShareRequest>, options?: CallOptions & CallOptionsExt): Promise<Operation>;
  /** Updates the settings of a specific share. */
  updateShare(request: DeepPartial<UpdateShareRequest>, options?: CallOptions & CallOptionsExt): Promise<Operation>;
}
