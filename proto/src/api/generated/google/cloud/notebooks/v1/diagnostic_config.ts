...
export const DiagnosticConfig: MessageFns<DiagnosticConfig> = {
  encode(message: DiagnosticConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.repairFlagEnabled !== false) {
      writer.uint32(24).bool(message.repairFlagEnabled);
    }
    if (message.packetCaptureFlagEnabled !== false) {
      writer.uint32(32).bool(message.packetCaptureFlagEnabled);
    }
    if (message.copyHomeFilesFlagEnabled !== false) {
      writer.uint32(40).bool(message.copyHomeFilesFlagEnabled);
    }
    return writer;
  },
  ...
  fromJSON(object: any): DiagnosticConfig {
    return {
      ...
      repairFlagEnabled: isSet(object.repairFlagEnabled) ? globalThis.Boolean(object.repairFlagEnabled) : false,
      packetCaptureFlagEnabled: isSet(object.packetCaptureFlagEnabled)
        ? globalThis.Boolean(object.packetCaptureFlagEnabled)
        : false,
      copyHomeFilesFlagEnabled: isSet(object.copyHomeFilesFlagEnabled)
        ? globalThis.Boolean(object.copyHomeFilesFlagEnabled)
        : false,
    };
  },
  ...
  toJSON(message: DiagnosticConfig): unknown {
    ...
    if (message.repairFlagEnabled !== false) {
      obj.repairFlagEnabled = message.repairFlagEnabled;
    }
    if (message.packetCaptureFlagEnabled !== false) {
      obj.packetCaptureFlagEnabled = message.packetCaptureFlagEnabled;
    }
    if (message.copyHomeFilesFlagEnabled !== false) {
      obj.copyHomeFilesFlagEnabled = message.copyHomeFilesFlagEnabled;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<DiagnosticConfig>): DiagnosticConfig {
    ...
    message.repairFlagEnabled = object.repairFlagEnabled ?? false;
    message.packetCaptureFlagEnabled = object.packetCaptureFlagEnabled ?? false;
    message.copyHomeFilesFlagEnabled = object.copyHomeFilesFlagEnabled ?? false;
    return message;
  },
};
