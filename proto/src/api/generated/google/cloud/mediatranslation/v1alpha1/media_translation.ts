...
export const protobufPackage = "google.cloud.mediatranslation.v1alpha1";
...
/** Audio translation result. */
export interface StreamingTranslateSpeechResult_AudioTranslationResult {
  /** Output only. The translated audio. */
  audioTranslation: Buffer;
}
...
export const TranslateSpeechConfig: MessageFns<TranslateSpeechConfig> = {
  encode(message: TranslateSpeechConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.alternativeSourceLanguageCodes) {
  ...
  fromJSON(object: any): TranslateSpeechConfig {
    return {
      ...
      alternativeSourceLanguageCodes: globalThis.Array.isArray(object?.alternativeSourceLanguageCodes)
        ? object.alternativeSourceLanguageCodes.map((e: any) => globalThis.String(e))
        : [],
  ...
  toJSON(message: TranslateSpeechConfig): unknown {
    ...
    if (message.alternativeSourceLanguageCodes?.length) {
      obj.alternativeSourceLanguageCodes = message.alternativeSourceLanguageCodes;
    }
    if (message.sampleRateHertz !== 0) {
  ...
  fromPartial(object: DeepPartial<TranslateSpeechConfig>): TranslateSpeechConfig {
    ...
    message.alternativeSourceLanguageCodes = object.alternativeSourceLanguageCodes?.map((e) => e) || [];
...
export const StreamingTranslateSpeechConfig: MessageFns<StreamingTranslateSpeechConfig> = {
  encode(message: StreamingTranslateSpeechConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stability !== "") {
      writer.uint32(26).string(message.stability);
    }
    if (message.translationMode !== "") {
      writer.uint32(34).string(message.translationMode);
    }
    if (message.disableInterimResults !== false) {
      writer.uint32(40).bool(message.disableInterimResults);
    }
    return writer;
  },
  ...
  fromJSON(object: any): StreamingTranslateSpeechConfig {
    return {
      ...
      stability: isSet(object.stability) ? globalThis.String(object.stability) : "",
      translationMode: isSet(object.translationMode) ? globalThis.String(object.translationMode) : "",
      disableInterimResults: isSet(object.disableInterimResults)
        ? globalThis.Boolean(object.disableInterimResults)
        : false,
    };
  },
  ...
  toJSON(message: StreamingTranslateSpeechConfig): unknown {
    ...
    if (message.translationMode !== "") {
      obj.translationMode = message.translationMode;
    }
    if (message.disableInterimResults !== false) {
      obj.disableInterimResults = message.disableInterimResults;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<StreamingTranslateSpeechConfig>): StreamingTranslateSpeechConfig {
    ...
    message.stability = object.stability ?? "";
    message.translationMode = object.translationMode ?? "";
    message.disableInterimResults = object.disableInterimResults ?? false;
    return message;
  },
};
...
function createBaseStreamingTranslateSpeechResult(): StreamingTranslateSpeechResult {
  return {
    textTranslationResult: undefined,
    audioTranslationResult: undefined,
    recognitionResult: "",
...
export const StreamingTranslateSpeechResult: MessageFns<StreamingTranslateSpeechResult> = {
  encode(message: StreamingTranslateSpeechResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.audioTranslationResult !== undefined) {
      StreamingTranslateSpeechResult_AudioTranslationResult.encode(
        message.audioTranslationResult,
        writer.uint32(18).fork(),
      ).join();
    }
    if (message.recognitionResult !== "") {
      writer.uint32(26).string(message.recognitionResult);
    }
    if (message.detectedSourceLanguageCode !== "") {
      writer.uint32(34).string(message.detectedSourceLanguageCode);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.audioTranslationResult = StreamingTranslateSpeechResult_AudioTranslationResult.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): StreamingTranslateSpeechResult {
    return {
      textTranslationResult: isSet(object.textTranslationResult)
        ...
        : undefined,
      audioTranslationResult: isSet(object.audioTranslationResult)
        ? StreamingTranslateSpeechResult_AudioTranslationResult.fromJSON(object.audioTranslationResult)
        : undefined,
      recognitionResult: isSet(object.recognitionResult) ? globalThis.String(object.recognitionResult) : "",
      detectedSourceLanguageCode: isSet(object.detectedSourceLanguageCode)
        ? globalThis.String(object.detectedSourceLanguageCode)
        : "",
    };
  },
  ...
  toJSON(message: StreamingTranslateSpeechResult): unknown {
    ...
    if (message.audioTranslationResult !== undefined) {
      obj.audioTranslationResult = StreamingTranslateSpeechResult_AudioTranslationResult.toJSON(
        message.audioTranslationResult,
      );
    }
    if (message.recognitionResult !== "") {
      obj.recognitionResult = message.recognitionResult;
    }
    if (message.detectedSourceLanguageCode !== "") {
      obj.detectedSourceLanguageCode = message.detectedSourceLanguageCode;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<StreamingTranslateSpeechResult>): StreamingTranslateSpeechResult {
    ...
    message.textTranslationResult =
      (object.textTranslationResult !== undefined && object.textTranslationResult !== null)
        ...
        : undefined;
    message.audioTranslationResult =
      (object.audioTranslationResult !== undefined && object.audioTranslationResult !== null)
        ? StreamingTranslateSpeechResult_AudioTranslationResult.fromPartial(object.audioTranslationResult)
        : undefined;
    message.recognitionResult = object.recognitionResult ?? "";
    message.detectedSourceLanguageCode = object.detectedSourceLanguageCode ?? "";
    return message;
  },
};
...
function createBaseStreamingTranslateSpeechResult_AudioTranslationResult(): StreamingTranslateSpeechResult_AudioTranslationResult {
  return { audioTranslation: Buffer.alloc(0) };
}

export const StreamingTranslateSpeechResult_AudioTranslationResult: MessageFns<
  StreamingTranslateSpeechResult_AudioTranslationResult
> = {
  encode(
    message: StreamingTranslateSpeechResult_AudioTranslationResult,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.audioTranslation.length !== 0) {
      writer.uint32(10).bytes(message.audioTranslation);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamingTranslateSpeechResult_AudioTranslationResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStreamingTranslateSpeechResult_AudioTranslationResult();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.audioTranslation = Buffer.from(reader.bytes());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): StreamingTranslateSpeechResult_AudioTranslationResult {
    return {
      audioTranslation: isSet(object.audioTranslation)
        ? Buffer.from(bytesFromBase64(object.audioTranslation))
        : Buffer.alloc(0),
    };
  },

  toJSON(message: StreamingTranslateSpeechResult_AudioTranslationResult): unknown {
    const obj: any = {};
    if (message.audioTranslation.length !== 0) {
      obj.audioTranslation = base64FromBytes(message.audioTranslation);
    }
    return obj;
  },

  create(
    base?: DeepPartial<StreamingTranslateSpeechResult_AudioTranslationResult>,
  ): StreamingTranslateSpeechResult_AudioTranslationResult {
    return StreamingTranslateSpeechResult_AudioTranslationResult.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<StreamingTranslateSpeechResult_AudioTranslationResult>,
  ): StreamingTranslateSpeechResult_AudioTranslationResult {
    const message = createBaseStreamingTranslateSpeechResult_AudioTranslationResult();
    message.audioTranslation = object.audioTranslation ?? Buffer.alloc(0);
    return message;
  },
};
