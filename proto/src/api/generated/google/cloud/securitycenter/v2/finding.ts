...
export const Finding: MessageFns<Finding> = {
  encode(message: Finding, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.externalUri !== "") {
      writer.uint32(66).string(message.externalUri);
    }
    Object.entries(message.sourceProperties).forEach(([key, value]) => {
      if (value !== undefined) {
        Finding_SourcePropertiesEntry.encode({ key: key as any, value }, writer.uint32(74).fork()).join();
      }
    });
    if (message.securityMarks !== undefined) {
      SecurityMarks.encode(message.securityMarks, writer.uint32(82).fork()).join();
    }
    if (message.eventTime !== undefined) {
      Timestamp.encode(toTimestamp(message.eventTime), writer.uint32(90).fork()).join();
    }
    if (message.createTime !== undefined) {
      Timestamp.encode(toTimestamp(message.createTime), writer.uint32(98).fork()).join();
    }
    if (message.severity !== 0) {
      writer.uint32(112).int32(message.severity);
    }
    if (message.mute !== 0) {
      writer.uint32(120).int32(message.mute);
    }
    if (message.muteInfo !== undefined) {
      Finding_MuteInfo.encode(message.muteInfo, writer.uint32(426).fork()).join();
    }
    if (message.findingClass !== 0) {
      writer.uint32(128).int32(message.findingClass);
    }
    if (message.indicator !== undefined) {
      Indicator.encode(message.indicator, writer.uint32(138).fork()).join();
    }
    if (message.vulnerability !== undefined) {
      Vulnerability.encode(message.vulnerability, writer.uint32(146).fork()).join();
    }
    if (message.muteUpdateTime !== undefined) {
      Timestamp.encode(toTimestamp(message.muteUpdateTime), writer.uint32(154).fork()).join();
    }
    Object.entries(message.externalSystems).forEach(([key, value]) => {
      Finding_ExternalSystemsEntry.encode({ key: key as any, value }, writer.uint32(162).fork()).join();
    });
    if (message.mitreAttack !== undefined) {
      MitreAttack.encode(message.mitreAttack, writer.uint32(170).fork()).join();
    }
    if (message.access !== undefined) {
      Access.encode(message.access, writer.uint32(178).fork()).join();
    }
    for (const v of message.connections) {
      Connection.encode(v!, writer.uint32(186).fork()).join();
    }
    if (message.muteInitiator !== "") {
      writer.uint32(194).string(message.muteInitiator);
    }
    for (const v of message.processes) {
      Process.encode(v!, writer.uint32(202).fork()).join();
    }
    Object.entries(message.contacts).forEach(([key, value]) => {
      Finding_ContactsEntry.encode({ key: key as any, value }, writer.uint32(210).fork()).join();
    });
    for (const v of message.compliances) {
      Compliance.encode(v!, writer.uint32(218).fork()).join();
    }
    if (message.parentDisplayName !== "") {
      writer.uint32(234).string(message.parentDisplayName);
    }
    if (message.description !== "") {
      writer.uint32(242).string(message.description);
    }
    if (message.exfiltration !== undefined) {
      Exfiltration.encode(message.exfiltration, writer.uint32(250).fork()).join();
    }
    for (const v of message.iamBindings) {
      IamBinding.encode(v!, writer.uint32(258).fork()).join();
    }
    if (message.nextSteps !== "") {
      writer.uint32(266).string(message.nextSteps);
    }
    if (message.moduleName !== "") {
      writer.uint32(274).string(message.moduleName);
    }
    for (const v of message.containers) {
      Container.encode(v!, writer.uint32(282).fork()).join();
    }
    if (message.kubernetes !== undefined) {
      Kubernetes.encode(message.kubernetes, writer.uint32(290).fork()).join();
    }
    if (message.database !== undefined) {
      Database.encode(message.database, writer.uint32(298).fork()).join();
    }
    if (message.attackExposure !== undefined) {
      AttackExposure.encode(message.attackExposure, writer.uint32(306).fork()).join();
    }
    for (const v of message.files) {
      File.encode(v!, writer.uint32(314).fork()).join();
    }
    if (message.cloudDlpInspection !== undefined) {
      CloudDlpInspection.encode(message.cloudDlpInspection, writer.uint32(322).fork()).join();
    }
    if (message.cloudDlpDataProfile !== undefined) {
      CloudDlpDataProfile.encode(message.cloudDlpDataProfile, writer.uint32(330).fork()).join();
    }
    if (message.kernelRootkit !== undefined) {
      KernelRootkit.encode(message.kernelRootkit, writer.uint32(338).fork()).join();
    }
    for (const v of message.orgPolicies) {
      OrgPolicy.encode(v!, writer.uint32(346).fork()).join();
    }
    if (message.application !== undefined) {
      Application.encode(message.application, writer.uint32(362).fork()).join();
    }
    if (message.backupDisasterRecovery !== undefined) {
      BackupDisasterRecovery.encode(message.backupDisasterRecovery, writer.uint32(378).fork()).join();
    }
    if (message.securityPosture !== undefined) {
      SecurityPosture.encode(message.securityPosture, writer.uint32(386).fork()).join();
    }
    for (const v of message.logEntries) {
      LogEntry.encode(v!, writer.uint32(394).fork()).join();
    }
    for (const v of message.loadBalancers) {
      LoadBalancer.encode(v!, writer.uint32(402).fork()).join();
    }
    if (message.cloudArmor !== undefined) {
      CloudArmor.encode(message.cloudArmor, writer.uint32(410).fork()).join();
    }
    if (message.notebook !== undefined) {
      Notebook.encode(message.notebook, writer.uint32(442).fork()).join();
    }
    if (message.toxicCombination !== undefined) {
      ToxicCombination.encode(message.toxicCombination, writer.uint32(450).fork()).join();
    }
    for (const v of message.groupMemberships) {
      GroupMembership.encode(v!, writer.uint32(458).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          const entry9 = Finding_SourcePropertiesEntry.decode(reader, reader.uint32());
          if (entry9.value !== undefined) {
            message.sourceProperties[entry9.key] = entry9.value;
          }
          continue;
        case 10:
          if (tag !== 82) {
        ...
        case 20:
          ...
          const entry20 = Finding_ExternalSystemsEntry.decode(reader, reader.uint32());
          if (entry20.value !== undefined) {
            message.externalSystems[entry20.key] = entry20.value;
          }
          continue;
        case 21:
          if (tag !== 170) {
        ...
        case 26:
          ...
          const entry26 = Finding_ContactsEntry.decode(reader, reader.uint32());
          if (entry26.value !== undefined) {
            message.contacts[entry26.key] = entry26.value;
          }
          continue;
        case 27:
          if (tag !== 218) {
