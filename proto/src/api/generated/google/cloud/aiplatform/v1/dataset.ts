...
export function exportDataConfig_ExportUseFromJSON(object: any): ExportDataConfig_ExportUse {
  switch (object) {
    case 0:
    case "EXPORT_USE_UNSPECIFIED":
      return ExportDataConfig_ExportUse.EXPORT_USE_UNSPECIFIED;
    case 6:
    case "CUSTOM_CODE_TRAINING":
      return ExportDataConfig_ExportUse.CUSTOM_CODE_TRAINING;
    case -1:
    case "UNRECOGNIZED":
    default:
      return ExportDataConfig_ExportUse.UNRECOGNIZED;
  }
}

export function exportDataConfig_ExportUseToJSON(object: ExportDataConfig_ExportUse): string {
  switch (object) {
    case ExportDataConfig_ExportUse.EXPORT_USE_UNSPECIFIED:
      return "EXPORT_USE_UNSPECIFIED";
    case ExportDataConfig_ExportUse.CUSTOM_CODE_TRAINING:
      return "CUSTOM_CODE_TRAINING";
    case ExportDataConfig_ExportUse.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
 ...
 */
export interface ExportFilterSplit {
  /**
...
export const ExportDataConfig: MessageFns<ExportDataConfig> = {
  encode(message: ExportDataConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.filterSplit !== undefined) {
      ExportFilterSplit.encode(message.filterSplit, writer.uint32(58).fork()).join();
    }
    if (message.annotationsFilter !== "") {
      writer.uint32(18).string(message.annotationsFilter);
    }
    if (message.savedQueryId !== "") {
      writer.uint32(90).string(message.savedQueryId);
    }
    if (message.annotationSchemaUri !== "") {
      writer.uint32(98).string(message.annotationSchemaUri);
    }
    if (message.exportUse !== 0) {
      writer.uint32(32).int32(message.exportUse);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.filterSplit = ExportFilterSplit.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
        ...
        case 4:
          ...
          message.exportUse = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ExportDataConfig {
    return {
      ...
      filterSplit: isSet(object.filterSplit) ? ExportFilterSplit.fromJSON(object.filterSplit) : undefined,
      ...
      exportUse: isSet(object.exportUse) ? exportDataConfig_ExportUseFromJSON(object.exportUse) : 0,
    };
  },
  ...
  toJSON(message: ExportDataConfig): unknown {
    ...
    if (message.filterSplit !== undefined) {
      obj.filterSplit = ExportFilterSplit.toJSON(message.filterSplit);
    }
    if (message.annotationsFilter !== "") {
    ...
    if (message.exportUse !== 0) {
      obj.exportUse = exportDataConfig_ExportUseToJSON(message.exportUse);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ExportDataConfig>): ExportDataConfig {
    ...
    message.filterSplit = (object.filterSplit !== undefined && object.filterSplit !== null)
      ? ExportFilterSplit.fromPartial(object.filterSplit)
      : undefined;
    ...
    message.exportUse = object.exportUse ?? 0;
    return message;
  },
};
...
function createBaseExportFilterSplit(): ExportFilterSplit {
  return { trainingFilter: "", validationFilter: "", testFilter: "" };
}

export const ExportFilterSplit: MessageFns<ExportFilterSplit> = {
  encode(message: ExportFilterSplit, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportFilterSplit {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExportFilterSplit();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ExportFilterSplit {
    return {
  ...
  toJSON(message: ExportFilterSplit): unknown {
    const obj: any = {};
    if (message.trainingFilter !== "") {
  ...
  create(base?: DeepPartial<ExportFilterSplit>): ExportFilterSplit {
    return ExportFilterSplit.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ExportFilterSplit>): ExportFilterSplit {
    const message = createBaseExportFilterSplit();
