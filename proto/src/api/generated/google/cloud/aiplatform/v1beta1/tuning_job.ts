 ...
 * population of values.
 */
export interface DatasetDistribution_DistributionBucket {
  /** Output only. Number of values in the bucket. */
  count: Long;
  /** Output only. Left bound of the bucket. */
  left: number;
...
export interface DistillationDataStats {
  ...
  trainingDatasetStats: DatasetStats | undefined;
}
...
export interface TuningDataStats {
  ...
  distillationDataStats?: DistillationDataStats | undefined;
}
...
export const TuningJob: MessageFns<TuningJob> = {
  encode(message: TuningJob, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.distillationSpec !== undefined) {
      DistillationSpec.encode(message.distillationSpec, writer.uint32(138).fork()).join();
    }
    if (message.name !== "") {
    ...
    if (message.pipelineJob !== "") {
      writer.uint32(146).string(message.pipelineJob);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 17:
          ...
          message.distillationSpec = DistillationSpec.decode(reader, reader.uint32());
          continue;
        case 1:
          if (tag !== 10) {
            break;
  ...
  fromJSON(object: any): TuningJob {
    return {
      ...
      supervisedTuningSpec: isSet(object.supervisedTuningSpec)
        ...
        : undefined,
      distillationSpec: isSet(object.distillationSpec) ? DistillationSpec.fromJSON(object.distillationSpec) : undefined,
  ...
  toJSON(message: TuningJob): unknown {
    ...
    if (message.distillationSpec !== undefined) {
      obj.distillationSpec = DistillationSpec.toJSON(message.distillationSpec);
    }
    if (message.name !== "") {
  ...
  fromPartial(object: DeepPartial<TuningJob>): TuningJob {
    ...
    message.supervisedTuningSpec = (object.supervisedTuningSpec !== undefined && object.supervisedTuningSpec !== null)
      ...
      : undefined;
    message.distillationSpec = (object.distillationSpec !== undefined && object.distillationSpec !== null)
      ? DistillationSpec.fromPartial(object.distillationSpec)
      : undefined;
...
function createBaseDatasetDistribution(): DatasetDistribution {
  return { sum: 0, min: 0, max: 0, mean: 0, median: 0, p5: 0, p95: 0, buckets: [] };
}

export const DatasetDistribution: MessageFns<DatasetDistribution> = {
  encode(message: DatasetDistribution, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sum !== 0) {
    ...
    for (const v of message.buckets) {
      DatasetDistribution_DistributionBucket.encode(v!, writer.uint32(66).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DatasetDistribution {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDatasetDistribution();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 8:
          ...
          message.buckets.push(DatasetDistribution_DistributionBucket.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DatasetDistribution {
    return {
      ...
      p95: isSet(object.p95) ? globalThis.Number(object.p95) : 0,
      buckets: globalThis.Array.isArray(object?.buckets)
        ? object.buckets.map((e: any) => DatasetDistribution_DistributionBucket.fromJSON(e))
        : [],
    };
  },

  toJSON(message: DatasetDistribution): unknown {
    const obj: any = {};
    if (message.sum !== 0) {
      obj.sum = message.sum;
    }
    ...
    if (message.buckets?.length) {
      obj.buckets = message.buckets.map((e) => DatasetDistribution_DistributionBucket.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<DatasetDistribution>): DatasetDistribution {
    return DatasetDistribution.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DatasetDistribution>): DatasetDistribution {
    const message = createBaseDatasetDistribution();
    ...
    message.p5 = object.p5 ?? 0;
    message.p95 = object.p95 ?? 0;
    message.buckets = object.buckets?.map((e) => DatasetDistribution_DistributionBucket.fromPartial(e)) || [];
    return message;
  },
};

function createBaseDatasetDistribution_DistributionBucket(): DatasetDistribution_DistributionBucket {
  return { count: Long.ZERO, left: 0, right: 0 };
}

export const DatasetDistribution_DistributionBucket: MessageFns<DatasetDistribution_DistributionBucket> = {
  encode(message: DatasetDistribution_DistributionBucket, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DatasetDistribution_DistributionBucket {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDatasetDistribution_DistributionBucket();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DatasetDistribution_DistributionBucket {
    return {
  ...
  toJSON(message: DatasetDistribution_DistributionBucket): unknown {
    const obj: any = {};
    if (!message.count.equals(Long.ZERO)) {
  ...
  create(base?: DeepPartial<DatasetDistribution_DistributionBucket>): DatasetDistribution_DistributionBucket {
    return DatasetDistribution_DistributionBucket.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DatasetDistribution_DistributionBucket>): DatasetDistribution_DistributionBucket {
    const message = createBaseDatasetDistribution_DistributionBucket();
...
function createBaseDatasetStats(): DatasetStats {
  return {
    tuningDatasetExampleCount: Long.ZERO,
    totalTuningCharacterCount: Long.ZERO,
    totalBillableCharacterCount: Long.ZERO,
...
export const DatasetStats: MessageFns<DatasetStats> = {
  encode(message: DatasetStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.tuningDatasetExampleCount.equals(Long.ZERO)) {
      writer.uint32(8).int64(message.tuningDatasetExampleCount.toString());
    }
    if (!message.totalTuningCharacterCount.equals(Long.ZERO)) {
    ...
    if (message.userInputTokenDistribution !== undefined) {
      DatasetDistribution.encode(message.userInputTokenDistribution, writer.uint32(42).fork()).join();
    }
    if (message.userOutputTokenDistribution !== undefined) {
      DatasetDistribution.encode(message.userOutputTokenDistribution, writer.uint32(50).fork()).join();
    }
    if (message.userMessagePerExampleDistribution !== undefined) {
      DatasetDistribution.encode(message.userMessagePerExampleDistribution, writer.uint32(58).fork()).join();
    }
    for (const v of message.userDatasetExamples) {
      Content.encode(v!, writer.uint32(66).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DatasetStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDatasetStats();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 5:
          ...
          message.userInputTokenDistribution = DatasetDistribution.decode(reader, reader.uint32());
          continue;
        case 6:
          if (tag !== 50) {
            break;
          ...
          message.userOutputTokenDistribution = DatasetDistribution.decode(reader, reader.uint32());
          continue;
        case 7:
          if (tag !== 58) {
            break;
          ...
          message.userMessagePerExampleDistribution = DatasetDistribution.decode(reader, reader.uint32());
          continue;
        case 8:
          if (tag !== 66) {
            break;
  ...
  fromJSON(object: any): DatasetStats {
    return {
      tuningDatasetExampleCount: isSet(object.tuningDatasetExampleCount)
        ? Long.fromValue(object.tuningDatasetExampleCount)
        : Long.ZERO,
      ...
      tuningStepCount: isSet(object.tuningStepCount) ? Long.fromValue(object.tuningStepCount) : Long.ZERO,
      userInputTokenDistribution: isSet(object.userInputTokenDistribution)
        ? DatasetDistribution.fromJSON(object.userInputTokenDistribution)
        : undefined,
      userOutputTokenDistribution: isSet(object.userOutputTokenDistribution)
        ? DatasetDistribution.fromJSON(object.userOutputTokenDistribution)
        : undefined,
      userMessagePerExampleDistribution: isSet(object.userMessagePerExampleDistribution)
        ? DatasetDistribution.fromJSON(object.userMessagePerExampleDistribution)
        : undefined,
      userDatasetExamples: globalThis.Array.isArray(object?.userDatasetExamples)
        ? object.userDatasetExamples.map((e: any) => Content.fromJSON(e))
        : [],
  ...
  toJSON(message: DatasetStats): unknown {
    const obj: any = {};
    if (!message.tuningDatasetExampleCount.equals(Long.ZERO)) {
      obj.tuningDatasetExampleCount = (message.tuningDatasetExampleCount || Long.ZERO).toString();
    }
    ...
    if (message.userInputTokenDistribution !== undefined) {
      obj.userInputTokenDistribution = DatasetDistribution.toJSON(message.userInputTokenDistribution);
    }
    if (message.userOutputTokenDistribution !== undefined) {
      obj.userOutputTokenDistribution = DatasetDistribution.toJSON(message.userOutputTokenDistribution);
    }
    if (message.userMessagePerExampleDistribution !== undefined) {
      obj.userMessagePerExampleDistribution = DatasetDistribution.toJSON(message.userMessagePerExampleDistribution);
    }
    if (message.userDatasetExamples?.length) {
      obj.userDatasetExamples = message.userDatasetExamples.map((e) => Content.toJSON(e));
    }
  ...
  create(base?: DeepPartial<DatasetStats>): DatasetStats {
    return DatasetStats.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DatasetStats>): DatasetStats {
    const message = createBaseDatasetStats();
    message.tuningDatasetExampleCount =
      (object.tuningDatasetExampleCount !== undefined && object.tuningDatasetExampleCount !== null)
        ? Long.fromValue(object.tuningDatasetExampleCount)
    ...
    message.userInputTokenDistribution =
      (object.userInputTokenDistribution !== undefined && object.userInputTokenDistribution !== null)
        ? DatasetDistribution.fromPartial(object.userInputTokenDistribution)
        : undefined;
    message.userOutputTokenDistribution =
      (object.userOutputTokenDistribution !== undefined && object.userOutputTokenDistribution !== null)
        ? DatasetDistribution.fromPartial(object.userOutputTokenDistribution)
        : undefined;
    message.userMessagePerExampleDistribution =
      (object.userMessagePerExampleDistribution !== undefined && object.userMessagePerExampleDistribution !== null)
        ? DatasetDistribution.fromPartial(object.userMessagePerExampleDistribution)
        : undefined;
    message.userDatasetExamples = object.userDatasetExamples?.map((e) => Content.fromPartial(e)) || [];
    return message;
  },
...
function createBaseDistillationDataStats(): DistillationDataStats {
  return { trainingDatasetStats: undefined };
}

export const DistillationDataStats: MessageFns<DistillationDataStats> = {
  encode(message: DistillationDataStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.trainingDatasetStats !== undefined) {
      DatasetStats.encode(message.trainingDatasetStats, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DistillationDataStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDistillationDataStats();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.trainingDatasetStats = DatasetStats.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DistillationDataStats {
    return {
      trainingDatasetStats: isSet(object.trainingDatasetStats)
        ? DatasetStats.fromJSON(object.trainingDatasetStats)
        : undefined,
    };
  },

  toJSON(message: DistillationDataStats): unknown {
    const obj: any = {};
    if (message.trainingDatasetStats !== undefined) {
      obj.trainingDatasetStats = DatasetStats.toJSON(message.trainingDatasetStats);
    }
    return obj;
  },

  create(base?: DeepPartial<DistillationDataStats>): DistillationDataStats {
    return DistillationDataStats.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DistillationDataStats>): DistillationDataStats {
    const message = createBaseDistillationDataStats();
    message.trainingDatasetStats = (object.trainingDatasetStats !== undefined && object.trainingDatasetStats !== null)
      ? DatasetStats.fromPartial(object.trainingDatasetStats)
      : undefined;
    return message;
  },
};
...
function createBaseTuningDataStats(): TuningDataStats {
  return { supervisedTuningDataStats: undefined, distillationDataStats: undefined };
}
...
export const TuningDataStats: MessageFns<TuningDataStats> = {
  encode(message: TuningDataStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.distillationDataStats !== undefined) {
      DistillationDataStats.encode(message.distillationDataStats, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.distillationDataStats = DistillationDataStats.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): TuningDataStats {
    return {
      supervisedTuningDataStats: isSet(object.supervisedTuningDataStats)
        ...
        : undefined,
      distillationDataStats: isSet(object.distillationDataStats)
        ? DistillationDataStats.fromJSON(object.distillationDataStats)
        : undefined,
    };
  },
  ...
  toJSON(message: TuningDataStats): unknown {
    ...
    if (message.distillationDataStats !== undefined) {
      obj.distillationDataStats = DistillationDataStats.toJSON(message.distillationDataStats);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<TuningDataStats>): TuningDataStats {
    ...
    message.distillationDataStats =
      (object.distillationDataStats !== undefined && object.distillationDataStats !== null)
        ? DistillationDataStats.fromPartial(object.distillationDataStats)
        : undefined;
    return message;
  },
};
...
function createBaseDistillationSpec(): DistillationSpec {
  return {
    baseTeacherModel: undefined,
    tunedTeacherModelSource: undefined,
    trainingDatasetUri: "",
...
export const DistillationSpec: MessageFns<DistillationSpec> = {
  encode(message: DistillationSpec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.baseTeacherModel !== undefined) {
      writer.uint32(42).string(message.baseTeacherModel);
    }
    if (message.tunedTeacherModelSource !== undefined) {
      writer.uint32(50).string(message.tunedTeacherModelSource);
    }
    if (message.trainingDatasetUri !== "") {
      writer.uint32(10).string(message.trainingDatasetUri);
    }
    if (message.validationDatasetUri !== undefined) {
      writer.uint32(18).string(message.validationDatasetUri);
    }
    if (message.hyperParameters !== undefined) {
      DistillationHyperParameters.encode(message.hyperParameters, writer.uint32(26).fork()).join();
    }
    if (message.studentModel !== "") {
      writer.uint32(34).string(message.studentModel);
    }
    if (message.pipelineRootDirectory !== "") {
      writer.uint32(58).string(message.pipelineRootDirectory);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DistillationSpec {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDistillationSpec();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 5:
          ...
          message.baseTeacherModel = reader.string();
          continue;
        case 6:
          if (tag !== 50) {
            break;
          ...
          message.tunedTeacherModelSource = reader.string();
          continue;
        case 1:
          if (tag !== 10) {
            break;
        ...
        case 3:
          ...
          message.hyperParameters = DistillationHyperParameters.decode(reader, reader.uint32());
          continue;
        case 4:
          if (tag !== 34) {
            break;
          ...
          message.studentModel = reader.string();
          continue;
        case 7:
          if (tag !== 58) {
            break;
          ...
          message.pipelineRootDirectory = reader.string();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DistillationSpec {
    return {
      baseTeacherModel: isSet(object.baseTeacherModel) ? globalThis.String(object.baseTeacherModel) : undefined,
      tunedTeacherModelSource: isSet(object.tunedTeacherModelSource)
        ? globalThis.String(object.tunedTeacherModelSource)
        : undefined,
      trainingDatasetUri: isSet(object.trainingDatasetUri) ? globalThis.String(object.trainingDatasetUri) : "",
      validationDatasetUri: isSet(object.validationDatasetUri)
        ? globalThis.String(object.validationDatasetUri)
        : undefined,
      hyperParameters: isSet(object.hyperParameters)
        ? DistillationHyperParameters.fromJSON(object.hyperParameters)
        : undefined,
      studentModel: isSet(object.studentModel) ? globalThis.String(object.studentModel) : "",
      pipelineRootDirectory: isSet(object.pipelineRootDirectory) ? globalThis.String(object.pipelineRootDirectory) : "",
    };
  },

  toJSON(message: DistillationSpec): unknown {
    const obj: any = {};
    if (message.baseTeacherModel !== undefined) {
      obj.baseTeacherModel = message.baseTeacherModel;
    }
    if (message.tunedTeacherModelSource !== undefined) {
      obj.tunedTeacherModelSource = message.tunedTeacherModelSource;
    }
    if (message.trainingDatasetUri !== "") {
      obj.trainingDatasetUri = message.trainingDatasetUri;
    }
    ...
    if (message.hyperParameters !== undefined) {
      obj.hyperParameters = DistillationHyperParameters.toJSON(message.hyperParameters);
    }
    if (message.studentModel !== "") {
      obj.studentModel = message.studentModel;
    }
    if (message.pipelineRootDirectory !== "") {
      obj.pipelineRootDirectory = message.pipelineRootDirectory;
    }
    return obj;
  },

  create(base?: DeepPartial<DistillationSpec>): DistillationSpec {
    return DistillationSpec.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DistillationSpec>): DistillationSpec {
    const message = createBaseDistillationSpec();
    message.baseTeacherModel = object.baseTeacherModel ?? undefined;
    message.tunedTeacherModelSource = object.tunedTeacherModelSource ?? undefined;
    message.trainingDatasetUri = object.trainingDatasetUri ?? "";
    message.validationDatasetUri = object.validationDatasetUri ?? undefined;
    message.hyperParameters = (object.hyperParameters !== undefined && object.hyperParameters !== null)
      ? DistillationHyperParameters.fromPartial(object.hyperParameters)
      : undefined;
    message.studentModel = object.studentModel ?? "";
    message.pipelineRootDirectory = object.pipelineRootDirectory ?? "";
    return message;
  },
};

function createBaseDistillationHyperParameters(): DistillationHyperParameters {
  return { epochCount: undefined, learningRateMultiplier: undefined, adapterSize: 0 };
}

export const DistillationHyperParameters: MessageFns<DistillationHyperParameters> = {
  encode(message: DistillationHyperParameters, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DistillationHyperParameters {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDistillationHyperParameters();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DistillationHyperParameters {
    return {
      epochCount: isSet(object.epochCount) ? Long.fromValue(object.epochCount) : undefined,
      learningRateMultiplier: isSet(object.learningRateMultiplier)
        ? globalThis.Number(object.learningRateMultiplier)
        : undefined,
      adapterSize: isSet(object.adapterSize) ? supervisedHyperParameters_AdapterSizeFromJSON(object.adapterSize) : 0,
  ...
  toJSON(message: DistillationHyperParameters): unknown {
    const obj: any = {};
    if (message.epochCount !== undefined) {
      obj.epochCount = (message.epochCount || Long.ZERO).toString();
    }
  ...
  create(base?: DeepPartial<DistillationHyperParameters>): DistillationHyperParameters {
    return DistillationHyperParameters.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DistillationHyperParameters>): DistillationHyperParameters {
    const message = createBaseDistillationHyperParameters();
    message.epochCount = (object.epochCount !== undefined && object.epochCount !== null)
      ? Long.fromValue(object.epochCount)
      : undefined;
