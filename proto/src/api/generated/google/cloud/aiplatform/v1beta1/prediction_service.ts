...
export interface ExplainRequest_ConcurrentExplanationSpecOverrideEntry {
  key: string;
  value: ExplanationSpecOverride | undefined;
}
...
export interface ExplainResponse_ConcurrentExplanation {
  /**
   * The explanations of the Model's
   * [PredictResponse.predictions][google.cloud.aiplatform.v1beta1.PredictResponse.predictions].
   *
...
export interface ExplainResponse_ConcurrentExplanationsEntry {
  key: string;
  value: ExplainResponse_ConcurrentExplanation | undefined;
}
...
export interface PredictLongRunningResponse {
  /** The response of the video generation prediction. */
  generateVideoResponse?: GenerateVideoResponse | undefined;
}

/** Metadata for PredictLongRunning long running operations. */
export interface PredictLongRunningMetadata {
}
...
export const ExplainRequest: MessageFns<ExplainRequest> = {
  encode(message: ExplainRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.concurrentExplanationSpecOverride).forEach(([key, value]) => {
      ExplainRequest_ConcurrentExplanationSpecOverrideEntry.encode({ key: key as any, value }, writer.uint32(50).fork())
        .join();
    });
    if (message.deployedModelId !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          const entry6 = ExplainRequest_ConcurrentExplanationSpecOverrideEntry.decode(reader, reader.uint32());
          if (entry6.value !== undefined) {
            message.concurrentExplanationSpecOverride[entry6.key] = entry6.value;
          }
          continue;
        case 3:
          if (tag !== 26) {
  ...
  fromJSON(object: any): ExplainRequest {
    return {
      ...
      explanationSpecOverride: isSet(object.explanationSpecOverride)
        ...
        : undefined,
      concurrentExplanationSpecOverride: isObject(object.concurrentExplanationSpecOverride)
        ? Object.entries(object.concurrentExplanationSpecOverride).reduce<{ [key: string]: ExplanationSpecOverride }>(
          (acc, [key, value]) => {
            acc[key] = ExplanationSpecOverride.fromJSON(value);
            return acc;
          },
          {},
        )
  ...
  toJSON(message: ExplainRequest): unknown {
    ...
    if (message.concurrentExplanationSpecOverride) {
      const entries = Object.entries(message.concurrentExplanationSpecOverride);
      if (entries.length > 0) {
        obj.concurrentExplanationSpecOverride = {};
        entries.forEach(([k, v]) => {
          obj.concurrentExplanationSpecOverride[k] = ExplanationSpecOverride.toJSON(v);
        });
      }
    }
    if (message.deployedModelId !== "") {
  ...
  fromPartial(object: DeepPartial<ExplainRequest>): ExplainRequest {
    ...
    message.explanationSpecOverride =
      (object.explanationSpecOverride !== undefined && object.explanationSpecOverride !== null)
        ...
        : undefined;
    message.concurrentExplanationSpecOverride = Object.entries(object.concurrentExplanationSpecOverride ?? {}).reduce<
      { [key: string]: ExplanationSpecOverride }
    >((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = ExplanationSpecOverride.fromPartial(value);
      }
      return acc;
    }, {});
    message.deployedModelId = object.deployedModelId ?? "";
...
function createBaseExplainRequest_ConcurrentExplanationSpecOverrideEntry(): ExplainRequest_ConcurrentExplanationSpecOverrideEntry {
  return { key: "", value: undefined };
}

export const ExplainRequest_ConcurrentExplanationSpecOverrideEntry: MessageFns<
  ExplainRequest_ConcurrentExplanationSpecOverrideEntry
> = {
  encode(
    message: ExplainRequest_ConcurrentExplanationSpecOverrideEntry,
    ...
    if (message.value !== undefined) {
      ExplanationSpecOverride.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ExplainRequest_ConcurrentExplanationSpecOverrideEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExplainRequest_ConcurrentExplanationSpecOverrideEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.value = ExplanationSpecOverride.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ExplainRequest_ConcurrentExplanationSpecOverrideEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? ExplanationSpecOverride.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: ExplainRequest_ConcurrentExplanationSpecOverrideEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
    if (message.value !== undefined) {
      obj.value = ExplanationSpecOverride.toJSON(message.value);
    }
    return obj;
  },

  create(
    base?: DeepPartial<ExplainRequest_ConcurrentExplanationSpecOverrideEntry>,
  ): ExplainRequest_ConcurrentExplanationSpecOverrideEntry {
    return ExplainRequest_ConcurrentExplanationSpecOverrideEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<ExplainRequest_ConcurrentExplanationSpecOverrideEntry>,
  ): ExplainRequest_ConcurrentExplanationSpecOverrideEntry {
    const message = createBaseExplainRequest_ConcurrentExplanationSpecOverrideEntry();
    message.key = object.key ?? "";
    message.value = (object.value !== undefined && object.value !== null)
      ? ExplanationSpecOverride.fromPartial(object.value)
      : undefined;
    return message;
  },
};
...
function createBaseExplainResponse(): ExplainResponse {
  return { explanations: [], concurrentExplanations: {}, deployedModelId: "", predictions: [] };
}
...
export const ExplainResponse: MessageFns<ExplainResponse> = {
  encode(message: ExplainResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.concurrentExplanations).forEach(([key, value]) => {
      ExplainResponse_ConcurrentExplanationsEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).join();
    });
    if (message.deployedModelId !== "") {
      writer.uint32(18).string(message.deployedModelId);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          const entry4 = ExplainResponse_ConcurrentExplanationsEntry.decode(reader, reader.uint32());
          if (entry4.value !== undefined) {
            message.concurrentExplanations[entry4.key] = entry4.value;
          }
          continue;
        case 2:
          if (tag !== 18) {
  ...
  fromJSON(object: any): ExplainResponse {
    return {
      explanations: globalThis.Array.isArray(object?.explanations)
        ...
        : [],
      concurrentExplanations: isObject(object.concurrentExplanations)
        ? Object.entries(object.concurrentExplanations).reduce<
          { [key: string]: ExplainResponse_ConcurrentExplanation }
        >((acc, [key, value]) => {
          acc[key] = ExplainResponse_ConcurrentExplanation.fromJSON(value);
          return acc;
        }, {})
        : {},
      deployedModelId: isSet(object.deployedModelId) ? globalThis.String(object.deployedModelId) : "",
  ...
  toJSON(message: ExplainResponse): unknown {
    ...
    if (message.concurrentExplanations) {
      const entries = Object.entries(message.concurrentExplanations);
      if (entries.length > 0) {
        obj.concurrentExplanations = {};
        entries.forEach(([k, v]) => {
          obj.concurrentExplanations[k] = ExplainResponse_ConcurrentExplanation.toJSON(v);
        });
      }
    }
    if (message.deployedModelId !== "") {
  ...
  fromPartial(object: DeepPartial<ExplainResponse>): ExplainResponse {
    ...
    message.concurrentExplanations = Object.entries(object.concurrentExplanations ?? {}).reduce<
      { [key: string]: ExplainResponse_ConcurrentExplanation }
    >((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = ExplainResponse_ConcurrentExplanation.fromPartial(value);
      }
      return acc;
    }, {});
    message.deployedModelId = object.deployedModelId ?? "";
...
function createBaseExplainResponse_ConcurrentExplanation(): ExplainResponse_ConcurrentExplanation {
  return { explanations: [] };
}

export const ExplainResponse_ConcurrentExplanation: MessageFns<ExplainResponse_ConcurrentExplanation> = {
  encode(message: ExplainResponse_ConcurrentExplanation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.explanations) {
      Explanation.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExplainResponse_ConcurrentExplanation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExplainResponse_ConcurrentExplanation();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ExplainResponse_ConcurrentExplanation {
    return {
      explanations: globalThis.Array.isArray(object?.explanations)
        ? object.explanations.map((e: any) => Explanation.fromJSON(e))
        : [],
  ...
  toJSON(message: ExplainResponse_ConcurrentExplanation): unknown {
    const obj: any = {};
    if (message.explanations?.length) {
      obj.explanations = message.explanations.map((e) => Explanation.toJSON(e));
    }
  ...
  create(base?: DeepPartial<ExplainResponse_ConcurrentExplanation>): ExplainResponse_ConcurrentExplanation {
    return ExplainResponse_ConcurrentExplanation.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ExplainResponse_ConcurrentExplanation>): ExplainResponse_ConcurrentExplanation {
    const message = createBaseExplainResponse_ConcurrentExplanation();
    message.explanations = object.explanations?.map((e) => Explanation.fromPartial(e)) || [];
    return message;
  },
...
function createBaseExplainResponse_ConcurrentExplanationsEntry(): ExplainResponse_ConcurrentExplanationsEntry {
  return { key: "", value: undefined };
}

export const ExplainResponse_ConcurrentExplanationsEntry: MessageFns<ExplainResponse_ConcurrentExplanationsEntry> = {
  encode(
    message: ExplainResponse_ConcurrentExplanationsEntry,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    ...
    if (message.value !== undefined) {
      ExplainResponse_ConcurrentExplanation.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ExplainResponse_ConcurrentExplanationsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExplainResponse_ConcurrentExplanationsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.value = ExplainResponse_ConcurrentExplanation.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ExplainResponse_ConcurrentExplanationsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? ExplainResponse_ConcurrentExplanation.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: ExplainResponse_ConcurrentExplanationsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
    if (message.value !== undefined) {
      obj.value = ExplainResponse_ConcurrentExplanation.toJSON(message.value);
    }
    return obj;
  },

  create(base?: DeepPartial<ExplainResponse_ConcurrentExplanationsEntry>): ExplainResponse_ConcurrentExplanationsEntry {
    return ExplainResponse_ConcurrentExplanationsEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<ExplainResponse_ConcurrentExplanationsEntry>,
  ): ExplainResponse_ConcurrentExplanationsEntry {
    const message = createBaseExplainResponse_ConcurrentExplanationsEntry();
    message.key = object.key ?? "";
    message.value = (object.value !== undefined && object.value !== null)
      ? ExplainResponse_ConcurrentExplanation.fromPartial(object.value)
      : undefined;
    return message;
  },
};
...
export const GenerateContentRequest: MessageFns<GenerateContentRequest> = {
  ...
  fromJSON(object: any): GenerateContentRequest {
    return {
      ...
      contents: globalThis.Array.isArray(object?.contents) ? object.contents.map((e: any) => Content.fromJSON(e)) : [],
      systemInstruction: isSet(object.systemInstruction) ? Content.fromJSON(object.systemInstruction) : undefined,
      cachedContent: isSet(object.cachedContent) ? globalThis.String(object.cachedContent) : "",
      tools: globalThis.Array.isArray(object?.tools) ? object.tools.map((e: any) => Tool.fromJSON(e)) : [],
  ...
  fromPartial(object: DeepPartial<GenerateContentRequest>): GenerateContentRequest {
    ...
    message.systemInstruction = (object.systemInstruction !== undefined && object.systemInstruction !== null)
      ? Content.fromPartial(object.systemInstruction)
      : undefined;
    message.cachedContent = object.cachedContent ?? "";
    message.tools = object.tools?.map((e) => Tool.fromPartial(e)) || [];
...
function createBaseGenerateContentResponse_UsageMetadata(): GenerateContentResponse_UsageMetadata {
  return { promptTokenCount: 0, candidatesTokenCount: 0, totalTokenCount: 0, cachedContentTokenCount: 0 };
}
...
function createBaseChatCompletionsRequest(): ChatCompletionsRequest {
  return { endpoint: "", httpBody: undefined };
}

export const ChatCompletionsRequest: MessageFns<ChatCompletionsRequest> = {
  encode(message: ChatCompletionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.endpoint !== "") {
      writer.uint32(10).string(message.endpoint);
    }
    if (message.httpBody !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ChatCompletionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseChatCompletionsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ChatCompletionsRequest {
    return {
      endpoint: isSet(object.endpoint) ? globalThis.String(object.endpoint) : "",
      httpBody: isSet(object.httpBody) ? HttpBody.fromJSON(object.httpBody) : undefined,
    };
  ...
  toJSON(message: ChatCompletionsRequest): unknown {
    const obj: any = {};
    if (message.endpoint !== "") {
      obj.endpoint = message.endpoint;
    }
  ...
  create(base?: DeepPartial<ChatCompletionsRequest>): ChatCompletionsRequest {
    return ChatCompletionsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ChatCompletionsRequest>): ChatCompletionsRequest {
    const message = createBaseChatCompletionsRequest();
    message.endpoint = object.endpoint ?? "";
    message.httpBody = (object.httpBody !== undefined && object.httpBody !== null)
      ? HttpBody.fromPartial(object.httpBody)
...
function createBasePredictLongRunningResponse(): PredictLongRunningResponse {
  return { generateVideoResponse: undefined };
}

export const PredictLongRunningResponse: MessageFns<PredictLongRunningResponse> = {
  encode(message: PredictLongRunningResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.generateVideoResponse !== undefined) {
      GenerateVideoResponse.encode(message.generateVideoResponse, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PredictLongRunningResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePredictLongRunningResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.generateVideoResponse = GenerateVideoResponse.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): PredictLongRunningResponse {
    return {
      generateVideoResponse: isSet(object.generateVideoResponse)
        ? GenerateVideoResponse.fromJSON(object.generateVideoResponse)
        : undefined,
    };
  },

  toJSON(message: PredictLongRunningResponse): unknown {
    const obj: any = {};
    if (message.generateVideoResponse !== undefined) {
      obj.generateVideoResponse = GenerateVideoResponse.toJSON(message.generateVideoResponse);
    }
    return obj;
  },

  create(base?: DeepPartial<PredictLongRunningResponse>): PredictLongRunningResponse {
    return PredictLongRunningResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PredictLongRunningResponse>): PredictLongRunningResponse {
    const message = createBasePredictLongRunningResponse();
    message.generateVideoResponse =
      (object.generateVideoResponse !== undefined && object.generateVideoResponse !== null)
        ? GenerateVideoResponse.fromPartial(object.generateVideoResponse)
        : undefined;
    return message;
  },
};

function createBasePredictLongRunningMetadata(): PredictLongRunningMetadata {
  return {};
}

export const PredictLongRunningMetadata: MessageFns<PredictLongRunningMetadata> = {
  encode(_: PredictLongRunningMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PredictLongRunningMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePredictLongRunningMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): PredictLongRunningMetadata {
    return {};
  },

  toJSON(_: PredictLongRunningMetadata): unknown {
    const obj: any = {};
    return obj;
  },

  create(base?: DeepPartial<PredictLongRunningMetadata>): PredictLongRunningMetadata {
    return PredictLongRunningMetadata.fromPartial(base ?? {});
  },
  fromPartial(_: DeepPartial<PredictLongRunningMetadata>): PredictLongRunningMetadata {
    const message = createBasePredictLongRunningMetadata();
    return message;
  },
};

function createBaseGenerateVideoResponse(): GenerateVideoResponse {
  return { generatedSamples: [], raiMediaFilteredCount: undefined, raiMediaFilteredReasons: [] };
}

export const GenerateVideoResponse: MessageFns<GenerateVideoResponse> = {
  encode(message: GenerateVideoResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.generatedSamples) {
      writer.uint32(10).string(v!);
    }
    if (message.raiMediaFilteredCount !== undefined) {
      writer.uint32(16).int32(message.raiMediaFilteredCount);
    }
    for (const v of message.raiMediaFilteredReasons) {
      writer.uint32(26).string(v!);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GenerateVideoResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGenerateVideoResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.generatedSamples.push(reader.string());
          continue;
        case 2:
          if (tag !== 16) {
            break;
  ...
  fromJSON(object: any): GenerateVideoResponse {
    return {
      generatedSamples: globalThis.Array.isArray(object?.generatedSamples)
        ? object.generatedSamples.map((e: any) => globalThis.String(e))
        : [],
      raiMediaFilteredCount: isSet(object.raiMediaFilteredCount)
        ? globalThis.Number(object.raiMediaFilteredCount)
        : undefined,
      raiMediaFilteredReasons: globalThis.Array.isArray(object?.raiMediaFilteredReasons)
        ? object.raiMediaFilteredReasons.map((e: any) => globalThis.String(e))
        : [],
    };
  },

  toJSON(message: GenerateVideoResponse): unknown {
    const obj: any = {};
    if (message.generatedSamples?.length) {
      obj.generatedSamples = message.generatedSamples;
    }
    if (message.raiMediaFilteredCount !== undefined) {
      obj.raiMediaFilteredCount = Math.round(message.raiMediaFilteredCount);
    }
    if (message.raiMediaFilteredReasons?.length) {
      obj.raiMediaFilteredReasons = message.raiMediaFilteredReasons;
    }
    return obj;
  },

  create(base?: DeepPartial<GenerateVideoResponse>): GenerateVideoResponse {
    return GenerateVideoResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GenerateVideoResponse>): GenerateVideoResponse {
    const message = createBaseGenerateVideoResponse();
    message.generatedSamples = object.generatedSamples?.map((e) => e) || [];
    message.raiMediaFilteredCount = object.raiMediaFilteredCount ?? undefined;
    message.raiMediaFilteredReasons = object.raiMediaFilteredReasons?.map((e) => e) || [];
    return message;
  },
};
...
export const PredictionServiceDefinition = {
  ...
  methods: {
    ...
    chatCompletions: {
      ...
      requestType: ChatCompletionsRequest,
      requestStream: false,
      responseType: HttpBody,
      responseStream: true,
      options: {
...
export interface PredictionServiceClient<CallOptionsExt = {}> {
  ...
  /** Exposes an OpenAI-compatible endpoint for chat completions. */
  chatCompletions(
    request: DeepPartial<ChatCompletionsRequest>,
    options?: CallOptions & CallOptionsExt,
  ): AsyncIterable<HttpBody>;
}
