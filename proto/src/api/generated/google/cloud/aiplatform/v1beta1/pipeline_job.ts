...
import { RuntimeArtifact } from "./ui_pipeline_spec.js";
 ...
 */
export interface PipelineTaskRerunConfig {
...
/** A list of artifact metadata. */
export interface PipelineTaskRerunConfig_ArtifactList {
  /** Optional. A list of artifact metadata. */
  artifacts: RuntimeArtifact[];
}

/** Runtime inputs data of the task. */
export interface PipelineTaskRerunConfig_Inputs {
...
export interface PipelineTaskRerunConfig_Inputs_ArtifactsEntry {
  key: string;
  value: PipelineTaskRerunConfig_ArtifactList | undefined;
}

export interface PipelineTaskRerunConfig_Inputs_ParameterValuesEntry {
  key: string;
  value: any | undefined;
}
...
function createBasePipelineJob(): PipelineJob {
  return {
    ...
    satisfiesPzs: false,
    satisfiesPzi: false,
    originalPipelineJobId: Long.ZERO,
...
export const PipelineJob: MessageFns<PipelineJob> = {
  encode(message: PipelineJob, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.originalPipelineJobId.equals(Long.ZERO)) {
      writer.uint32(232).int64(message.originalPipelineJobId.toString());
    }
    for (const v of message.pipelineTaskRerunConfigs) {
      PipelineTaskRerunConfig.encode(v!, writer.uint32(242).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 29:
          ...
          message.originalPipelineJobId = Long.fromString(reader.int64().toString());
          continue;
        case 30:
          if (tag !== 242) {
            break;
          ...
          message.pipelineTaskRerunConfigs.push(PipelineTaskRerunConfig.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): PipelineJob {
    return {
      ...
      originalPipelineJobId: isSet(object.originalPipelineJobId)
        ? Long.fromValue(object.originalPipelineJobId)
        : Long.ZERO,
      pipelineTaskRerunConfigs: globalThis.Array.isArray(object?.pipelineTaskRerunConfigs)
        ? object.pipelineTaskRerunConfigs.map((e: any) => PipelineTaskRerunConfig.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: PipelineJob): unknown {
    ...
    if (!message.originalPipelineJobId.equals(Long.ZERO)) {
      obj.originalPipelineJobId = (message.originalPipelineJobId || Long.ZERO).toString();
    }
    if (message.pipelineTaskRerunConfigs?.length) {
      obj.pipelineTaskRerunConfigs = message.pipelineTaskRerunConfigs.map((e) => PipelineTaskRerunConfig.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<PipelineJob>): PipelineJob {
    ...
    message.originalPipelineJobId =
      (object.originalPipelineJobId !== undefined && object.originalPipelineJobId !== null)
        ? Long.fromValue(object.originalPipelineJobId)
        : Long.ZERO;
    message.pipelineTaskRerunConfigs =
      object.pipelineTaskRerunConfigs?.map((e) => PipelineTaskRerunConfig.fromPartial(e)) || [];
    return message;
  },
};
...
function createBasePipelineTaskRerunConfig(): PipelineTaskRerunConfig {
  return { taskId: Long.ZERO, taskName: "", inputs: undefined, skipTask: false, skipDownstreamTasks: false };
}

export const PipelineTaskRerunConfig: MessageFns<PipelineTaskRerunConfig> = {
  encode(message: PipelineTaskRerunConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.taskId.equals(Long.ZERO)) {
      writer.uint32(8).int64(message.taskId.toString());
    }
    if (message.taskName !== "") {
    ...
    if (message.inputs !== undefined) {
      PipelineTaskRerunConfig_Inputs.encode(message.inputs, writer.uint32(26).fork()).join();
    }
    if (message.skipTask !== false) {
      writer.uint32(32).bool(message.skipTask);
    }
    if (message.skipDownstreamTasks !== false) {
      writer.uint32(40).bool(message.skipDownstreamTasks);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PipelineTaskRerunConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePipelineTaskRerunConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 3:
          ...
          message.inputs = PipelineTaskRerunConfig_Inputs.decode(reader, reader.uint32());
          continue;
        case 4:
          if (tag !== 32) {
            break;
        ...
        case 5:
          ...
          message.skipDownstreamTasks = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): PipelineTaskRerunConfig {
    return {
      taskId: isSet(object.taskId) ? Long.fromValue(object.taskId) : Long.ZERO,
      taskName: isSet(object.taskName) ? globalThis.String(object.taskName) : "",
      inputs: isSet(object.inputs) ? PipelineTaskRerunConfig_Inputs.fromJSON(object.inputs) : undefined,
      skipTask: isSet(object.skipTask) ? globalThis.Boolean(object.skipTask) : false,
      skipDownstreamTasks: isSet(object.skipDownstreamTasks) ? globalThis.Boolean(object.skipDownstreamTasks) : false,
    };
  },

  toJSON(message: PipelineTaskRerunConfig): unknown {
    const obj: any = {};
    if (!message.taskId.equals(Long.ZERO)) {
      obj.taskId = (message.taskId || Long.ZERO).toString();
    }
    ...
    if (message.inputs !== undefined) {
      obj.inputs = PipelineTaskRerunConfig_Inputs.toJSON(message.inputs);
    }
    if (message.skipTask !== false) {
      obj.skipTask = message.skipTask;
    }
    if (message.skipDownstreamTasks !== false) {
      obj.skipDownstreamTasks = message.skipDownstreamTasks;
    }
    return obj;
  },

  create(base?: DeepPartial<PipelineTaskRerunConfig>): PipelineTaskRerunConfig {
    return PipelineTaskRerunConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PipelineTaskRerunConfig>): PipelineTaskRerunConfig {
    const message = createBasePipelineTaskRerunConfig();
    message.taskId = (object.taskId !== undefined && object.taskId !== null)
      ? Long.fromValue(object.taskId)
      : Long.ZERO;
    ...
    message.inputs = (object.inputs !== undefined && object.inputs !== null)
      ? PipelineTaskRerunConfig_Inputs.fromPartial(object.inputs)
      : undefined;
    message.skipTask = object.skipTask ?? false;
    message.skipDownstreamTasks = object.skipDownstreamTasks ?? false;
    return message;
  },
};

function createBasePipelineTaskRerunConfig_ArtifactList(): PipelineTaskRerunConfig_ArtifactList {
  return { artifacts: [] };
}

export const PipelineTaskRerunConfig_ArtifactList: MessageFns<PipelineTaskRerunConfig_ArtifactList> = {
  encode(message: PipelineTaskRerunConfig_ArtifactList, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.artifacts) {
      RuntimeArtifact.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PipelineTaskRerunConfig_ArtifactList {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePipelineTaskRerunConfig_ArtifactList();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): PipelineTaskRerunConfig_ArtifactList {
    return {
      artifacts: globalThis.Array.isArray(object?.artifacts)
        ? object.artifacts.map((e: any) => RuntimeArtifact.fromJSON(e))
        : [],
    };
  },

  toJSON(message: PipelineTaskRerunConfig_ArtifactList): unknown {
    const obj: any = {};
    if (message.artifacts?.length) {
      obj.artifacts = message.artifacts.map((e) => RuntimeArtifact.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<PipelineTaskRerunConfig_ArtifactList>): PipelineTaskRerunConfig_ArtifactList {
    return PipelineTaskRerunConfig_ArtifactList.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PipelineTaskRerunConfig_ArtifactList>): PipelineTaskRerunConfig_ArtifactList {
    const message = createBasePipelineTaskRerunConfig_ArtifactList();
...
function createBasePipelineTaskRerunConfig_Inputs(): PipelineTaskRerunConfig_Inputs {
  return { artifacts: {}, parameterValues: {} };
}

export const PipelineTaskRerunConfig_Inputs: MessageFns<PipelineTaskRerunConfig_Inputs> = {
  encode(message: PipelineTaskRerunConfig_Inputs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    Object.entries(message.artifacts).forEach(([key, value]) => {
      PipelineTaskRerunConfig_Inputs_ArtifactsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    Object.entries(message.parameterValues).forEach(([key, value]) => {
      if (value !== undefined) {
        PipelineTaskRerunConfig_Inputs_ParameterValuesEntry.encode({ key: key as any, value }, writer.uint32(18).fork())
          .join();
      }
    });
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PipelineTaskRerunConfig_Inputs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePipelineTaskRerunConfig_Inputs();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          const entry1 = PipelineTaskRerunConfig_Inputs_ArtifactsEntry.decode(reader, reader.uint32());
          if (entry1.value !== undefined) {
        ...
        case 2:
          ...
          const entry2 = PipelineTaskRerunConfig_Inputs_ParameterValuesEntry.decode(reader, reader.uint32());
  ...
  fromJSON(object: any): PipelineTaskRerunConfig_Inputs {
    return {
      artifacts: isObject(object.artifacts)
        ? Object.entries(object.artifacts).reduce<{ [key: string]: PipelineTaskRerunConfig_ArtifactList }>(
          (acc, [key, value]) => {
            acc[key] = PipelineTaskRerunConfig_ArtifactList.fromJSON(value);
            return acc;
          },
          {},
        )
  ...
  toJSON(message: PipelineTaskRerunConfig_Inputs): unknown {
    const obj: any = {};
    if (message.artifacts) {
      ...
      if (entries.length > 0) {
        obj.artifacts = {};
        entries.forEach(([k, v]) => {
          obj.artifacts[k] = PipelineTaskRerunConfig_ArtifactList.toJSON(v);
        });
      }
    }
    if (message.parameterValues) {
  ...
  create(base?: DeepPartial<PipelineTaskRerunConfig_Inputs>): PipelineTaskRerunConfig_Inputs {
    return PipelineTaskRerunConfig_Inputs.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PipelineTaskRerunConfig_Inputs>): PipelineTaskRerunConfig_Inputs {
    const message = createBasePipelineTaskRerunConfig_Inputs();
    message.artifacts = Object.entries(object.artifacts ?? {}).reduce<
      { [key: string]: PipelineTaskRerunConfig_ArtifactList }
    >((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = PipelineTaskRerunConfig_ArtifactList.fromPartial(value);
      }
      return acc;
    }, {});
    message.parameterValues = Object.entries(object.parameterValues ?? {}).reduce<{ [key: string]: any | undefined }>(
...
function createBasePipelineTaskRerunConfig_Inputs_ArtifactsEntry(): PipelineTaskRerunConfig_Inputs_ArtifactsEntry {
  return { key: "", value: undefined };
}

export const PipelineTaskRerunConfig_Inputs_ArtifactsEntry: MessageFns<PipelineTaskRerunConfig_Inputs_ArtifactsEntry> =
  {
    encode(
      message: PipelineTaskRerunConfig_Inputs_ArtifactsEntry,
      writer: BinaryWriter = new BinaryWriter(),
    ): BinaryWriter {
      if (message.key !== "") {
        writer.uint32(10).string(message.key);
      ...
      if (message.value !== undefined) {
        PipelineTaskRerunConfig_ArtifactList.encode(message.value, writer.uint32(18).fork()).join();
      }
      return writer;
    },

    decode(input: BinaryReader | Uint8Array, length?: number): PipelineTaskRerunConfig_Inputs_ArtifactsEntry {
      const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
      let end = length === undefined ? reader.len : reader.pos + length;
      const message = createBasePipelineTaskRerunConfig_Inputs_ArtifactsEntry();
      while (reader.pos < end) {
        const tag = reader.uint32();
        switch (tag >>> 3) {
          case 1:
          ...
          case 2:
            ...
            message.value = PipelineTaskRerunConfig_ArtifactList.decode(reader, reader.uint32());
            continue;
        }
        if ((tag & 7) === 4 || tag === 0) {
          break;
    ...
    fromJSON(object: any): PipelineTaskRerunConfig_Inputs_ArtifactsEntry {
      return {
        key: isSet(object.key) ? globalThis.String(object.key) : "",
        value: isSet(object.value) ? PipelineTaskRerunConfig_ArtifactList.fromJSON(object.value) : undefined,
      };
    },

    toJSON(message: PipelineTaskRerunConfig_Inputs_ArtifactsEntry): unknown {
      const obj: any = {};
      if (message.key !== "") {
        obj.key = message.key;
      }
      if (message.value !== undefined) {
        obj.value = PipelineTaskRerunConfig_ArtifactList.toJSON(message.value);
      }
      return obj;
    },

    create(
      base?: DeepPartial<PipelineTaskRerunConfig_Inputs_ArtifactsEntry>,
    ): PipelineTaskRerunConfig_Inputs_ArtifactsEntry {
      return PipelineTaskRerunConfig_Inputs_ArtifactsEntry.fromPartial(base ?? {});
    },
    fromPartial(
      object: DeepPartial<PipelineTaskRerunConfig_Inputs_ArtifactsEntry>,
    ): PipelineTaskRerunConfig_Inputs_ArtifactsEntry {
      const message = createBasePipelineTaskRerunConfig_Inputs_ArtifactsEntry();
      message.key = object.key ?? "";
      message.value = (object.value !== undefined && object.value !== null)
        ? PipelineTaskRerunConfig_ArtifactList.fromPartial(object.value)
        : undefined;
      return message;
    },
  };

function createBasePipelineTaskRerunConfig_Inputs_ParameterValuesEntry(): PipelineTaskRerunConfig_Inputs_ParameterValuesEntry {
  return { key: "", value: undefined };
}

export const PipelineTaskRerunConfig_Inputs_ParameterValuesEntry: MessageFns<
  PipelineTaskRerunConfig_Inputs_ParameterValuesEntry
> = {
  encode(
    message: PipelineTaskRerunConfig_Inputs_ParameterValuesEntry,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PipelineTaskRerunConfig_Inputs_ParameterValuesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePipelineTaskRerunConfig_Inputs_ParameterValuesEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): PipelineTaskRerunConfig_Inputs_ParameterValuesEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object?.value) ? object.value : undefined,
    };
  ...
  toJSON(message: PipelineTaskRerunConfig_Inputs_ParameterValuesEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(
    base?: DeepPartial<PipelineTaskRerunConfig_Inputs_ParameterValuesEntry>,
  ): PipelineTaskRerunConfig_Inputs_ParameterValuesEntry {
    return PipelineTaskRerunConfig_Inputs_ParameterValuesEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<PipelineTaskRerunConfig_Inputs_ParameterValuesEntry>,
  ): PipelineTaskRerunConfig_Inputs_ParameterValuesEntry {
    const message = createBasePipelineTaskRerunConfig_Inputs_ParameterValuesEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? undefined;
