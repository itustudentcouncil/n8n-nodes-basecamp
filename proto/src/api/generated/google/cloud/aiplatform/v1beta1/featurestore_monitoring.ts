...
function createBaseFeaturestoreMonitoringConfig_SnapshotAnalysis(): FeaturestoreMonitoringConfig_SnapshotAnalysis {
  return { disabled: false, monitoringInterval: undefined, monitoringIntervalDays: 0, stalenessDays: 0 };
}
...
export const FeaturestoreMonitoringConfig_SnapshotAnalysis: MessageFns<FeaturestoreMonitoringConfig_SnapshotAnalysis> =
  {
    encode(
      ...
      if (message.monitoringInterval !== undefined) {
        Duration.encode(message.monitoringInterval, writer.uint32(18).fork()).join();
      }
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2:
            ...
            message.monitoringInterval = Duration.decode(reader, reader.uint32());
            continue;
          case 3:
            if (tag !== 24) {
              break;
    ...
    fromJSON(object: any): FeaturestoreMonitoringConfig_SnapshotAnalysis {
      return {
        ...
        monitoringInterval: isSet(object.monitoringInterval) ? Duration.fromJSON(object.monitoringInterval) : undefined,
    ...
    toJSON(message: FeaturestoreMonitoringConfig_SnapshotAnalysis): unknown {
      ...
      if (message.monitoringInterval !== undefined) {
        obj.monitoringInterval = Duration.toJSON(message.monitoringInterval);
      }
      if (message.monitoringIntervalDays !== 0) {
    ...
    fromPartial(
      ...
      message.monitoringInterval = (object.monitoringInterval !== undefined && object.monitoringInterval !== null)
        ? Duration.fromPartial(object.monitoringInterval)
        : undefined;
