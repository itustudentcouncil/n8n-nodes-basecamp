...
export const protobufPackage = "google.cloud.secretmanager.v1beta2";
...
export enum SecretVersion_State {
  ...
  STATE_UNSPECIFIED = 0,
  /**
   * ENABLED - The [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion] may
   * be accessed.
   */
  ENABLED = 1,
  /**
   * DISABLED - The [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion] may
  ...
  DISABLED = 2,
  /**
   * DESTROYED - The [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion] is
