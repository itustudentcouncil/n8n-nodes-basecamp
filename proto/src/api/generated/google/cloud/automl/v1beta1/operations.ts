...
export interface ExportEvaluatedExamplesOperationMetadata {
   ...
   * examples export.
   */
  outputInfo: ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo | undefined;
}
 ...
 */
export interface ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo {
  /**
   * The path of the BigQuery dataset created, in bq://projectId.bqDatasetId
...
function createBaseOperationMetadata(): OperationMetadata {
  return {
    ...
    exportEvaluatedExamplesDetails: undefined,
    progressPercent: 0,
    partialFailures: [],
...
export const OperationMetadata: MessageFns<OperationMetadata> = {
  encode(message: OperationMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.exportEvaluatedExamplesDetails !== undefined) {
      ExportEvaluatedExamplesOperationMetadata.encode(message.exportEvaluatedExamplesDetails, writer.uint32(210).fork())
        .join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 26:
          ...
          message.exportEvaluatedExamplesDetails = ExportEvaluatedExamplesOperationMetadata.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): OperationMetadata {
    return {
      ...
      exportModelDetails: isSet(object.exportModelDetails)
        ...
        : undefined,
      exportEvaluatedExamplesDetails: isSet(object.exportEvaluatedExamplesDetails)
        ? ExportEvaluatedExamplesOperationMetadata.fromJSON(object.exportEvaluatedExamplesDetails)
        : undefined,
  ...
  toJSON(message: OperationMetadata): unknown {
    ...
    if (message.exportEvaluatedExamplesDetails !== undefined) {
      obj.exportEvaluatedExamplesDetails = ExportEvaluatedExamplesOperationMetadata.toJSON(
        message.exportEvaluatedExamplesDetails,
      );
    }
    if (message.progressPercent !== 0) {
  ...
  fromPartial(object: DeepPartial<OperationMetadata>): OperationMetadata {
    ...
    message.exportModelDetails = (object.exportModelDetails !== undefined && object.exportModelDetails !== null)
      ...
      : undefined;
    message.exportEvaluatedExamplesDetails =
      (object.exportEvaluatedExamplesDetails !== undefined && object.exportEvaluatedExamplesDetails !== null)
        ? ExportEvaluatedExamplesOperationMetadata.fromPartial(object.exportEvaluatedExamplesDetails)
        : undefined;
...
function createBaseExportDataOperationMetadata_ExportDataOutputInfo(): ExportDataOperationMetadata_ExportDataOutputInfo {
  return { gcsOutputDirectory: undefined, bigqueryOutputDataset: undefined };
}
...
function createBaseExportEvaluatedExamplesOperationMetadata(): ExportEvaluatedExamplesOperationMetadata {
  return { outputInfo: undefined };
}

export const ExportEvaluatedExamplesOperationMetadata: MessageFns<ExportEvaluatedExamplesOperationMetadata> = {
  encode(message: ExportEvaluatedExamplesOperationMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.outputInfo !== undefined) {
      ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.encode(
        message.outputInfo,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportEvaluatedExamplesOperationMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExportEvaluatedExamplesOperationMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
          ...
          message.outputInfo = ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): ExportEvaluatedExamplesOperationMetadata {
    return {
      outputInfo: isSet(object.outputInfo)
        ? ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.fromJSON(object.outputInfo)
        : undefined,
    };
  },

  toJSON(message: ExportEvaluatedExamplesOperationMetadata): unknown {
    const obj: any = {};
    if (message.outputInfo !== undefined) {
      obj.outputInfo = ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.toJSON(
        message.outputInfo,
      );
    }
    return obj;
  ...
  create(base?: DeepPartial<ExportEvaluatedExamplesOperationMetadata>): ExportEvaluatedExamplesOperationMetadata {
    return ExportEvaluatedExamplesOperationMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ExportEvaluatedExamplesOperationMetadata>): ExportEvaluatedExamplesOperationMetadata {
    const message = createBaseExportEvaluatedExamplesOperationMetadata();
    message.outputInfo = (object.outputInfo !== undefined && object.outputInfo !== null)
      ? ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.fromPartial(object.outputInfo)
      : undefined;
    return message;
  },
};

function createBaseExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo(): ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo {
  return { bigqueryOutputDataset: "" };
}

export const ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo: MessageFns<
  ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo
> = {
  encode(
    message: ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.bigqueryOutputDataset !== "") {
      writer.uint32(18).string(message.bigqueryOutputDataset);
    }
    return writer;
  },
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
  ...
  fromJSON(object: any): ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo {
    return {
      bigqueryOutputDataset: isSet(object.bigqueryOutputDataset) ? globalThis.String(object.bigqueryOutputDataset) : "",
    };
  },

  toJSON(message: ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo): unknown {
    const obj: any = {};
    if (message.bigqueryOutputDataset !== "") {
      obj.bigqueryOutputDataset = message.bigqueryOutputDataset;
    }
  ...
  create(
    base?: DeepPartial<ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo>,
  ): ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo {
    return ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo>,
  ): ExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo {
    const message = createBaseExportEvaluatedExamplesOperationMetadata_ExportEvaluatedExamplesOutputInfo();
    message.bigqueryOutputDataset = object.bigqueryOutputDataset ?? "";
    return message;
  },
};
