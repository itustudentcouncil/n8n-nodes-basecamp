...
export interface InputConfig_ParamsEntry {
  key: string;
  value: string;
}
...
export interface ModelExportOutputConfig_ParamsEntry {
  key: string;
  value: string;
}
...
function createBaseInputConfig(): InputConfig {
  return { gcsSource: undefined, bigquerySource: undefined, params: {} };
}
...
export const InputConfig: MessageFns<InputConfig> = {
  encode(message: InputConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.params).forEach(([key, value]) => {
      InputConfig_ParamsEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          const entry2 = InputConfig_ParamsEntry.decode(reader, reader.uint32());
...
function createBaseInputConfig_ParamsEntry(): InputConfig_ParamsEntry {
  return { key: "", value: "" };
}

export const InputConfig_ParamsEntry: MessageFns<InputConfig_ParamsEntry> = {
  encode(message: InputConfig_ParamsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InputConfig_ParamsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseInputConfig_ParamsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): InputConfig_ParamsEntry {
    return {
  ...
  toJSON(message: InputConfig_ParamsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<InputConfig_ParamsEntry>): InputConfig_ParamsEntry {
    return InputConfig_ParamsEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<InputConfig_ParamsEntry>): InputConfig_ParamsEntry {
    const message = createBaseInputConfig_ParamsEntry();
...
function createBaseBatchPredictInputConfig(): BatchPredictInputConfig {
  return { gcsSource: undefined, bigquerySource: undefined };
}

export const BatchPredictInputConfig: MessageFns<BatchPredictInputConfig> = {
  encode(message: BatchPredictInputConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.gcsSource !== undefined) {
      GcsSource.encode(message.gcsSource, writer.uint32(10).fork()).join();
    }
    if (message.bigquerySource !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BatchPredictInputConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBatchPredictInputConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BatchPredictInputConfig {
    return {
      gcsSource: isSet(object.gcsSource) ? GcsSource.fromJSON(object.gcsSource) : undefined,
      bigquerySource: isSet(object.bigquerySource) ? BigQuerySource.fromJSON(object.bigquerySource) : undefined,
    };
  ...
  toJSON(message: BatchPredictInputConfig): unknown {
    const obj: any = {};
    if (message.gcsSource !== undefined) {
      obj.gcsSource = GcsSource.toJSON(message.gcsSource);
    }
  ...
  create(base?: DeepPartial<BatchPredictInputConfig>): BatchPredictInputConfig {
    return BatchPredictInputConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchPredictInputConfig>): BatchPredictInputConfig {
    const message = createBaseBatchPredictInputConfig();
    message.gcsSource = (object.gcsSource !== undefined && object.gcsSource !== null)
      ? GcsSource.fromPartial(object.gcsSource)
      : undefined;
...
function createBaseBatchPredictOutputConfig(): BatchPredictOutputConfig {
  return { gcsDestination: undefined, bigqueryDestination: undefined };
}

export const BatchPredictOutputConfig: MessageFns<BatchPredictOutputConfig> = {
  encode(message: BatchPredictOutputConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.gcsDestination !== undefined) {
      GcsDestination.encode(message.gcsDestination, writer.uint32(10).fork()).join();
    }
    if (message.bigqueryDestination !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BatchPredictOutputConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBatchPredictOutputConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BatchPredictOutputConfig {
    return {
      gcsDestination: isSet(object.gcsDestination) ? GcsDestination.fromJSON(object.gcsDestination) : undefined,
      bigqueryDestination: isSet(object.bigqueryDestination)
        ? BigQueryDestination.fromJSON(object.bigqueryDestination)
  ...
  toJSON(message: BatchPredictOutputConfig): unknown {
    const obj: any = {};
    if (message.gcsDestination !== undefined) {
      obj.gcsDestination = GcsDestination.toJSON(message.gcsDestination);
    }
  ...
  create(base?: DeepPartial<BatchPredictOutputConfig>): BatchPredictOutputConfig {
    return BatchPredictOutputConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchPredictOutputConfig>): BatchPredictOutputConfig {
    const message = createBaseBatchPredictOutputConfig();
    message.gcsDestination = (object.gcsDestination !== undefined && object.gcsDestination !== null)
      ? GcsDestination.fromPartial(object.gcsDestination)
      : undefined;
...
function createBaseModelExportOutputConfig(): ModelExportOutputConfig {
  return { gcsDestination: undefined, gcrDestination: undefined, modelFormat: "", params: {} };
}

export const ModelExportOutputConfig: MessageFns<ModelExportOutputConfig> = {
  encode(message: ModelExportOutputConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.gcsDestination !== undefined) {
      GcsDestination.encode(message.gcsDestination, writer.uint32(10).fork()).join();
    }
    if (message.gcrDestination !== undefined) {
      GcrDestination.encode(message.gcrDestination, writer.uint32(26).fork()).join();
    }
    if (message.modelFormat !== "") {
      writer.uint32(34).string(message.modelFormat);
    }
    Object.entries(message.params).forEach(([key, value]) => {
      ModelExportOutputConfig_ParamsEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ModelExportOutputConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseModelExportOutputConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 3:
          ...
          message.gcrDestination = GcrDestination.decode(reader, reader.uint32());
          continue;
        case 4:
          if (tag !== 34) {
            break;
          ...
          message.modelFormat = reader.string();
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          const entry2 = ModelExportOutputConfig_ParamsEntry.decode(reader, reader.uint32());
          if (entry2.value !== undefined) {
            message.params[entry2.key] = entry2.value;
          }
          continue;
  ...
  fromJSON(object: any): ModelExportOutputConfig {
    return {
      gcsDestination: isSet(object.gcsDestination) ? GcsDestination.fromJSON(object.gcsDestination) : undefined,
      gcrDestination: isSet(object.gcrDestination) ? GcrDestination.fromJSON(object.gcrDestination) : undefined,
      modelFormat: isSet(object.modelFormat) ? globalThis.String(object.modelFormat) : "",
      params: isObject(object.params)
        ? Object.entries(object.params).reduce<{ [key: string]: string }>((acc, [key, value]) => {
          acc[key] = String(value);
          return acc;
  ...
  toJSON(message: ModelExportOutputConfig): unknown {
    const obj: any = {};
    if (message.gcsDestination !== undefined) {
      obj.gcsDestination = GcsDestination.toJSON(message.gcsDestination);
    }
    if (message.gcrDestination !== undefined) {
      obj.gcrDestination = GcrDestination.toJSON(message.gcrDestination);
    }
    if (message.modelFormat !== "") {
      obj.modelFormat = message.modelFormat;
    }
    if (message.params) {
      const entries = Object.entries(message.params);
      if (entries.length > 0) {
  ...
  create(base?: DeepPartial<ModelExportOutputConfig>): ModelExportOutputConfig {
    return ModelExportOutputConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ModelExportOutputConfig>): ModelExportOutputConfig {
    const message = createBaseModelExportOutputConfig();
    message.gcsDestination = (object.gcsDestination !== undefined && object.gcsDestination !== null)
      ? GcsDestination.fromPartial(object.gcsDestination)
      : undefined;
    message.gcrDestination = (object.gcrDestination !== undefined && object.gcrDestination !== null)
      ? GcrDestination.fromPartial(object.gcrDestination)
      : undefined;
    message.modelFormat = object.modelFormat ?? "";
    message.params = Object.entries(object.params ?? {}).reduce<{ [key: string]: string }>((acc, [key, value]) => {
      if (value !== undefined) {
        acc[key] = globalThis.String(value);
      }
...
function createBaseModelExportOutputConfig_ParamsEntry(): ModelExportOutputConfig_ParamsEntry {
  return { key: "", value: "" };
}

export const ModelExportOutputConfig_ParamsEntry: MessageFns<ModelExportOutputConfig_ParamsEntry> = {
  encode(message: ModelExportOutputConfig_ParamsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ModelExportOutputConfig_ParamsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseModelExportOutputConfig_ParamsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ModelExportOutputConfig_ParamsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: ModelExportOutputConfig_ParamsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<ModelExportOutputConfig_ParamsEntry>): ModelExportOutputConfig_ParamsEntry {
    return ModelExportOutputConfig_ParamsEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ModelExportOutputConfig_ParamsEntry>): ModelExportOutputConfig_ParamsEntry {
    const message = createBaseModelExportOutputConfig_ParamsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
function createBaseExportEvaluatedExamplesOutputConfig(): ExportEvaluatedExamplesOutputConfig {
  return { bigqueryDestination: undefined };
}

export const ExportEvaluatedExamplesOutputConfig: MessageFns<ExportEvaluatedExamplesOutputConfig> = {
  encode(message: ExportEvaluatedExamplesOutputConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bigqueryDestination !== undefined) {
      BigQueryDestination.encode(message.bigqueryDestination, writer.uint32(18).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportEvaluatedExamplesOutputConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExportEvaluatedExamplesOutputConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
  ...
  fromJSON(object: any): ExportEvaluatedExamplesOutputConfig {
    return {
      bigqueryDestination: isSet(object.bigqueryDestination)
        ? BigQueryDestination.fromJSON(object.bigqueryDestination)
        : undefined,
  ...
  toJSON(message: ExportEvaluatedExamplesOutputConfig): unknown {
    const obj: any = {};
    if (message.bigqueryDestination !== undefined) {
      obj.bigqueryDestination = BigQueryDestination.toJSON(message.bigqueryDestination);
    }
  ...
  create(base?: DeepPartial<ExportEvaluatedExamplesOutputConfig>): ExportEvaluatedExamplesOutputConfig {
    return ExportEvaluatedExamplesOutputConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ExportEvaluatedExamplesOutputConfig>): ExportEvaluatedExamplesOutputConfig {
    const message = createBaseExportEvaluatedExamplesOutputConfig();
    message.bigqueryDestination = (object.bigqueryDestination !== undefined && object.bigqueryDestination !== null)
      ? BigQueryDestination.fromPartial(object.bigqueryDestination)
      : undefined;
...
function createBaseGcrDestination(): GcrDestination {
  return { outputUri: "" };
}

export const GcrDestination: MessageFns<GcrDestination> = {
  encode(message: GcrDestination, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.outputUri !== "") {
      writer.uint32(10).string(message.outputUri);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GcrDestination {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGcrDestination();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GcrDestination {
    return { outputUri: isSet(object.outputUri) ? globalThis.String(object.outputUri) : "" };
  },

  toJSON(message: GcrDestination): unknown {
    const obj: any = {};
    if (message.outputUri !== "") {
      obj.outputUri = message.outputUri;
    }
  ...
  create(base?: DeepPartial<GcrDestination>): GcrDestination {
    return GcrDestination.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GcrDestination>): GcrDestination {
    const message = createBaseGcrDestination();
    message.outputUri = object.outputUri ?? "";
    return message;
  },
