...
import { ClassificationAnnotation, VideoClassificationAnnotation } from "./classification.js";
import { ImageObjectDetectionAnnotation, VideoObjectTrackingAnnotation } from "./detection.js";
import { TablesAnnotation } from "./tables.js";
...
function createBaseAnnotationPayload(): AnnotationPayload {
  return {
    ...
    videoClassification: undefined,
    videoObjectTracking: undefined,
...
export const AnnotationPayload: MessageFns<AnnotationPayload> = {
  encode(message: AnnotationPayload, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.videoClassification !== undefined) {
      VideoClassificationAnnotation.encode(message.videoClassification, writer.uint32(74).fork()).join();
    }
    if (message.videoObjectTracking !== undefined) {
      VideoObjectTrackingAnnotation.encode(message.videoObjectTracking, writer.uint32(66).fork()).join();
    }
    ...
    if (message.tables !== undefined) {
      TablesAnnotation.encode(message.tables, writer.uint32(82).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          message.videoClassification = VideoClassificationAnnotation.decode(reader, reader.uint32());
          continue;
        case 8:
          if (tag !== 66) {
            break;
          ...
          message.videoObjectTracking = VideoObjectTrackingAnnotation.decode(reader, reader.uint32());
          continue;
        case 6:
          if (tag !== 50) {
            break;
        ...
        case 10:
          ...
          message.tables = TablesAnnotation.decode(reader, reader.uint32());
          continue;
        case 1:
          if (tag !== 10) {
            break;
  ...
  fromJSON(object: any): AnnotationPayload {
    return {
      ...
      imageObjectDetection: isSet(object.imageObjectDetection)
        ...
        : undefined,
      videoClassification: isSet(object.videoClassification)
        ? VideoClassificationAnnotation.fromJSON(object.videoClassification)
        : undefined,
      videoObjectTracking: isSet(object.videoObjectTracking)
        ? VideoObjectTrackingAnnotation.fromJSON(object.videoObjectTracking)
        : undefined,
      ...
      tables: isSet(object.tables) ? TablesAnnotation.fromJSON(object.tables) : undefined,
  ...
  toJSON(message: AnnotationPayload): unknown {
    ...
    if (message.videoClassification !== undefined) {
      obj.videoClassification = VideoClassificationAnnotation.toJSON(message.videoClassification);
    }
    if (message.videoObjectTracking !== undefined) {
      obj.videoObjectTracking = VideoObjectTrackingAnnotation.toJSON(message.videoObjectTracking);
    }
    if (message.textExtraction !== undefined) {
    ...
    if (message.tables !== undefined) {
      obj.tables = TablesAnnotation.toJSON(message.tables);
    }
    if (message.annotationSpecId !== "") {
  ...
  fromPartial(object: DeepPartial<AnnotationPayload>): AnnotationPayload {
    ...
    message.imageObjectDetection = (object.imageObjectDetection !== undefined && object.imageObjectDetection !== null)
      ...
      : undefined;
    message.videoClassification = (object.videoClassification !== undefined && object.videoClassification !== null)
      ? VideoClassificationAnnotation.fromPartial(object.videoClassification)
      : undefined;
    message.videoObjectTracking = (object.videoObjectTracking !== undefined && object.videoObjectTracking !== null)
      ? VideoObjectTrackingAnnotation.fromPartial(object.videoObjectTracking)
      : undefined;
    ...
    message.tables = (object.tables !== undefined && object.tables !== null)
      ? TablesAnnotation.fromPartial(object.tables)
      : undefined;
