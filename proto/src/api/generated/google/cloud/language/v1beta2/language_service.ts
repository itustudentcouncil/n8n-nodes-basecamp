...
export const protobufPackage = "google.cloud.language.v1beta2";
...
export enum Document_BoilerplateHandling {
  ...
  /**
   * SKIP_BOILERPLATE - Do not analyze detected boilerplate. Reference web URI is required for
...
export function document_BoilerplateHandlingFromJSON(object: any): Document_BoilerplateHandling {
  switch (object) {
    case 0:
    case "BOILERPLATE_HANDLING_UNSPECIFIED":
      return Document_BoilerplateHandling.BOILERPLATE_HANDLING_UNSPECIFIED;
    case 1:
    case "SKIP_BOILERPLATE":
      return Document_BoilerplateHandling.SKIP_BOILERPLATE;
    case 2:
    case "KEEP_BOILERPLATE":
      return Document_BoilerplateHandling.KEEP_BOILERPLATE;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Document_BoilerplateHandling.UNRECOGNIZED;
  }
}

export function document_BoilerplateHandlingToJSON(object: Document_BoilerplateHandling): string {
  switch (object) {
    case Document_BoilerplateHandling.BOILERPLATE_HANDLING_UNSPECIFIED:
      return "BOILERPLATE_HANDLING_UNSPECIFIED";
    case Document_BoilerplateHandling.SKIP_BOILERPLATE:
      return "SKIP_BOILERPLATE";
    case Document_BoilerplateHandling.KEEP_BOILERPLATE:
      return "KEEP_BOILERPLATE";
    case Document_BoilerplateHandling.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
function createBaseDocument(): Document {
  return {
    type: 0,
    content: undefined,
    gcsContentUri: undefined,
    language: "",
    referenceWebUri: "",
    boilerplateHandling: 0,
  };
}
...
export const Document: MessageFns<Document> = {
  encode(message: Document, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.referenceWebUri !== "") {
      writer.uint32(42).string(message.referenceWebUri);
    }
    if (message.boilerplateHandling !== 0) {
      writer.uint32(48).int32(message.boilerplateHandling);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.boilerplateHandling = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Document {
    return {
      ...
      referenceWebUri: isSet(object.referenceWebUri) ? globalThis.String(object.referenceWebUri) : "",
      boilerplateHandling: isSet(object.boilerplateHandling)
        ? document_BoilerplateHandlingFromJSON(object.boilerplateHandling)
        : 0,
    };
  },
  ...
  toJSON(message: Document): unknown {
    ...
    if (message.referenceWebUri !== "") {
      obj.referenceWebUri = message.referenceWebUri;
    }
    if (message.boilerplateHandling !== 0) {
      obj.boilerplateHandling = document_BoilerplateHandlingToJSON(message.boilerplateHandling);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Document>): Document {
    ...
    message.referenceWebUri = object.referenceWebUri ?? "";
    message.boilerplateHandling = object.boilerplateHandling ?? 0;
    return message;
  },
};
...
export const AnnotateTextResponse: MessageFns<AnnotateTextResponse> = {
  encode(message: AnnotateTextResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.moderationCategories) {
      ClassificationCategory.encode(v!, writer.uint32(66).fork()).join();
    }
    return writer;
  },
