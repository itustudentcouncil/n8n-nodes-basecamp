...
export const protobufPackage = "google.cloud.language.v1beta1";
...
function createBaseEntity(): Entity {
  return { name: "", type: 0, metadata: {}, salience: 0, mentions: [] };
}
...
function createBaseSentiment(): Sentiment {
  return { polarity: 0, magnitude: 0, score: 0 };
}
...
export const Sentiment: MessageFns<Sentiment> = {
  encode(message: Sentiment, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.polarity !== 0) {
      writer.uint32(13).float(message.polarity);
    }
  ...
  fromJSON(object: any): Sentiment {
    return {
      polarity: isSet(object.polarity) ? globalThis.Number(object.polarity) : 0,
...
function createBaseAnnotateTextRequest_Features(): AnnotateTextRequest_Features {
  return { extractSyntax: false, extractEntities: false, extractDocumentSentiment: false };
}
...
function createBaseAnnotateTextResponse(): AnnotateTextResponse {
  return { sentences: [], tokens: [], entities: [], documentSentiment: undefined, language: "" };
}
...
export const LanguageServiceDefinition = {
  ...
  fullName: "google.cloud.language.v1beta1.LanguageService",
  methods: {
