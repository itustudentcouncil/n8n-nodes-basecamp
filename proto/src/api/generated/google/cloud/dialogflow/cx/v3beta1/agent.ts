...
export const Agent: MessageFns<Agent> = {
  encode(message: Agent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.startFlow !== undefined) {
      writer.uint32(130).string(message.startFlow);
    }
    if (message.startPlaybook !== undefined) {
      writer.uint32(314).string(message.startPlaybook);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 39:
          ...
          message.startPlaybook = reader.string();
          continue;
        case 17:
          if (tag !== 138) {
            break;
  ...
  fromJSON(object: any): Agent {
    return {
      ...
      speechToTextSettings: isSet(object.speechToTextSettings)
        ...
        : undefined,
      startFlow: isSet(object.startFlow) ? globalThis.String(object.startFlow) : undefined,
      startPlaybook: isSet(object.startPlaybook) ? globalThis.String(object.startPlaybook) : undefined,
  ...
  toJSON(message: Agent): unknown {
    ...
    if (message.startPlaybook !== undefined) {
      obj.startPlaybook = message.startPlaybook;
    }
    if (message.securitySettings !== "") {
  ...
  fromPartial(object: DeepPartial<Agent>): Agent {
    ...
    message.speechToTextSettings = (object.speechToTextSettings !== undefined && object.speechToTextSettings !== null)
      ...
      : undefined;
    message.startFlow = object.startFlow ?? undefined;
    message.startPlaybook = object.startPlaybook ?? undefined;
