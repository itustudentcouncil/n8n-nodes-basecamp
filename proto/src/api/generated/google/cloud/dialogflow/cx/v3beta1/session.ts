...
import { ToolCallResult } from "./tool_call.js";
...
export interface GenerativeInfo {
   ...
   * response.
   */
  actionTracingInfo: Example | undefined;
}
...
export enum Match_MatchType {
  ...
  /**
   * PLAYBOOK - The query was handled by a
...
export const QueryParameters: MessageFns<QueryParameters> = {
  encode(message: QueryParameters, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.currentPlaybook !== "") {
      writer.uint32(154).string(message.currentPlaybook);
    }
    if (message.llmModelSettings !== undefined) {
      LlmModelSettings.encode(message.llmModelSettings, writer.uint32(170).fork()).join();
    }
    if (message.channel !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 19:
          ...
          message.currentPlaybook = reader.string();
          continue;
        case 21:
          if (tag !== 170) {
            break;
  ...
  fromJSON(object: any): QueryParameters {
    return {
      ...
      flowVersions: globalThis.Array.isArray(object?.flowVersions)
        ...
        : [],
      currentPlaybook: isSet(object.currentPlaybook) ? globalThis.String(object.currentPlaybook) : "",
  ...
  toJSON(message: QueryParameters): unknown {
    ...
    if (message.currentPlaybook !== "") {
      obj.currentPlaybook = message.currentPlaybook;
    }
    if (message.llmModelSettings !== undefined) {
  ...
  fromPartial(object: DeepPartial<QueryParameters>): QueryParameters {
    ...
    message.currentPlaybook = object.currentPlaybook ?? "";
...
export const QueryInput: MessageFns<QueryInput> = {
  encode(message: QueryInput, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.toolCallResult !== undefined) {
      ToolCallResult.encode(message.toolCallResult, writer.uint32(90).fork()).join();
    }
    if (message.languageCode !== "") {
...
function createBaseGenerativeInfo(): GenerativeInfo {
  return { currentPlaybooks: [], actionTracingInfo: undefined };
}

export const GenerativeInfo: MessageFns<GenerativeInfo> = {
  encode(message: GenerativeInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.currentPlaybooks) {
      writer.uint32(10).string(v!);
    }
    if (message.actionTracingInfo !== undefined) {
      Example.encode(message.actionTracingInfo, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GenerativeInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGenerativeInfo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.currentPlaybooks.push(reader.string());
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.actionTracingInfo = Example.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): GenerativeInfo {
    return {
      currentPlaybooks: globalThis.Array.isArray(object?.currentPlaybooks)
        ? object.currentPlaybooks.map((e: any) => globalThis.String(e))
        : [],
      actionTracingInfo: isSet(object.actionTracingInfo) ? Example.fromJSON(object.actionTracingInfo) : undefined,
    };
  },

  toJSON(message: GenerativeInfo): unknown {
    const obj: any = {};
    if (message.currentPlaybooks?.length) {
      obj.currentPlaybooks = message.currentPlaybooks;
    }
    if (message.actionTracingInfo !== undefined) {
      obj.actionTracingInfo = Example.toJSON(message.actionTracingInfo);
    }
    return obj;
  },

  create(base?: DeepPartial<GenerativeInfo>): GenerativeInfo {
    return GenerativeInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GenerativeInfo>): GenerativeInfo {
    const message = createBaseGenerativeInfo();
    message.currentPlaybooks = object.currentPlaybooks?.map((e) => e) || [];
    message.actionTracingInfo = (object.actionTracingInfo !== undefined && object.actionTracingInfo !== null)
      ? Example.fromPartial(object.actionTracingInfo)
      : undefined;
    return message;
  },
};
...
export const QueryResult: MessageFns<QueryResult> = {
  encode(message: QueryResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.generativeInfo !== undefined) {
      GenerativeInfo.encode(message.generativeInfo, writer.uint32(266).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 33:
          ...
          message.generativeInfo = GenerativeInfo.decode(reader, reader.uint32());
          continue;
        case 17:
          if (tag !== 138) {
            break;
  ...
  fromJSON(object: any): QueryResult {
    return {
      ...
      generativeInfo: isSet(object.generativeInfo) ? GenerativeInfo.fromJSON(object.generativeInfo) : undefined,
  ...
  toJSON(message: QueryResult): unknown {
    ...
    if (message.generativeInfo !== undefined) {
      obj.generativeInfo = GenerativeInfo.toJSON(message.generativeInfo);
    }
    if (message.sentimentAnalysisResult !== undefined) {
  ...
  fromPartial(object: DeepPartial<QueryResult>): QueryResult {
    ...
    message.generativeInfo = (object.generativeInfo !== undefined && object.generativeInfo !== null)
      ? GenerativeInfo.fromPartial(object.generativeInfo)
      : undefined;
