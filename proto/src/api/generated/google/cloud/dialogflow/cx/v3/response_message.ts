...
export enum ResponseMessage_ResponseType {
  ...
  /**
   * ENTRY_PROMPT - The response is from an [entry
   * prompt][google.cloud.dialogflow.cx.v3.Page.entry_fulfillment] in the
   * page.
   */
  ENTRY_PROMPT = 1,
  /**
   * PARAMETER_PROMPT - The response is from [form-filling
   * prompt][google.cloud.dialogflow.cx.v3.Form.Parameter.fill_behavior] in
   * the page.
   */
  PARAMETER_PROMPT = 2,
  /**
   * HANDLER_PROMPT - The response is from a [transition
...
export function responseMessage_ResponseTypeFromJSON(object: any): ResponseMessage_ResponseType {
  switch (object) {
    case 0:
    case "RESPONSE_TYPE_UNSPECIFIED":
      return ResponseMessage_ResponseType.RESPONSE_TYPE_UNSPECIFIED;
    case 1:
    case "ENTRY_PROMPT":
      return ResponseMessage_ResponseType.ENTRY_PROMPT;
    case 2:
    case "PARAMETER_PROMPT":
      return ResponseMessage_ResponseType.PARAMETER_PROMPT;
    case 3:
    case "HANDLER_PROMPT":
      return ResponseMessage_ResponseType.HANDLER_PROMPT;
    case -1:
    case "UNRECOGNIZED":
    default:
      return ResponseMessage_ResponseType.UNRECOGNIZED;
  }
}

export function responseMessage_ResponseTypeToJSON(object: ResponseMessage_ResponseType): string {
  switch (object) {
    case ResponseMessage_ResponseType.RESPONSE_TYPE_UNSPECIFIED:
      return "RESPONSE_TYPE_UNSPECIFIED";
    case ResponseMessage_ResponseType.ENTRY_PROMPT:
      return "ENTRY_PROMPT";
    case ResponseMessage_ResponseType.PARAMETER_PROMPT:
      return "PARAMETER_PROMPT";
    case ResponseMessage_ResponseType.HANDLER_PROMPT:
      return "HANDLER_PROMPT";
    case ResponseMessage_ResponseType.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const ResponseMessage: MessageFns<ResponseMessage> = {
  ...
  fromJSON(object: any): ResponseMessage {
    return {
      ...
      knowledgeInfoCard: isSet(object.knowledgeInfoCard)
        ...
        : undefined,
      responseType: isSet(object.responseType) ? responseMessage_ResponseTypeFromJSON(object.responseType) : 0,
  ...
  toJSON(message: ResponseMessage): unknown {
    ...
    if (message.responseType !== 0) {
      obj.responseType = responseMessage_ResponseTypeToJSON(message.responseType);
    }
    if (message.channel !== "") {
