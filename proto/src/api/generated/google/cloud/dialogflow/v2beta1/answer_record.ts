 ...
 */
export interface GetAnswerRecordRequest {
  /**
...
function createBaseAgentAssistantFeedback_SummarizationFeedback(): AgentAssistantFeedback_SummarizationFeedback {
  return { startTimestamp: undefined, submitTimestamp: undefined, summaryText: "", textSections: {} };
}
...
export const AgentAssistantFeedback_SummarizationFeedback: MessageFns<AgentAssistantFeedback_SummarizationFeedback> = {
  encode(
    ...
    if (message.submitTimestamp !== undefined) {
      Timestamp.encode(toTimestamp(message.submitTimestamp), writer.uint32(18).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.submitTimestamp = fromTimestamp(Timestamp.decode(reader, reader.uint32()));
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): AgentAssistantFeedback_SummarizationFeedback {
    return {
      ...
      submitTimestamp: isSet(object.submitTimestamp) ? fromJsonTimestamp(object.submitTimestamp) : undefined,
  ...
  toJSON(message: AgentAssistantFeedback_SummarizationFeedback): unknown {
    ...
    if (message.submitTimestamp !== undefined) {
      obj.submitTimestamp = message.submitTimestamp.toISOString();
    }
    if (message.summaryText !== "") {
  ...
  fromPartial(
    ...
    message.submitTimestamp = object.submitTimestamp ?? undefined;
...
function createBaseGetAnswerRecordRequest(): GetAnswerRecordRequest {
  return { name: "" };
}

export const GetAnswerRecordRequest: MessageFns<GetAnswerRecordRequest> = {
  encode(message: GetAnswerRecordRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAnswerRecordRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetAnswerRecordRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetAnswerRecordRequest {
    return { name: isSet(object.name) ? globalThis.String(object.name) : "" };
  },

  toJSON(message: GetAnswerRecordRequest): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create(base?: DeepPartial<GetAnswerRecordRequest>): GetAnswerRecordRequest {
    return GetAnswerRecordRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetAnswerRecordRequest>): GetAnswerRecordRequest {
    const message = createBaseGetAnswerRecordRequest();
    message.name = object.name ?? "";
    return message;
  },
...
export interface AnswerRecordsClient<CallOptionsExt = {}> {
   ...
   */
  getAnswerRecord(
    request: DeepPartial<GetAnswerRecordRequest>,
