...
import { GcsDestination, GcsSource, GcsSources } from "./gcs.js";
...
export function document_KnowledgeTypeFromJSON(object: any): Document_KnowledgeType {
  switch (object) {
    ...
    case 4:
    case "SMART_REPLY":
      return Document_KnowledgeType.SMART_REPLY;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function document_KnowledgeTypeToJSON(object: Document_KnowledgeType): string {
  switch (object) {
    ...
    case Document_KnowledgeType.SMART_REPLY:
      return "SMART_REPLY";
...
function createBaseCreateDocumentRequest(): CreateDocumentRequest {
  return { parent: "", document: undefined, importGcsCustomMetadata: false };
}
...
export const CreateDocumentRequest: MessageFns<CreateDocumentRequest> = {
  encode(message: CreateDocumentRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.importGcsCustomMetadata !== false) {
      writer.uint32(24).bool(message.importGcsCustomMetadata);
    }
    return writer;
  },
...
function createBaseReloadDocumentRequest(): ReloadDocumentRequest {
  return { name: "", gcsSource: undefined, importGcsCustomMetadata: false };
}
    ...
    reloadDocument: {
      ...
      options: {
        _unknownFields: {
          ...
          8410: [Buffer.from([15, 110, 97, 109, 101, 44, 103, 99, 115, 95, 115, 111, 117, 114, 99, 101])],
          578365826: [
            Buffer.from([
              223,
              1,
