...
export const protobufPackage = "google.cloud.alloydb.v1alpha";
...
export interface Cluster {
   ...
   * cluster.
   */
  pscConfig: Cluster_PscConfig | undefined;
}
...
export interface Instance {
  ...
  networkConfig: Instance_InstanceNetworkConfig | undefined;
}
...
export const Cluster: MessageFns<Cluster> = {
  encode(message: Cluster, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.satisfiesPzi !== false) {
      writer.uint32(264).bool(message.satisfiesPzi);
    }
    if (message.satisfiesPzs !== false) {
      writer.uint32(240).bool(message.satisfiesPzs);
    }
    if (message.pscConfig !== undefined) {
      Cluster_PscConfig.encode(message.pscConfig, writer.uint32(250).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 31:
          ...
          message.pscConfig = Cluster_PscConfig.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Cluster {
    return {
      ...
      pscConfig: isSet(object.pscConfig) ? Cluster_PscConfig.fromJSON(object.pscConfig) : undefined,
    };
  },
  ...
  toJSON(message: Cluster): unknown {
    ...
    if (message.pscConfig !== undefined) {
      obj.pscConfig = Cluster_PscConfig.toJSON(message.pscConfig);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Cluster>): Cluster {
    ...
    message.pscConfig = (object.pscConfig !== undefined && object.pscConfig !== null)
      ? Cluster_PscConfig.fromPartial(object.pscConfig)
      : undefined;
    return message;
  },
};
...
function createBaseCluster_PscConfig(): Cluster_PscConfig {
  return { pscEnabled: false };
}

export const Cluster_PscConfig: MessageFns<Cluster_PscConfig> = {
  encode(message: Cluster_PscConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Cluster_PscConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCluster_PscConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Cluster_PscConfig {
    return { pscEnabled: isSet(object.pscEnabled) ? globalThis.Boolean(object.pscEnabled) : false };
  },

  toJSON(message: Cluster_PscConfig): unknown {
    const obj: any = {};
    if (message.pscEnabled !== false) {
  ...
  create(base?: DeepPartial<Cluster_PscConfig>): Cluster_PscConfig {
    return Cluster_PscConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Cluster_PscConfig>): Cluster_PscConfig {
    const message = createBaseCluster_PscConfig();
...
function createBaseInstance_InstanceNetworkConfig(): Instance_InstanceNetworkConfig {
  return { authorizedExternalNetworks: [], enablePublicIp: false };
}
...
export const Backup: MessageFns<Backup> = {
  encode(message: Backup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.satisfiesPzi !== false) {
      writer.uint32(184).bool(message.satisfiesPzi);
    }
    if (message.satisfiesPzs !== false) {
