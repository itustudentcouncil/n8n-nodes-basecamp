...
export const OSPolicy: MessageFns<OSPolicy> = {
  encode(_: OSPolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  fromJSON(_: any): OSPolicy {
    return {};
  },

  toJSON(_: OSPolicy): unknown {
    const obj: any = {};
    return obj;
  },
  ...
  fromPartial(_: DeepPartial<OSPolicy>): OSPolicy {
    const message = createBaseOSPolicy();
    return message;
  },
};
