...
import { Finding_FindingType, finding_FindingTypeFromJSON, finding_FindingTypeToJSON } from "./finding.js";
...
function createBaseFindingTypeStats(): FindingTypeStats {
  return { findingType: 0, findingCount: 0 };
}
...
export const FindingTypeStats: MessageFns<FindingTypeStats> = {
  encode(message: FindingTypeStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.findingType !== 0) {
      writer.uint32(8).int32(message.findingType);
    }
