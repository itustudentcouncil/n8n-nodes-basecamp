...
export const protobufPackage = "google.cloud.bigquery.datapolicies.v1";
...
export enum DataMaskingPolicy_PredefinedExpression {
  ...
  /**
   * LAST_FOUR_CHARACTERS - Masking expression shows the last four characters of text.
  ...
  /**
   * FIRST_FOUR_CHARACTERS - Masking expression shows the first four characters of text.
   * The masking behavior is as follows:
   *
  ...
  /**
   * EMAIL_MASK - Masking expression for email addresses.
   * The masking behavior is as follows:
   *
...
export function dataMaskingPolicy_PredefinedExpressionFromJSON(object: any): DataMaskingPolicy_PredefinedExpression {
  switch (object) {
    ...
    case "LAST_FOUR_CHARACTERS":
      return DataMaskingPolicy_PredefinedExpression.LAST_FOUR_CHARACTERS;
    case 10:
    case "FIRST_FOUR_CHARACTERS":
      return DataMaskingPolicy_PredefinedExpression.FIRST_FOUR_CHARACTERS;
    case 12:
    case "EMAIL_MASK":
      return DataMaskingPolicy_PredefinedExpression.EMAIL_MASK;
    case 13:
    case "DATE_YEAR_MASK":
      return DataMaskingPolicy_PredefinedExpression.DATE_YEAR_MASK;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function dataMaskingPolicy_PredefinedExpressionToJSON(object: DataMaskingPolicy_PredefinedExpression): string {
  switch (object) {
    ...
    case DataMaskingPolicy_PredefinedExpression.LAST_FOUR_CHARACTERS:
      return "LAST_FOUR_CHARACTERS";
    case DataMaskingPolicy_PredefinedExpression.FIRST_FOUR_CHARACTERS:
      return "FIRST_FOUR_CHARACTERS";
    case DataMaskingPolicy_PredefinedExpression.EMAIL_MASK:
      return "EMAIL_MASK";
    case DataMaskingPolicy_PredefinedExpression.DATE_YEAR_MASK:
...
function createBaseRenameDataPolicyRequest(): RenameDataPolicyRequest {
  return { name: "", newDataPolicyId: "" };
}

export const RenameDataPolicyRequest: MessageFns<RenameDataPolicyRequest> = {
  encode(message: RenameDataPolicyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.newDataPolicyId !== "") {
      writer.uint32(18).string(message.newDataPolicyId);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RenameDataPolicyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRenameDataPolicyRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.newDataPolicyId = reader.string();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): RenameDataPolicyRequest {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      newDataPolicyId: isSet(object.newDataPolicyId) ? globalThis.String(object.newDataPolicyId) : "",
    };
  },

  toJSON(message: RenameDataPolicyRequest): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
    if (message.newDataPolicyId !== "") {
      obj.newDataPolicyId = message.newDataPolicyId;
    }
    return obj;
  },

  create(base?: DeepPartial<RenameDataPolicyRequest>): RenameDataPolicyRequest {
    return RenameDataPolicyRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RenameDataPolicyRequest>): RenameDataPolicyRequest {
    const message = createBaseRenameDataPolicyRequest();
    message.name = object.name ?? "";
    message.newDataPolicyId = object.newDataPolicyId ?? "";
    return message;
  },
};
...
function createBaseDataMaskingPolicy(): DataMaskingPolicy {
  return { predefinedExpression: undefined, routine: undefined };
}
...
export const DataMaskingPolicy: MessageFns<DataMaskingPolicy> = {
  encode(message: DataMaskingPolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.routine !== undefined) {
      writer.uint32(26).string(message.routine);
    }
    return writer;
  },
  ...
  fromJSON(object: any): DataMaskingPolicy {
    return {
      predefinedExpression: isSet(object.predefinedExpression)
        ...
        : undefined,
      routine: isSet(object.routine) ? globalThis.String(object.routine) : undefined,
    };
  },
...
export const DataPolicyServiceDefinition = {
  ...
  methods: {
    ...
    renameDataPolicy: {
      ...
      requestType: RenameDataPolicyRequest,
      requestStream: false,
      responseType: DataPolicy,
      responseStream: false,
      options: {
...
export interface DataPolicyServiceClient<CallOptionsExt = {}> {
  ...
  /** Renames the id (display name) of the specified data policy. */
  renameDataPolicy(
    request: DeepPartial<RenameDataPolicyRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<DataPolicy>;
  /** Deletes the data policy specified by its resource name. */
  deleteDataPolicy(
