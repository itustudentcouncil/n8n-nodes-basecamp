...
export interface GuidedSearchSpec {
  /**
...
export interface CustomFineTuningSpec {
  /**
...
export interface IdpConfig {
  ...
  externalIdpConfig: IdpConfig_ExternalIdpConfig | undefined;
}
...
export function idpConfig_IdpTypeFromJSON(object: any): IdpConfig_IdpType {
  switch (object) {
    case 0:
    case "IDP_TYPE_UNSPECIFIED":
      return IdpConfig_IdpType.IDP_TYPE_UNSPECIFIED;
    case 1:
    case "GSUITE":
      return IdpConfig_IdpType.GSUITE;
    case 2:
    case "THIRD_PARTY":
      return IdpConfig_IdpType.THIRD_PARTY;
    case -1:
    case "UNRECOGNIZED":
    default:
      return IdpConfig_IdpType.UNRECOGNIZED;
  }
}

export function idpConfig_IdpTypeToJSON(object: IdpConfig_IdpType): string {
  switch (object) {
    case IdpConfig_IdpType.IDP_TYPE_UNSPECIFIED:
      return "IDP_TYPE_UNSPECIFIED";
    case IdpConfig_IdpType.GSUITE:
      return "GSUITE";
    case IdpConfig_IdpType.THIRD_PARTY:
      return "THIRD_PARTY";
    case IdpConfig_IdpType.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface IdpConfig_ExternalIdpConfig {
  /**
   * Workforce pool name.
...
function createBaseGuidedSearchSpec(): GuidedSearchSpec {
  return { enableRefinementAttributes: false, enableRelatedQuestions: false, maxRelatedQuestions: 0 };
}

export const GuidedSearchSpec: MessageFns<GuidedSearchSpec> = {
  encode(message: GuidedSearchSpec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.enableRefinementAttributes !== false) {
      writer.uint32(8).bool(message.enableRefinementAttributes);
    }
    if (message.enableRelatedQuestions !== false) {
      writer.uint32(16).bool(message.enableRelatedQuestions);
    }
    if (message.maxRelatedQuestions !== 0) {
      writer.uint32(24).int32(message.maxRelatedQuestions);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GuidedSearchSpec {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGuidedSearchSpec();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.enableRefinementAttributes = reader.bool();
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.enableRelatedQuestions = reader.bool();
          continue;
        case 3:
          if (tag !== 24) {
            break;
          ...
          message.maxRelatedQuestions = reader.int32();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): GuidedSearchSpec {
    return {
      enableRefinementAttributes: isSet(object.enableRefinementAttributes)
        ? globalThis.Boolean(object.enableRefinementAttributes)
        : false,
      enableRelatedQuestions: isSet(object.enableRelatedQuestions)
        ? globalThis.Boolean(object.enableRelatedQuestions)
        : false,
      maxRelatedQuestions: isSet(object.maxRelatedQuestions) ? globalThis.Number(object.maxRelatedQuestions) : 0,
    };
  },

  toJSON(message: GuidedSearchSpec): unknown {
    const obj: any = {};
    if (message.enableRefinementAttributes !== false) {
      obj.enableRefinementAttributes = message.enableRefinementAttributes;
    }
    if (message.enableRelatedQuestions !== false) {
      obj.enableRelatedQuestions = message.enableRelatedQuestions;
    }
    if (message.maxRelatedQuestions !== 0) {
      obj.maxRelatedQuestions = Math.round(message.maxRelatedQuestions);
    }
    return obj;
  },

  create(base?: DeepPartial<GuidedSearchSpec>): GuidedSearchSpec {
    return GuidedSearchSpec.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GuidedSearchSpec>): GuidedSearchSpec {
    const message = createBaseGuidedSearchSpec();
    message.enableRefinementAttributes = object.enableRefinementAttributes ?? false;
    message.enableRelatedQuestions = object.enableRelatedQuestions ?? false;
    message.maxRelatedQuestions = object.maxRelatedQuestions ?? 0;
    return message;
  },
};

function createBaseCustomFineTuningSpec(): CustomFineTuningSpec {
  return { enableSearchAdaptor: false };
}

export const CustomFineTuningSpec: MessageFns<CustomFineTuningSpec> = {
  encode(message: CustomFineTuningSpec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.enableSearchAdaptor !== false) {
      writer.uint32(8).bool(message.enableSearchAdaptor);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CustomFineTuningSpec {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCustomFineTuningSpec();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.enableSearchAdaptor = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CustomFineTuningSpec {
    return {
      enableSearchAdaptor: isSet(object.enableSearchAdaptor) ? globalThis.Boolean(object.enableSearchAdaptor) : false,
    };
  },

  toJSON(message: CustomFineTuningSpec): unknown {
    const obj: any = {};
    if (message.enableSearchAdaptor !== false) {
      obj.enableSearchAdaptor = message.enableSearchAdaptor;
    }
    return obj;
  },

  create(base?: DeepPartial<CustomFineTuningSpec>): CustomFineTuningSpec {
    return CustomFineTuningSpec.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CustomFineTuningSpec>): CustomFineTuningSpec {
    const message = createBaseCustomFineTuningSpec();
    message.enableSearchAdaptor = object.enableSearchAdaptor ?? false;
    return message;
  },
};

function createBaseIdpConfig(): IdpConfig {
  return { idpType: 0, externalIdpConfig: undefined };
}
...
export const IdpConfig: MessageFns<IdpConfig> = {
  encode(message: IdpConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.idpType !== 0) {
      writer.uint32(8).int32(message.idpType);
    }
    if (message.externalIdpConfig !== undefined) {
      IdpConfig_ExternalIdpConfig.encode(message.externalIdpConfig, writer.uint32(18).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.externalIdpConfig = IdpConfig_ExternalIdpConfig.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): IdpConfig {
    return {
      idpType: isSet(object.idpType) ? idpConfig_IdpTypeFromJSON(object.idpType) : 0,
      externalIdpConfig: isSet(object.externalIdpConfig)
        ? IdpConfig_ExternalIdpConfig.fromJSON(object.externalIdpConfig)
        : undefined,
    };
  },
  ...
  toJSON(message: IdpConfig): unknown {
    const obj: any = {};
    if (message.idpType !== 0) {
      obj.idpType = idpConfig_IdpTypeToJSON(message.idpType);
    }
    if (message.externalIdpConfig !== undefined) {
      obj.externalIdpConfig = IdpConfig_ExternalIdpConfig.toJSON(message.externalIdpConfig);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<IdpConfig>): IdpConfig {
    ...
    message.externalIdpConfig = (object.externalIdpConfig !== undefined && object.externalIdpConfig !== null)
      ? IdpConfig_ExternalIdpConfig.fromPartial(object.externalIdpConfig)
      : undefined;
    return message;
  },
};

function createBaseIdpConfig_ExternalIdpConfig(): IdpConfig_ExternalIdpConfig {
  return { workforcePoolName: "" };
}

export const IdpConfig_ExternalIdpConfig: MessageFns<IdpConfig_ExternalIdpConfig> = {
  encode(message: IdpConfig_ExternalIdpConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.workforcePoolName !== "") {
      writer.uint32(10).string(message.workforcePoolName);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): IdpConfig_ExternalIdpConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseIdpConfig_ExternalIdpConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.workforcePoolName = reader.string();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): IdpConfig_ExternalIdpConfig {
    return { workforcePoolName: isSet(object.workforcePoolName) ? globalThis.String(object.workforcePoolName) : "" };
  },

  toJSON(message: IdpConfig_ExternalIdpConfig): unknown {
    const obj: any = {};
    if (message.workforcePoolName !== "") {
      obj.workforcePoolName = message.workforcePoolName;
    }
    return obj;
  },

  create(base?: DeepPartial<IdpConfig_ExternalIdpConfig>): IdpConfig_ExternalIdpConfig {
    return IdpConfig_ExternalIdpConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<IdpConfig_ExternalIdpConfig>): IdpConfig_ExternalIdpConfig {
    const message = createBaseIdpConfig_ExternalIdpConfig();
    message.workforcePoolName = object.workforcePoolName ?? "";
    return message;
  },
};
