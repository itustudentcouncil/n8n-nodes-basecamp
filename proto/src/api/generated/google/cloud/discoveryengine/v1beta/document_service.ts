...
export enum BatchGetDocumentsMetadataResponse_State {
  ...
  STATE_UNSPECIFIED = 0,
  /** INDEXED - The [Document][google.cloud.discoveryengine.v1beta.Document] is indexed. */
  INDEXED = 1,
  /**
   * NOT_IN_TARGET_SITE - The [Document][google.cloud.discoveryengine.v1beta.Document] is not
   * indexed because its URI is not in the
   * [TargetSite][google.cloud.discoveryengine.v1beta.TargetSite].
   */
  NOT_IN_TARGET_SITE = 2,
  /**
   * NOT_IN_INDEX - The [Document][google.cloud.discoveryengine.v1beta.Document] is not
   * indexed.
   */
  NOT_IN_INDEX = 3,
  UNRECOGNIZED = -1,
