...
export const protobufPackage = "google.cloud.webrisk.v1beta1";
 ...
 */
export type WebRiskServiceV1Beta1Definition = typeof WebRiskServiceV1Beta1Definition;
export const WebRiskServiceV1Beta1Definition = {
...
export interface WebRiskServiceV1Beta1ServiceImplementation<CallContextExt = {}> {
  /** Gets the most recent threat list diffs. */
  computeThreatListDiff(
...
export interface WebRiskServiceV1Beta1Client<CallOptionsExt = {}> {
  /** Gets the most recent threat list diffs. */
  computeThreatListDiff(
