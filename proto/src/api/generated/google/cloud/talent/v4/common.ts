...
export enum CommuteMethod {
  ...
  CYCLING = 4,
  /**
   * TRANSIT_ACCESSIBLE - Commute time is calculated based on public transit that is wheelchair
   * accessible.
   */
...
export function commuteMethodFromJSON(object: any): CommuteMethod {
  switch (object) {
    ...
    case "TRANSIT_ACCESSIBLE":
      return CommuteMethod.TRANSIT_ACCESSIBLE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function commuteMethodToJSON(object: CommuteMethod): string {
  switch (object) {
    ...
    case CommuteMethod.CYCLING:
      return "CYCLING";
    case CommuteMethod.TRANSIT_ACCESSIBLE:
