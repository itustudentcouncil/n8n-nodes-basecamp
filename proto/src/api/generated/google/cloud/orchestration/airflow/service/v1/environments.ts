...
export const protobufPackage = "google.cloud.orchestration.airflow.service.v1";
...
export interface EnvironmentConfig {
   ...
   * mechanism.
   */
  dataRetentionConfig: DataRetentionConfig | undefined;
}
...
export interface IPAllocationPolicy {
   ...
   * to use.
   */
  servicesIpv4CidrBlock?: string | undefined;
}
...
export interface DataRetentionConfig {
  ...
  taskLogsRetentionConfig: TaskLogsRetentionConfig | undefined;
}
...
export const EnvironmentConfig: MessageFns<EnvironmentConfig> = {
  encode(message: EnvironmentConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.webServerNetworkAccessControl !== undefined) {
      WebServerNetworkAccessControl.encode(message.webServerNetworkAccessControl, writer.uint32(66).fork()).join();
    }
    if (message.databaseConfig !== undefined) {
      DatabaseConfig.encode(message.databaseConfig, writer.uint32(74).fork()).join();
    }
    if (message.webServerConfig !== undefined) {
      WebServerConfig.encode(message.webServerConfig, writer.uint32(82).fork()).join();
    }
    if (message.encryptionConfig !== undefined) {
      EncryptionConfig.encode(message.encryptionConfig, writer.uint32(90).fork()).join();
    }
    if (message.maintenanceWindow !== undefined) {
      MaintenanceWindow.encode(message.maintenanceWindow, writer.uint32(98).fork()).join();
    }
    ...
    if (message.airflowByoidUri !== "") {
      writer.uint32(162).string(message.airflowByoidUri);
    }
    ...
    if (message.resilienceMode !== 0) {
      writer.uint32(152).int32(message.resilienceMode);
    }
    if (message.dataRetentionConfig !== undefined) {
      DataRetentionConfig.encode(message.dataRetentionConfig, writer.uint32(170).fork()).join();
    }
    return writer;
  },
...
function createBaseIPAllocationPolicy(): IPAllocationPolicy {
  return {
    useIpAliases: false,
    clusterSecondaryRangeName: undefined,
    clusterIpv4CidrBlock: undefined,
    servicesSecondaryRangeName: undefined,
    servicesIpv4CidrBlock: undefined,
  };
}
...
export const IPAllocationPolicy: MessageFns<IPAllocationPolicy> = {
  encode(message: IPAllocationPolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.clusterSecondaryRangeName !== undefined) {
      writer.uint32(18).string(message.clusterSecondaryRangeName);
    }
    if (message.clusterIpv4CidrBlock !== undefined) {
      writer.uint32(34).string(message.clusterIpv4CidrBlock);
    }
    if (message.servicesSecondaryRangeName !== undefined) {
      writer.uint32(26).string(message.servicesSecondaryRangeName);
    }
    if (message.servicesIpv4CidrBlock !== undefined) {
  ...
  fromJSON(object: any): IPAllocationPolicy {
    return {
      ...
      clusterSecondaryRangeName: isSet(object.clusterSecondaryRangeName)
        ...
        : undefined,
      clusterIpv4CidrBlock: isSet(object.clusterIpv4CidrBlock)
        ? globalThis.String(object.clusterIpv4CidrBlock)
        : undefined,
      servicesSecondaryRangeName: isSet(object.servicesSecondaryRangeName)
        ? globalThis.String(object.servicesSecondaryRangeName)
        : undefined,
      servicesIpv4CidrBlock: isSet(object.servicesIpv4CidrBlock)
        ? globalThis.String(object.servicesIpv4CidrBlock)
        : undefined,
    };
  },
  ...
  fromPartial(object: DeepPartial<IPAllocationPolicy>): IPAllocationPolicy {
    ...
    message.clusterSecondaryRangeName = object.clusterSecondaryRangeName ?? undefined;
    message.clusterIpv4CidrBlock = object.clusterIpv4CidrBlock ?? undefined;
    message.servicesSecondaryRangeName = object.servicesSecondaryRangeName ?? undefined;
    message.servicesIpv4CidrBlock = object.servicesIpv4CidrBlock ?? undefined;
    return message;
  },
};
...
function createBaseDataRetentionConfig(): DataRetentionConfig {
  return { airflowMetadataRetentionConfig: undefined, taskLogsRetentionConfig: undefined };
}
...
export const DataRetentionConfig: MessageFns<DataRetentionConfig> = {
  encode(message: DataRetentionConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.airflowMetadataRetentionConfig !== undefined) {
      AirflowMetadataRetentionPolicyConfig.encode(message.airflowMetadataRetentionConfig, writer.uint32(10).fork())
        .join();
    }
    if (message.taskLogsRetentionConfig !== undefined) {
      TaskLogsRetentionConfig.encode(message.taskLogsRetentionConfig, writer.uint32(18).fork()).join();
    }
    return writer;
  },
