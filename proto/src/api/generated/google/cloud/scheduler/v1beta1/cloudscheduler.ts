...
export const protobufPackage = "google.cloud.scheduler.v1beta1";
...
function createBaseListJobsRequest(): ListJobsRequest {
  return { parent: "", filter: "", pageSize: 0, pageToken: "", legacyAppEngineCron: false };
}
...
export const ListJobsRequest: MessageFns<ListJobsRequest> = {
  encode(message: ListJobsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.legacyAppEngineCron !== false) {
      writer.uint32(56).bool(message.legacyAppEngineCron);
    }
    return writer;
  },
  ...
  fromJSON(object: any): ListJobsRequest {
    return {
      ...
      legacyAppEngineCron: isSet(object.legacyAppEngineCron) ? globalThis.Boolean(object.legacyAppEngineCron) : false,
    };
  },
  ...
  toJSON(message: ListJobsRequest): unknown {
    ...
    if (message.legacyAppEngineCron !== false) {
      obj.legacyAppEngineCron = message.legacyAppEngineCron;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ListJobsRequest>): ListJobsRequest {
    ...
    message.legacyAppEngineCron = object.legacyAppEngineCron ?? false;
    return message;
  },
};
...
function createBaseDeleteJobRequest(): DeleteJobRequest {
  return { name: "", legacyAppEngineCron: false };
}
...
export const DeleteJobRequest: MessageFns<DeleteJobRequest> = {
  encode(message: DeleteJobRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.legacyAppEngineCron !== false) {
      writer.uint32(16).bool(message.legacyAppEngineCron);
    }
    return writer;
  },
