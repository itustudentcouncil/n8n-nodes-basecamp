...
export interface DiscoverConnectionProfileRequest {
  ...
  mysqlRdbms?: MysqlRdbms | undefined;
}
...
export const DiscoverConnectionProfileRequest: MessageFns<DiscoverConnectionProfileRequest> = {
  encode(message: DiscoverConnectionProfileRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.recursionDepth !== undefined) {
      writer.uint32(32).int32(message.recursionDepth);
    }
  ...
  fromJSON(object: any): DiscoverConnectionProfileRequest {
    return {
      ...
      recursionDepth: isSet(object.recursionDepth) ? globalThis.Number(object.recursionDepth) : undefined,
  ...
  toJSON(message: DiscoverConnectionProfileRequest): unknown {
    ...
    if (message.recursionDepth !== undefined) {
      obj.recursionDepth = Math.round(message.recursionDepth);
    }
    if (message.oracleRdbms !== undefined) {
  ...
  fromPartial(object: DeepPartial<DiscoverConnectionProfileRequest>): DiscoverConnectionProfileRequest {
    ...
    message.recursionDepth = object.recursionDepth ?? undefined;
...
function createBaseDiscoverConnectionProfileResponse(): DiscoverConnectionProfileResponse {
  return { oracleRdbms: undefined, mysqlRdbms: undefined };
}
...
function createBaseFetchErrorsRequest(): FetchErrorsRequest {
  return { stream: "" };
}

export const FetchErrorsRequest: MessageFns<FetchErrorsRequest> = {
  encode(message: FetchErrorsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.stream !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FetchErrorsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFetchErrorsRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): FetchErrorsRequest {
    return { stream: isSet(object.stream) ? globalThis.String(object.stream) : "" };
  },

  toJSON(message: FetchErrorsRequest): unknown {
    const obj: any = {};
    if (message.stream !== "") {
  ...
  create(base?: DeepPartial<FetchErrorsRequest>): FetchErrorsRequest {
    return FetchErrorsRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<FetchErrorsRequest>): FetchErrorsRequest {
    const message = createBaseFetchErrorsRequest();
...
function createBaseFetchErrorsResponse(): FetchErrorsResponse {
  return { errors: [] };
}

export const FetchErrorsResponse: MessageFns<FetchErrorsResponse> = {
  encode(message: FetchErrorsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FetchErrorsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFetchErrorsResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): FetchErrorsResponse {
    return { errors: globalThis.Array.isArray(object?.errors) ? object.errors.map((e: any) => Error.fromJSON(e)) : [] };
  },

  toJSON(message: FetchErrorsResponse): unknown {
    const obj: any = {};
  ...
  create(base?: DeepPartial<FetchErrorsResponse>): FetchErrorsResponse {
    return FetchErrorsResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<FetchErrorsResponse>): FetchErrorsResponse {
    const message = createBaseFetchErrorsResponse();
...
function createBaseCreateConnectionProfileRequest(): CreateConnectionProfileRequest {
  return { parent: "", connectionProfileId: "", connectionProfile: undefined, requestId: "" };
}
...
function createBaseUpdateConnectionProfileRequest(): UpdateConnectionProfileRequest {
  return { updateMask: undefined, connectionProfile: undefined, requestId: "" };
}
...
export interface DatastreamServiceImplementation<CallContextExt = {}> {
  ...
  /** Use this method to fetch any errors associated with a stream. */
  fetchErrors(request: FetchErrorsRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Operation>>;
  /**
   * The FetchStaticIps API call exposes the static ips used by Datastream.
   * Typically, a request returns children data objects under
   * a parent data object that's optionally supplied in the request.
...
export interface DatastreamClient<CallOptionsExt = {}> {
  ...
  /** Use this method to fetch any errors associated with a stream. */
  fetchErrors(request: DeepPartial<FetchErrorsRequest>, options?: CallOptions & CallOptionsExt): Promise<Operation>;
  /**
   * The FetchStaticIps API call exposes the static ips used by Datastream.
   * Typically, a request returns children data objects under
   * a parent data object that's optionally supplied in the request.
