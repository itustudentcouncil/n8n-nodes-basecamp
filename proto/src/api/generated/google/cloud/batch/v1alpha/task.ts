...
export interface TaskStatus {
  ...
  resourceUsage: TaskResourceUsage | undefined;
}
...
function createBaseComputeResource(): ComputeResource {
  return { cpuMilli: Long.ZERO, memoryMib: Long.ZERO, gpuCount: Long.ZERO, bootDiskMib: Long.ZERO };
}
...
export const ComputeResource: MessageFns<ComputeResource> = {
  encode(message: ComputeResource, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.gpuCount.equals(Long.ZERO)) {
      writer.uint32(24).int64(message.gpuCount.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.gpuCount = Long.fromString(reader.int64().toString());
          continue;
        case 4:
          if (tag !== 32) {
            break;
  ...
  fromJSON(object: any): ComputeResource {
    return {
      ...
      gpuCount: isSet(object.gpuCount) ? Long.fromValue(object.gpuCount) : Long.ZERO,
  ...
  toJSON(message: ComputeResource): unknown {
    ...
    if (!message.gpuCount.equals(Long.ZERO)) {
      obj.gpuCount = (message.gpuCount || Long.ZERO).toString();
    }
    if (!message.bootDiskMib.equals(Long.ZERO)) {
  ...
  fromPartial(object: DeepPartial<ComputeResource>): ComputeResource {
    ...
    message.gpuCount = (object.gpuCount !== undefined && object.gpuCount !== null)
      ? Long.fromValue(object.gpuCount)
      : Long.ZERO;
...
function createBaseTaskExecution(): TaskExecution {
  return { exitCode: 0, stderrSnippet: "" };
}
...
export const TaskExecution: MessageFns<TaskExecution> = {
  encode(message: TaskExecution, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stderrSnippet !== "") {
      writer.uint32(18).string(message.stderrSnippet);
    }
    return writer;
  },
  ...
  fromJSON(object: any): TaskExecution {
    return {
      ...
      stderrSnippet: isSet(object.stderrSnippet) ? globalThis.String(object.stderrSnippet) : "",
    };
  },
  ...
  toJSON(message: TaskExecution): unknown {
    ...
    if (message.stderrSnippet !== "") {
      obj.stderrSnippet = message.stderrSnippet;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<TaskExecution>): TaskExecution {
    ...
    message.stderrSnippet = object.stderrSnippet ?? "";
    return message;
  },
};

function createBaseTaskStatus(): TaskStatus {
  return { state: 0, statusEvents: [], resourceUsage: undefined };
}
...
export const TaskStatus: MessageFns<TaskStatus> = {
  encode(message: TaskStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.resourceUsage !== undefined) {
      TaskResourceUsage.encode(message.resourceUsage, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.resourceUsage = TaskResourceUsage.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): TaskStatus {
    return {
      ...
      statusEvents: globalThis.Array.isArray(object?.statusEvents)
        ...
        : [],
      resourceUsage: isSet(object.resourceUsage) ? TaskResourceUsage.fromJSON(object.resourceUsage) : undefined,
    };
  },
  ...
  toJSON(message: TaskStatus): unknown {
    ...
    if (message.resourceUsage !== undefined) {
      obj.resourceUsage = TaskResourceUsage.toJSON(message.resourceUsage);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<TaskStatus>): TaskStatus {
    ...
    message.resourceUsage = (object.resourceUsage !== undefined && object.resourceUsage !== null)
      ? TaskResourceUsage.fromPartial(object.resourceUsage)
      : undefined;
    return message;
  },
};

function createBaseTaskResourceUsage(): TaskResourceUsage {
  return { coreHours: 0 };
}

export const TaskResourceUsage: MessageFns<TaskResourceUsage> = {
  encode(message: TaskResourceUsage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TaskResourceUsage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTaskResourceUsage();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): TaskResourceUsage {
    return { coreHours: isSet(object.coreHours) ? globalThis.Number(object.coreHours) : 0 };
  },

  toJSON(message: TaskResourceUsage): unknown {
    const obj: any = {};
    if (message.coreHours !== 0) {
  ...
  create(base?: DeepPartial<TaskResourceUsage>): TaskResourceUsage {
    return TaskResourceUsage.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskResourceUsage>): TaskResourceUsage {
    const message = createBaseTaskResourceUsage();
