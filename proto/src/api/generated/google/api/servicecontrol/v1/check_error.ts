...
export const CheckError: MessageFns<CheckError> = {
  encode(message: CheckError, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== 0) {
  ...
  create(base?: DeepPartial<CheckError>): CheckError {
    return CheckError.fromPartial(base ?? {});
  },
