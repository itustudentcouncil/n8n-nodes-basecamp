...
export const GetAuthRequestRequest: MessageFns<GetAuthRequestRequest> = {
  encode(message: GetAuthRequestRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAuthRequestRequest {
...
export const GetAuthRequestResponse: MessageFns<GetAuthRequestResponse> = {
  encode(message: GetAuthRequestResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAuthRequestResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateCallbackRequest: MessageFns<CreateCallbackRequest> = {
  encode(message: CreateCallbackRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.authRequestId !== "") {
      writer.uint32(10).string(message.authRequestId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateCallbackRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateCallbackResponse: MessageFns<CreateCallbackResponse> = {
  encode(message: CreateCallbackResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateCallbackResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
