...
export const ActionIDQuery: MessageFns<ActionIDQuery> = {
  encode(message: ActionIDQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ActionIDQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ActionNameQuery: MessageFns<ActionNameQuery> = {
  encode(message: ActionNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ActionNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ActionStateQuery: MessageFns<ActionStateQuery> = {
  encode(message: ActionStateQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ActionStateQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FlowType: MessageFns<FlowType> = {
  encode(message: FlowType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FlowType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TriggerType: MessageFns<TriggerType> = {
  encode(message: TriggerType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.name !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TriggerType {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const TriggerAction: MessageFns<TriggerAction> = {
  encode(message: TriggerAction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TriggerAction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
