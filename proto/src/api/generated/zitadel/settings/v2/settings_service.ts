...
export const GetLoginSettingsRequest: MessageFns<GetLoginSettingsRequest> = {
  encode(message: GetLoginSettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLoginSettingsRequest {
...
export const GetLoginSettingsResponse: MessageFns<GetLoginSettingsResponse> = {
  encode(message: GetLoginSettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLoginSettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetPasswordComplexitySettingsRequest: MessageFns<GetPasswordComplexitySettingsRequest> = {
  encode(message: GetPasswordComplexitySettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ctx !== undefined) {
      RequestContext.encode(message.ctx, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetPasswordComplexitySettingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetPasswordComplexitySettingsResponse: MessageFns<GetPasswordComplexitySettingsResponse> = {
  encode(message: GetPasswordComplexitySettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.settings !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetPasswordComplexitySettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetPasswordExpirySettingsRequest: MessageFns<GetPasswordExpirySettingsRequest> = {
  encode(message: GetPasswordExpirySettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ctx !== undefined) {
      RequestContext.encode(message.ctx, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetPasswordExpirySettingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetPasswordExpirySettingsResponse: MessageFns<GetPasswordExpirySettingsResponse> = {
  encode(message: GetPasswordExpirySettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.settings !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetPasswordExpirySettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetBrandingSettingsRequest: MessageFns<GetBrandingSettingsRequest> = {
  encode(message: GetBrandingSettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ctx !== undefined) {
      RequestContext.encode(message.ctx, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetBrandingSettingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetBrandingSettingsResponse: MessageFns<GetBrandingSettingsResponse> = {
  encode(message: GetBrandingSettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.settings !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetBrandingSettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetDomainSettingsRequest: MessageFns<GetDomainSettingsRequest> = {
  encode(message: GetDomainSettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ctx !== undefined) {
      RequestContext.encode(message.ctx, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetDomainSettingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetDomainSettingsResponse: MessageFns<GetDomainSettingsResponse> = {
  encode(message: GetDomainSettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.settings !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetDomainSettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetLegalAndSupportSettingsRequest: MessageFns<GetLegalAndSupportSettingsRequest> = {
  encode(message: GetLegalAndSupportSettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ctx !== undefined) {
      RequestContext.encode(message.ctx, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLegalAndSupportSettingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetLegalAndSupportSettingsResponse: MessageFns<GetLegalAndSupportSettingsResponse> = {
  encode(message: GetLegalAndSupportSettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.settings !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLegalAndSupportSettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetLockoutSettingsRequest: MessageFns<GetLockoutSettingsRequest> = {
  encode(message: GetLockoutSettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ctx !== undefined) {
      RequestContext.encode(message.ctx, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLockoutSettingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetLockoutSettingsResponse: MessageFns<GetLockoutSettingsResponse> = {
  encode(message: GetLockoutSettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.settings !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetLockoutSettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetActiveIdentityProvidersRequest: MessageFns<GetActiveIdentityProvidersRequest> = {
  encode(message: GetActiveIdentityProvidersRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ctx !== undefined) {
      RequestContext.encode(message.ctx, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetActiveIdentityProvidersRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetActiveIdentityProvidersResponse: MessageFns<GetActiveIdentityProvidersResponse> = {
  encode(message: GetActiveIdentityProvidersResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetActiveIdentityProvidersResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetGeneralSettingsRequest: MessageFns<GetGeneralSettingsRequest> = {
  encode(_: GetGeneralSettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetGeneralSettingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetGeneralSettingsResponse: MessageFns<GetGeneralSettingsResponse> = {
  encode(message: GetGeneralSettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetGeneralSettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetSecuritySettingsResponse: MessageFns<GetSecuritySettingsResponse> = {
  encode(message: GetSecuritySettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.settings !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetSecuritySettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetSecuritySettingsRequest: MessageFns<SetSecuritySettingsRequest> = {
  encode(message: SetSecuritySettingsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetSecuritySettingsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetSecuritySettingsResponse: MessageFns<SetSecuritySettingsResponse> = {
  encode(message: SetSecuritySettingsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetSecuritySettingsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
