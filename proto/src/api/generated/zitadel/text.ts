...
export const MessageCustomText: MessageFns<MessageCustomText> = {
  encode(message: MessageCustomText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MessageCustomText {
...
export const LoginCustomText: MessageFns<LoginCustomText> = {
  encode(message: LoginCustomText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LoginCustomText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SelectAccountScreenText: MessageFns<SelectAccountScreenText> = {
  encode(message: SelectAccountScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SelectAccountScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LoginScreenText: MessageFns<LoginScreenText> = {
  encode(message: LoginScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LoginScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasswordScreenText: MessageFns<PasswordScreenText> = {
  encode(message: PasswordScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasswordScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UsernameChangeScreenText: MessageFns<UsernameChangeScreenText> = {
  encode(message: UsernameChangeScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UsernameChangeScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UsernameChangeDoneScreenText: MessageFns<UsernameChangeDoneScreenText> = {
  encode(message: UsernameChangeDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UsernameChangeDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InitPasswordScreenText: MessageFns<InitPasswordScreenText> = {
  encode(message: InitPasswordScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitPasswordScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InitPasswordDoneScreenText: MessageFns<InitPasswordDoneScreenText> = {
  encode(message: InitPasswordDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitPasswordDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EmailVerificationScreenText: MessageFns<EmailVerificationScreenText> = {
  encode(message: EmailVerificationScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EmailVerificationScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EmailVerificationDoneScreenText: MessageFns<EmailVerificationDoneScreenText> = {
  encode(message: EmailVerificationDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EmailVerificationDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InitializeUserScreenText: MessageFns<InitializeUserScreenText> = {
  encode(message: InitializeUserScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitializeUserScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InitializeUserDoneScreenText: MessageFns<InitializeUserDoneScreenText> = {
  encode(message: InitializeUserDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitializeUserDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InitMFAPromptScreenText: MessageFns<InitMFAPromptScreenText> = {
  encode(message: InitMFAPromptScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitMFAPromptScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InitMFAOTPScreenText: MessageFns<InitMFAOTPScreenText> = {
  encode(message: InitMFAOTPScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitMFAOTPScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InitMFAU2FScreenText: MessageFns<InitMFAU2FScreenText> = {
  encode(message: InitMFAU2FScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitMFAU2FScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const InitMFADoneScreenText: MessageFns<InitMFADoneScreenText> = {
  encode(message: InitMFADoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InitMFADoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MFAProvidersText: MessageFns<MFAProvidersText> = {
  encode(message: MFAProvidersText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MFAProvidersText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMFAOTPScreenText: MessageFns<VerifyMFAOTPScreenText> = {
  encode(message: VerifyMFAOTPScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMFAOTPScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMFAU2FScreenText: MessageFns<VerifyMFAU2FScreenText> = {
  encode(message: VerifyMFAU2FScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMFAU2FScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasswordlessScreenText: MessageFns<PasswordlessScreenText> = {
  encode(message: PasswordlessScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasswordlessScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasswordChangeScreenText: MessageFns<PasswordChangeScreenText> = {
  encode(message: PasswordChangeScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasswordChangeScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasswordChangeDoneScreenText: MessageFns<PasswordChangeDoneScreenText> = {
  encode(message: PasswordChangeDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasswordChangeDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasswordResetDoneScreenText: MessageFns<PasswordResetDoneScreenText> = {
  encode(message: PasswordResetDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasswordResetDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RegistrationOptionScreenText: MessageFns<RegistrationOptionScreenText> = {
  encode(message: RegistrationOptionScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RegistrationOptionScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RegistrationUserScreenText: MessageFns<RegistrationUserScreenText> = {
  encode(message: RegistrationUserScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RegistrationUserScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExternalRegistrationUserOverviewScreenText: MessageFns<ExternalRegistrationUserOverviewScreenText> = {
  encode(message: ExternalRegistrationUserOverviewScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExternalRegistrationUserOverviewScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RegistrationOrgScreenText: MessageFns<RegistrationOrgScreenText> = {
  encode(message: RegistrationOrgScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RegistrationOrgScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LinkingUserPromptScreenText: MessageFns<LinkingUserPromptScreenText> = {
  encode(message: LinkingUserPromptScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LinkingUserPromptScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LinkingUserDoneScreenText: MessageFns<LinkingUserDoneScreenText> = {
  encode(message: LinkingUserDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LinkingUserDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExternalUserNotFoundScreenText: MessageFns<ExternalUserNotFoundScreenText> = {
  encode(message: ExternalUserNotFoundScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExternalUserNotFoundScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SuccessLoginScreenText: MessageFns<SuccessLoginScreenText> = {
  encode(message: SuccessLoginScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SuccessLoginScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const LogoutDoneScreenText: MessageFns<LogoutDoneScreenText> = {
  encode(message: LogoutDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LogoutDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FooterText: MessageFns<FooterText> = {
  encode(message: FooterText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tos !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FooterText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasswordlessPromptScreenText: MessageFns<PasswordlessPromptScreenText> = {
  encode(message: PasswordlessPromptScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasswordlessPromptScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasswordlessRegistrationScreenText: MessageFns<PasswordlessRegistrationScreenText> = {
  encode(message: PasswordlessRegistrationScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasswordlessRegistrationScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasswordlessRegistrationDoneScreenText: MessageFns<PasswordlessRegistrationDoneScreenText> = {
  encode(message: PasswordlessRegistrationDoneScreenText, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.title !== "") {
      writer.uint32(10).string(message.title);
    }
    if (message.description !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasswordlessRegistrationDoneScreenText {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
