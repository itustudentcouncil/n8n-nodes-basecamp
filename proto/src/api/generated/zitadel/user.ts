...
export const Human: MessageFns<Human> = {
  encode(message: Human, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Human {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const OrQuery: MessageFns<OrQuery> = {
  encode(message: OrQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const AndQuery: MessageFns<AndQuery> = {
  encode(message: AndQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.queries) {
      SearchQuery.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
...
export const NotQuery: MessageFns<NotQuery> = {
  encode(message: NotQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const InUserIDQuery: MessageFns<InUserIDQuery> = {
  encode(message: InUserIDQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const InUserEmailsQuery: MessageFns<InUserEmailsQuery> = {
  encode(message: InUserEmailsQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const UserNameQuery: MessageFns<UserNameQuery> = {
  encode(message: UserNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userName !== "") {
...
export const FirstNameQuery: MessageFns<FirstNameQuery> = {
  encode(message: FirstNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.firstName !== "") {
      writer.uint32(10).string(message.firstName);
    }
    if (message.method !== 0) {
...
export const LastNameQuery: MessageFns<LastNameQuery> = {
  encode(message: LastNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.lastName !== "") {
...
export const NickNameQuery: MessageFns<NickNameQuery> = {
  encode(message: NickNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.nickName !== "") {
...
export const DisplayNameQuery: MessageFns<DisplayNameQuery> = {
  encode(message: DisplayNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.displayName !== "") {
...
export const EmailQuery: MessageFns<EmailQuery> = {
  encode(message: EmailQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const LoginNameQuery: MessageFns<LoginNameQuery> = {
  encode(message: LoginNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const StateQuery: MessageFns<StateQuery> = {
  encode(message: StateQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
...
export const TypeQuery: MessageFns<TypeQuery> = {
  encode(message: TypeQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
...
export const AuthFactor: MessageFns<AuthFactor> = {
  encode(message: AuthFactor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.state !== 0) {
      writer.uint32(8).int32(message.state);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthFactor {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthFactorOTP: MessageFns<AuthFactorOTP> = {
  encode(_: AuthFactorOTP, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AuthFactorOTP {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthFactorOTPSMS: MessageFns<AuthFactorOTPSMS> = {
  encode(_: AuthFactorOTPSMS, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AuthFactorOTPSMS {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthFactorOTPEmail: MessageFns<AuthFactorOTPEmail> = {
  encode(_: AuthFactorOTPEmail, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AuthFactorOTPEmail {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AuthFactorU2F: MessageFns<AuthFactorU2F> = {
  encode(message: AuthFactorU2F, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AuthFactorU2F {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WebAuthNKey: MessageFns<WebAuthNKey> = {
  encode(message: WebAuthNKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WebAuthNKey {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WebAuthNVerification: MessageFns<WebAuthNVerification> = {
  encode(message: WebAuthNVerification, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WebAuthNVerification {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const WebAuthNToken: MessageFns<WebAuthNToken> = {
  encode(message: WebAuthNToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.state !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WebAuthNToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MembershipQuery: MessageFns<MembershipQuery> = {
  encode(message: MembershipQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MembershipQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MembershipOrgQuery: MessageFns<MembershipOrgQuery> = {
  encode(message: MembershipOrgQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.orgId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MembershipOrgQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MembershipProjectQuery: MessageFns<MembershipProjectQuery> = {
  encode(message: MembershipProjectQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MembershipProjectQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MembershipProjectGrantQuery: MessageFns<MembershipProjectGrantQuery> = {
  encode(message: MembershipProjectGrantQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MembershipProjectGrantQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MembershipIAMQuery: MessageFns<MembershipIAMQuery> = {
  encode(message: MembershipIAMQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MembershipIAMQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PersonalAccessToken: MessageFns<PersonalAccessToken> = {
  encode(message: PersonalAccessToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.details !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PersonalAccessToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantQuery: MessageFns<UserGrantQuery> = {
  encode(message: UserGrantQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantProjectIDQuery: MessageFns<UserGrantProjectIDQuery> = {
  encode(message: UserGrantProjectIDQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
      writer.uint32(10).string(message.projectId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantProjectIDQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantUserIDQuery: MessageFns<UserGrantUserIDQuery> = {
  encode(message: UserGrantUserIDQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantUserIDQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantWithGrantedQuery: MessageFns<UserGrantWithGrantedQuery> = {
  encode(message: UserGrantWithGrantedQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantWithGrantedQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantRoleKeyQuery: MessageFns<UserGrantRoleKeyQuery> = {
  encode(message: UserGrantRoleKeyQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.roleKey !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantRoleKeyQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantProjectGrantIDQuery: MessageFns<UserGrantProjectGrantIDQuery> = {
  encode(message: UserGrantProjectGrantIDQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectGrantId !== "") {
      writer.uint32(10).string(message.projectGrantId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantProjectGrantIDQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantUserNameQuery: MessageFns<UserGrantUserNameQuery> = {
  encode(message: UserGrantUserNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userName !== "") {
      writer.uint32(10).string(message.userName);
    }
    if (message.method !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantUserNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantFirstNameQuery: MessageFns<UserGrantFirstNameQuery> = {
  encode(message: UserGrantFirstNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.firstName !== "") {
      writer.uint32(10).string(message.firstName);
    }
    if (message.method !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantFirstNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantLastNameQuery: MessageFns<UserGrantLastNameQuery> = {
  encode(message: UserGrantLastNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.lastName !== "") {
      writer.uint32(10).string(message.lastName);
    }
    if (message.method !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantLastNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantEmailQuery: MessageFns<UserGrantEmailQuery> = {
  encode(message: UserGrantEmailQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== "") {
      writer.uint32(10).string(message.email);
    }
    if (message.method !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantEmailQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantOrgNameQuery: MessageFns<UserGrantOrgNameQuery> = {
  encode(message: UserGrantOrgNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.orgName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantOrgNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantOrgDomainQuery: MessageFns<UserGrantOrgDomainQuery> = {
  encode(message: UserGrantOrgDomainQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.orgDomain !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantOrgDomainQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantProjectNameQuery: MessageFns<UserGrantProjectNameQuery> = {
  encode(message: UserGrantProjectNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantProjectNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantDisplayNameQuery: MessageFns<UserGrantDisplayNameQuery> = {
  encode(message: UserGrantDisplayNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.displayName !== "") {
      writer.uint32(10).string(message.displayName);
    }
    if (message.method !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantDisplayNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UserGrantUserTypeQuery: MessageFns<UserGrantUserTypeQuery> = {
  encode(message: UserGrantUserTypeQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
      writer.uint32(8).int32(message.type);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrantUserTypeQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
