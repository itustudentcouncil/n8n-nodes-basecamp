...
export const SendPasskeyRegistrationLink: MessageFns<SendPasskeyRegistrationLink> = {
  encode(message: SendPasskeyRegistrationLink, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SendPasskeyRegistrationLink {
...
export const ReturnPasskeyRegistrationCode: MessageFns<ReturnPasskeyRegistrationCode> = {
  encode(_: ReturnPasskeyRegistrationCode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ReturnPasskeyRegistrationCode {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const PasskeyRegistrationCode: MessageFns<PasskeyRegistrationCode> = {
  encode(message: PasskeyRegistrationCode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PasskeyRegistrationCode {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
