...
function createBaseRemoveU2FRequest(): RemoveU2FRequest {
  return { userId: "", u2fId: "" };
}

export const RemoveU2FRequest: MessageFns<RemoveU2FRequest> = {
  encode(message: RemoveU2FRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.u2fId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveU2FRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RemoveU2FRequest {
    return {
      userId: isSet(object.userId) ? globalThis.String(object.userId) : "",
      u2fId: isSet(object.u2fId) ? globalThis.String(object.u2fId) : "",
    };
  ...
  toJSON(message: RemoveU2FRequest): unknown {
    const obj: any = {};
    if (message.userId !== "") {
      obj.userId = message.userId;
    }
  ...
  create(base?: DeepPartial<RemoveU2FRequest>): RemoveU2FRequest {
    return RemoveU2FRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RemoveU2FRequest>): RemoveU2FRequest {
    const message = createBaseRemoveU2FRequest();
    message.userId = object.userId ?? "";
    message.u2fId = object.u2fId ?? "";
    return message;
...
function createBaseRemoveU2FResponse(): RemoveU2FResponse {
  return { details: undefined };
}

export const RemoveU2FResponse: MessageFns<RemoveU2FResponse> = {
  encode(message: RemoveU2FResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveU2FResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RemoveU2FResponse {
    return { details: isSet(object.details) ? Details.fromJSON(object.details) : undefined };
  },

  toJSON(message: RemoveU2FResponse): unknown {
    const obj: any = {};
    if (message.details !== undefined) {
      obj.details = Details.toJSON(message.details);
    }
  ...
  create(base?: DeepPartial<RemoveU2FResponse>): RemoveU2FResponse {
    return RemoveU2FResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RemoveU2FResponse>): RemoveU2FResponse {
    const message = createBaseRemoveU2FResponse();
    message.details = (object.details !== undefined && object.details !== null)
      ? Details.fromPartial(object.details)
      : undefined;
...
export const ListPasskeysRequest: MessageFns<ListPasskeysRequest> = {
  encode(message: ListPasskeysRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    return writer;
  ...
  create(base?: DeepPartial<ListPasskeysRequest>): ListPasskeysRequest {
    return ListPasskeysRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListPasskeysRequest>): ListPasskeysRequest {
    const message = createBaseListPasskeysRequest();
    message.userId = object.userId ?? "";
    return message;
  },
...
export const ListPasskeysResponse: MessageFns<ListPasskeysResponse> = {
  ...
  fromJSON(object: any): ListPasskeysResponse {
    return {
      details: isSet(object.details) ? ListDetails.fromJSON(object.details) : undefined,
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => Passkey.fromJSON(e)) : [],
    };
  },
  ...
  create(base?: DeepPartial<ListPasskeysResponse>): ListPasskeysResponse {
    return ListPasskeysResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListPasskeysResponse>): ListPasskeysResponse {
    const message = createBaseListPasskeysResponse();
    message.details = (object.details !== undefined && object.details !== null)
      ? ListDetails.fromPartial(object.details)
      : undefined;
...
function createBaseRemovePasskeyRequest(): RemovePasskeyRequest {
  return { userId: "", passkeyId: "" };
}

export const RemovePasskeyRequest: MessageFns<RemovePasskeyRequest> = {
  encode(message: RemovePasskeyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.passkeyId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemovePasskeyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RemovePasskeyRequest {
    return {
      userId: isSet(object.userId) ? globalThis.String(object.userId) : "",
      passkeyId: isSet(object.passkeyId) ? globalThis.String(object.passkeyId) : "",
    };
  ...
  toJSON(message: RemovePasskeyRequest): unknown {
    const obj: any = {};
    if (message.userId !== "") {
      obj.userId = message.userId;
    }
  ...
  create(base?: DeepPartial<RemovePasskeyRequest>): RemovePasskeyRequest {
    return RemovePasskeyRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RemovePasskeyRequest>): RemovePasskeyRequest {
    const message = createBaseRemovePasskeyRequest();
    message.userId = object.userId ?? "";
    message.passkeyId = object.passkeyId ?? "";
    return message;
...
function createBaseRemovePasskeyResponse(): RemovePasskeyResponse {
  return { details: undefined };
}

export const RemovePasskeyResponse: MessageFns<RemovePasskeyResponse> = {
  encode(message: RemovePasskeyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemovePasskeyResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RemovePasskeyResponse {
    return { details: isSet(object.details) ? Details.fromJSON(object.details) : undefined };
  },

  toJSON(message: RemovePasskeyResponse): unknown {
    const obj: any = {};
    if (message.details !== undefined) {
      obj.details = Details.toJSON(message.details);
    }
  ...
  create(base?: DeepPartial<RemovePasskeyResponse>): RemovePasskeyResponse {
    return RemovePasskeyResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RemovePasskeyResponse>): RemovePasskeyResponse {
    const message = createBaseRemovePasskeyResponse();
    message.details = (object.details !== undefined && object.details !== null)
      ? Details.fromPartial(object.details)
      : undefined;
...
function createBaseListIDPLinksRequest(): ListIDPLinksRequest {
  return { userId: "", query: undefined };
}

export const ListIDPLinksRequest: MessageFns<ListIDPLinksRequest> = {
  encode(message: ListIDPLinksRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.query !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListIDPLinksRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListIDPLinksRequest {
    return {
      userId: isSet(object.userId) ? globalThis.String(object.userId) : "",
      query: isSet(object.query) ? ListQuery.fromJSON(object.query) : undefined,
    };
  ...
  toJSON(message: ListIDPLinksRequest): unknown {
    const obj: any = {};
    if (message.userId !== "") {
      obj.userId = message.userId;
    }
  ...
  create(base?: DeepPartial<ListIDPLinksRequest>): ListIDPLinksRequest {
    return ListIDPLinksRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListIDPLinksRequest>): ListIDPLinksRequest {
    const message = createBaseListIDPLinksRequest();
    message.userId = object.userId ?? "";
    message.query = (object.query !== undefined && object.query !== null)
      ? ListQuery.fromPartial(object.query)
...
function createBaseListIDPLinksResponse(): ListIDPLinksResponse {
  return { details: undefined, result: [] };
}

export const ListIDPLinksResponse: MessageFns<ListIDPLinksResponse> = {
  encode(message: ListIDPLinksResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ListDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListIDPLinksResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListIDPLinksResponse {
    return {
      details: isSet(object.details) ? ListDetails.fromJSON(object.details) : undefined,
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => IDPLink.fromJSON(e)) : [],
    };
  },

  toJSON(message: ListIDPLinksResponse): unknown {
    const obj: any = {};
    if (message.details !== undefined) {
      obj.details = ListDetails.toJSON(message.details);
    }
  ...
  create(base?: DeepPartial<ListIDPLinksResponse>): ListIDPLinksResponse {
    return ListIDPLinksResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListIDPLinksResponse>): ListIDPLinksResponse {
    const message = createBaseListIDPLinksResponse();
    message.details = (object.details !== undefined && object.details !== null)
      ? ListDetails.fromPartial(object.details)
      : undefined;
...
function createBaseRemoveIDPLinkRequest(): RemoveIDPLinkRequest {
  return { userId: "", idpId: "", linkedUserId: "" };
}

export const RemoveIDPLinkRequest: MessageFns<RemoveIDPLinkRequest> = {
  encode(message: RemoveIDPLinkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.idpId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveIDPLinkRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RemoveIDPLinkRequest {
    return {
      userId: isSet(object.userId) ? globalThis.String(object.userId) : "",
      idpId: isSet(object.idpId) ? globalThis.String(object.idpId) : "",
  ...
  toJSON(message: RemoveIDPLinkRequest): unknown {
    const obj: any = {};
    if (message.userId !== "") {
      obj.userId = message.userId;
    }
  ...
  create(base?: DeepPartial<RemoveIDPLinkRequest>): RemoveIDPLinkRequest {
    return RemoveIDPLinkRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RemoveIDPLinkRequest>): RemoveIDPLinkRequest {
    const message = createBaseRemoveIDPLinkRequest();
    message.userId = object.userId ?? "";
    message.idpId = object.idpId ?? "";
...
function createBaseRemoveIDPLinkResponse(): RemoveIDPLinkResponse {
  return { details: undefined };
}

export const RemoveIDPLinkResponse: MessageFns<RemoveIDPLinkResponse> = {
  encode(message: RemoveIDPLinkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveIDPLinkResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): RemoveIDPLinkResponse {
    return { details: isSet(object.details) ? Details.fromJSON(object.details) : undefined };
  },

  toJSON(message: RemoveIDPLinkResponse): unknown {
    const obj: any = {};
    if (message.details !== undefined) {
      obj.details = Details.toJSON(message.details);
    }
  ...
  create(base?: DeepPartial<RemoveIDPLinkResponse>): RemoveIDPLinkResponse {
    return RemoveIDPLinkResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RemoveIDPLinkResponse>): RemoveIDPLinkResponse {
    const message = createBaseRemoveIDPLinkResponse();
    message.details = (object.details !== undefined && object.details !== null)
      ? Details.fromPartial(object.details)
      : undefined;
...
function createBaseCreateInviteCodeRequest(): CreateInviteCodeRequest {
  return { userId: "", sendCode: undefined, returnCode: undefined };
}

export const CreateInviteCodeRequest: MessageFns<CreateInviteCodeRequest> = {
  encode(message: CreateInviteCodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.sendCode !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInviteCodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CreateInviteCodeRequest {
    return {
      userId: isSet(object.userId) ? globalThis.String(object.userId) : "",
  ...
  toJSON(message: CreateInviteCodeRequest): unknown {
    const obj: any = {};
    if (message.userId !== "") {
      obj.userId = message.userId;
    }
  ...
  create(base?: DeepPartial<CreateInviteCodeRequest>): CreateInviteCodeRequest {
    return CreateInviteCodeRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CreateInviteCodeRequest>): CreateInviteCodeRequest {
    const message = createBaseCreateInviteCodeRequest();
    message.userId = object.userId ?? "";
    message.sendCode = (object.sendCode !== undefined && object.sendCode !== null)
...
function createBaseCreateInviteCodeResponse(): CreateInviteCodeResponse {
  return { details: undefined, inviteCode: undefined };
}

export const CreateInviteCodeResponse: MessageFns<CreateInviteCodeResponse> = {
  encode(message: CreateInviteCodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInviteCodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): CreateInviteCodeResponse {
    return {
      details: isSet(object.details) ? Details.fromJSON(object.details) : undefined,
  ...
  toJSON(message: CreateInviteCodeResponse): unknown {
    const obj: any = {};
    if (message.details !== undefined) {
      obj.details = Details.toJSON(message.details);
    }
  ...
  create(base?: DeepPartial<CreateInviteCodeResponse>): CreateInviteCodeResponse {
    return CreateInviteCodeResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CreateInviteCodeResponse>): CreateInviteCodeResponse {
    const message = createBaseCreateInviteCodeResponse();
    message.details = (object.details !== undefined && object.details !== null)
      ? Details.fromPartial(object.details)
      : undefined;
...
function createBaseResendInviteCodeRequest(): ResendInviteCodeRequest {
  return { userId: "" };
}

export const ResendInviteCodeRequest: MessageFns<ResendInviteCodeRequest> = {
  encode(message: ResendInviteCodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ResendInviteCodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ResendInviteCodeRequest {
    return { userId: isSet(object.userId) ? globalThis.String(object.userId) : "" };
  },

  toJSON(message: ResendInviteCodeRequest): unknown {
    const obj: any = {};
    if (message.userId !== "") {
      obj.userId = message.userId;
    }
  ...
  create(base?: DeepPartial<ResendInviteCodeRequest>): ResendInviteCodeRequest {
    return ResendInviteCodeRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ResendInviteCodeRequest>): ResendInviteCodeRequest {
    const message = createBaseResendInviteCodeRequest();
    message.userId = object.userId ?? "";
    return message;
  },
...
function createBaseResendInviteCodeResponse(): ResendInviteCodeResponse {
  return { details: undefined };
}

export const ResendInviteCodeResponse: MessageFns<ResendInviteCodeResponse> = {
  encode(message: ResendInviteCodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ResendInviteCodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ResendInviteCodeResponse {
    return { details: isSet(object.details) ? Details.fromJSON(object.details) : undefined };
  },

  toJSON(message: ResendInviteCodeResponse): unknown {
    const obj: any = {};
    if (message.details !== undefined) {
      obj.details = Details.toJSON(message.details);
    }
  ...
  create(base?: DeepPartial<ResendInviteCodeResponse>): ResendInviteCodeResponse {
    return ResendInviteCodeResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ResendInviteCodeResponse>): ResendInviteCodeResponse {
    const message = createBaseResendInviteCodeResponse();
    message.details = (object.details !== undefined && object.details !== null)
      ? Details.fromPartial(object.details)
      : undefined;
...
export const VerifyInviteCodeRequest: MessageFns<VerifyInviteCodeRequest> = {
  encode(message: VerifyInviteCodeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.verificationCode !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyInviteCodeRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<VerifyInviteCodeRequest>): VerifyInviteCodeRequest {
    return VerifyInviteCodeRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<VerifyInviteCodeRequest>): VerifyInviteCodeRequest {
    const message = createBaseVerifyInviteCodeRequest();
    message.userId = object.userId ?? "";
    message.verificationCode = object.verificationCode ?? "";
    return message;
...
export const VerifyInviteCodeResponse: MessageFns<VerifyInviteCodeResponse> = {
  encode(message: VerifyInviteCodeResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyInviteCodeResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<VerifyInviteCodeResponse>): VerifyInviteCodeResponse {
    return VerifyInviteCodeResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<VerifyInviteCodeResponse>): VerifyInviteCodeResponse {
    const message = createBaseVerifyInviteCodeResponse();
    message.details = (object.details !== undefined && object.details !== null)
      ? Details.fromPartial(object.details)
      : undefined;
...
export interface UserServiceImplementation<CallContextExt = {}> {
  ...
  listPasskeys(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListPasskeysResponse>>;
  /**
   * Remove passkey from a user
   *
   * Remove passkey from a user.
  ...
  removePasskey(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<RemovePasskeyResponse>>;
  /**
   * Start the registration of a u2f token for a user
   *
   * Start the registration of a u2f token for a user, as a response the public key credential creation options are returned, which are used to verify the u2f token..
   ...
   */
  listIDPLinks(
    request: ListIDPLinksRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListIDPLinksResponse>>;
  /**
   * Remove link of an identity provider to an user
   *
   * Remove link of an identity provider to an user.
   */
  removeIDPLink(
    request: RemoveIDPLinkRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<RemoveIDPLinkResponse>>;
  /**
   * Request a code to reset a password
   *
   * Request a code to reset a password..
  ...
  createInviteCode(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<CreateInviteCodeResponse>>;
  /**
   * Resend an invite code for a user
   *
   * Resend an invite code for a user to initialize their first authentication method (password, passkeys, IdP) depending on the organization's available methods.
   ...
   */
  resendInviteCode(
    request: ResendInviteCodeRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ResendInviteCodeResponse>>;
  /**
   * Verify an invite code for a user
   *
   * Verify the invite code of a user previously issued. This will set their email to a verified state and
  ...
  verifyInviteCode(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<VerifyInviteCodeResponse>>;
}
...
export interface UserServiceClient<CallOptionsExt = {}> {
   ...
   */
  listPasskeys(
    request: DeepPartial<ListPasskeysRequest>,
    options?: CallOptions & CallOptionsExt,
   ...
   */
  removePasskey(
    request: DeepPartial<RemovePasskeyRequest>,
    options?: CallOptions & CallOptionsExt,
   ...
   */
  listIDPLinks(
    request: DeepPartial<ListIDPLinksRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ListIDPLinksResponse>;
  /**
   * Remove link of an identity provider to an user
   *
   * Remove link of an identity provider to an user.
   */
  removeIDPLink(
    request: DeepPartial<RemoveIDPLinkRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<RemoveIDPLinkResponse>;
  /**
   * Request a code to reset a password
   *
   * Request a code to reset a password..
   ...
   */
  createInviteCode(
    request: DeepPartial<CreateInviteCodeRequest>,
    options?: CallOptions & CallOptionsExt,
   ...
   */
  resendInviteCode(
    request: DeepPartial<ResendInviteCodeRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ResendInviteCodeResponse>;
  /**
   * Verify an invite code for a user
   *
   * Verify the invite code of a user previously issued. This will set their email to a verified state and
