...
// @generated from file google/cloud/scheduler/v1beta1/job.proto (package google.cloud.scheduler.v1beta1, syntax proto3)
/* eslint-disable */
...
import { file_google_cloud_scheduler_v1beta1_target } from "./target_pb";
...
/**
 * Describes the file google/cloud/scheduler/v1beta1/job.proto.
 */
export const file_google_cloud_scheduler_v1beta1_job: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_field_behavior, file_google_api_resource, file_google_cloud_scheduler_v1beta1_target, file_google_protobuf_duration, file_google_protobuf_timestamp, file_google_rpc_status]);

/**
 * Configuration for a job.
 * The maximum allowed size for a job is 1MB.
 *
 * @generated from message google.cloud.scheduler.v1beta1.Job
 */
export type Job = Message<"google.cloud.scheduler.v1beta1.Job"> & {
  /**
   ...
   *
   * @generated from oneof google.cloud.scheduler.v1beta1.Job.target
   */
  target: {
    /**
     * Pub/Sub target.
     *
     * @generated from field: google.cloud.scheduler.v1beta1.PubsubTarget pubsub_target = 4;
     */
    value: PubsubTarget;
    case: "pubsubTarget";
  } | {
     ...
     *
     * @generated from field: google.cloud.scheduler.v1beta1.AppEngineHttpTarget app_engine_http_target = 5;
     */
     ...
     * HTTP target.
     *
     * @generated from field: google.cloud.scheduler.v1beta1.HttpTarget http_target = 6;
     */
    value: HttpTarget;
    case: "httpTarget";
   ...
   *
   * @generated from field: google.cloud.scheduler.v1beta1.Job.State state = 10;
   */
  state: Job_State;
   ...
   *
   * @generated from field: google.cloud.scheduler.v1beta1.RetryConfig retry_config = 19;
   */
   ...
   * targets.
   *
   * @generated from field: bool legacy_app_engine_cron = 23;
   */
  legacyAppEngineCron: boolean;
};

/**
 * Describes the message google.cloud.scheduler.v1beta1.Job.
 * Use `create(JobSchema)` to create a new message.
 */
export const JobSchema: GenMessage<Job> = /*@__PURE__*/
  messageDesc(file_google_cloud_scheduler_v1beta1_job, 0);

/**
 * State of the job.
 *
 * @generated from enum google.cloud.scheduler.v1beta1.Job.State
 */
...
/**
 * Describes the enum google.cloud.scheduler.v1beta1.Job.State.
 */
export const Job_StateSchema: GenEnum<Job_State> = /*@__PURE__*/
  enumDesc(file_google_cloud_scheduler_v1beta1_job, 0, 0);
 ...
 *
 * @generated from message google.cloud.scheduler.v1beta1.RetryConfig
 */
export type RetryConfig = Message<"google.cloud.scheduler.v1beta1.RetryConfig"> & {
  /**
...
/**
 * Describes the message google.cloud.scheduler.v1beta1.RetryConfig.
 * Use `create(RetryConfigSchema)` to create a new message.
 */
export const RetryConfigSchema: GenMessage<RetryConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_scheduler_v1beta1_job, 1);
