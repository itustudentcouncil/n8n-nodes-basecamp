...
// @generated from file google/cloud/retail/v2beta/serving_config.proto (package google.cloud.retail.v2beta, syntax proto3)
/* eslint-disable */
...
import { file_google_cloud_retail_v2beta_search_service } from "./search_service_pb";
import type { Message } from "@bufbuild/protobuf";

/**
 * Describes the file google/cloud/retail/v2beta/serving_config.proto.
 */
export const file_google_cloud_retail_v2beta_serving_config: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_field_behavior, file_google_api_resource, file_google_cloud_retail_v2beta_common, file_google_cloud_retail_v2beta_search_service]);

/**
 * Configures metadata that is used to generate serving time results (e.g.
 * search results or recommendation predictions).
 *
 * @generated from message google.cloud.retail.v2beta.ServingConfig
 */
export type ServingConfig = Message<"google.cloud.retail.v2beta.ServingConfig"> & {
  /**
   ...
   * [SOLUTION_TYPE_SEARCH][google.cloud.retail.v2main.SolutionType.SOLUTION_TYPE_SEARCH].
   *
   * @generated from field: google.cloud.retail.v2beta.SearchRequest.DynamicFacetSpec dynamic_facet_spec = 6;
   */
   ...
   *
   * @generated from field: google.cloud.retail.v2beta.ServingConfig.DiversityType diversity_type = 20;
   */
   ...
   * [ServingConfig.personalization_spec][google.cloud.retail.v2beta.ServingConfig.personalization_spec].
   *
   * @generated from field: google.cloud.retail.v2beta.SearchRequest.PersonalizationSpec personalization_spec = 21;
   */
   ...
   *
   * @generated from field: repeated google.cloud.retail.v2beta.SolutionType solution_types = 19;
   */
  solutionTypes: SolutionType[];
};

/**
 * Describes the message google.cloud.retail.v2beta.ServingConfig.
 * Use `create(ServingConfigSchema)` to create a new message.
 */
export const ServingConfigSchema: GenMessage<ServingConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_retail_v2beta_serving_config, 0);

/**
 * What type of diversity - data or rule based.
 *
 * @generated from enum google.cloud.retail.v2beta.ServingConfig.DiversityType
 */
...
/**
 * Describes the enum google.cloud.retail.v2beta.ServingConfig.DiversityType.
 */
export const ServingConfig_DiversityTypeSchema: GenEnum<ServingConfig_DiversityType> = /*@__PURE__*/
  enumDesc(file_google_cloud_retail_v2beta_serving_config, 0, 0);
