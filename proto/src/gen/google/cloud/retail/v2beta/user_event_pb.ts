...
// @generated from file google/cloud/retail/v2beta/user_event.proto (package google.cloud.retail.v2beta, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file google/cloud/retail/v2beta/user_event.proto.
 */
export const file_google_cloud_retail_v2beta_user_event: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_field_behavior, file_google_cloud_retail_v2beta_common, file_google_cloud_retail_v2beta_product, file_google_protobuf_timestamp, file_google_protobuf_wrappers]);

/**
 * UserEvent captures all metadata information Retail API needs to know about
 * how end users interact with customers' website.
 *
 * @generated from message google.cloud.retail.v2beta.UserEvent
 */
export type UserEvent = Message<"google.cloud.retail.v2beta.UserEvent"> & {
  /**
   ...
   *
   * @generated from field: repeated google.cloud.retail.v2beta.ProductDetail product_details = 6;
   */
   ...
   *
   * @generated from field: google.cloud.retail.v2beta.CompletionDetail completion_detail = 22;
   */
   ...
   *
   * @generated from field: map<string, google.cloud.retail.v2beta.CustomAttribute> attributes = 7;
   */
   ...
   *
   * @generated from field: google.cloud.retail.v2beta.PurchaseTransaction purchase_transaction = 9;
   */
   ...
   * User information.
   *
   * @generated from field: google.cloud.retail.v2beta.UserInfo user_info = 12;
   */
  userInfo?: UserInfo;
...
/**
 * Describes the message google.cloud.retail.v2beta.UserEvent.
 * Use `create(UserEventSchema)` to create a new message.
 */
export const UserEventSchema: GenMessage<UserEvent> = /*@__PURE__*/
  messageDesc(file_google_cloud_retail_v2beta_user_event, 0);

/**
 * Detailed product information associated with a user event.
 *
 * @generated from message google.cloud.retail.v2beta.ProductDetail
 */
export type ProductDetail = Message<"google.cloud.retail.v2beta.ProductDetail"> & {
  /**
...
/**
 * Describes the message google.cloud.retail.v2beta.ProductDetail.
 * Use `create(ProductDetailSchema)` to create a new message.
 */
export const ProductDetailSchema: GenMessage<ProductDetail> = /*@__PURE__*/
  messageDesc(file_google_cloud_retail_v2beta_user_event, 1);

/**
 * Detailed completion information including completion attribution token and
 * clicked completion info.
 *
 * @generated from message google.cloud.retail.v2beta.CompletionDetail
 */
export type CompletionDetail = Message<"google.cloud.retail.v2beta.CompletionDetail"> & {
  /**
...
/**
 * Describes the message google.cloud.retail.v2beta.CompletionDetail.
...
export const CompletionDetailSchema: GenMessage<CompletionDetail> = /*@__PURE__*/
  messageDesc(file_google_cloud_retail_v2beta_user_event, 2);

/**
 * A transaction represents the entire purchase transaction.
 *
 * @generated from message google.cloud.retail.v2beta.PurchaseTransaction
 */
export type PurchaseTransaction = Message<"google.cloud.retail.v2beta.PurchaseTransaction"> & {
  /**
...
/**
 * Describes the message google.cloud.retail.v2beta.PurchaseTransaction.
...
export const PurchaseTransactionSchema: GenMessage<PurchaseTransaction> = /*@__PURE__*/
  messageDesc(file_google_cloud_retail_v2beta_user_event, 3);
