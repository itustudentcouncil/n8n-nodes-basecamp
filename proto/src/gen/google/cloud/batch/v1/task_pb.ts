...
// @generated from file google/cloud/batch/v1/task.proto (package google.cloud.batch.v1, syntax proto3)
/* eslint-disable */
...
import { file_google_cloud_batch_v1_volume } from "./volume_pb";
import type { Duration, Timestamp } from "@bufbuild/protobuf/wkt";
import { file_google_protobuf_duration, file_google_protobuf_timestamp } from "@bufbuild/protobuf/wkt";
import type { Message } from "@bufbuild/protobuf";

/**
 * Describes the file google/cloud/batch/v1/task.proto.
 */
export const file_google_cloud_batch_v1_task: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_field_behavior, file_google_api_resource, file_google_cloud_batch_v1_volume, file_google_protobuf_duration, file_google_protobuf_timestamp]);
 ...
 *
 * @generated from message google.cloud.batch.v1.ComputeResource
 */
export type ComputeResource = Message<"google.cloud.batch.v1.ComputeResource"> & {
  /**
   * The milliCPU count.
   *
...
/**
 * Describes the message google.cloud.batch.v1.ComputeResource.
...
export const ComputeResourceSchema: GenMessage<ComputeResource> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 0);

/**
 * Status event.
 *
 * @generated from message google.cloud.batch.v1.StatusEvent
 */
export type StatusEvent = Message<"google.cloud.batch.v1.StatusEvent"> & {
  /**
   * Type of the event.
   *
   ...
   * fails.
   *
   * @generated from field: google.cloud.batch.v1.TaskExecution task_execution = 4;
   */
   ...
   *
   * @generated from field: google.cloud.batch.v1.TaskStatus.State task_state = 5;
   */
  taskState: TaskStatus_State;
};

/**
 * Describes the message google.cloud.batch.v1.StatusEvent.
 * Use `create(StatusEventSchema)` to create a new message.
 */
export const StatusEventSchema: GenMessage<StatusEvent> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 1);

/**
 * This Task Execution field includes detail information for
 * task execution procedures, based on StatusEvent types.
 *
 * @generated from message google.cloud.batch.v1.TaskExecution
 */
export type TaskExecution = Message<"google.cloud.batch.v1.TaskExecution"> & {
  /**
...
/**
 * Describes the message google.cloud.batch.v1.TaskExecution.
 * Use `create(TaskExecutionSchema)` to create a new message.
 */
export const TaskExecutionSchema: GenMessage<TaskExecution> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 2);

/**
 * Status of a task.
 *
 * @generated from message google.cloud.batch.v1.TaskStatus
 */
export type TaskStatus = Message<"google.cloud.batch.v1.TaskStatus"> & {
  /**
   * Task state.
   *
   * @generated from field: google.cloud.batch.v1.TaskStatus.State state = 1;
   */
...
/**
 * Describes the message google.cloud.batch.v1.TaskStatus.
 * Use `create(TaskStatusSchema)` to create a new message.
 */
export const TaskStatusSchema: GenMessage<TaskStatus> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 3);

/**
 * Task states.
 *
 * @generated from enum google.cloud.batch.v1.TaskStatus.State
 */
...
/**
 * Describes the enum google.cloud.batch.v1.TaskStatus.State.
 */
export const TaskStatus_StateSchema: GenEnum<TaskStatus_State> = /*@__PURE__*/
  enumDesc(file_google_cloud_batch_v1_task, 3, 0);

/**
 * Runnable describes instructions for executing a specific script or container
 * as part of a Task.
 *
 * @generated from message google.cloud.batch.v1.Runnable
 */
export type Runnable = Message<"google.cloud.batch.v1.Runnable"> & {
  /**
   * Required. The script, container, or barrier for this runnable to execute.
   *
   * @generated from oneof google.cloud.batch.v1.Runnable.executable
   */
  executable: {
    /**
     * Container runnable.
     *
     * @generated from field: google.cloud.batch.v1.Runnable.Container container = 1;
     */
     ...
     * Script runnable.
     *
     * @generated from field: google.cloud.batch.v1.Runnable.Script script = 2;
     */
     ...
     * Barrier runnable.
     *
     * @generated from field: google.cloud.batch.v1.Runnable.Barrier barrier = 6;
     */
   ...
   *
   * @generated from field: google.cloud.batch.v1.Environment environment = 7;
   */
...
/**
 * Describes the message google.cloud.batch.v1.Runnable.
 * Use `create(RunnableSchema)` to create a new message.
 */
export const RunnableSchema: GenMessage<Runnable> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 4);

/**
 * Container runnable.
 *
 * @generated from message google.cloud.batch.v1.Runnable.Container
 */
export type Runnable_Container = Message<"google.cloud.batch.v1.Runnable.Container"> & {
  /**
...
/**
 * Describes the message google.cloud.batch.v1.Runnable.Container.
...
export const Runnable_ContainerSchema: GenMessage<Runnable_Container> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 4, 0);

/**
 * Script runnable.
 *
 * @generated from message google.cloud.batch.v1.Runnable.Script
 */
export type Runnable_Script = Message<"google.cloud.batch.v1.Runnable.Script"> & {
  /**
   * Required. The source code for this script runnable.
   *
   * @generated from oneof google.cloud.batch.v1.Runnable.Script.command
   */
  command: {
    /**
...
/**
 * Describes the message google.cloud.batch.v1.Runnable.Script.
...
export const Runnable_ScriptSchema: GenMessage<Runnable_Script> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 4, 1);
 ...
 *
 * @generated from message google.cloud.batch.v1.Runnable.Barrier
 */
export type Runnable_Barrier = Message<"google.cloud.batch.v1.Runnable.Barrier"> & {
  /**
...
/**
 * Describes the message google.cloud.batch.v1.Runnable.Barrier.
...
export const Runnable_BarrierSchema: GenMessage<Runnable_Barrier> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 4, 2);

/**
 * Spec of a task
 *
 * @generated from message google.cloud.batch.v1.TaskSpec
 */
export type TaskSpec = Message<"google.cloud.batch.v1.TaskSpec"> & {
  /**
   ...
   *
   * @generated from field: repeated google.cloud.batch.v1.Runnable runnables = 8;
   */
  runnables: Runnable[];
   ...
   *
   * @generated from field: google.cloud.batch.v1.ComputeResource compute_resource = 3;
   */
   ...
   *
   * @generated from field: repeated google.cloud.batch.v1.LifecyclePolicy lifecycle_policies = 9;
   */
   ...
   *
   * @generated from field: repeated google.cloud.batch.v1.Volume volumes = 7;
   */
  volumes: Volume[];
   ...
   *
   * @generated from field: google.cloud.batch.v1.Environment environment = 10;
   */
  environment?: Environment;
};

/**
 * Describes the message google.cloud.batch.v1.TaskSpec.
 * Use `create(TaskSpecSchema)` to create a new message.
 */
export const TaskSpecSchema: GenMessage<TaskSpec> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 5);

/**
 * LifecyclePolicy describes how to deal with task failures
 * based on different conditions.
 *
 * @generated from message google.cloud.batch.v1.LifecyclePolicy
 */
export type LifecyclePolicy = Message<"google.cloud.batch.v1.LifecyclePolicy"> & {
  /**
   ...
   *
   * @generated from field: google.cloud.batch.v1.LifecyclePolicy.Action action = 1;
   */
   ...
   *
   * @generated from field: google.cloud.batch.v1.LifecyclePolicy.ActionCondition action_condition = 2;
   */
  actionCondition?: LifecyclePolicy_ActionCondition;
};

/**
 * Describes the message google.cloud.batch.v1.LifecyclePolicy.
...
export const LifecyclePolicySchema: GenMessage<LifecyclePolicy> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 6);

/**
 * Conditions for actions to deal with task failures.
 *
 * @generated from message google.cloud.batch.v1.LifecyclePolicy.ActionCondition
 */
export type LifecyclePolicy_ActionCondition = Message<"google.cloud.batch.v1.LifecyclePolicy.ActionCondition"> & {
  /**
...
/**
 * Describes the message google.cloud.batch.v1.LifecyclePolicy.ActionCondition.
...
export const LifecyclePolicy_ActionConditionSchema: GenMessage<LifecyclePolicy_ActionCondition> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 6, 0);

/**
 * Action on task failures based on different conditions.
 *
 * @generated from enum google.cloud.batch.v1.LifecyclePolicy.Action
 */
...
/**
 * Describes the enum google.cloud.batch.v1.LifecyclePolicy.Action.
 */
export const LifecyclePolicy_ActionSchema: GenEnum<LifecyclePolicy_Action> = /*@__PURE__*/
  enumDesc(file_google_cloud_batch_v1_task, 6, 0);

/**
 * A Cloud Batch task.
 *
 * @generated from message google.cloud.batch.v1.Task
 */
export type Task = Message<"google.cloud.batch.v1.Task"> & {
  /**
   * Task name.
   ...
   * Task Status.
   *
   * @generated from field: google.cloud.batch.v1.TaskStatus status = 2;
   */
  status?: TaskStatus;
};

/**
 * Describes the message google.cloud.batch.v1.Task.
 * Use `create(TaskSchema)` to create a new message.
 */
export const TaskSchema: GenMessage<Task> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 7);

/**
 * An Environment describes a collection of environment variables to set when
 * executing Tasks.
 *
 * @generated from message google.cloud.batch.v1.Environment
 */
export type Environment = Message<"google.cloud.batch.v1.Environment"> & {
  /**
   ...
   *
   * @generated from field: google.cloud.batch.v1.Environment.KMSEnvMap encrypted_variables = 3;
   */
  encryptedVariables?: Environment_KMSEnvMap;
};

/**
 * Describes the message google.cloud.batch.v1.Environment.
 * Use `create(EnvironmentSchema)` to create a new message.
 */
export const EnvironmentSchema: GenMessage<Environment> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 8);

/**
 * @generated from message google.cloud.batch.v1.Environment.KMSEnvMap
 */
export type Environment_KMSEnvMap = Message<"google.cloud.batch.v1.Environment.KMSEnvMap"> & {
  /**
...
/**
 * Describes the message google.cloud.batch.v1.Environment.KMSEnvMap.
...
export const Environment_KMSEnvMapSchema: GenMessage<Environment_KMSEnvMap> = /*@__PURE__*/
  messageDesc(file_google_cloud_batch_v1_task, 8, 0);
