...
// @generated from file google/cloud/aiplatform/v1/batch_prediction_job.proto (package google.cloud.aiplatform.v1, syntax proto3)
/* eslint-disable */
...
import { file_google_cloud_aiplatform_v1_completion_stats } from "./completion_stats_pb";
...
import { file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters } from "./manual_batch_tuning_parameters_pb";
import type { UnmanagedContainerModel } from "./unmanaged_container_model_pb";
import { file_google_cloud_aiplatform_v1_unmanaged_container_model } from "./unmanaged_container_model_pb";
...
/**
 * Describes the file google/cloud/aiplatform/v1/batch_prediction_job.proto.
 */
export const file_google_cloud_aiplatform_v1_batch_prediction_job: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_field_behavior, file_google_api_resource, file_google_cloud_aiplatform_v1_completion_stats, file_google_cloud_aiplatform_v1_encryption_spec, file_google_cloud_aiplatform_v1_explanation, file_google_cloud_aiplatform_v1_io, file_google_cloud_aiplatform_v1_job_state, file_google_cloud_aiplatform_v1_machine_resources, file_google_cloud_aiplatform_v1_manual_batch_tuning_parameters, file_google_cloud_aiplatform_v1_unmanaged_container_model, file_google_protobuf_struct, file_google_protobuf_timestamp, file_google_rpc_status]);
 ...
 *
 * @generated from message google.cloud.aiplatform.v1.BatchPredictionJob
 */
export type BatchPredictionJob = Message<"google.cloud.aiplatform.v1.BatchPredictionJob"> & {
  /**
   ...
   * Exactly one of model and unmanaged_container_model must be set.
   *
   * @generated from field: google.cloud.aiplatform.v1.UnmanagedContainerModel unmanaged_container_model = 28;
   */
   ...
   *
   * @generated from field: google.cloud.aiplatform.v1.BatchPredictionJob.InputConfig input_config = 4;
   */
   ...
   *
   * @generated from field: google.cloud.aiplatform.v1.BatchPredictionJob.InstanceConfig instance_config = 27;
   */
   ...
   *
   * @generated from field: google.cloud.aiplatform.v1.BatchPredictionJob.OutputConfig output_config = 6;
   */
   ...
   * must be provided.
   *
   * @generated from field: google.cloud.aiplatform.v1.BatchDedicatedResources dedicated_resources = 7;
   */
   ...
   *
   * @generated from field: google.cloud.aiplatform.v1.ManualBatchTuningParameters manual_batch_tuning_parameters = 8;
   */
   ...
   * object is inherited.
   *
   * @generated from field: google.cloud.aiplatform.v1.ExplanationSpec explanation_spec = 25;
   */
   ...
   *
   * @generated from field: google.cloud.aiplatform.v1.BatchPredictionJob.OutputInfo output_info = 9;
   */
   ...
   * use AutoML Models.
   *
   * @generated from field: google.cloud.aiplatform.v1.ResourcesConsumed resources_consumed = 13;
   */
   ...
   *
   * @generated from field: google.cloud.aiplatform.v1.CompletionStats completion_stats = 14;
   */
...
/**
 * Describes the message google.cloud.aiplatform.v1.BatchPredictionJob.
...
export const BatchPredictionJobSchema: GenMessage<BatchPredictionJob> = /*@__PURE__*/
  messageDesc(file_google_cloud_aiplatform_v1_batch_prediction_job, 0);
 ...
 * via any of them.
 *
 * @generated from message google.cloud.aiplatform.v1.BatchPredictionJob.InputConfig
 */
export type BatchPredictionJob_InputConfig = Message<"google.cloud.aiplatform.v1.BatchPredictionJob.InputConfig"> & {
  /**
   * Required. The source of the input.
   *
   * @generated from oneof google.cloud.aiplatform.v1.BatchPredictionJob.InputConfig.source
   */
  source: {
    /**
...
/**
 * Describes the message google.cloud.aiplatform.v1.BatchPredictionJob.InputConfig.
...
export const BatchPredictionJob_InputConfigSchema: GenMessage<BatchPredictionJob_InputConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_aiplatform_v1_batch_prediction_job, 0, 0);

/**
 * Configuration defining how to transform batch prediction input instances to
 * the instances that the Model accepts.
 *
 * @generated from message google.cloud.aiplatform.v1.BatchPredictionJob.InstanceConfig
 */
export type BatchPredictionJob_InstanceConfig = Message<"google.cloud.aiplatform.v1.BatchPredictionJob.InstanceConfig"> & {
  /**
...
/**
 * Describes the message google.cloud.aiplatform.v1.BatchPredictionJob.InstanceConfig.
...
export const BatchPredictionJob_InstanceConfigSchema: GenMessage<BatchPredictionJob_InstanceConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_aiplatform_v1_batch_prediction_job, 0, 1);
 ...
 * them.
 *
 * @generated from message google.cloud.aiplatform.v1.BatchPredictionJob.OutputConfig
 */
export type BatchPredictionJob_OutputConfig = Message<"google.cloud.aiplatform.v1.BatchPredictionJob.OutputConfig"> & {
  /**
   * Required. The destination of the output.
   *
   * @generated from oneof google.cloud.aiplatform.v1.BatchPredictionJob.OutputConfig.destination
   */
  destination: {
    /**
     ...
     *
     * @generated from field: google.cloud.aiplatform.v1.GcsDestination gcs_destination = 2;
     */
...
/**
 * Describes the message google.cloud.aiplatform.v1.BatchPredictionJob.OutputConfig.
...
export const BatchPredictionJob_OutputConfigSchema: GenMessage<BatchPredictionJob_OutputConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_aiplatform_v1_batch_prediction_job, 0, 2);
 ...
 *
 * @generated from message google.cloud.aiplatform.v1.BatchPredictionJob.OutputInfo
 */
export type BatchPredictionJob_OutputInfo = Message<"google.cloud.aiplatform.v1.BatchPredictionJob.OutputInfo"> & {
  /**
   * The output location into which prediction output is written.
   *
   * @generated from oneof google.cloud.aiplatform.v1.BatchPredictionJob.OutputInfo.output_location
   */
  outputLocation: {
    /**
...
/**
 * Describes the message google.cloud.aiplatform.v1.BatchPredictionJob.OutputInfo.
...
export const BatchPredictionJob_OutputInfoSchema: GenMessage<BatchPredictionJob_OutputInfo> = /*@__PURE__*/
  messageDesc(file_google_cloud_aiplatform_v1_batch_prediction_job, 0, 3);
