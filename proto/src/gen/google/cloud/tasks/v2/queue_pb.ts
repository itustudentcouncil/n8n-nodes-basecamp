...
// @generated from file google/cloud/tasks/v2/queue.proto (package google.cloud.tasks.v2, syntax proto3)
/* eslint-disable */

import type { GenEnum, GenFile, GenMessage } from "@bufbuild/protobuf/codegenv1";
import { enumDesc, fileDesc, messageDesc } from "@bufbuild/protobuf/codegenv1";
import { file_google_api_resource } from "../../../api/resource_pb";
import type { AppEngineRouting } from "./target_pb";
...
/**
 * Describes the file google/cloud/tasks/v2/queue.proto.
 */
export const file_google_cloud_tasks_v2_queue: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_resource, file_google_cloud_tasks_v2_target, file_google_protobuf_duration, file_google_protobuf_timestamp]);
 ...
 *
 * @generated from message google.cloud.tasks.v2.Queue
 */
export type Queue = Message<"google.cloud.tasks.v2.Queue"> & {
  /**
   ...
   * app_engine_routing][google.cloud.tasks.v2.AppEngineHttpRequest.app_engine_routing].
   *
   * @generated from field: google.cloud.tasks.v2.AppEngineRouting app_engine_routing_override = 2;
   */
   ...
   *
   * @generated from field: google.cloud.tasks.v2.RateLimits rate_limits = 3;
   */
   ...
   *
   * @generated from field: google.cloud.tasks.v2.RetryConfig retry_config = 4;
   */
   ...
   * to change `state`.
   *
   * @generated from field: google.cloud.tasks.v2.Queue.State state = 5;
   */
  state: Queue_State;
   ...
   *
   * @generated from field: google.protobuf.Timestamp purge_time = 6;
   */
  purgeTime?: Timestamp;
   ...
   *
   * @generated from field: google.cloud.tasks.v2.StackdriverLoggingConfig stackdriver_logging_config = 9;
   */
  stackdriverLoggingConfig?: StackdriverLoggingConfig;
};

/**
 * Describes the message google.cloud.tasks.v2.Queue.
 * Use `create(QueueSchema)` to create a new message.
 */
export const QueueSchema: GenMessage<Queue> = /*@__PURE__*/
  messageDesc(file_google_cloud_tasks_v2_queue, 0);

/**
 * State of the queue.
 *
 * @generated from enum google.cloud.tasks.v2.Queue.State
 */
...
/**
 * Describes the enum google.cloud.tasks.v2.Queue.State.
 */
export const Queue_StateSchema: GenEnum<Queue_State> = /*@__PURE__*/
  enumDesc(file_google_cloud_tasks_v2_queue, 0, 0);
 ...
 *
 * @generated from message google.cloud.tasks.v2.RateLimits
 */
export type RateLimits = Message<"google.cloud.tasks.v2.RateLimits"> & {
  /**
 ...
 *
 * @generated from message google.cloud.tasks.v2.RetryConfig
 */
export type RetryConfig = Message<"google.cloud.tasks.v2.RetryConfig"> & {
  /**
...
/**
 * Describes the message google.cloud.tasks.v2.RetryConfig.
 * Use `create(RetryConfigSchema)` to create a new message.
 */
export const RetryConfigSchema: GenMessage<RetryConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_tasks_v2_queue, 2);

/**
 * Configuration options for writing logs to
 * [Stackdriver Logging](https://cloud.google.com/logging/docs/).
 *
 * @generated from message google.cloud.tasks.v2.StackdriverLoggingConfig
 */
export type StackdriverLoggingConfig = Message<"google.cloud.tasks.v2.StackdriverLoggingConfig"> & {
  /**
...
/**
 * Describes the message google.cloud.tasks.v2.StackdriverLoggingConfig.
...
export const StackdriverLoggingConfigSchema: GenMessage<StackdriverLoggingConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_tasks_v2_queue, 3);
