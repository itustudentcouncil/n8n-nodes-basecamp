...
// @generated from file google/cloud/automl/v1/io.proto (package google.cloud.automl.v1, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file google/cloud/automl/v1/io.proto.
 */
export const file_google_cloud_automl_v1_io: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_api_field_behavior]);
 ...
 *
 *
 * @generated from message google.cloud.automl.v1.InputConfig
 */
export type InputConfig = Message<"google.cloud.automl.v1.InputConfig"> & {
  /**
   * The source of the input.
   *
   * @generated from oneof google.cloud.automl.v1.InputConfig.source
   */
  source: {
    /**
     ...
     *
     * @generated from field: google.cloud.automl.v1.GcsSource gcs_source = 1;
     */
    value: GcsSource;
    case: "gcsSource";
 ...
 *  Operation.metadata.partial_failures.
 *
 * @generated from message google.cloud.automl.v1.BatchPredictInputConfig
 */
export type BatchPredictInputConfig = Message<"google.cloud.automl.v1.BatchPredictInputConfig"> & {
  /**
   * The source of the input.
   *
   * @generated from oneof google.cloud.automl.v1.BatchPredictInputConfig.source
   */
  source: {
    /**
...
/**
 * Describes the message google.cloud.automl.v1.BatchPredictInputConfig.
...
export const BatchPredictInputConfigSchema: GenMessage<BatchPredictInputConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_automl_v1_io, 1);

/**
 * Input configuration of a [Document][google.cloud.automl.v1.Document].
 *
 * @generated from message google.cloud.automl.v1.DocumentInputConfig
 */
export type DocumentInputConfig = Message<"google.cloud.automl.v1.DocumentInputConfig"> & {
  /**
...
/**
 * Describes the message google.cloud.automl.v1.DocumentInputConfig.
...
export const DocumentInputConfigSchema: GenMessage<DocumentInputConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_automl_v1_io, 2);
 ...
 *
 * @generated from message google.cloud.automl.v1.OutputConfig
 */
export type OutputConfig = Message<"google.cloud.automl.v1.OutputConfig"> & {
  /**
   * The destination of the output.
   *
   * @generated from oneof google.cloud.automl.v1.OutputConfig.destination
   */
  destination: {
    /**
     ...
     *
     * @generated from field: google.cloud.automl.v1.GcsDestination gcs_destination = 1;
     */
 ...
 *
 * @generated from message google.cloud.automl.v1.BatchPredictOutputConfig
 */
export type BatchPredictOutputConfig = Message<"google.cloud.automl.v1.BatchPredictOutputConfig"> & {
  /**
   * The destination of the output.
   *
   * @generated from oneof google.cloud.automl.v1.BatchPredictOutputConfig.destination
   */
  destination: {
    /**
...
/**
 * Describes the message google.cloud.automl.v1.BatchPredictOutputConfig.
...
export const BatchPredictOutputConfigSchema: GenMessage<BatchPredictOutputConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_automl_v1_io, 4);

/**
 * Output configuration for ModelExport Action.
 *
 * @generated from message google.cloud.automl.v1.ModelExportOutputConfig
 */
export type ModelExportOutputConfig = Message<"google.cloud.automl.v1.ModelExportOutputConfig"> & {
  /**
   * The destination of the output.
   *
   * @generated from oneof google.cloud.automl.v1.ModelExportOutputConfig.destination
   */
  destination: {
    /**
...
/**
 * Describes the message google.cloud.automl.v1.ModelExportOutputConfig.
...
export const ModelExportOutputConfigSchema: GenMessage<ModelExportOutputConfig> = /*@__PURE__*/
  messageDesc(file_google_cloud_automl_v1_io, 5);

/**
 * The Google Cloud Storage location for the input content.
 *
 * @generated from message google.cloud.automl.v1.GcsSource
 */
export type GcsSource = Message<"google.cloud.automl.v1.GcsSource"> & {
  /**
...
/**
 * Describes the message google.cloud.automl.v1.GcsSource.
 * Use `create(GcsSourceSchema)` to create a new message.
 */
export const GcsSourceSchema: GenMessage<GcsSource> = /*@__PURE__*/
  messageDesc(file_google_cloud_automl_v1_io, 6);

/**
 * The Google Cloud Storage location where the output is to be written to.
 *
 * @generated from message google.cloud.automl.v1.GcsDestination
 */
export type GcsDestination = Message<"google.cloud.automl.v1.GcsDestination"> & {
  /**
...
/**
 * Describes the message google.cloud.automl.v1.GcsDestination.
...
export const GcsDestinationSchema: GenMessage<GcsDestination> = /*@__PURE__*/
  messageDesc(file_google_cloud_automl_v1_io, 7);
