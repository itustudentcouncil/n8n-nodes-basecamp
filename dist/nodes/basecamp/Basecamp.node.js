...
const actions = Object.keys(routes).map((action) => createAction(action, Object.keys(routes[action]).map((key) => ({
...
const idSelector = {
    ...
    displayOptions: {
        show: {
            operation: Object.entries(routes).flatMap(([resource, operations]) => Object.keys(operations)
