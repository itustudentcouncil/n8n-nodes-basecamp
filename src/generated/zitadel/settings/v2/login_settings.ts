...
export const LoginSettings: MessageFns<LoginSettings> = {
  encode(message: LoginSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): LoginSettings {
