...
import { Org, OrgFieldName, orgFieldNameFromJSON, orgFieldNameToJSON, OrgQuery } from "./org.js";
...
import {
  ...
  User,
  UserGrantState,
  userGrantStateFromJSON,
  userGrantStateToJSON,
  WebAuthNKey,
  WebAuthNToken,
...
export const GetMyUserRequest: MessageFns<GetMyUserRequest> = {
  encode(_: GetMyUserRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetMyUserRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyUserResponse: MessageFns<GetMyUserResponse> = {
  encode(message: GetMyUserResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyUserResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyUserRequest: MessageFns<RemoveMyUserRequest> = {
  encode(_: RemoveMyUserRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyUserRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyUserResponse: MessageFns<RemoveMyUserResponse> = {
  encode(message: RemoveMyUserResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyUserResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyUserChangesRequest: MessageFns<ListMyUserChangesRequest> = {
  encode(message: ListMyUserChangesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyUserChangesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyUserChangesResponse: MessageFns<ListMyUserChangesResponse> = {
  encode(message: ListMyUserChangesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyUserChangesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyUserSessionsRequest: MessageFns<ListMyUserSessionsRequest> = {
  encode(_: ListMyUserSessionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListMyUserSessionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyUserSessionsResponse: MessageFns<ListMyUserSessionsResponse> = {
  encode(message: ListMyUserSessionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyUserSessionsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyUserSessionsResponse {
    return {
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => Session.fromJSON(e)) : [],
    };
  },
...
export const ListMyMetadataRequest: MessageFns<ListMyMetadataRequest> = {
  encode(message: ListMyMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyMetadataRequest {
    return {
      ...
      queries: globalThis.Array.isArray(object?.queries)
        ? object.queries.map((e: any) => MetadataQuery.fromJSON(e))
        : [],
    };
  },
...
export const ListMyMetadataResponse: MessageFns<ListMyMetadataResponse> = {
  encode(message: ListMyMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyMetadataResponse {
    return {
      ...
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => Metadata.fromJSON(e)) : [],
    };
  },
...
export const GetMyMetadataRequest: MessageFns<GetMyMetadataRequest> = {
  encode(message: GetMyMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyMetadataResponse: MessageFns<GetMyMetadataResponse> = {
  encode(message: GetMyMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMyMetadataRequest: MessageFns<SetMyMetadataRequest> = {
  encode(message: SetMyMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetMyMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMyMetadataResponse: MessageFns<SetMyMetadataResponse> = {
  encode(message: SetMyMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetMyMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BulkSetMyMetadataRequest: MessageFns<BulkSetMyMetadataRequest> = {
  encode(message: BulkSetMyMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BulkSetMyMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BulkSetMyMetadataRequest_Metadata: MessageFns<BulkSetMyMetadataRequest_Metadata> = {
  encode(message: BulkSetMyMetadataRequest_Metadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value.length !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BulkSetMyMetadataRequest_Metadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BulkSetMyMetadataResponse: MessageFns<BulkSetMyMetadataResponse> = {
  encode(message: BulkSetMyMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BulkSetMyMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyMetadataRequest: MessageFns<RemoveMyMetadataRequest> = {
  encode(message: RemoveMyMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyMetadataResponse: MessageFns<RemoveMyMetadataResponse> = {
  encode(message: RemoveMyMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BulkRemoveMyMetadataRequest: MessageFns<BulkRemoveMyMetadataRequest> = {
  encode(message: BulkRemoveMyMetadataRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BulkRemoveMyMetadataRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BulkRemoveMyMetadataResponse: MessageFns<BulkRemoveMyMetadataResponse> = {
  encode(message: BulkRemoveMyMetadataResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BulkRemoveMyMetadataResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyRefreshTokensRequest: MessageFns<ListMyRefreshTokensRequest> = {
  encode(_: ListMyRefreshTokensRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListMyRefreshTokensRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyRefreshTokensResponse: MessageFns<ListMyRefreshTokensResponse> = {
  encode(message: ListMyRefreshTokensResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ListDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyRefreshTokensResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyRefreshTokensResponse {
    return {
      details: isSet(object.details) ? ListDetails.fromJSON(object.details) : undefined,
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => RefreshToken.fromJSON(e)) : [],
    };
  },
...
export const RevokeMyRefreshTokenRequest: MessageFns<RevokeMyRefreshTokenRequest> = {
  encode(message: RevokeMyRefreshTokenRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RevokeMyRefreshTokenRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RevokeMyRefreshTokenResponse: MessageFns<RevokeMyRefreshTokenResponse> = {
  encode(message: RevokeMyRefreshTokenResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RevokeMyRefreshTokenResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RevokeAllMyRefreshTokensRequest: MessageFns<RevokeAllMyRefreshTokensRequest> = {
  encode(_: RevokeAllMyRefreshTokensRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RevokeAllMyRefreshTokensRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RevokeAllMyRefreshTokensResponse: MessageFns<RevokeAllMyRefreshTokensResponse> = {
  encode(_: RevokeAllMyRefreshTokensResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RevokeAllMyRefreshTokensResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateMyUserNameRequest: MessageFns<UpdateMyUserNameRequest> = {
  encode(message: UpdateMyUserNameRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateMyUserNameRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateMyUserNameResponse: MessageFns<UpdateMyUserNameResponse> = {
  encode(message: UpdateMyUserNameResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateMyUserNameResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyPasswordComplexityPolicyRequest: MessageFns<GetMyPasswordComplexityPolicyRequest> = {
  encode(_: GetMyPasswordComplexityPolicyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetMyPasswordComplexityPolicyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyPasswordComplexityPolicyResponse: MessageFns<GetMyPasswordComplexityPolicyResponse> = {
  encode(message: GetMyPasswordComplexityPolicyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyPasswordComplexityPolicyResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateMyPasswordRequest: MessageFns<UpdateMyPasswordRequest> = {
  encode(message: UpdateMyPasswordRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateMyPasswordRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateMyPasswordResponse: MessageFns<UpdateMyPasswordResponse> = {
  encode(message: UpdateMyPasswordResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateMyPasswordResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyProfileResponse: MessageFns<GetMyProfileResponse> = {
  encode(message: GetMyProfileResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyProfileResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateMyProfileRequest: MessageFns<UpdateMyProfileRequest> = {
  encode(message: UpdateMyProfileRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateMyProfileRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateMyProfileResponse: MessageFns<UpdateMyProfileResponse> = {
  encode(message: UpdateMyProfileResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateMyProfileResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyEmailRequest: MessageFns<GetMyEmailRequest> = {
  encode(_: GetMyEmailRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetMyEmailRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyEmailResponse: MessageFns<GetMyEmailResponse> = {
  encode(message: GetMyEmailResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyEmailResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMyEmailRequest: MessageFns<SetMyEmailRequest> = {
  encode(message: SetMyEmailRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetMyEmailRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMyEmailResponse: MessageFns<SetMyEmailResponse> = {
  encode(message: SetMyEmailResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetMyEmailResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyEmailRequest: MessageFns<VerifyMyEmailRequest> = {
  encode(message: VerifyMyEmailRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyEmailRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyEmailResponse: MessageFns<VerifyMyEmailResponse> = {
  encode(message: VerifyMyEmailResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyEmailResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ResendMyEmailVerificationRequest: MessageFns<ResendMyEmailVerificationRequest> = {
  encode(_: ResendMyEmailVerificationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ResendMyEmailVerificationRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ResendMyEmailVerificationResponse: MessageFns<ResendMyEmailVerificationResponse> = {
  encode(message: ResendMyEmailVerificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ResendMyEmailVerificationResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyPhoneRequest: MessageFns<GetMyPhoneRequest> = {
  encode(_: GetMyPhoneRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetMyPhoneRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyPhoneResponse: MessageFns<GetMyPhoneResponse> = {
  encode(message: GetMyPhoneResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyPhoneResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMyPhoneRequest: MessageFns<SetMyPhoneRequest> = {
  encode(message: SetMyPhoneRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.phone !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetMyPhoneRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetMyPhoneResponse: MessageFns<SetMyPhoneResponse> = {
  encode(message: SetMyPhoneResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetMyPhoneResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyPhoneRequest: MessageFns<VerifyMyPhoneRequest> = {
  encode(message: VerifyMyPhoneRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== "") {
      writer.uint32(10).string(message.code);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyPhoneRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyPhoneResponse: MessageFns<VerifyMyPhoneResponse> = {
  encode(message: VerifyMyPhoneResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyPhoneResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ResendMyPhoneVerificationRequest: MessageFns<ResendMyPhoneVerificationRequest> = {
  encode(_: ResendMyPhoneVerificationRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ResendMyPhoneVerificationRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ResendMyPhoneVerificationResponse: MessageFns<ResendMyPhoneVerificationResponse> = {
  encode(message: ResendMyPhoneVerificationResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ResendMyPhoneVerificationResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyPhoneRequest: MessageFns<RemoveMyPhoneRequest> = {
  encode(_: RemoveMyPhoneRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyPhoneRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyPhoneResponse: MessageFns<RemoveMyPhoneResponse> = {
  encode(message: RemoveMyPhoneResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyPhoneResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAvatarRequest: MessageFns<RemoveMyAvatarRequest> = {
  encode(_: RemoveMyAvatarRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAvatarRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAvatarResponse: MessageFns<RemoveMyAvatarResponse> = {
  encode(message: RemoveMyAvatarResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAvatarResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyLinkedIDPsRequest: MessageFns<ListMyLinkedIDPsRequest> = {
  encode(message: ListMyLinkedIDPsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
      ListQuery.encode(message.query, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyLinkedIDPsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyLinkedIDPsResponse: MessageFns<ListMyLinkedIDPsResponse> = {
  encode(message: ListMyLinkedIDPsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ListDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyLinkedIDPsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyLinkedIDPsResponse {
    return {
      details: isSet(object.details) ? ListDetails.fromJSON(object.details) : undefined,
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => IDPUserLink.fromJSON(e)) : [],
    };
  },
...
export const RemoveMyLinkedIDPRequest: MessageFns<RemoveMyLinkedIDPRequest> = {
  encode(message: RemoveMyLinkedIDPRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.idpId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyLinkedIDPRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyLinkedIDPResponse: MessageFns<RemoveMyLinkedIDPResponse> = {
  encode(message: RemoveMyLinkedIDPResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyLinkedIDPResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyAuthFactorsRequest: MessageFns<ListMyAuthFactorsRequest> = {
  encode(_: ListMyAuthFactorsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListMyAuthFactorsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyAuthFactorsResponse: MessageFns<ListMyAuthFactorsResponse> = {
  encode(message: ListMyAuthFactorsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyAuthFactorsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyAuthFactorsResponse {
    return {
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => AuthFactor.fromJSON(e)) : [],
    };
  },
...
export const AddMyAuthFactorU2FRequest: MessageFns<AddMyAuthFactorU2FRequest> = {
  encode(_: AddMyAuthFactorU2FRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AddMyAuthFactorU2FRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyAuthFactorU2FResponse: MessageFns<AddMyAuthFactorU2FResponse> = {
  encode(message: AddMyAuthFactorU2FResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddMyAuthFactorU2FResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyAuthFactorOTPRequest: MessageFns<AddMyAuthFactorOTPRequest> = {
  encode(_: AddMyAuthFactorOTPRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AddMyAuthFactorOTPRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyAuthFactorOTPResponse: MessageFns<AddMyAuthFactorOTPResponse> = {
  encode(message: AddMyAuthFactorOTPResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddMyAuthFactorOTPResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyAuthFactorOTPRequest: MessageFns<VerifyMyAuthFactorOTPRequest> = {
  encode(message: VerifyMyAuthFactorOTPRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== "") {
      writer.uint32(10).string(message.code);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyAuthFactorOTPRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyAuthFactorOTPResponse: MessageFns<VerifyMyAuthFactorOTPResponse> = {
  encode(message: VerifyMyAuthFactorOTPResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyAuthFactorOTPResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyAuthFactorU2FRequest: MessageFns<VerifyMyAuthFactorU2FRequest> = {
  encode(message: VerifyMyAuthFactorU2FRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyAuthFactorU2FRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyAuthFactorU2FResponse: MessageFns<VerifyMyAuthFactorU2FResponse> = {
  encode(message: VerifyMyAuthFactorU2FResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyAuthFactorU2FResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAuthFactorOTPRequest: MessageFns<RemoveMyAuthFactorOTPRequest> = {
  encode(_: RemoveMyAuthFactorOTPRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAuthFactorOTPRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAuthFactorOTPResponse: MessageFns<RemoveMyAuthFactorOTPResponse> = {
  encode(message: RemoveMyAuthFactorOTPResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAuthFactorOTPResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyAuthFactorOTPSMSRequest: MessageFns<AddMyAuthFactorOTPSMSRequest> = {
  encode(_: AddMyAuthFactorOTPSMSRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AddMyAuthFactorOTPSMSRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyAuthFactorOTPSMSResponse: MessageFns<AddMyAuthFactorOTPSMSResponse> = {
  encode(message: AddMyAuthFactorOTPSMSResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddMyAuthFactorOTPSMSResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAuthFactorOTPSMSRequest: MessageFns<RemoveMyAuthFactorOTPSMSRequest> = {
  encode(_: RemoveMyAuthFactorOTPSMSRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAuthFactorOTPSMSRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAuthFactorOTPSMSResponse: MessageFns<RemoveMyAuthFactorOTPSMSResponse> = {
  encode(message: RemoveMyAuthFactorOTPSMSResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAuthFactorOTPSMSResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyAuthFactorOTPEmailRequest: MessageFns<AddMyAuthFactorOTPEmailRequest> = {
  encode(_: AddMyAuthFactorOTPEmailRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AddMyAuthFactorOTPEmailRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyAuthFactorOTPEmailResponse: MessageFns<AddMyAuthFactorOTPEmailResponse> = {
  encode(message: AddMyAuthFactorOTPEmailResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddMyAuthFactorOTPEmailResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAuthFactorOTPEmailRequest: MessageFns<RemoveMyAuthFactorOTPEmailRequest> = {
  encode(_: RemoveMyAuthFactorOTPEmailRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAuthFactorOTPEmailRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAuthFactorOTPEmailResponse: MessageFns<RemoveMyAuthFactorOTPEmailResponse> = {
  encode(message: RemoveMyAuthFactorOTPEmailResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAuthFactorOTPEmailResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAuthFactorU2FRequest: MessageFns<RemoveMyAuthFactorU2FRequest> = {
  encode(message: RemoveMyAuthFactorU2FRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tokenId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAuthFactorU2FRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyAuthFactorU2FResponse: MessageFns<RemoveMyAuthFactorU2FResponse> = {
  encode(message: RemoveMyAuthFactorU2FResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyAuthFactorU2FResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyPasswordlessRequest: MessageFns<ListMyPasswordlessRequest> = {
  encode(_: ListMyPasswordlessRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListMyPasswordlessRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyPasswordlessResponse: MessageFns<ListMyPasswordlessResponse> = {
  encode(message: ListMyPasswordlessResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyPasswordlessResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyPasswordlessResponse {
    return {
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => WebAuthNToken.fromJSON(e)) : [],
    };
  },
...
export const AddMyPasswordlessRequest: MessageFns<AddMyPasswordlessRequest> = {
  encode(_: AddMyPasswordlessRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AddMyPasswordlessRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyPasswordlessResponse: MessageFns<AddMyPasswordlessResponse> = {
  encode(message: AddMyPasswordlessResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== undefined) {
      WebAuthNKey.encode(message.key, writer.uint32(10).fork()).join();
    }
    if (message.details !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddMyPasswordlessResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyPasswordlessLinkRequest: MessageFns<AddMyPasswordlessLinkRequest> = {
  encode(_: AddMyPasswordlessLinkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AddMyPasswordlessLinkRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddMyPasswordlessLinkResponse: MessageFns<AddMyPasswordlessLinkResponse> = {
  encode(message: AddMyPasswordlessLinkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.link !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddMyPasswordlessLinkResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SendMyPasswordlessLinkRequest: MessageFns<SendMyPasswordlessLinkRequest> = {
  encode(_: SendMyPasswordlessLinkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SendMyPasswordlessLinkRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SendMyPasswordlessLinkResponse: MessageFns<SendMyPasswordlessLinkResponse> = {
  encode(message: SendMyPasswordlessLinkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SendMyPasswordlessLinkResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyPasswordlessRequest: MessageFns<VerifyMyPasswordlessRequest> = {
  encode(message: VerifyMyPasswordlessRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.verification !== undefined) {
      WebAuthNVerification.encode(message.verification, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyPasswordlessRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const VerifyMyPasswordlessResponse: MessageFns<VerifyMyPasswordlessResponse> = {
  encode(message: VerifyMyPasswordlessResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VerifyMyPasswordlessResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyPasswordlessRequest: MessageFns<RemoveMyPasswordlessRequest> = {
  encode(message: RemoveMyPasswordlessRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tokenId !== "") {
      writer.uint32(10).string(message.tokenId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyPasswordlessRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveMyPasswordlessResponse: MessageFns<RemoveMyPasswordlessResponse> = {
  encode(message: RemoveMyPasswordlessResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveMyPasswordlessResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyUserGrantsRequest: MessageFns<ListMyUserGrantsRequest> = {
  encode(message: ListMyUserGrantsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
      ListQuery.encode(message.query, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyUserGrantsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyUserGrantsResponse: MessageFns<ListMyUserGrantsResponse> = {
  encode(message: ListMyUserGrantsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ListDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyUserGrantsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyUserGrantsResponse {
    return {
      details: isSet(object.details) ? ListDetails.fromJSON(object.details) : undefined,
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => UserGrant.fromJSON(e)) : [],
    };
  },
...
export const UserGrant: MessageFns<UserGrant> = {
  encode(message: UserGrant, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.orgId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserGrant {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): UserGrant {
    return {
      ...
      roleKeys: globalThis.Array.isArray(object?.roleKeys) ? object.roleKeys.map((e: any) => globalThis.String(e)) : [],
...
export const ListMyProjectOrgsRequest: MessageFns<ListMyProjectOrgsRequest> = {
  encode(message: ListMyProjectOrgsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
      ListQuery.encode(message.query, writer.uint32(10).fork()).join();
    }
    for (const v of message.queries) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyProjectOrgsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyProjectOrgsResponse: MessageFns<ListMyProjectOrgsResponse> = {
  encode(message: ListMyProjectOrgsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ListDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyProjectOrgsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyZitadelPermissionsRequest: MessageFns<ListMyZitadelPermissionsRequest> = {
  encode(_: ListMyZitadelPermissionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListMyZitadelPermissionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyZitadelPermissionsResponse: MessageFns<ListMyZitadelPermissionsResponse> = {
  encode(message: ListMyZitadelPermissionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.result) {
      writer.uint32(10).string(v!);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyZitadelPermissionsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyProjectPermissionsRequest: MessageFns<ListMyProjectPermissionsRequest> = {
  encode(_: ListMyProjectPermissionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ListMyProjectPermissionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyProjectPermissionsResponse: MessageFns<ListMyProjectPermissionsResponse> = {
  encode(message: ListMyProjectPermissionsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.result) {
      writer.uint32(10).string(v!);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyProjectPermissionsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ListMyMembershipsRequest: MessageFns<ListMyMembershipsRequest> = {
  encode(message: ListMyMembershipsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
      ListQuery.encode(message.query, writer.uint32(10).fork()).join();
    }
    for (const v of message.queries) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyMembershipsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyMembershipsRequest {
    return {
      query: isSet(object.query) ? ListQuery.fromJSON(object.query) : undefined,
      queries: globalThis.Array.isArray(object?.queries)
        ? object.queries.map((e: any) => MembershipQuery.fromJSON(e))
        : [],
    };
  },
...
export const ListMyMembershipsResponse: MessageFns<ListMyMembershipsResponse> = {
  encode(message: ListMyMembershipsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ListDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    for (const v of message.result) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListMyMembershipsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): ListMyMembershipsResponse {
    return {
      details: isSet(object.details) ? ListDetails.fromJSON(object.details) : undefined,
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => Membership.fromJSON(e)) : [],
    };
  },
...
export const GetMyLabelPolicyRequest: MessageFns<GetMyLabelPolicyRequest> = {
  encode(_: GetMyLabelPolicyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetMyLabelPolicyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyLabelPolicyResponse: MessageFns<GetMyLabelPolicyResponse> = {
  encode(message: GetMyLabelPolicyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.policy !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyLabelPolicyResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyPrivacyPolicyRequest: MessageFns<GetMyPrivacyPolicyRequest> = {
  encode(_: GetMyPrivacyPolicyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetMyPrivacyPolicyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyPrivacyPolicyResponse: MessageFns<GetMyPrivacyPolicyResponse> = {
  encode(message: GetMyPrivacyPolicyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.policy !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyPrivacyPolicyResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyLoginPolicyRequest: MessageFns<GetMyLoginPolicyRequest> = {
  encode(_: GetMyLoginPolicyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetMyLoginPolicyRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetMyLoginPolicyResponse: MessageFns<GetMyLoginPolicyResponse> = {
  encode(message: GetMyLoginPolicyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.policy !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetMyLoginPolicyResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
