...
export const InstanceDetail: MessageFns<InstanceDetail> = {
  encode(message: InstanceDetail, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.details !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): InstanceDetail {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DomainsQuery: MessageFns<DomainsQuery> = {
  encode(message: DomainsQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.domains) {
      writer.uint32(10).string(v!);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DomainsQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DomainQuery: MessageFns<DomainQuery> = {
  encode(message: DomainQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.domain !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DomainQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DomainGeneratedQuery: MessageFns<DomainGeneratedQuery> = {
  encode(message: DomainGeneratedQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.generated !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DomainGeneratedQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DomainPrimaryQuery: MessageFns<DomainPrimaryQuery> = {
  encode(message: DomainPrimaryQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.primary !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DomainPrimaryQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseTrustedDomain(): TrustedDomain {
  return { details: undefined, domain: "" };
}

export const TrustedDomain: MessageFns<TrustedDomain> = {
  encode(message: TrustedDomain, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.domain !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TrustedDomain {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): TrustedDomain {
    return {
      details: isSet(object.details) ? ObjectDetails.fromJSON(object.details) : undefined,
      domain: isSet(object.domain) ? globalThis.String(object.domain) : "",
    };
  ...
  toJSON(message: TrustedDomain): unknown {
    const obj: any = {};
    if (message.details !== undefined) {
      obj.details = ObjectDetails.toJSON(message.details);
    }
  ...
  create(base?: DeepPartial<TrustedDomain>): TrustedDomain {
    return TrustedDomain.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TrustedDomain>): TrustedDomain {
    const message = createBaseTrustedDomain();
    message.details = (object.details !== undefined && object.details !== null)
      ? ObjectDetails.fromPartial(object.details)
      : undefined;
...
function createBaseTrustedDomainSearchQuery(): TrustedDomainSearchQuery {
  return { domainQuery: undefined };
}

export const TrustedDomainSearchQuery: MessageFns<TrustedDomainSearchQuery> = {
  encode(message: TrustedDomainSearchQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.domainQuery !== undefined) {
      DomainQuery.encode(message.domainQuery, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TrustedDomainSearchQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  create(base?: DeepPartial<TrustedDomainSearchQuery>): TrustedDomainSearchQuery {
    return TrustedDomainSearchQuery.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TrustedDomainSearchQuery>): TrustedDomainSearchQuery {
    const message = createBaseTrustedDomainSearchQuery();
    message.domainQuery = (object.domainQuery !== undefined && object.domainQuery !== null)
      ? DomainQuery.fromPartial(object.domainQuery)
      : undefined;
