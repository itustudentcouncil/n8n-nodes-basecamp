...
export const CreateSessionRequest: MessageFns<CreateSessionRequest> = {
  encode(message: CreateSessionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      CreateSessionRequest_MetadataEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
...
export const SetSessionRequest: MessageFns<SetSessionRequest> = {
  encode(message: SetSessionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sessionId !== "") {
      writer.uint32(10).string(message.sessionId);
    }
    if (message.sessionToken !== "") {
    ...
    Object.entries(message.metadata).forEach(([key, value]) => {
      SetSessionRequest_MetadataEntry.encode({ key: key as any, value }, writer.uint32(34).fork()).join();
    });
    if (message.challenges !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetSessionRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetSessionRequest_MetadataEntry: MessageFns<SetSessionRequest_MetadataEntry> = {
  encode(message: SetSessionRequest_MetadataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value.length !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetSessionRequest_MetadataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetSessionResponse: MessageFns<SetSessionResponse> = {
  encode(message: SetSessionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      Details.encode(message.details, writer.uint32(10).fork()).join();
    }
    if (message.sessionToken !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetSessionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Checks: MessageFns<Checks> = {
  encode(message: Checks, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Checks {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckUser: MessageFns<CheckUser> = {
  encode(message: CheckUser, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CheckUser {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckPassword: MessageFns<CheckPassword> = {
  encode(message: CheckPassword, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.password !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CheckPassword {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckWebAuthN: MessageFns<CheckWebAuthN> = {
  encode(message: CheckWebAuthN, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CheckWebAuthN {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckIDPIntent: MessageFns<CheckIDPIntent> = {
  encode(message: CheckIDPIntent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CheckIDPIntent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckTOTP: MessageFns<CheckTOTP> = {
  encode(message: CheckTOTP, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CheckTOTP {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CheckOTP: MessageFns<CheckOTP> = {
  encode(message: CheckOTP, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.code !== "") {
      writer.uint32(10).string(message.code);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CheckOTP {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
