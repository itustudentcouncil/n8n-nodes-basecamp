...
import { KeyType, keyTypeFromJSON, keyTypeToJSON } from "./auth_n_key.js";
import { InstanceFeature, instanceFeatureFromJSON, instanceFeatureToJSON } from "./feature.js";
import {
  Domain,
  DomainFieldName,
...
import { Notification, Unit, unitFromJSON, unitToJSON } from "./quota.js";
...
export const ListInstancesResponse: MessageFns<ListInstancesResponse> = {
  ...
  fromJSON(object: any): ListInstancesResponse {
    return {
      ...
      sortingColumn: isSet(object.sortingColumn) ? fieldNameFromJSON(object.sortingColumn) : 0,
      result: globalThis.Array.isArray(object?.result) ? object.result.map((e: any) => Instance.fromJSON(e)) : [],
    };
  },
...
export const GetInstanceResponse: MessageFns<GetInstanceResponse> = {
...
export const AddInstanceRequest: MessageFns<AddInstanceRequest> = {
  encode(message: AddInstanceRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddInstanceRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddInstanceRequest_Profile: MessageFns<AddInstanceRequest_Profile> = {
  encode(message: AddInstanceRequest_Profile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddInstanceRequest_Profile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddInstanceRequest_Email: MessageFns<AddInstanceRequest_Email> = {
  encode(message: AddInstanceRequest_Email, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddInstanceRequest_Email {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddInstanceRequest_Password: MessageFns<AddInstanceRequest_Password> = {
  encode(message: AddInstanceRequest_Password, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.password !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddInstanceRequest_Password {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddInstanceResponse: MessageFns<AddInstanceResponse> = {
  encode(message: AddInstanceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceId !== "") {
      writer.uint32(10).string(message.instanceId);
    }
    if (message.details !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddInstanceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateInstanceRequest_Profile: MessageFns<CreateInstanceRequest_Profile> = {
  encode(message: CreateInstanceRequest_Profile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.firstName !== "") {
      writer.uint32(10).string(message.firstName);
    }
    if (message.lastName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInstanceRequest_Profile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateInstanceRequest_Email: MessageFns<CreateInstanceRequest_Email> = {
  encode(message: CreateInstanceRequest_Email, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== "") {
      writer.uint32(10).string(message.email);
    }
    if (message.isEmailVerified !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInstanceRequest_Email {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateInstanceRequest_Password: MessageFns<CreateInstanceRequest_Password> = {
  encode(message: CreateInstanceRequest_Password, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.password !== "") {
      writer.uint32(10).string(message.password);
    }
    if (message.passwordChangeRequired !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInstanceRequest_Password {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateInstanceRequest_Human: MessageFns<CreateInstanceRequest_Human> = {
  encode(message: CreateInstanceRequest_Human, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInstanceRequest_Human {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateInstanceRequest_PersonalAccessToken: MessageFns<CreateInstanceRequest_PersonalAccessToken> = {
  encode(message: CreateInstanceRequest_PersonalAccessToken, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInstanceRequest_PersonalAccessToken {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateInstanceRequest_MachineKey: MessageFns<CreateInstanceRequest_MachineKey> = {
  encode(message: CreateInstanceRequest_MachineKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInstanceRequest_MachineKey {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CreateInstanceRequest_Machine: MessageFns<CreateInstanceRequest_Machine> = {
  encode(message: CreateInstanceRequest_Machine, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userName !== "") {
      writer.uint32(10).string(message.userName);
    }
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateInstanceRequest_Machine {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const UpdateInstanceResponse: MessageFns<UpdateInstanceResponse> = {
  encode(message: UpdateInstanceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateInstanceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveInstanceRequest: MessageFns<RemoveInstanceRequest> = {
  encode(message: RemoveInstanceRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceId !== "") {
      writer.uint32(10).string(message.instanceId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveInstanceRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveInstanceResponse: MessageFns<RemoveInstanceResponse> = {
  encode(message: RemoveInstanceResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveInstanceResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddQuotaRequest: MessageFns<AddQuotaRequest> = {
  encode(message: AddQuotaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceId !== "") {
      writer.uint32(10).string(message.instanceId);
    }
    if (message.unit !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddQuotaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddQuotaResponse: MessageFns<AddQuotaResponse> = {
  encode(message: AddQuotaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddQuotaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetQuotaRequest: MessageFns<SetQuotaRequest> = {
  encode(message: SetQuotaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceId !== "") {
      writer.uint32(10).string(message.instanceId);
    }
    if (message.unit !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetQuotaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetQuotaResponse: MessageFns<SetQuotaResponse> = {
  encode(message: SetQuotaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetQuotaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveQuotaRequest: MessageFns<RemoveQuotaRequest> = {
  encode(message: RemoveQuotaRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceId !== "") {
      writer.uint32(10).string(message.instanceId);
    }
    if (message.unit !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveQuotaRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveQuotaResponse: MessageFns<RemoveQuotaResponse> = {
  encode(message: RemoveQuotaResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveQuotaResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const BulkSetLimitsRequest: MessageFns<BulkSetLimitsRequest> = {
  encode(message: BulkSetLimitsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BulkSetLimitsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): BulkSetLimitsRequest {
    return {
      limits: globalThis.Array.isArray(object?.limits)
        ? object.limits.map((e: any) => SetLimitsRequest.fromJSON(e))
        : [],
    };
  },
...
export const BulkSetLimitsResponse: MessageFns<BulkSetLimitsResponse> = {
  encode(message: BulkSetLimitsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BulkSetLimitsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ResetLimitsRequest: MessageFns<ResetLimitsRequest> = {
  encode(message: ResetLimitsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceId !== "") {
      writer.uint32(10).string(message.instanceId);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ResetLimitsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ResetLimitsResponse: MessageFns<ResetLimitsResponse> = {
  encode(message: ResetLimitsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ResetLimitsResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExistsDomainRequest: MessageFns<ExistsDomainRequest> = {
  encode(message: ExistsDomainRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.domain !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExistsDomainRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExistsDomainResponse: MessageFns<ExistsDomainResponse> = {
  encode(message: ExistsDomainResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExistsDomainResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AddDomainResponse: MessageFns<AddDomainResponse> = {
  encode(message: AddDomainResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AddDomainResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RemoveDomainResponse: MessageFns<RemoveDomainResponse> = {
  encode(message: RemoveDomainResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RemoveDomainResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetPrimaryDomainRequest: MessageFns<SetPrimaryDomainRequest> = {
  encode(message: SetPrimaryDomainRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceId !== "") {
      writer.uint32(10).string(message.instanceId);
    }
    if (message.domain !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetPrimaryDomainRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetPrimaryDomainResponse: MessageFns<SetPrimaryDomainResponse> = {
  encode(message: SetPrimaryDomainResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetPrimaryDomainResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClearViewRequest: MessageFns<ClearViewRequest> = {
  encode(message: ClearViewRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.database !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ClearViewRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ClearViewResponse: MessageFns<ClearViewResponse> = {
  encode(_: ClearViewResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClearViewResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetInstanceFeatureRequest: MessageFns<SetInstanceFeatureRequest> = {
  encode(message: SetInstanceFeatureRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceId !== "") {
      writer.uint32(10).string(message.instanceId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetInstanceFeatureRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetInstanceFeatureResponse: MessageFns<SetInstanceFeatureResponse> = {
  encode(message: SetInstanceFeatureResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.details !== undefined) {
      ObjectDetails.encode(message.details, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetInstanceFeatureResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
