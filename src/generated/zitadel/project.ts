...
export const GrantedProject: MessageFns<GrantedProject> = {
  encode(message: GrantedProject, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.grantId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GrantedProject {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): GrantedProject {
    return {
      ...
      grantedRoleKeys: globalThis.Array.isArray(object?.grantedRoleKeys)
        ? object.grantedRoleKeys.map((e: any) => globalThis.String(e))
        : [],
...
export const ProjectQuery: MessageFns<ProjectQuery> = {
  encode(message: ProjectQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectNameQuery: MessageFns<ProjectNameQuery> = {
  encode(message: ProjectNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectResourceOwnerQuery: MessageFns<ProjectResourceOwnerQuery> = {
  encode(message: ProjectResourceOwnerQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectResourceOwnerQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RoleQuery: MessageFns<RoleQuery> = {
  encode(message: RoleQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RoleQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RoleKeyQuery: MessageFns<RoleKeyQuery> = {
  encode(message: RoleKeyQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.method !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RoleKeyQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RoleDisplayNameQuery: MessageFns<RoleDisplayNameQuery> = {
  encode(message: RoleDisplayNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.displayName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RoleDisplayNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectGrantQuery: MessageFns<ProjectGrantQuery> = {
  encode(message: ProjectGrantQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectGrantQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const AllProjectGrantQuery: MessageFns<AllProjectGrantQuery> = {
  encode(message: AllProjectGrantQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectNameQuery !== undefined) {
      GrantProjectNameQuery.encode(message.projectNameQuery, writer.uint32(10).fork()).join();
    }
    if (message.roleKeyQuery !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AllProjectGrantQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GrantProjectNameQuery: MessageFns<GrantProjectNameQuery> = {
  encode(message: GrantProjectNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    if (message.method !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GrantProjectNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GrantRoleKeyQuery: MessageFns<GrantRoleKeyQuery> = {
  encode(message: GrantRoleKeyQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.roleKey !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GrantRoleKeyQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ProjectIDQuery: MessageFns<ProjectIDQuery> = {
  encode(message: ProjectIDQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProjectIDQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GrantedOrgIDQuery: MessageFns<GrantedOrgIDQuery> = {
  encode(message: GrantedOrgIDQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.grantedOrgId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GrantedOrgIDQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
