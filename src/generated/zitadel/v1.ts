  ...
  fromJSON(object: any): DataOrg {
    return {
      ...
      idps: globalThis.Array.isArray(object?.idps)
        ? object.idps.map((e: any) => AddIDPToLoginPolicyRequest.fromJSON(e))
        : [],
...
export const DataOIDCIDP: MessageFns<DataOIDCIDP> = {
  encode(message: DataOIDCIDP, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.idpId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataOIDCIDP {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataJWTIDP: MessageFns<DataJWTIDP> = {
  encode(message: DataJWTIDP, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.idpId !== "") {
      writer.uint32(10).string(message.idpId);
    }
    if (message.idp !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataJWTIDP {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExportHumanUser: MessageFns<ExportHumanUser> = {
  encode(message: ExportHumanUser, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userName !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportHumanUser {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExportHumanUser_Profile: MessageFns<ExportHumanUser_Profile> = {
  encode(message: ExportHumanUser_Profile, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportHumanUser_Profile {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExportHumanUser_Email: MessageFns<ExportHumanUser_Email> = {
  encode(message: ExportHumanUser_Email, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.email !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportHumanUser_Email {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExportHumanUser_Phone: MessageFns<ExportHumanUser_Phone> = {
  encode(message: ExportHumanUser_Phone, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.phone !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportHumanUser_Phone {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ExportHumanUser_HashedPassword: MessageFns<ExportHumanUser_HashedPassword> = {
  encode(message: ExportHumanUser_HashedPassword, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ExportHumanUser_HashedPassword {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataAppKey: MessageFns<DataAppKey> = {
  encode(message: DataAppKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataAppKey {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataMachineKey: MessageFns<DataMachineKey> = {
  encode(message: DataMachineKey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.keyId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataMachineKey {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataProject: MessageFns<DataProject> = {
  encode(message: DataProject, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.projectId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataProject {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataAPIApplication: MessageFns<DataAPIApplication> = {
  encode(message: DataAPIApplication, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.appId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataAPIApplication {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataOIDCApplication: MessageFns<DataOIDCApplication> = {
  encode(message: DataOIDCApplication, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.appId !== "") {
      writer.uint32(10).string(message.appId);
    }
    if (message.app !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataOIDCApplication {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataHumanUser: MessageFns<DataHumanUser> = {
  encode(message: DataHumanUser, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataHumanUser {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataMachineUser: MessageFns<DataMachineUser> = {
  encode(message: DataMachineUser, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.userId !== "") {
      writer.uint32(10).string(message.userId);
    }
    if (message.user !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataMachineUser {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataAction: MessageFns<DataAction> = {
  encode(message: DataAction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.actionId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataAction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DataProjectGrant: MessageFns<DataProjectGrant> = {
  encode(message: DataProjectGrant, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.grantId !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataProjectGrant {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const SetTriggerActionsRequest: MessageFns<SetTriggerActionsRequest> = {
  encode(message: SetTriggerActionsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SetTriggerActionsRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
