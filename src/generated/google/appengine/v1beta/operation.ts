...
export interface OperationMetadataV1Beta {
   ...
   */
  warning: string[];
  createVersionMetadata?: CreateVersionMetadataV1Beta | undefined;
}
...
function createBaseOperationMetadataV1Beta(): OperationMetadataV1Beta {
  return {
    method: "",
...
export const OperationMetadataV1Beta: MessageFns<OperationMetadataV1Beta> = {
  encode(message: OperationMetadataV1Beta, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.method !== "") {
    ...
    if (message.createVersionMetadata !== undefined) {
      CreateVersionMetadataV1Beta.encode(message.createVersionMetadata, writer.uint32(66).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): OperationMetadataV1Beta {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseOperationMetadataV1Beta();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.createVersionMetadata = CreateVersionMetadataV1Beta.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): OperationMetadataV1Beta {
    return {
      ...
      createVersionMetadata: isSet(object.createVersionMetadata)
        ? CreateVersionMetadataV1Beta.fromJSON(object.createVersionMetadata)
        : undefined,
    };
  },

  toJSON(message: OperationMetadataV1Beta): unknown {
    const obj: any = {};
    if (message.method !== "") {
    ...
    if (message.createVersionMetadata !== undefined) {
      obj.createVersionMetadata = CreateVersionMetadataV1Beta.toJSON(message.createVersionMetadata);
    }
    return obj;
  },

  create(base?: DeepPartial<OperationMetadataV1Beta>): OperationMetadataV1Beta {
    return OperationMetadataV1Beta.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<OperationMetadataV1Beta>): OperationMetadataV1Beta {
    const message = createBaseOperationMetadataV1Beta();
    ...
    message.createVersionMetadata =
      (object.createVersionMetadata !== undefined && object.createVersionMetadata !== null)
        ? CreateVersionMetadataV1Beta.fromPartial(object.createVersionMetadata)
        : undefined;
    return message;
  },
};

function createBaseCreateVersionMetadataV1Beta(): CreateVersionMetadataV1Beta {
  return { cloudBuildId: "" };
}

export const CreateVersionMetadataV1Beta: MessageFns<CreateVersionMetadataV1Beta> = {
  encode(message: CreateVersionMetadataV1Beta, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CreateVersionMetadataV1Beta {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCreateVersionMetadataV1Beta();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): CreateVersionMetadataV1Beta {
    return { cloudBuildId: isSet(object.cloudBuildId) ? globalThis.String(object.cloudBuildId) : "" };
  },

  toJSON(message: CreateVersionMetadataV1Beta): unknown {
    const obj: any = {};
    if (message.cloudBuildId !== "") {
  ...
  create(base?: DeepPartial<CreateVersionMetadataV1Beta>): CreateVersionMetadataV1Beta {
    return CreateVersionMetadataV1Beta.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CreateVersionMetadataV1Beta>): CreateVersionMetadataV1Beta {
    const message = createBaseCreateVersionMetadataV1Beta();
