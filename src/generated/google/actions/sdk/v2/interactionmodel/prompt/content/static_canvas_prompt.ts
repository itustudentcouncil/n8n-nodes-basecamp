 ...
 */
export interface StaticCanvasPrompt {
...
function createBaseStaticCanvasPrompt(): StaticCanvasPrompt {
  return { url: "", data: [], suppressMic: false, sendStateDataToCanvasApp: false, enableFullScreen: false };
}

export const StaticCanvasPrompt: MessageFns<StaticCanvasPrompt> = {
  encode(message: StaticCanvasPrompt, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.url !== "") {
    ...
    if (message.sendStateDataToCanvasApp !== false) {
      writer.uint32(40).bool(message.sendStateDataToCanvasApp);
    }
    if (message.enableFullScreen !== false) {
      writer.uint32(48).bool(message.enableFullScreen);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StaticCanvasPrompt {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStaticCanvasPrompt();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.sendStateDataToCanvasApp = reader.bool();
          continue;
        case 6:
          if (tag !== 48) {
            break;
  ...
  fromJSON(object: any): StaticCanvasPrompt {
    return {
      ...
      sendStateDataToCanvasApp: isSet(object.sendStateDataToCanvasApp)
        ? globalThis.Boolean(object.sendStateDataToCanvasApp)
        : false,
      enableFullScreen: isSet(object.enableFullScreen) ? globalThis.Boolean(object.enableFullScreen) : false,
    };
  },

  toJSON(message: StaticCanvasPrompt): unknown {
    const obj: any = {};
    if (message.url !== "") {
      obj.url = message.url;
    }
    ...
    if (message.sendStateDataToCanvasApp !== false) {
      obj.sendStateDataToCanvasApp = message.sendStateDataToCanvasApp;
    }
    if (message.enableFullScreen !== false) {
  ...
  create(base?: DeepPartial<StaticCanvasPrompt>): StaticCanvasPrompt {
    return StaticCanvasPrompt.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<StaticCanvasPrompt>): StaticCanvasPrompt {
    const message = createBaseStaticCanvasPrompt();
    message.url = object.url ?? "";
    message.data = object.data?.map((e) => e) || [];
    message.suppressMic = object.suppressMic ?? false;
    message.sendStateDataToCanvasApp = object.sendStateDataToCanvasApp ?? false;
