...
export const BiddingStrategy: MessageFns<BiddingStrategy> = {
  encode(message: BiddingStrategy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.targetOutrankShare !== undefined) {
      TargetOutrankShare.encode(message.targetOutrankShare, writer.uint32(82).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10:
          ...
          message.targetOutrankShare = TargetOutrankShare.decode(reader, reader.uint32());
          continue;
        case 11:
          if (tag !== 90) {
            break;
  ...
  fromJSON(object: any): BiddingStrategy {
    return {
      ...
      targetImpressionShare: isSet(object.targetImpressionShare)
        ...
        : undefined,
      targetOutrankShare: isSet(object.targetOutrankShare)
        ? TargetOutrankShare.fromJSON(object.targetOutrankShare)
        : undefined,
  ...
  toJSON(message: BiddingStrategy): unknown {
    ...
    if (message.targetOutrankShare !== undefined) {
      obj.targetOutrankShare = TargetOutrankShare.toJSON(message.targetOutrankShare);
    }
    if (message.targetRoas !== undefined) {
  ...
  fromPartial(object: DeepPartial<BiddingStrategy>): BiddingStrategy {
    ...
    message.targetImpressionShare =
      (object.targetImpressionShare !== undefined && object.targetImpressionShare !== null)
        ...
        : undefined;
    message.targetOutrankShare = (object.targetOutrankShare !== undefined && object.targetOutrankShare !== null)
      ? TargetOutrankShare.fromPartial(object.targetOutrankShare)
      : undefined;
