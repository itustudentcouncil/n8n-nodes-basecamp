...
export function advertisingChannelSubTypeEnum_AdvertisingChannelSubTypeFromJSON(
  ...
  switch (object) {
    ...
    case 21:
    case "SOCIAL_FACEBOOK_TRACKING_ONLY":
      return AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.SOCIAL_FACEBOOK_TRACKING_ONLY;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function advertisingChannelSubTypeEnum_AdvertisingChannelSubTypeToJSON(
  ...
  switch (object) {
    ...
    case AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.SOCIAL_FACEBOOK_TRACKING_ONLY:
      return "SOCIAL_FACEBOOK_TRACKING_ONLY";
