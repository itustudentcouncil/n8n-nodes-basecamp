...
function createBaseDiscoveryCarouselCardAsset(): DiscoveryCarouselCardAsset {
  return {
    marketingImageAsset: "",
...
export const DiscoveryCarouselCardAsset: MessageFns<DiscoveryCarouselCardAsset> = {
  encode(message: DiscoveryCarouselCardAsset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DiscoveryCarouselCardAsset {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDiscoveryCarouselCardAsset();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DiscoveryCarouselCardAsset {
    return {
  ...
  toJSON(message: DiscoveryCarouselCardAsset): unknown {
    const obj: any = {};
    if (message.marketingImageAsset !== "") {
  ...
  create(base?: DeepPartial<DiscoveryCarouselCardAsset>): DiscoveryCarouselCardAsset {
    return DiscoveryCarouselCardAsset.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DiscoveryCarouselCardAsset>): DiscoveryCarouselCardAsset {
    const message = createBaseDiscoveryCarouselCardAsset();
