...
import {
  ...
  assetGroupPrimaryStatusEnum_AssetGroupPrimaryStatusFromJSON,
  assetGroupPrimaryStatusEnum_AssetGroupPrimaryStatusToJSON,
} from "../enums/asset_group_primary_status.js";
import {
  AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason,
  assetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReasonFromJSON,
  assetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReasonToJSON,
} from "../enums/asset_group_primary_status_reason.js";
import {
...
export const AssetGroup: MessageFns<AssetGroup> = {
  encode(message: AssetGroup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.primaryStatus !== 0) {
      writer.uint32(88).int32(message.primaryStatus);
    }
  ...
  fromJSON(object: any): AssetGroup {
    return {
      ...
      primaryStatus: isSet(object.primaryStatus)
        ? assetGroupPrimaryStatusEnum_AssetGroupPrimaryStatusFromJSON(object.primaryStatus)
        : 0,
      primaryStatusReasons: globalThis.Array.isArray(object?.primaryStatusReasons)
        ? object.primaryStatusReasons.map((e: any) =>
          assetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReasonFromJSON(e)
        )
        : [],
  ...
  toJSON(message: AssetGroup): unknown {
    ...
    if (message.primaryStatus !== 0) {
      obj.primaryStatus = assetGroupPrimaryStatusEnum_AssetGroupPrimaryStatusToJSON(message.primaryStatus);
    }
    if (message.primaryStatusReasons?.length) {
      obj.primaryStatusReasons = message.primaryStatusReasons.map((e) =>
        assetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReasonToJSON(e)
      );
    }
    if (message.path1 !== "") {
