...
function createBaseAdGroup(): AdGroup {
  return {
    ...
    fixedCpmMicros: undefined,
    targetCpvMicros: undefined,
...
export const AdGroup: MessageFns<AdGroup> = {
  encode(message: AdGroup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.fixedCpmMicros !== undefined) {
      writer.uint32(512).int64(message.fixedCpmMicros.toString());
    }
    if (message.targetCpvMicros !== undefined) {
      writer.uint32(520).int64(message.targetCpvMicros.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 64:
          ...
          message.fixedCpmMicros = Long.fromString(reader.int64().toString());
          continue;
        case 65:
          if (tag !== 520) {
            break;
          ...
          message.targetCpvMicros = Long.fromString(reader.int64().toString());
          continue;
        case 59:
          if (tag !== 472) {
            break;
  ...
  fromJSON(object: any): AdGroup {
    return {
      ...
      fixedCpmMicros: isSet(object.fixedCpmMicros) ? Long.fromValue(object.fixedCpmMicros) : undefined,
      targetCpvMicros: isSet(object.targetCpvMicros) ? Long.fromValue(object.targetCpvMicros) : undefined,
  ...
  toJSON(message: AdGroup): unknown {
    ...
    if (message.fixedCpmMicros !== undefined) {
      obj.fixedCpmMicros = (message.fixedCpmMicros || Long.ZERO).toString();
    }
    if (message.targetCpvMicros !== undefined) {
      obj.targetCpvMicros = (message.targetCpvMicros || Long.ZERO).toString();
    }
    if (message.optimizedTargetingEnabled !== false) {
  ...
  fromPartial(object: DeepPartial<AdGroup>): AdGroup {
    ...
    message.percentCpcBidMicros = (object.percentCpcBidMicros !== undefined && object.percentCpcBidMicros !== null)
      ...
      : undefined;
    message.fixedCpmMicros = (object.fixedCpmMicros !== undefined && object.fixedCpmMicros !== null)
      ? Long.fromValue(object.fixedCpmMicros)
      : undefined;
    message.targetCpvMicros = (object.targetCpvMicros !== undefined && object.targetCpvMicros !== null)
      ? Long.fromValue(object.targetCpvMicros)
      : undefined;
