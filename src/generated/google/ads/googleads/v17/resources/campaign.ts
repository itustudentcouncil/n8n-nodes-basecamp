...
import {
  ...
  campaignKeywordMatchTypeEnum_CampaignKeywordMatchTypeFromJSON,
  campaignKeywordMatchTypeEnum_CampaignKeywordMatchTypeToJSON,
} from "../enums/campaign_keyword_match_type.js";
import {
...
export interface Campaign {
  ...
  demandGenCampaignSettings:
    | Campaign_DemandGenCampaignSettings
    | undefined;
...
/** Settings for Demand Gen campaign. */
export interface Campaign_DemandGenCampaignSettings {
  /**
...
/** Settings for Video campaign. */
export interface Campaign_VideoCampaignSettings {
  /** Inventory control for responsive ad containers in reach campaigns. */
  videoAdInventoryControl: Campaign_VideoCampaignSettings_VideoAdInventoryControl | undefined;
}
 ...
 */
export interface Campaign_VideoCampaignSettings_VideoAdInventoryControl {
...
function createBaseCampaign(): Campaign {
  return {
    ...
    demandGenCampaignSettings: undefined,
    videoCampaignSettings: undefined,
...
export const Campaign: MessageFns<Campaign> = {
  encode(message: Campaign, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.demandGenCampaignSettings !== undefined) {
      Campaign_DemandGenCampaignSettings.encode(message.demandGenCampaignSettings, writer.uint32(730).fork()).join();
    }
    if (message.videoCampaignSettings !== undefined) {
      Campaign_VideoCampaignSettings.encode(message.videoCampaignSettings, writer.uint32(754).fork()).join();
    }
    ...
    if (message.keywordMatchType !== 0) {
      writer.uint32(720).int32(message.keywordMatchType);
    }
    ...
    if (message.fixedCpm !== undefined) {
      FixedCpm.encode(message.fixedCpm, writer.uint32(738).fork()).join();
    }
    if (message.targetCpv !== undefined) {
      TargetCpv.encode(message.targetCpv, writer.uint32(746).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 91:
          ...
          message.demandGenCampaignSettings = Campaign_DemandGenCampaignSettings.decode(reader, reader.uint32());
          continue;
        case 94:
          if (tag !== 754) {
            break;
          ...
          message.videoCampaignSettings = Campaign_VideoCampaignSettings.decode(reader, reader.uint32());
          continue;
        case 39:
          if (tag !== 314) {
            break;
        ...
        case 90:
          ...
          message.keywordMatchType = reader.int32() as any;
          continue;
        case 67:
          if (tag !== 538) {
            break;
        ...
        case 92:
          ...
          message.fixedCpm = FixedCpm.decode(reader, reader.uint32());
          continue;
        case 93:
          if (tag !== 746) {
            break;
          ...
          message.targetCpv = TargetCpv.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Campaign {
    return {
      ...
      travelCampaignSettings: isSet(object.travelCampaignSettings)
        ...
        : undefined,
      demandGenCampaignSettings: isSet(object.demandGenCampaignSettings)
        ? Campaign_DemandGenCampaignSettings.fromJSON(object.demandGenCampaignSettings)
        : undefined,
      videoCampaignSettings: isSet(object.videoCampaignSettings)
        ? Campaign_VideoCampaignSettings.fromJSON(object.videoCampaignSettings)
        : undefined,
      ...
      assetAutomationSettings: globalThis.Array.isArray(object?.assetAutomationSettings)
        ...
        : [],
      keywordMatchType: isSet(object.keywordMatchType)
        ? campaignKeywordMatchTypeEnum_CampaignKeywordMatchTypeFromJSON(object.keywordMatchType)
        : 0,
      ...
      fixedCpm: isSet(object.fixedCpm) ? FixedCpm.fromJSON(object.fixedCpm) : undefined,
      targetCpv: isSet(object.targetCpv) ? TargetCpv.fromJSON(object.targetCpv) : undefined,
    };
  },
  ...
  toJSON(message: Campaign): unknown {
    ...
    if (message.demandGenCampaignSettings !== undefined) {
      obj.demandGenCampaignSettings = Campaign_DemandGenCampaignSettings.toJSON(message.demandGenCampaignSettings);
    }
    if (message.videoCampaignSettings !== undefined) {
      obj.videoCampaignSettings = Campaign_VideoCampaignSettings.toJSON(message.videoCampaignSettings);
    }
    if (message.realTimeBiddingSetting !== undefined) {
    ...
    if (message.keywordMatchType !== 0) {
      obj.keywordMatchType = campaignKeywordMatchTypeEnum_CampaignKeywordMatchTypeToJSON(message.keywordMatchType);
    }
    if (message.biddingStrategy !== undefined) {
    ...
    if (message.fixedCpm !== undefined) {
      obj.fixedCpm = FixedCpm.toJSON(message.fixedCpm);
    }
    if (message.targetCpv !== undefined) {
      obj.targetCpv = TargetCpv.toJSON(message.targetCpv);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Campaign>): Campaign {
    ...
    message.demandGenCampaignSettings =
      (object.demandGenCampaignSettings !== undefined && object.demandGenCampaignSettings !== null)
        ? Campaign_DemandGenCampaignSettings.fromPartial(object.demandGenCampaignSettings)
        : undefined;
    message.videoCampaignSettings =
      (object.videoCampaignSettings !== undefined && object.videoCampaignSettings !== null)
        ? Campaign_VideoCampaignSettings.fromPartial(object.videoCampaignSettings)
        : undefined;
    ...
    message.keywordMatchType = object.keywordMatchType ?? 0;
    ...
    message.targetCpm = (object.targetCpm !== undefined && object.targetCpm !== null)
      ...
      : undefined;
    message.fixedCpm = (object.fixedCpm !== undefined && object.fixedCpm !== null)
      ? FixedCpm.fromPartial(object.fixedCpm)
      : undefined;
    message.targetCpv = (object.targetCpv !== undefined && object.targetCpv !== null)
      ? TargetCpv.fromPartial(object.targetCpv)
      : undefined;
    return message;
  },
};
...
function createBaseCampaign_DemandGenCampaignSettings(): Campaign_DemandGenCampaignSettings {
  return { upgradedTargeting: undefined };
}

export const Campaign_DemandGenCampaignSettings: MessageFns<Campaign_DemandGenCampaignSettings> = {
  encode(message: Campaign_DemandGenCampaignSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Campaign_DemandGenCampaignSettings {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCampaign_DemandGenCampaignSettings();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Campaign_DemandGenCampaignSettings {
    return {
      upgradedTargeting: isSet(object.upgradedTargeting) ? globalThis.Boolean(object.upgradedTargeting) : undefined,
    };
  },

  toJSON(message: Campaign_DemandGenCampaignSettings): unknown {
    const obj: any = {};
    if (message.upgradedTargeting !== undefined) {
  ...
  create(base?: DeepPartial<Campaign_DemandGenCampaignSettings>): Campaign_DemandGenCampaignSettings {
    return Campaign_DemandGenCampaignSettings.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Campaign_DemandGenCampaignSettings>): Campaign_DemandGenCampaignSettings {
    const message = createBaseCampaign_DemandGenCampaignSettings();
...
function createBaseCampaign_VideoCampaignSettings(): Campaign_VideoCampaignSettings {
  return { videoAdInventoryControl: undefined };
}

export const Campaign_VideoCampaignSettings: MessageFns<Campaign_VideoCampaignSettings> = {
  encode(message: Campaign_VideoCampaignSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.videoAdInventoryControl !== undefined) {
      Campaign_VideoCampaignSettings_VideoAdInventoryControl.encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Campaign_VideoCampaignSettings {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCampaign_VideoCampaignSettings();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.videoAdInventoryControl = Campaign_VideoCampaignSettings_VideoAdInventoryControl.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): Campaign_VideoCampaignSettings {
    return {
      videoAdInventoryControl: isSet(object.videoAdInventoryControl)
        ? Campaign_VideoCampaignSettings_VideoAdInventoryControl.fromJSON(object.videoAdInventoryControl)
        : undefined,
    };
  },

  toJSON(message: Campaign_VideoCampaignSettings): unknown {
    const obj: any = {};
    if (message.videoAdInventoryControl !== undefined) {
      obj.videoAdInventoryControl = Campaign_VideoCampaignSettings_VideoAdInventoryControl.toJSON(
        message.videoAdInventoryControl,
      );
    }
    return obj;
  ...
  create(base?: DeepPartial<Campaign_VideoCampaignSettings>): Campaign_VideoCampaignSettings {
    return Campaign_VideoCampaignSettings.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Campaign_VideoCampaignSettings>): Campaign_VideoCampaignSettings {
    const message = createBaseCampaign_VideoCampaignSettings();
    message.videoAdInventoryControl =
      (object.videoAdInventoryControl !== undefined && object.videoAdInventoryControl !== null)
        ? Campaign_VideoCampaignSettings_VideoAdInventoryControl.fromPartial(object.videoAdInventoryControl)
        : undefined;
    return message;
  },
};

function createBaseCampaign_VideoCampaignSettings_VideoAdInventoryControl(): Campaign_VideoCampaignSettings_VideoAdInventoryControl {
  return { allowInStream: undefined, allowInFeed: undefined, allowShorts: undefined };
}

export const Campaign_VideoCampaignSettings_VideoAdInventoryControl: MessageFns<
  Campaign_VideoCampaignSettings_VideoAdInventoryControl
> = {
  encode(
    message: Campaign_VideoCampaignSettings_VideoAdInventoryControl,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.allowInStream !== undefined) {
      writer.uint32(8).bool(message.allowInStream);
    }
    if (message.allowInFeed !== undefined) {
      writer.uint32(16).bool(message.allowInFeed);
    }
    if (message.allowShorts !== undefined) {
      writer.uint32(24).bool(message.allowShorts);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Campaign_VideoCampaignSettings_VideoAdInventoryControl {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCampaign_VideoCampaignSettings_VideoAdInventoryControl();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.allowInStream = reader.bool();
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.allowInFeed = reader.bool();
          continue;
        case 3:
          if (tag !== 24) {
            break;
          ...
          message.allowShorts = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Campaign_VideoCampaignSettings_VideoAdInventoryControl {
    return {
      allowInStream: isSet(object.allowInStream) ? globalThis.Boolean(object.allowInStream) : undefined,
      allowInFeed: isSet(object.allowInFeed) ? globalThis.Boolean(object.allowInFeed) : undefined,
      allowShorts: isSet(object.allowShorts) ? globalThis.Boolean(object.allowShorts) : undefined,
    };
  },

  toJSON(message: Campaign_VideoCampaignSettings_VideoAdInventoryControl): unknown {
    const obj: any = {};
    if (message.allowInStream !== undefined) {
      obj.allowInStream = message.allowInStream;
    }
    if (message.allowInFeed !== undefined) {
      obj.allowInFeed = message.allowInFeed;
    }
    if (message.allowShorts !== undefined) {
      obj.allowShorts = message.allowShorts;
    }
    return obj;
  },

  create(
    base?: DeepPartial<Campaign_VideoCampaignSettings_VideoAdInventoryControl>,
  ): Campaign_VideoCampaignSettings_VideoAdInventoryControl {
    return Campaign_VideoCampaignSettings_VideoAdInventoryControl.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<Campaign_VideoCampaignSettings_VideoAdInventoryControl>,
  ): Campaign_VideoCampaignSettings_VideoAdInventoryControl {
    const message = createBaseCampaign_VideoCampaignSettings_VideoAdInventoryControl();
    message.allowInStream = object.allowInStream ?? undefined;
    message.allowInFeed = object.allowInFeed ?? undefined;
    message.allowShorts = object.allowShorts ?? undefined;
    return message;
  },
};
