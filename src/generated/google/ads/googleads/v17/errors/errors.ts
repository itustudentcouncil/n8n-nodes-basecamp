...
import {
  ...
  automaticallyCreatedAssetRemovalErrorEnum_AutomaticallyCreatedAssetRemovalErrorFromJSON,
  automaticallyCreatedAssetRemovalErrorEnum_AutomaticallyCreatedAssetRemovalErrorToJSON,
} from "./automatically_created_asset_removal_error.js";
import {
...
import {
  ...
  shareablePreviewErrorEnum_ShareablePreviewErrorFromJSON,
  shareablePreviewErrorEnum_ShareablePreviewErrorToJSON,
} from "./shareable_preview_error.js";
import {
...
import {
  ...
  shoppingProductErrorEnum_ShoppingProductErrorFromJSON,
  shoppingProductErrorEnum_ShoppingProductErrorToJSON,
} from "./shopping_product_error.js";
import {
...
import {
  ...
  userListCustomerTypeErrorEnum_UserListCustomerTypeErrorFromJSON,
  userListCustomerTypeErrorEnum_UserListCustomerTypeErrorToJSON,
} from "./user_list_customer_type_error.js";
import {
...
export interface ErrorCode {
  ...
  shareablePreviewError?: ShareablePreviewErrorEnum_ShareablePreviewError | undefined;
}
...
function createBaseErrorCode(): ErrorCode {
  return {
    ...
    userListCustomerTypeError: undefined,
    shoppingProductError: undefined,
    automaticallyCreatedAssetRemovalError: undefined,
    shareablePreviewError: undefined,
  };
}
...
export const ErrorCode: MessageFns<ErrorCode> = {
  encode(message: ErrorCode, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.userListCustomerTypeError !== undefined) {
      writer.uint32(1464).int32(message.userListCustomerTypeError);
    }
    if (message.shoppingProductError !== undefined) {
      writer.uint32(1472).int32(message.shoppingProductError);
    }
    if (message.automaticallyCreatedAssetRemovalError !== undefined) {
      writer.uint32(1480).int32(message.automaticallyCreatedAssetRemovalError);
    }
    if (message.shareablePreviewError !== undefined) {
      writer.uint32(1488).int32(message.shareablePreviewError);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 183:
          ...
          message.userListCustomerTypeError = reader.int32() as any;
          continue;
        case 184:
          if (tag !== 1472) {
            break;
          ...
          message.shoppingProductError = reader.int32() as any;
          continue;
        case 185:
          if (tag !== 1480) {
            break;
          ...
          message.automaticallyCreatedAssetRemovalError = reader.int32() as any;
          continue;
        case 186:
          if (tag !== 1488) {
            break;
          ...
          message.shareablePreviewError = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ErrorCode {
    return {
      ...
      identityVerificationError: isSet(object.identityVerificationError)
        ...
        : undefined,
      userListCustomerTypeError: isSet(object.userListCustomerTypeError)
        ? userListCustomerTypeErrorEnum_UserListCustomerTypeErrorFromJSON(object.userListCustomerTypeError)
        : undefined,
      shoppingProductError: isSet(object.shoppingProductError)
        ? shoppingProductErrorEnum_ShoppingProductErrorFromJSON(object.shoppingProductError)
        : undefined,
      automaticallyCreatedAssetRemovalError: isSet(object.automaticallyCreatedAssetRemovalError)
        ? automaticallyCreatedAssetRemovalErrorEnum_AutomaticallyCreatedAssetRemovalErrorFromJSON(
          object.automaticallyCreatedAssetRemovalError,
        )
        : undefined,
      shareablePreviewError: isSet(object.shareablePreviewError)
        ? shareablePreviewErrorEnum_ShareablePreviewErrorFromJSON(object.shareablePreviewError)
        : undefined,
    };
  },
  ...
  toJSON(message: ErrorCode): unknown {
    ...
    if (message.userListCustomerTypeError !== undefined) {
      obj.userListCustomerTypeError = userListCustomerTypeErrorEnum_UserListCustomerTypeErrorToJSON(
        message.userListCustomerTypeError,
      );
    }
    if (message.shoppingProductError !== undefined) {
      obj.shoppingProductError = shoppingProductErrorEnum_ShoppingProductErrorToJSON(message.shoppingProductError);
    }
    if (message.automaticallyCreatedAssetRemovalError !== undefined) {
      obj.automaticallyCreatedAssetRemovalError =
        automaticallyCreatedAssetRemovalErrorEnum_AutomaticallyCreatedAssetRemovalErrorToJSON(
          message.automaticallyCreatedAssetRemovalError,
        );
    }
    if (message.shareablePreviewError !== undefined) {
      obj.shareablePreviewError = shareablePreviewErrorEnum_ShareablePreviewErrorToJSON(message.shareablePreviewError);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ErrorCode>): ErrorCode {
    ...
    message.userListCustomerTypeError = object.userListCustomerTypeError ?? undefined;
    message.shoppingProductError = object.shoppingProductError ?? undefined;
    message.automaticallyCreatedAssetRemovalError = object.automaticallyCreatedAssetRemovalError ?? undefined;
    message.shareablePreviewError = object.shareablePreviewError ?? undefined;
    return message;
  },
};
