...
import { ComputeCustomRoutesRequest } from "./compute_custom_routes_request.js";
import { ComputeCustomRoutesResponse } from "./compute_custom_routes_response.js";
import { ComputeRouteMatrixRequest } from "./compute_route_matrix_request.js";
import { ComputeRoutesRequest } from "./compute_routes_request.js";
import { ComputeRoutesResponse } from "./compute_routes_response.js";
import { RouteMatrixElement } from "./route_matrix_element.js";

export const protobufPackage = "google.maps.routes.v1";

/** The Routes Preferred API. */
export type RoutesPreferredDefinition = typeof RoutesPreferredDefinition;
export const RoutesPreferredDefinition = {
...
export interface RoutesPreferredServiceImplementation<CallContextExt = {}> {
  /**
   * Returns the primary route along with optional alternate routes, given a set
   * of terminal and intermediate waypoints.
   *
...
export interface RoutesPreferredClient<CallOptionsExt = {}> {
  /**
   * Returns the primary route along with optional alternate routes, given a set
   * of terminal and intermediate waypoints.
   *
