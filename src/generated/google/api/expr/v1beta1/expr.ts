...
import { SourceInfo } from "./source.js";
...
export const Expr: MessageFns<Expr> = {
  encode(message: Expr, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.literalExpr !== undefined) {
      Literal.encode(message.literalExpr, writer.uint32(26).fork()).join();
    }
  ...
  toJSON(message: Expr): unknown {
    ...
    if (message.literalExpr !== undefined) {
      obj.literalExpr = Literal.toJSON(message.literalExpr);
    }
    if (message.identExpr !== undefined) {
  ...
  fromPartial(object: DeepPartial<Expr>): Expr {
    ...
    message.literalExpr = (object.literalExpr !== undefined && object.literalExpr !== null)
