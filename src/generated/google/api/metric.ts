...
export const MetricDescriptor: MessageFns<MetricDescriptor> = {
  encode(message: MetricDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
    ...
    if (message.metadata !== undefined) {
      MetricDescriptor_MetricDescriptorMetadata.encode(message.metadata, writer.uint32(82).fork()).join();
    }
  ...
  fromJSON(object: any): MetricDescriptor {
    return {
      ...
      monitoredResourceTypes: globalThis.Array.isArray(object?.monitoredResourceTypes)
        ? object.monitoredResourceTypes.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: MetricDescriptor): unknown {
    ...
    if (message.monitoredResourceTypes?.length) {
      obj.monitoredResourceTypes = message.monitoredResourceTypes;
    }
    return obj;
  },
...
export const MetricDescriptor_MetricDescriptorMetadata: MessageFns<MetricDescriptor_MetricDescriptorMetadata> = {
  encode(message: MetricDescriptor_MetricDescriptorMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.launchStage !== 0) {
      writer.uint32(8).int32(message.launchStage);
    }
    if (message.samplePeriod !== undefined) {
      Duration.encode(message.samplePeriod, writer.uint32(18).fork()).join();
    }
    if (message.ingestDelay !== undefined) {
      Duration.encode(message.ingestDelay, writer.uint32(26).fork()).join();
    }
    return writer;
  },
  ...
  toJSON(message: MetricDescriptor_MetricDescriptorMetadata): unknown {
    ...
    if (message.samplePeriod !== undefined) {
      obj.samplePeriod = Duration.toJSON(message.samplePeriod);
    }
    if (message.ingestDelay !== undefined) {
      obj.ingestDelay = Duration.toJSON(message.ingestDelay);
    }
    return obj;
  },
...
export const Metric: MessageFns<Metric> = {
  encode(message: Metric, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      Metric_LabelsEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    return writer;
  },
...
export const Metric_LabelsEntry: MessageFns<Metric_LabelsEntry> = {
  encode(message: Metric_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
