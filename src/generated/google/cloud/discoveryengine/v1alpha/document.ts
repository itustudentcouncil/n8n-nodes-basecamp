...
import { Principal } from "./common.js";
 ...
 * }
 */
export interface Document_AclInfo_AccessRestriction {
  /** List of principals. */
...
export const Document: MessageFns<Document> = {
  encode(message: Document, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.aclInfo !== undefined) {
      Document_AclInfo.encode(message.aclInfo, writer.uint32(90).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.aclInfo = Document_AclInfo.decode(reader, reader.uint32());
          continue;
        case 13:
          if (tag !== 106) {
            break;
  ...
  fromJSON(object: any): Document {
    return {
      ...
      aclInfo: isSet(object.aclInfo) ? Document_AclInfo.fromJSON(object.aclInfo) : undefined,
  ...
  toJSON(message: Document): unknown {
    ...
    if (message.aclInfo !== undefined) {
      obj.aclInfo = Document_AclInfo.toJSON(message.aclInfo);
    }
    if (message.indexTime !== undefined) {
  ...
  fromPartial(object: DeepPartial<Document>): Document {
    ...
    message.aclInfo = (object.aclInfo !== undefined && object.aclInfo !== null)
      ? Document_AclInfo.fromPartial(object.aclInfo)
      : undefined;
...
function createBaseDocument_AclInfo(): Document_AclInfo {
  return { readers: [] };
}

export const Document_AclInfo: MessageFns<Document_AclInfo> = {
  encode(message: Document_AclInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.readers) {
      Document_AclInfo_AccessRestriction.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Document_AclInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDocument_AclInfo();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.readers.push(Document_AclInfo_AccessRestriction.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Document_AclInfo {
    return {
      readers: globalThis.Array.isArray(object?.readers)
        ? object.readers.map((e: any) => Document_AclInfo_AccessRestriction.fromJSON(e))
        : [],
    };
  },

  toJSON(message: Document_AclInfo): unknown {
    const obj: any = {};
    if (message.readers?.length) {
      obj.readers = message.readers.map((e) => Document_AclInfo_AccessRestriction.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<Document_AclInfo>): Document_AclInfo {
    return Document_AclInfo.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Document_AclInfo>): Document_AclInfo {
    const message = createBaseDocument_AclInfo();
    message.readers = object.readers?.map((e) => Document_AclInfo_AccessRestriction.fromPartial(e)) || [];
    return message;
  },
};

function createBaseDocument_AclInfo_AccessRestriction(): Document_AclInfo_AccessRestriction {
  return { principals: [], idpWide: false };
}

export const Document_AclInfo_AccessRestriction: MessageFns<Document_AclInfo_AccessRestriction> = {
  encode(message: Document_AclInfo_AccessRestriction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.principals) {
      Principal.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.idpWide !== false) {
      writer.uint32(16).bool(message.idpWide);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Document_AclInfo_AccessRestriction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDocument_AclInfo_AccessRestriction();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Document_AclInfo_AccessRestriction {
    return {
      principals: globalThis.Array.isArray(object?.principals)
        ? object.principals.map((e: any) => Principal.fromJSON(e))
        : [],
      idpWide: isSet(object.idpWide) ? globalThis.Boolean(object.idpWide) : false,
    };
  },

  toJSON(message: Document_AclInfo_AccessRestriction): unknown {
    const obj: any = {};
    if (message.principals?.length) {
      obj.principals = message.principals.map((e) => Principal.toJSON(e));
    }
    if (message.idpWide !== false) {
      obj.idpWide = message.idpWide;
    }
    return obj;
  },

  create(base?: DeepPartial<Document_AclInfo_AccessRestriction>): Document_AclInfo_AccessRestriction {
    return Document_AclInfo_AccessRestriction.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Document_AclInfo_AccessRestriction>): Document_AclInfo_AccessRestriction {
    const message = createBaseDocument_AclInfo_AccessRestriction();
    message.principals = object.principals?.map((e) => Principal.fromPartial(e)) || [];
    message.idpWide = object.idpWide ?? false;
    return message;
  },
};
...
function createBaseProcessedDocument(): ProcessedDocument {
  return { jsonData: undefined, document: "" };
}

export const ProcessedDocument: MessageFns<ProcessedDocument> = {
  encode(message: ProcessedDocument, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.jsonData !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProcessedDocument {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseProcessedDocument();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
  ...
  fromJSON(object: any): ProcessedDocument {
    return {
      jsonData: isSet(object.jsonData) ? globalThis.String(object.jsonData) : undefined,
  ...
  toJSON(message: ProcessedDocument): unknown {
    const obj: any = {};
    if (message.jsonData !== undefined) {
      obj.jsonData = message.jsonData;
    }
  ...
  create(base?: DeepPartial<ProcessedDocument>): ProcessedDocument {
    return ProcessedDocument.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ProcessedDocument>): ProcessedDocument {
    const message = createBaseProcessedDocument();
    message.jsonData = object.jsonData ?? undefined;
