...
export const protobufPackage = "google.cloud.gkehub.multiclusteringress.v1";
...
export const FeatureSpec: MessageFns<FeatureSpec> = {
  ...
  fromJSON(object: any): FeatureSpec {
    return { configMembership: isSet(object.configMembership) ? globalThis.String(object.configMembership) : "" };
  },
