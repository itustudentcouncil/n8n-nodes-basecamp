...
export const protobufPackage = "google.cloud.gkehub.configmanagement.v1alpha";
...
export const PolicyController: MessageFns<PolicyController> = {
  encode(message: PolicyController, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.mutationEnabled !== false) {
      writer.uint32(56).bool(message.mutationEnabled);
    }
    return writer;
  },
  ...
  fromJSON(object: any): PolicyController {
    return {
      ...
      mutationEnabled: isSet(object.mutationEnabled) ? globalThis.Boolean(object.mutationEnabled) : false,
    };
  },
  ...
  toJSON(message: PolicyController): unknown {
    ...
    if (message.mutationEnabled !== false) {
      obj.mutationEnabled = message.mutationEnabled;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<PolicyController>): PolicyController {
    ...
    message.mutationEnabled = object.mutationEnabled ?? false;
    return message;
  },
};
...
function createBaseGatekeeperDeploymentState(): GatekeeperDeploymentState {
  return { gatekeeperControllerManagerState: 0, gatekeeperAudit: 0, gatekeeperMutation: 0 };
}
...
export const GatekeeperDeploymentState: MessageFns<GatekeeperDeploymentState> = {
  encode(message: GatekeeperDeploymentState, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.gatekeeperMutation !== 0) {
      writer.uint32(24).int32(message.gatekeeperMutation);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.gatekeeperMutation = reader.int32() as any;
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): GatekeeperDeploymentState {
    return {
      ...
      gatekeeperMutation: isSet(object.gatekeeperMutation) ? deploymentStateFromJSON(object.gatekeeperMutation) : 0,
    };
  },
  ...
  toJSON(message: GatekeeperDeploymentState): unknown {
    ...
    if (message.gatekeeperMutation !== 0) {
      obj.gatekeeperMutation = deploymentStateToJSON(message.gatekeeperMutation);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<GatekeeperDeploymentState>): GatekeeperDeploymentState {
    ...
    message.gatekeeperMutation = object.gatekeeperMutation ?? 0;
    return message;
  },
};
