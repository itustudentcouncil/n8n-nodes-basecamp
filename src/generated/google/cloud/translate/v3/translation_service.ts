...
import {
  ...
  ListModelsResponse,
  Model,
} from "./automl_translation.js";
import { GlossaryEntry } from "./common.js";
...
export interface GetGlossaryEntryRequest {
...
export interface ListGlossaryEntriesRequest {
  /**
 ...
 */
export interface UpdateGlossaryMetadata {
...
export function updateGlossaryMetadata_StateFromJSON(object: any): UpdateGlossaryMetadata_State {
  switch (object) {
    case 0:
    case "STATE_UNSPECIFIED":
      return UpdateGlossaryMetadata_State.STATE_UNSPECIFIED;
    case 1:
    case "RUNNING":
      return UpdateGlossaryMetadata_State.RUNNING;
    case 2:
    case "SUCCEEDED":
      return UpdateGlossaryMetadata_State.SUCCEEDED;
    case 3:
    case "FAILED":
      return UpdateGlossaryMetadata_State.FAILED;
    case 4:
    case "CANCELLING":
      return UpdateGlossaryMetadata_State.CANCELLING;
    case 5:
    case "CANCELLED":
      return UpdateGlossaryMetadata_State.CANCELLED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return UpdateGlossaryMetadata_State.UNRECOGNIZED;
  }
}

export function updateGlossaryMetadata_StateToJSON(object: UpdateGlossaryMetadata_State): string {
  switch (object) {
    case UpdateGlossaryMetadata_State.STATE_UNSPECIFIED:
      return "STATE_UNSPECIFIED";
    case UpdateGlossaryMetadata_State.RUNNING:
      return "RUNNING";
    case UpdateGlossaryMetadata_State.SUCCEEDED:
      return "SUCCEEDED";
    case UpdateGlossaryMetadata_State.FAILED:
      return "FAILED";
    case UpdateGlossaryMetadata_State.CANCELLING:
      return "CANCELLING";
    case UpdateGlossaryMetadata_State.CANCELLED:
      return "CANCELLED";
    case UpdateGlossaryMetadata_State.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
function createBaseTransliterationConfig(): TransliterationConfig {
  return { enableTransliteration: false };
}

export const TransliterationConfig: MessageFns<TransliterationConfig> = {
  encode(message: TransliterationConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.enableTransliteration !== false) {
      writer.uint32(8).bool(message.enableTransliteration);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TransliterationConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTransliterationConfig();
  ...
  fromJSON(object: any): TransliterationConfig {
    return {
      enableTransliteration: isSet(object.enableTransliteration)
        ? globalThis.Boolean(object.enableTransliteration)
        : false,
    };
  },

  toJSON(message: TransliterationConfig): unknown {
    const obj: any = {};
    if (message.enableTransliteration !== false) {
      obj.enableTransliteration = message.enableTransliteration;
    }
    return obj;
  },

  create(base?: DeepPartial<TransliterationConfig>): TransliterationConfig {
    return TransliterationConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TransliterationConfig>): TransliterationConfig {
    const message = createBaseTransliterationConfig();
    message.enableTransliteration = object.enableTransliteration ?? false;
    return message;
  },
};
...
function createBaseTranslateTextRequest(): TranslateTextRequest {
  return {
    ...
    transliterationConfig: undefined,
    labels: {},
  };
}
...
export const TranslateTextRequest: MessageFns<TranslateTextRequest> = {
  encode(message: TranslateTextRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.transliterationConfig !== undefined) {
      TransliterationConfig.encode(message.transliterationConfig, writer.uint32(106).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13:
          ...
          message.transliterationConfig = TransliterationConfig.decode(reader, reader.uint32());
          continue;
        case 10:
          if (tag !== 82) {
            break;
  ...
  fromJSON(object: any): TranslateTextRequest {
    return {
      ...
      glossaryConfig: isSet(object.glossaryConfig)
        ...
        : undefined,
      transliterationConfig: isSet(object.transliterationConfig)
        ? TransliterationConfig.fromJSON(object.transliterationConfig)
        : undefined,
  ...
  toJSON(message: TranslateTextRequest): unknown {
    ...
    if (message.transliterationConfig !== undefined) {
      obj.transliterationConfig = TransliterationConfig.toJSON(message.transliterationConfig);
    }
    if (message.labels) {
  ...
  fromPartial(object: DeepPartial<TranslateTextRequest>): TranslateTextRequest {
    ...
    message.transliterationConfig =
      (object.transliterationConfig !== undefined && object.transliterationConfig !== null)
        ? TransliterationConfig.fromPartial(object.transliterationConfig)
        : undefined;
...
function createBaseRomanizeTextRequest(): RomanizeTextRequest {
  return { parent: "", contents: [], sourceLanguageCode: "" };
}

export const RomanizeTextRequest: MessageFns<RomanizeTextRequest> = {
  encode(message: RomanizeTextRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parent !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RomanizeTextRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRomanizeTextRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 4:
  ...
  fromJSON(object: any): RomanizeTextRequest {
    return {
      parent: isSet(object.parent) ? globalThis.String(object.parent) : "",
      contents: globalThis.Array.isArray(object?.contents) ? object.contents.map((e: any) => globalThis.String(e)) : [],
      sourceLanguageCode: isSet(object.sourceLanguageCode) ? globalThis.String(object.sourceLanguageCode) : "",
  ...
  toJSON(message: RomanizeTextRequest): unknown {
    const obj: any = {};
    if (message.parent !== "") {
      obj.parent = message.parent;
    }
  ...
  create(base?: DeepPartial<RomanizeTextRequest>): RomanizeTextRequest {
    return RomanizeTextRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RomanizeTextRequest>): RomanizeTextRequest {
    const message = createBaseRomanizeTextRequest();
    message.parent = object.parent ?? "";
    message.contents = object.contents?.map((e) => e) || [];
    message.sourceLanguageCode = object.sourceLanguageCode ?? "";
...
function createBaseRomanization(): Romanization {
  return { romanizedText: "", detectedLanguageCode: "" };
}

export const Romanization: MessageFns<Romanization> = {
  encode(message: Romanization, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.romanizedText !== "") {
      writer.uint32(10).string(message.romanizedText);
    }
    if (message.detectedLanguageCode !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Romanization {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRomanization();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Romanization {
    return {
      romanizedText: isSet(object.romanizedText) ? globalThis.String(object.romanizedText) : "",
      detectedLanguageCode: isSet(object.detectedLanguageCode) ? globalThis.String(object.detectedLanguageCode) : "",
    };
  },

  toJSON(message: Romanization): unknown {
    const obj: any = {};
    if (message.romanizedText !== "") {
  ...
  create(base?: DeepPartial<Romanization>): Romanization {
    return Romanization.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Romanization>): Romanization {
    const message = createBaseRomanization();
    message.romanizedText = object.romanizedText ?? "";
    message.detectedLanguageCode = object.detectedLanguageCode ?? "";
    return message;
  },
};

function createBaseRomanizeTextResponse(): RomanizeTextResponse {
  return { romanizations: [] };
}

export const RomanizeTextResponse: MessageFns<RomanizeTextResponse> = {
  encode(message: RomanizeTextResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.romanizations) {
      Romanization.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RomanizeTextResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRomanizeTextResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.romanizations.push(Romanization.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): RomanizeTextResponse {
    return {
      romanizations: globalThis.Array.isArray(object?.romanizations)
        ? object.romanizations.map((e: any) => Romanization.fromJSON(e))
        : [],
    };
  },

  toJSON(message: RomanizeTextResponse): unknown {
    const obj: any = {};
    if (message.romanizations?.length) {
      obj.romanizations = message.romanizations.map((e) => Romanization.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<RomanizeTextResponse>): RomanizeTextResponse {
    return RomanizeTextResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<RomanizeTextResponse>): RomanizeTextResponse {
    const message = createBaseRomanizeTextResponse();
    message.romanizations = object.romanizations?.map((e) => Romanization.fromPartial(e)) || [];
    return message;
  },
};
...
function createBaseUpdateGlossaryRequest(): UpdateGlossaryRequest {
  return { glossary: undefined, updateMask: undefined };
}

export const UpdateGlossaryRequest: MessageFns<UpdateGlossaryRequest> = {
  encode(message: UpdateGlossaryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.glossary !== undefined) {
      Glossary.encode(message.glossary, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateGlossaryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateGlossaryRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): UpdateGlossaryRequest {
    return {
      glossary: isSet(object.glossary) ? Glossary.fromJSON(object.glossary) : undefined,
  ...
  toJSON(message: UpdateGlossaryRequest): unknown {
    const obj: any = {};
    if (message.glossary !== undefined) {
      obj.glossary = Glossary.toJSON(message.glossary);
    }
  ...
  create(base?: DeepPartial<UpdateGlossaryRequest>): UpdateGlossaryRequest {
    return UpdateGlossaryRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateGlossaryRequest>): UpdateGlossaryRequest {
    const message = createBaseUpdateGlossaryRequest();
    message.glossary = (object.glossary !== undefined && object.glossary !== null)
      ? Glossary.fromPartial(object.glossary)
      : undefined;
...
function createBaseGetGlossaryEntryRequest(): GetGlossaryEntryRequest {
  return { name: "" };
}

export const GetGlossaryEntryRequest: MessageFns<GetGlossaryEntryRequest> = {
  encode(message: GetGlossaryEntryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetGlossaryEntryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetGlossaryEntryRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetGlossaryEntryRequest {
    return { name: isSet(object.name) ? globalThis.String(object.name) : "" };
  },

  toJSON(message: GetGlossaryEntryRequest): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create(base?: DeepPartial<GetGlossaryEntryRequest>): GetGlossaryEntryRequest {
    return GetGlossaryEntryRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<GetGlossaryEntryRequest>): GetGlossaryEntryRequest {
    const message = createBaseGetGlossaryEntryRequest();
    message.name = object.name ?? "";
    return message;
  },
...
function createBaseDeleteGlossaryEntryRequest(): DeleteGlossaryEntryRequest {
  return { name: "" };
}

export const DeleteGlossaryEntryRequest: MessageFns<DeleteGlossaryEntryRequest> = {
  encode(message: DeleteGlossaryEntryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
      writer.uint32(10).string(message.name);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeleteGlossaryEntryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDeleteGlossaryEntryRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DeleteGlossaryEntryRequest {
    return { name: isSet(object.name) ? globalThis.String(object.name) : "" };
  },

  toJSON(message: DeleteGlossaryEntryRequest): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create(base?: DeepPartial<DeleteGlossaryEntryRequest>): DeleteGlossaryEntryRequest {
    return DeleteGlossaryEntryRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DeleteGlossaryEntryRequest>): DeleteGlossaryEntryRequest {
    const message = createBaseDeleteGlossaryEntryRequest();
    message.name = object.name ?? "";
    return message;
  },
...
function createBaseListGlossaryEntriesRequest(): ListGlossaryEntriesRequest {
  return { parent: "", pageSize: 0, pageToken: "" };
}

export const ListGlossaryEntriesRequest: MessageFns<ListGlossaryEntriesRequest> = {
  encode(message: ListGlossaryEntriesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parent !== "") {
      writer.uint32(10).string(message.parent);
    }
    if (message.pageSize !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListGlossaryEntriesRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListGlossaryEntriesRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ListGlossaryEntriesRequest {
    return {
      parent: isSet(object.parent) ? globalThis.String(object.parent) : "",
      pageSize: isSet(object.pageSize) ? globalThis.Number(object.pageSize) : 0,
      pageToken: isSet(object.pageToken) ? globalThis.String(object.pageToken) : "",
  ...
  toJSON(message: ListGlossaryEntriesRequest): unknown {
    const obj: any = {};
    if (message.parent !== "") {
      obj.parent = message.parent;
    }
  ...
  create(base?: DeepPartial<ListGlossaryEntriesRequest>): ListGlossaryEntriesRequest {
    return ListGlossaryEntriesRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListGlossaryEntriesRequest>): ListGlossaryEntriesRequest {
    const message = createBaseListGlossaryEntriesRequest();
    message.parent = object.parent ?? "";
    message.pageSize = object.pageSize ?? 0;
    message.pageToken = object.pageToken ?? "";
...
function createBaseListGlossaryEntriesResponse(): ListGlossaryEntriesResponse {
  return { glossaryEntries: [], nextPageToken: "" };
}

export const ListGlossaryEntriesResponse: MessageFns<ListGlossaryEntriesResponse> = {
  encode(message: ListGlossaryEntriesResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.glossaryEntries) {
      GlossaryEntry.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.nextPageToken !== "") {
      writer.uint32(18).string(message.nextPageToken);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ListGlossaryEntriesResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseListGlossaryEntriesResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.glossaryEntries.push(GlossaryEntry.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  fromJSON(object: any): ListGlossaryEntriesResponse {
    return {
      glossaryEntries: globalThis.Array.isArray(object?.glossaryEntries)
        ? object.glossaryEntries.map((e: any) => GlossaryEntry.fromJSON(e))
        : [],
      nextPageToken: isSet(object.nextPageToken) ? globalThis.String(object.nextPageToken) : "",
    };
  },

  toJSON(message: ListGlossaryEntriesResponse): unknown {
    const obj: any = {};
    if (message.glossaryEntries?.length) {
      obj.glossaryEntries = message.glossaryEntries.map((e) => GlossaryEntry.toJSON(e));
    }
    if (message.nextPageToken !== "") {
      obj.nextPageToken = message.nextPageToken;
    }
  ...
  create(base?: DeepPartial<ListGlossaryEntriesResponse>): ListGlossaryEntriesResponse {
    return ListGlossaryEntriesResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ListGlossaryEntriesResponse>): ListGlossaryEntriesResponse {
    const message = createBaseListGlossaryEntriesResponse();
    message.glossaryEntries = object.glossaryEntries?.map((e) => GlossaryEntry.fromPartial(e)) || [];
    message.nextPageToken = object.nextPageToken ?? "";
    return message;
  },
};

function createBaseCreateGlossaryEntryRequest(): CreateGlossaryEntryRequest {
  return { parent: "", glossaryEntry: undefined };
}

export const CreateGlossaryEntryRequest: MessageFns<CreateGlossaryEntryRequest> = {
  encode(message: CreateGlossaryEntryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parent !== "") {
      writer.uint32(10).string(message.parent);
    }
    if (message.glossaryEntry !== undefined) {
      GlossaryEntry.encode(message.glossaryEntry, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CreateGlossaryEntryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCreateGlossaryEntryRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.glossaryEntry = GlossaryEntry.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CreateGlossaryEntryRequest {
    return {
      parent: isSet(object.parent) ? globalThis.String(object.parent) : "",
      glossaryEntry: isSet(object.glossaryEntry) ? GlossaryEntry.fromJSON(object.glossaryEntry) : undefined,
    };
  },

  toJSON(message: CreateGlossaryEntryRequest): unknown {
    const obj: any = {};
    if (message.parent !== "") {
      obj.parent = message.parent;
    }
    if (message.glossaryEntry !== undefined) {
      obj.glossaryEntry = GlossaryEntry.toJSON(message.glossaryEntry);
    }
    return obj;
  },

  create(base?: DeepPartial<CreateGlossaryEntryRequest>): CreateGlossaryEntryRequest {
    return CreateGlossaryEntryRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<CreateGlossaryEntryRequest>): CreateGlossaryEntryRequest {
    const message = createBaseCreateGlossaryEntryRequest();
    message.parent = object.parent ?? "";
    message.glossaryEntry = (object.glossaryEntry !== undefined && object.glossaryEntry !== null)
      ? GlossaryEntry.fromPartial(object.glossaryEntry)
      : undefined;
    return message;
  },
};

function createBaseUpdateGlossaryEntryRequest(): UpdateGlossaryEntryRequest {
  return { glossaryEntry: undefined };
}

export const UpdateGlossaryEntryRequest: MessageFns<UpdateGlossaryEntryRequest> = {
  encode(message: UpdateGlossaryEntryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.glossaryEntry !== undefined) {
      GlossaryEntry.encode(message.glossaryEntry, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UpdateGlossaryEntryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateGlossaryEntryRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): UpdateGlossaryEntryRequest {
    return { glossaryEntry: isSet(object.glossaryEntry) ? GlossaryEntry.fromJSON(object.glossaryEntry) : undefined };
  },

  toJSON(message: UpdateGlossaryEntryRequest): unknown {
    const obj: any = {};
    if (message.glossaryEntry !== undefined) {
      obj.glossaryEntry = GlossaryEntry.toJSON(message.glossaryEntry);
    }
  ...
  create(base?: DeepPartial<UpdateGlossaryEntryRequest>): UpdateGlossaryEntryRequest {
    return UpdateGlossaryEntryRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateGlossaryEntryRequest>): UpdateGlossaryEntryRequest {
    const message = createBaseUpdateGlossaryEntryRequest();
    message.glossaryEntry = (object.glossaryEntry !== undefined && object.glossaryEntry !== null)
      ? GlossaryEntry.fromPartial(object.glossaryEntry)
      : undefined;
...
function createBaseUpdateGlossaryMetadata(): UpdateGlossaryMetadata {
  return { glossary: undefined, state: 0, submitTime: undefined };
}

export const UpdateGlossaryMetadata: MessageFns<UpdateGlossaryMetadata> = {
  encode(message: UpdateGlossaryMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.glossary !== undefined) {
      Glossary.encode(message.glossary, writer.uint32(10).fork()).join();
    }
    if (message.state !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UpdateGlossaryMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUpdateGlossaryMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): UpdateGlossaryMetadata {
    return {
      glossary: isSet(object.glossary) ? Glossary.fromJSON(object.glossary) : undefined,
      state: isSet(object.state) ? updateGlossaryMetadata_StateFromJSON(object.state) : 0,
      submitTime: isSet(object.submitTime) ? fromJsonTimestamp(object.submitTime) : undefined,
    };
  },

  toJSON(message: UpdateGlossaryMetadata): unknown {
    const obj: any = {};
    if (message.glossary !== undefined) {
      obj.glossary = Glossary.toJSON(message.glossary);
    }
    if (message.state !== 0) {
      obj.state = updateGlossaryMetadata_StateToJSON(message.state);
    }
    if (message.submitTime !== undefined) {
      obj.submitTime = message.submitTime.toISOString();
    }
  ...
  create(base?: DeepPartial<UpdateGlossaryMetadata>): UpdateGlossaryMetadata {
    return UpdateGlossaryMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UpdateGlossaryMetadata>): UpdateGlossaryMetadata {
    const message = createBaseUpdateGlossaryMetadata();
    message.glossary = (object.glossary !== undefined && object.glossary !== null)
      ? Glossary.fromPartial(object.glossary)
      : undefined;
...
export const TranslationServiceDefinition = {
  ...
  methods: {
    ...
    romanizeText: {
      name: "RomanizeText",
      requestType: RomanizeTextRequest,
      requestStream: false,
      responseType: RomanizeTextResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([15, 112, 97, 114, 101, 110, 116, 44, 99, 111, 110, 116, 101, 110, 116, 115])],
          578365826: [
            Buffer.from([
              96,
              58,
    ...
    updateGlossary: {
      name: "UpdateGlossary",
      requestType: UpdateGlossaryRequest,
      requestStream: false,
      responseType: Operation,
      responseStream: false,
      options: {
    ...
    getGlossaryEntry: {
      ...
      requestType: GetGlossaryEntryRequest,
      requestStream: false,
      responseType: GlossaryEntry,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([4, 110, 97, 109, 101])],
    ...
    listGlossaryEntries: {
      ...
      requestType: ListGlossaryEntriesRequest,
      requestStream: false,
      responseType: ListGlossaryEntriesResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([6, 112, 97, 114, 101, 110, 116])],
    ...
    createGlossaryEntry: {
      ...
      requestType: CreateGlossaryEntryRequest,
      requestStream: false,
      responseType: GlossaryEntry,
      responseStream: false,
      options: {
    ...
    updateGlossaryEntry: {
      ...
      requestType: UpdateGlossaryEntryRequest,
      requestStream: false,
      responseType: GlossaryEntry,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([14, 103, 108, 111, 115, 115, 97, 114, 121, 95, 101, 110, 116, 114, 121])],
          578365826: [
            Buffer.from([
              97,
              58,
    ...
    deleteGlossaryEntry: {
      ...
      requestType: DeleteGlossaryEntryRequest,
      requestStream: false,
      responseType: Empty,
      responseStream: false,
      options: {
    ...
    createAdaptiveMtDataset: {
      ...
      requestType: CreateAdaptiveMtDatasetRequest,
      requestStream: false,
      responseType: AdaptiveMtDataset,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [
    ...
    deleteAdaptiveMtDataset: {
      ...
      requestType: DeleteAdaptiveMtDatasetRequest,
      requestStream: false,
      responseType: Empty,
      responseStream: false,
      options: {
    ...
    getAdaptiveMtDataset: {
      ...
      requestType: GetAdaptiveMtDatasetRequest,
      requestStream: false,
      responseType: AdaptiveMtDataset,
      responseStream: false,
      options: {
    ...
    listAdaptiveMtDatasets: {
      ...
      requestType: ListAdaptiveMtDatasetsRequest,
      requestStream: false,
      responseType: ListAdaptiveMtDatasetsResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([6, 112, 97, 114, 101, 110, 116])],
    ...
    adaptiveMtTranslate: {
      ...
      requestType: AdaptiveMtTranslateRequest,
      requestStream: false,
      responseType: AdaptiveMtTranslateResponse,
      responseStream: false,
      options: {
        _unknownFields: {
    ...
    getAdaptiveMtFile: {
      ...
      requestType: GetAdaptiveMtFileRequest,
      requestStream: false,
      responseType: AdaptiveMtFile,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([4, 110, 97, 109, 101])],
    ...
    deleteAdaptiveMtFile: {
      ...
      requestType: DeleteAdaptiveMtFileRequest,
      requestStream: false,
      responseType: Empty,
      responseStream: false,
      options: {
    ...
    importAdaptiveMtFile: {
      ...
      requestType: ImportAdaptiveMtFileRequest,
      requestStream: false,
      responseType: ImportAdaptiveMtFileResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([6, 112, 97, 114, 101, 110, 116])],
    ...
    listAdaptiveMtFiles: {
      ...
      requestType: ListAdaptiveMtFilesRequest,
      requestStream: false,
      responseType: ListAdaptiveMtFilesResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([6, 112, 97, 114, 101, 110, 116])],
    ...
    listAdaptiveMtSentences: {
      ...
      requestType: ListAdaptiveMtSentencesRequest,
      requestStream: false,
      responseType: ListAdaptiveMtSentencesResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [Buffer.from([6, 112, 97, 114, 101, 110, 116])],
...
export interface TranslationServiceImplementation<CallContextExt = {}> {
  ...
  romanizeText(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<RomanizeTextResponse>>;
  /** Detects the language of text within a request. */
  detectLanguage(
  ...
  getGlossaryEntry(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<GlossaryEntry>>;
  /** List the entries for the glossary. */
  listGlossaryEntries(
    request: ListGlossaryEntriesRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListGlossaryEntriesResponse>>;
  /** Creates a glossary entry. */
  createGlossaryEntry(
  ...
  createAdaptiveMtDataset(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<AdaptiveMtDataset>>;
  /**
   * Deletes an Adaptive MT dataset, including all its entries and associated
   * metadata.
   */
  ...
  listAdaptiveMtDatasets(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListAdaptiveMtDatasetsResponse>>;
  /** Translate text using Adaptive MT. */
  adaptiveMtTranslate(
    request: AdaptiveMtTranslateRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<AdaptiveMtTranslateResponse>>;
  /** Gets and AdaptiveMtFile */
  getAdaptiveMtFile(
    request: GetAdaptiveMtFileRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<AdaptiveMtFile>>;
  /** Deletes an AdaptiveMtFile along with its sentences. */
  deleteAdaptiveMtFile(
  ...
  importAdaptiveMtFile(
    ...
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ImportAdaptiveMtFileResponse>>;
  /** Lists all AdaptiveMtFiles associated to an AdaptiveMtDataset. */
  listAdaptiveMtFiles(
    request: ListAdaptiveMtFilesRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListAdaptiveMtFilesResponse>>;
  /** Lists all AdaptiveMtSentences under a given file/dataset. */
  listAdaptiveMtSentences(
    request: ListAdaptiveMtSentencesRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ListAdaptiveMtSentencesResponse>>;
  /** Import sentence pairs into translation Dataset. */
...
export interface TranslationServiceClient<CallOptionsExt = {}> {
  ...
  /** Romanize input text written in non-Latin scripts to Latin text. */
  romanizeText(
    request: DeepPartial<RomanizeTextRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<RomanizeTextResponse>;
  /** Detects the language of text within a request. */
  detectLanguage(
   ...
   */
  updateGlossary(
    request: DeepPartial<UpdateGlossaryRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Operation>;
  /**
   * Lists glossaries in a project. Returns NOT_FOUND, if the project doesn't
  ...
  /** Gets a single glossary entry by the given id. */
  getGlossaryEntry(
    request: DeepPartial<GetGlossaryEntryRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<GlossaryEntry>;
  /** List the entries for the glossary. */
  listGlossaryEntries(
    request: DeepPartial<ListGlossaryEntriesRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ListGlossaryEntriesResponse>;
  /** Creates a glossary entry. */
  createGlossaryEntry(
    request: DeepPartial<CreateGlossaryEntryRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<GlossaryEntry>;
  /** Updates a glossary entry. */
  updateGlossaryEntry(
    request: DeepPartial<UpdateGlossaryEntryRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<GlossaryEntry>;
  /** Deletes a single entry from the glossary */
  deleteGlossaryEntry(
    request: DeepPartial<DeleteGlossaryEntryRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Empty>;
  /** Creates a Dataset. */
  ...
  /** Creates an Adaptive MT dataset. */
  createAdaptiveMtDataset(
    request: DeepPartial<CreateAdaptiveMtDatasetRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<AdaptiveMtDataset>;
  /**
   * Deletes an Adaptive MT dataset, including all its entries and associated
   * metadata.
   */
  deleteAdaptiveMtDataset(
    request: DeepPartial<DeleteAdaptiveMtDatasetRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Empty>;
  /** Gets the Adaptive MT dataset. */
  getAdaptiveMtDataset(
    request: DeepPartial<GetAdaptiveMtDatasetRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<AdaptiveMtDataset>;
  /** Lists all Adaptive MT datasets for which the caller has read permission. */
  listAdaptiveMtDatasets(
    request: DeepPartial<ListAdaptiveMtDatasetsRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ListAdaptiveMtDatasetsResponse>;
  /** Translate text using Adaptive MT. */
  adaptiveMtTranslate(
    request: DeepPartial<AdaptiveMtTranslateRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<AdaptiveMtTranslateResponse>;
  /** Gets and AdaptiveMtFile */
  getAdaptiveMtFile(
    request: DeepPartial<GetAdaptiveMtFileRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<AdaptiveMtFile>;
  /** Deletes an AdaptiveMtFile along with its sentences. */
  deleteAdaptiveMtFile(
    request: DeepPartial<DeleteAdaptiveMtFileRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Empty>;
  /**
   * Imports an AdaptiveMtFile and adds all of its sentences into the
   ...
   */
  importAdaptiveMtFile(
    request: DeepPartial<ImportAdaptiveMtFileRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ImportAdaptiveMtFileResponse>;
  /** Lists all AdaptiveMtFiles associated to an AdaptiveMtDataset. */
  listAdaptiveMtFiles(
    request: DeepPartial<ListAdaptiveMtFilesRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ListAdaptiveMtFilesResponse>;
  /** Lists all AdaptiveMtSentences under a given file/dataset. */
  listAdaptiveMtSentences(
    request: DeepPartial<ListAdaptiveMtSentencesRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<ListAdaptiveMtSentencesResponse>;
  /** Import sentence pairs into translation Dataset. */
