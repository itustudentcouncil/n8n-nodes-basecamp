...
export const RecognitionConfig: MessageFns<RecognitionConfig> = {
  encode(message: RecognitionConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.enableSpeakerDiarization !== false) {
      writer.uint32(128).bool(message.enableSpeakerDiarization);
    }
    if (message.diarizationSpeakerCount !== 0) {
      writer.uint32(136).int32(message.diarizationSpeakerCount);
    }
...
export const RecognitionMetadata: MessageFns<RecognitionMetadata> = {
  encode(message: RecognitionMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (!message.obfuscatedId.equals(Long.ZERO)) {
      writer.uint32(72).int64(message.obfuscatedId.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9:
          ...
          message.obfuscatedId = Long.fromString(reader.int64().toString());
          continue;
        case 10:
          if (tag !== 82) {
            break;
  ...
  fromJSON(object: any): RecognitionMetadata {
    return {
      ...
      obfuscatedId: isSet(object.obfuscatedId) ? Long.fromValue(object.obfuscatedId) : Long.ZERO,
  ...
  toJSON(message: RecognitionMetadata): unknown {
    ...
    if (!message.obfuscatedId.equals(Long.ZERO)) {
      obj.obfuscatedId = (message.obfuscatedId || Long.ZERO).toString();
    }
    if (message.audioTopic !== "") {
  ...
  fromPartial(object: DeepPartial<RecognitionMetadata>): RecognitionMetadata {
    ...
    message.obfuscatedId = (object.obfuscatedId !== undefined && object.obfuscatedId !== null)
      ? Long.fromValue(object.obfuscatedId)
      : Long.ZERO;
...
function createBaseLongRunningRecognizeMetadata(): LongRunningRecognizeMetadata {
  return { progressPercent: 0, startTime: undefined, lastUpdateTime: undefined, uri: "", outputConfig: undefined };
}
...
export const LongRunningRecognizeMetadata: MessageFns<LongRunningRecognizeMetadata> = {
  encode(message: LongRunningRecognizeMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.outputConfig !== undefined) {
      TranscriptOutputConfig.encode(message.outputConfig, writer.uint32(42).fork()).join();
    }
    return writer;
  },
