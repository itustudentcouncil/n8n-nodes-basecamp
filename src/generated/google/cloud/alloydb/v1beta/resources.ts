...
export const protobufPackage = "google.cloud.alloydb.v1beta";
...
export function databaseVersionFromJSON(object: any): DatabaseVersion {
  switch (object) {
    ...
    case 3:
    case "POSTGRES_15":
      return DatabaseVersion.POSTGRES_15;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function databaseVersionToJSON(object: DatabaseVersion): string {
  switch (object) {
    ...
    case DatabaseVersion.POSTGRES_14:
      return "POSTGRES_14";
    case DatabaseVersion.POSTGRES_15:
      return "POSTGRES_15";
...
export interface MaintenanceUpdatePolicy_MaintenanceWindow {
...
export interface Instance_UpdatePolicy {
...
export enum Instance_UpdatePolicy_Mode {
  ...
  DEFAULT = 1,
  /**
   * FORCE_APPLY - Performs a forced update when applicable. This will be fast but may
   * incur a downtime.
   */
  FORCE_APPLY = 2,
  UNRECOGNIZED = -1,
...
export function instance_UpdatePolicy_ModeFromJSON(object: any): Instance_UpdatePolicy_Mode {
  switch (object) {
    case 0:
    case "MODE_UNSPECIFIED":
      return Instance_UpdatePolicy_Mode.MODE_UNSPECIFIED;
    case 1:
    case "DEFAULT":
      return Instance_UpdatePolicy_Mode.DEFAULT;
    case 2:
    case "FORCE_APPLY":
      return Instance_UpdatePolicy_Mode.FORCE_APPLY;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Instance_UpdatePolicy_Mode.UNRECOGNIZED;
  }
}

export function instance_UpdatePolicy_ModeToJSON(object: Instance_UpdatePolicy_Mode): string {
  switch (object) {
    case Instance_UpdatePolicy_Mode.MODE_UNSPECIFIED:
      return "MODE_UNSPECIFIED";
    case Instance_UpdatePolicy_Mode.DEFAULT:
      return "DEFAULT";
    case Instance_UpdatePolicy_Mode.FORCE_APPLY:
      return "FORCE_APPLY";
    case Instance_UpdatePolicy_Mode.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
 ...
 * done via LDTM.
 */
export interface Instance_PscInterfaceConfig {
  /**
...
export interface Instance_InstanceNetworkConfig {
...
export interface Instance_InstanceNetworkConfig_AuthorizedNetwork {
...
function createBaseMaintenanceUpdatePolicy(): MaintenanceUpdatePolicy {
  return { maintenanceWindows: [] };
}

export const MaintenanceUpdatePolicy: MessageFns<MaintenanceUpdatePolicy> = {
  encode(message: MaintenanceUpdatePolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.maintenanceWindows) {
      MaintenanceUpdatePolicy_MaintenanceWindow.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MaintenanceUpdatePolicy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMaintenanceUpdatePolicy();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.maintenanceWindows.push(MaintenanceUpdatePolicy_MaintenanceWindow.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): MaintenanceUpdatePolicy {
    return {
      maintenanceWindows: globalThis.Array.isArray(object?.maintenanceWindows)
        ? object.maintenanceWindows.map((e: any) => MaintenanceUpdatePolicy_MaintenanceWindow.fromJSON(e))
        : [],
    };
  },

  toJSON(message: MaintenanceUpdatePolicy): unknown {
    const obj: any = {};
    if (message.maintenanceWindows?.length) {
      obj.maintenanceWindows = message.maintenanceWindows.map((e) =>
        MaintenanceUpdatePolicy_MaintenanceWindow.toJSON(e)
      );
    }
    return obj;
  },

  create(base?: DeepPartial<MaintenanceUpdatePolicy>): MaintenanceUpdatePolicy {
    return MaintenanceUpdatePolicy.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MaintenanceUpdatePolicy>): MaintenanceUpdatePolicy {
    const message = createBaseMaintenanceUpdatePolicy();
    message.maintenanceWindows =
      object.maintenanceWindows?.map((e) => MaintenanceUpdatePolicy_MaintenanceWindow.fromPartial(e)) || [];
    return message;
  },
};

function createBaseMaintenanceUpdatePolicy_MaintenanceWindow(): MaintenanceUpdatePolicy_MaintenanceWindow {
  return { day: 0, startTime: undefined };
}

export const MaintenanceUpdatePolicy_MaintenanceWindow: MessageFns<MaintenanceUpdatePolicy_MaintenanceWindow> = {
  encode(message: MaintenanceUpdatePolicy_MaintenanceWindow, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.day !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MaintenanceUpdatePolicy_MaintenanceWindow {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMaintenanceUpdatePolicy_MaintenanceWindow();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MaintenanceUpdatePolicy_MaintenanceWindow {
    return {
  ...
  toJSON(message: MaintenanceUpdatePolicy_MaintenanceWindow): unknown {
    const obj: any = {};
    if (message.day !== 0) {
  ...
  create(base?: DeepPartial<MaintenanceUpdatePolicy_MaintenanceWindow>): MaintenanceUpdatePolicy_MaintenanceWindow {
    return MaintenanceUpdatePolicy_MaintenanceWindow.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<MaintenanceUpdatePolicy_MaintenanceWindow>,
...
export const Cluster: MessageFns<Cluster> = {
  encode(message: Cluster, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.satisfiesPzs !== false) {
      writer.uint32(240).bool(message.satisfiesPzs);
    }
    if (message.maintenanceUpdatePolicy !== undefined) {
      MaintenanceUpdatePolicy.encode(message.maintenanceUpdatePolicy, writer.uint32(258).fork()).join();
    }
    if (message.maintenanceSchedule !== undefined) {
      MaintenanceSchedule.encode(message.maintenanceSchedule, writer.uint32(298).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 32:
          ...
          message.maintenanceUpdatePolicy = MaintenanceUpdatePolicy.decode(reader, reader.uint32());
          continue;
        case 37:
          if (tag !== 298) {
            break;
  ...
  fromJSON(object: any): Cluster {
    return {
      ...
      maintenanceUpdatePolicy: isSet(object.maintenanceUpdatePolicy)
        ? MaintenanceUpdatePolicy.fromJSON(object.maintenanceUpdatePolicy)
        : undefined,
  ...
  toJSON(message: Cluster): unknown {
    ...
    if (message.maintenanceUpdatePolicy !== undefined) {
      obj.maintenanceUpdatePolicy = MaintenanceUpdatePolicy.toJSON(message.maintenanceUpdatePolicy);
    }
    if (message.maintenanceSchedule !== undefined) {
  ...
  fromPartial(object: DeepPartial<Cluster>): Cluster {
    ...
    message.maintenanceUpdatePolicy =
      (object.maintenanceUpdatePolicy !== undefined && object.maintenanceUpdatePolicy !== null)
        ? MaintenanceUpdatePolicy.fromPartial(object.maintenanceUpdatePolicy)
        : undefined;
...
export const Instance: MessageFns<Instance> = {
  encode(message: Instance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.publicIpAddress !== "") {
      writer.uint32(218).string(message.publicIpAddress);
    }
    if (message.reconciling !== false) {
    ...
    if (message.updatePolicy !== undefined) {
      Instance_UpdatePolicy.encode(message.updatePolicy, writer.uint32(178).fork()).join();
    }
    ...
    if (message.satisfiesPzs !== false) {
      writer.uint32(192).bool(message.satisfiesPzs);
    }
    if (message.pscInstanceConfig !== undefined) {
      Instance_PscInstanceConfig.encode(message.pscInstanceConfig, writer.uint32(226).fork()).join();
    }
    if (message.networkConfig !== undefined) {
      Instance_InstanceNetworkConfig.encode(message.networkConfig, writer.uint32(234).fork()).join();
    }
    for (const v of message.outboundPublicIpAddresses) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 22:
          ...
          message.updatePolicy = Instance_UpdatePolicy.decode(reader, reader.uint32());
          continue;
        case 23:
          if (tag !== 186) {
            break;
        ...
        case 28:
          ...
          message.pscInstanceConfig = Instance_PscInstanceConfig.decode(reader, reader.uint32());
          continue;
        case 29:
          if (tag !== 234) {
            break;
          ...
          message.networkConfig = Instance_InstanceNetworkConfig.decode(reader, reader.uint32());
          continue;
        case 34:
          if (tag !== 274) {
            break;
  ...
  fromJSON(object: any): Instance {
    return {
      ...
      annotations: isObject(object.annotations)
        ...
        : {},
      updatePolicy: isSet(object.updatePolicy) ? Instance_UpdatePolicy.fromJSON(object.updatePolicy) : undefined,
      clientConnectionConfig: isSet(object.clientConnectionConfig)
        ...
        : undefined,
      satisfiesPzs: isSet(object.satisfiesPzs) ? globalThis.Boolean(object.satisfiesPzs) : false,
      pscInstanceConfig: isSet(object.pscInstanceConfig)
        ? Instance_PscInstanceConfig.fromJSON(object.pscInstanceConfig)
        : undefined,
      networkConfig: isSet(object.networkConfig)
        ? Instance_InstanceNetworkConfig.fromJSON(object.networkConfig)
        : undefined,
      outboundPublicIpAddresses: globalThis.Array.isArray(object?.outboundPublicIpAddresses)
        ? object.outboundPublicIpAddresses.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: Instance): unknown {
    ...
    if (message.updatePolicy !== undefined) {
      obj.updatePolicy = Instance_UpdatePolicy.toJSON(message.updatePolicy);
    }
    if (message.clientConnectionConfig !== undefined) {
    ...
    if (message.pscInstanceConfig !== undefined) {
      obj.pscInstanceConfig = Instance_PscInstanceConfig.toJSON(message.pscInstanceConfig);
    }
    if (message.networkConfig !== undefined) {
      obj.networkConfig = Instance_InstanceNetworkConfig.toJSON(message.networkConfig);
    }
    if (message.outboundPublicIpAddresses?.length) {
      obj.outboundPublicIpAddresses = message.outboundPublicIpAddresses;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Instance>): Instance {
    ...
    message.updatePolicy = (object.updatePolicy !== undefined && object.updatePolicy !== null)
      ? Instance_UpdatePolicy.fromPartial(object.updatePolicy)
      : undefined;
    message.clientConnectionConfig =
      (object.clientConnectionConfig !== undefined && object.clientConnectionConfig !== null)
        ...
        : undefined;
    message.satisfiesPzs = object.satisfiesPzs ?? false;
    message.pscInstanceConfig = (object.pscInstanceConfig !== undefined && object.pscInstanceConfig !== null)
      ? Instance_PscInstanceConfig.fromPartial(object.pscInstanceConfig)
      : undefined;
    message.networkConfig = (object.networkConfig !== undefined && object.networkConfig !== null)
      ? Instance_InstanceNetworkConfig.fromPartial(object.networkConfig)
      : undefined;
    message.outboundPublicIpAddresses = object.outboundPublicIpAddresses?.map((e) => e) || [];
    return message;
  },
};
...
function createBaseInstance_UpdatePolicy(): Instance_UpdatePolicy {
  return { mode: 0 };
}

export const Instance_UpdatePolicy: MessageFns<Instance_UpdatePolicy> = {
  encode(message: Instance_UpdatePolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.mode !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Instance_UpdatePolicy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseInstance_UpdatePolicy();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Instance_UpdatePolicy {
    return { mode: isSet(object.mode) ? instance_UpdatePolicy_ModeFromJSON(object.mode) : 0 };
  },

  toJSON(message: Instance_UpdatePolicy): unknown {
    const obj: any = {};
    if (message.mode !== 0) {
      obj.mode = instance_UpdatePolicy_ModeToJSON(message.mode);
    }
    return obj;
  },

  create(base?: DeepPartial<Instance_UpdatePolicy>): Instance_UpdatePolicy {
    return Instance_UpdatePolicy.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Instance_UpdatePolicy>): Instance_UpdatePolicy {
    const message = createBaseInstance_UpdatePolicy();
...
function createBaseInstance_PscInterfaceConfig(): Instance_PscInterfaceConfig {
  return { consumerEndpointIps: [], networkAttachment: "" };
}

export const Instance_PscInterfaceConfig: MessageFns<Instance_PscInterfaceConfig> = {
  encode(message: Instance_PscInterfaceConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.consumerEndpointIps) {
      writer.uint32(10).string(v!);
    }
    if (message.networkAttachment !== "") {
      writer.uint32(18).string(message.networkAttachment);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Instance_PscInterfaceConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseInstance_PscInterfaceConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.consumerEndpointIps.push(reader.string());
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  fromJSON(object: any): Instance_PscInterfaceConfig {
    return {
      consumerEndpointIps: globalThis.Array.isArray(object?.consumerEndpointIps)
        ? object.consumerEndpointIps.map((e: any) => globalThis.String(e))
        : [],
      networkAttachment: isSet(object.networkAttachment) ? globalThis.String(object.networkAttachment) : "",
    };
  },

  toJSON(message: Instance_PscInterfaceConfig): unknown {
    const obj: any = {};
    if (message.consumerEndpointIps?.length) {
      obj.consumerEndpointIps = message.consumerEndpointIps;
    }
    if (message.networkAttachment !== "") {
  ...
  create(base?: DeepPartial<Instance_PscInterfaceConfig>): Instance_PscInterfaceConfig {
    return Instance_PscInterfaceConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Instance_PscInterfaceConfig>): Instance_PscInterfaceConfig {
    const message = createBaseInstance_PscInterfaceConfig();
    message.consumerEndpointIps = object.consumerEndpointIps?.map((e) => e) || [];
    message.networkAttachment = object.networkAttachment ?? "";
    return message;
  },
};

function createBaseInstance_PscInstanceConfig(): Instance_PscInstanceConfig {
  return {
...
export const Instance_PscInstanceConfig: MessageFns<Instance_PscInstanceConfig> = {
  encode(message: Instance_PscInstanceConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.serviceAttachmentLink !== "") {
      writer.uint32(10).string(message.serviceAttachmentLink);
    }
    for (const v of message.allowedConsumerProjects) {
      writer.uint32(18).string(v!);
    }
    for (const v of message.allowedConsumerNetworks) {
      writer.uint32(26).string(v!);
    }
    for (const v of message.pscInterfaceConfigs) {
      Instance_PscInterfaceConfig.encode(v!, writer.uint32(34).fork()).join();
    }
    for (const v of message.outgoingServiceAttachmentLinks) {
      writer.uint32(42).string(v!);
    }
    if (message.pscEnabled !== false) {
      writer.uint32(48).bool(message.pscEnabled);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Instance_PscInstanceConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseInstance_PscInstanceConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 3:
          ...
          message.allowedConsumerNetworks.push(reader.string());
          continue;
        case 4:
          if (tag !== 34) {
            break;
          ...
          message.pscInterfaceConfigs.push(Instance_PscInterfaceConfig.decode(reader, reader.uint32()));
          continue;
        case 5:
          if (tag !== 42) {
            break;
          ...
          message.outgoingServiceAttachmentLinks.push(reader.string());
          continue;
        case 6:
          if (tag !== 48) {
            break;
  ...
  fromJSON(object: any): Instance_PscInstanceConfig {
    return {
      serviceAttachmentLink: isSet(object.serviceAttachmentLink) ? globalThis.String(object.serviceAttachmentLink) : "",
      allowedConsumerProjects: globalThis.Array.isArray(object?.allowedConsumerProjects)
        ...
        : [],
      allowedConsumerNetworks: globalThis.Array.isArray(object?.allowedConsumerNetworks)
        ? object.allowedConsumerNetworks.map((e: any) => globalThis.String(e))
        : [],
      pscInterfaceConfigs: globalThis.Array.isArray(object?.pscInterfaceConfigs)
        ? object.pscInterfaceConfigs.map((e: any) => Instance_PscInterfaceConfig.fromJSON(e))
        : [],
      outgoingServiceAttachmentLinks: globalThis.Array.isArray(object?.outgoingServiceAttachmentLinks)
        ? object.outgoingServiceAttachmentLinks.map((e: any) => globalThis.String(e))
        : [],
      pscEnabled: isSet(object.pscEnabled) ? globalThis.Boolean(object.pscEnabled) : false,
    };
  },

  toJSON(message: Instance_PscInstanceConfig): unknown {
    const obj: any = {};
    if (message.serviceAttachmentLink !== "") {
      obj.serviceAttachmentLink = message.serviceAttachmentLink;
    }
    if (message.allowedConsumerProjects?.length) {
      obj.allowedConsumerProjects = message.allowedConsumerProjects;
    }
    if (message.allowedConsumerNetworks?.length) {
      obj.allowedConsumerNetworks = message.allowedConsumerNetworks;
    }
    if (message.pscInterfaceConfigs?.length) {
      obj.pscInterfaceConfigs = message.pscInterfaceConfigs.map((e) => Instance_PscInterfaceConfig.toJSON(e));
    }
    if (message.outgoingServiceAttachmentLinks?.length) {
      obj.outgoingServiceAttachmentLinks = message.outgoingServiceAttachmentLinks;
    }
    if (message.pscEnabled !== false) {
  ...
  create(base?: DeepPartial<Instance_PscInstanceConfig>): Instance_PscInstanceConfig {
    return Instance_PscInstanceConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Instance_PscInstanceConfig>): Instance_PscInstanceConfig {
    const message = createBaseInstance_PscInstanceConfig();
    message.serviceAttachmentLink = object.serviceAttachmentLink ?? "";
    message.allowedConsumerProjects = object.allowedConsumerProjects?.map((e) => e) || [];
    message.allowedConsumerNetworks = object.allowedConsumerNetworks?.map((e) => e) || [];
    message.pscInterfaceConfigs = object.pscInterfaceConfigs?.map((e) => Instance_PscInterfaceConfig.fromPartial(e)) ||
      [];
    message.outgoingServiceAttachmentLinks = object.outgoingServiceAttachmentLinks?.map((e) => e) || [];
    message.pscEnabled = object.pscEnabled ?? false;
    return message;
  },
};

function createBaseInstance_InstanceNetworkConfig(): Instance_InstanceNetworkConfig {
  return { authorizedExternalNetworks: [], enablePublicIp: false, enableOutboundPublicIp: false };
}

export const Instance_InstanceNetworkConfig: MessageFns<Instance_InstanceNetworkConfig> = {
  encode(message: Instance_InstanceNetworkConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.authorizedExternalNetworks) {
      Instance_InstanceNetworkConfig_AuthorizedNetwork.encode(v!, writer.uint32(10).fork()).join();
    }
    if (message.enablePublicIp !== false) {
      writer.uint32(16).bool(message.enablePublicIp);
    }
    if (message.enableOutboundPublicIp !== false) {
      writer.uint32(24).bool(message.enableOutboundPublicIp);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Instance_InstanceNetworkConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseInstance_InstanceNetworkConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.authorizedExternalNetworks.push(
            Instance_InstanceNetworkConfig_AuthorizedNetwork.decode(reader, reader.uint32()),
          );
          continue;
        case 2:
          if (tag !== 16) {
          ...
          message.enablePublicIp = reader.bool();
          continue;
        case 3:
          if (tag !== 24) {
            break;
  ...
  fromJSON(object: any): Instance_InstanceNetworkConfig {
    return {
      authorizedExternalNetworks: globalThis.Array.isArray(object?.authorizedExternalNetworks)
        ? object.authorizedExternalNetworks.map((e: any) =>
          Instance_InstanceNetworkConfig_AuthorizedNetwork.fromJSON(e)
        )
        : [],
      enablePublicIp: isSet(object.enablePublicIp) ? globalThis.Boolean(object.enablePublicIp) : false,
      enableOutboundPublicIp: isSet(object.enableOutboundPublicIp)
        ? globalThis.Boolean(object.enableOutboundPublicIp)
        : false,
    };
  },

  toJSON(message: Instance_InstanceNetworkConfig): unknown {
    const obj: any = {};
    if (message.authorizedExternalNetworks?.length) {
      obj.authorizedExternalNetworks = message.authorizedExternalNetworks.map((e) =>
        Instance_InstanceNetworkConfig_AuthorizedNetwork.toJSON(e)
      );
    }
    if (message.enablePublicIp !== false) {
      obj.enablePublicIp = message.enablePublicIp;
    }
    if (message.enableOutboundPublicIp !== false) {
      obj.enableOutboundPublicIp = message.enableOutboundPublicIp;
    }
    return obj;
  },

  create(base?: DeepPartial<Instance_InstanceNetworkConfig>): Instance_InstanceNetworkConfig {
    return Instance_InstanceNetworkConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Instance_InstanceNetworkConfig>): Instance_InstanceNetworkConfig {
    const message = createBaseInstance_InstanceNetworkConfig();
    message.authorizedExternalNetworks =
      object.authorizedExternalNetworks?.map((e) => Instance_InstanceNetworkConfig_AuthorizedNetwork.fromPartial(e)) ||
      [];
    message.enablePublicIp = object.enablePublicIp ?? false;
    message.enableOutboundPublicIp = object.enableOutboundPublicIp ?? false;
    return message;
  },
};

function createBaseInstance_InstanceNetworkConfig_AuthorizedNetwork(): Instance_InstanceNetworkConfig_AuthorizedNetwork {
  return { cidrRange: "" };
}

export const Instance_InstanceNetworkConfig_AuthorizedNetwork: MessageFns<
  Instance_InstanceNetworkConfig_AuthorizedNetwork
> = {
  encode(
    message: Instance_InstanceNetworkConfig_AuthorizedNetwork,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.cidrRange !== "") {
      writer.uint32(10).string(message.cidrRange);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Instance_InstanceNetworkConfig_AuthorizedNetwork {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseInstance_InstanceNetworkConfig_AuthorizedNetwork();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Instance_InstanceNetworkConfig_AuthorizedNetwork {
    return { cidrRange: isSet(object.cidrRange) ? globalThis.String(object.cidrRange) : "" };
  },

  toJSON(message: Instance_InstanceNetworkConfig_AuthorizedNetwork): unknown {
    const obj: any = {};
    if (message.cidrRange !== "") {
      obj.cidrRange = message.cidrRange;
    }
    return obj;
  },

  create(
    base?: DeepPartial<Instance_InstanceNetworkConfig_AuthorizedNetwork>,
  ): Instance_InstanceNetworkConfig_AuthorizedNetwork {
    return Instance_InstanceNetworkConfig_AuthorizedNetwork.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<Instance_InstanceNetworkConfig_AuthorizedNetwork>,
  ): Instance_InstanceNetworkConfig_AuthorizedNetwork {
    const message = createBaseInstance_InstanceNetworkConfig_AuthorizedNetwork();
    message.cidrRange = object.cidrRange ?? "";
    return message;
  },
};
...
function createBaseConnectionInfo(): ConnectionInfo {
  return { name: "", ipAddress: "", publicIpAddress: "", pemCertificateChain: [], instanceUid: "", pscDnsName: "" };
}
...
export const ConnectionInfo: MessageFns<ConnectionInfo> = {
  encode(message: ConnectionInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.publicIpAddress !== "") {
      writer.uint32(42).string(message.publicIpAddress);
    }
    ...
    if (message.pscDnsName !== "") {
      writer.uint32(50).string(message.pscDnsName);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.pscDnsName = reader.string();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ConnectionInfo {
    return {
      ...
      pscDnsName: isSet(object.pscDnsName) ? globalThis.String(object.pscDnsName) : "",
    };
  },
  ...
  toJSON(message: ConnectionInfo): unknown {
    ...
    if (message.pscDnsName !== "") {
      obj.pscDnsName = message.pscDnsName;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ConnectionInfo>): ConnectionInfo {
    ...
    message.pscDnsName = object.pscDnsName ?? "";
    return message;
  },
};
...
export const Backup: MessageFns<Backup> = {
  encode(message: Backup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.satisfiesPzs !== false) {
      writer.uint32(168).bool(message.satisfiesPzs);
    }
    if (message.databaseVersion !== 0) {
