...
export const protobufPackage = "google.cloud.memcache.v1beta2";
...
export const Instance: MessageFns<Instance> = {
  encode(message: Instance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.updateAvailable !== false) {
      writer.uint32(168).bool(message.updateAvailable);
    }
    if (message.maintenancePolicy !== undefined) {
      MaintenancePolicy.encode(message.maintenancePolicy, writer.uint32(178).fork()).join();
    }
    if (message.maintenanceSchedule !== undefined) {
      MaintenanceSchedule.encode(message.maintenanceSchedule, writer.uint32(186).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Instance {
    return {
      ...
      updateAvailable: isSet(object.updateAvailable) ? globalThis.Boolean(object.updateAvailable) : false,
...
function createBaseInstance_Node(): Instance_Node {
  return { nodeId: "", zone: "", state: 0, host: "", port: 0, parameters: undefined, updateAvailable: false };
}
...
export const Instance_Node: MessageFns<Instance_Node> = {
  encode(message: Instance_Node, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.updateAvailable !== false) {
      writer.uint32(56).bool(message.updateAvailable);
    }
    return writer;
  },
...
export const ListInstancesResponse: MessageFns<ListInstancesResponse> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          message.resources.push(Instance.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 18) {
            break;
  ...
  fromJSON(object: any): ListInstancesResponse {
    return {
      resources: globalThis.Array.isArray(object?.resources)
        ? object.resources.map((e: any) => Instance.fromJSON(e))
        : [],
  ...
  toJSON(message: ListInstancesResponse): unknown {
    ...
    if (message.resources?.length) {
      obj.resources = message.resources.map((e) => Instance.toJSON(e));
    }
    if (message.nextPageToken !== "") {
  ...
  fromPartial(object: DeepPartial<ListInstancesResponse>): ListInstancesResponse {
    const message = createBaseListInstancesResponse();
    message.resources = object.resources?.map((e) => Instance.fromPartial(e)) || [];
...
function createBaseCreateInstanceRequest(): CreateInstanceRequest {
  return { parent: "", instanceId: "", resource: undefined };
}
...
export const CreateInstanceRequest: MessageFns<CreateInstanceRequest> = {
  encode(message: CreateInstanceRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.resource !== undefined) {
      Instance.encode(message.resource, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.resource = Instance.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CreateInstanceRequest {
    return {
      ...
      resource: isSet(object.resource) ? Instance.fromJSON(object.resource) : undefined,
    };
  },
  ...
  toJSON(message: CreateInstanceRequest): unknown {
    ...
    if (message.resource !== undefined) {
      obj.resource = Instance.toJSON(message.resource);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<CreateInstanceRequest>): CreateInstanceRequest {
    ...
    message.resource = (object.resource !== undefined && object.resource !== null)
      ? Instance.fromPartial(object.resource)
      : undefined;
    return message;
  },
};
...
export const UpdateInstanceRequest: MessageFns<UpdateInstanceRequest> = {
  encode(message: UpdateInstanceRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.resource !== undefined) {
      Instance.encode(message.resource, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
function createBaseApplySoftwareUpdateRequest(): ApplySoftwareUpdateRequest {
  return { instance: "", nodeIds: [], applyAll: false };
}

export const ApplySoftwareUpdateRequest: MessageFns<ApplySoftwareUpdateRequest> = {
  encode(message: ApplySoftwareUpdateRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instance !== "") {
      writer.uint32(10).string(message.instance);
    }
    for (const v of message.nodeIds) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ApplySoftwareUpdateRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseApplySoftwareUpdateRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ApplySoftwareUpdateRequest {
    return {
      instance: isSet(object.instance) ? globalThis.String(object.instance) : "",
      nodeIds: globalThis.Array.isArray(object?.nodeIds) ? object.nodeIds.map((e: any) => globalThis.String(e)) : [],
      applyAll: isSet(object.applyAll) ? globalThis.Boolean(object.applyAll) : false,
  ...
  toJSON(message: ApplySoftwareUpdateRequest): unknown {
    const obj: any = {};
    if (message.instance !== "") {
      obj.instance = message.instance;
    }
  ...
  create(base?: DeepPartial<ApplySoftwareUpdateRequest>): ApplySoftwareUpdateRequest {
    return ApplySoftwareUpdateRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ApplySoftwareUpdateRequest>): ApplySoftwareUpdateRequest {
    const message = createBaseApplySoftwareUpdateRequest();
    message.instance = object.instance ?? "";
    message.nodeIds = object.nodeIds?.map((e) => e) || [];
    message.applyAll = object.applyAll ?? false;
...
export const CloudMemcacheDefinition = {
  ...
  methods: {
    ...
    applySoftwareUpdate: {
      ...
      requestType: ApplySoftwareUpdateRequest,
      requestStream: false,
      responseType: Operation,
      responseStream: false,
      options: {
...
export interface CloudMemcacheClient<CallOptionsExt = {}> {
  ...
  /** Updates software on the selected nodes of the Instance. */
  applySoftwareUpdate(
    request: DeepPartial<ApplySoftwareUpdateRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Operation>;
  /** Performs the apply phase of the RescheduleMaintenance verb. */
  rescheduleMaintenance(
