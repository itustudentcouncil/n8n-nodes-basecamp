 ...
 * user.
 */
export interface Asset_IamPolicy {
  /**
...
export const Asset: MessageFns<Asset> = {
  encode(message: Asset, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.iamPolicy !== undefined) {
      Asset_IamPolicy.encode(message.iamPolicy, writer.uint32(90).fork()).join();
    }
    if (message.canonicalName !== "") {
      writer.uint32(106).string(message.canonicalName);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.iamPolicy = Asset_IamPolicy.decode(reader, reader.uint32());
          continue;
        case 13:
          if (tag !== 106) {
            break;
  ...
  fromJSON(object: any): Asset {
    return {
      ...
      iamPolicy: isSet(object.iamPolicy) ? Asset_IamPolicy.fromJSON(object.iamPolicy) : undefined,
  ...
  toJSON(message: Asset): unknown {
    ...
    if (message.iamPolicy !== undefined) {
      obj.iamPolicy = Asset_IamPolicy.toJSON(message.iamPolicy);
    }
    if (message.canonicalName !== "") {
  ...
  fromPartial(object: DeepPartial<Asset>): Asset {
    ...
    message.iamPolicy = (object.iamPolicy !== undefined && object.iamPolicy !== null)
      ? Asset_IamPolicy.fromPartial(object.iamPolicy)
      : undefined;
...
export const Asset_SecurityCenterProperties: MessageFns<Asset_SecurityCenterProperties> = {
  encode(message: Asset_SecurityCenterProperties, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.resourceDisplayName !== "") {
      writer.uint32(50).string(message.resourceDisplayName);
    }
    if (message.resourceParentDisplayName !== "") {
      writer.uint32(58).string(message.resourceParentDisplayName);
    }
    if (message.resourceProjectDisplayName !== "") {
      writer.uint32(66).string(message.resourceProjectDisplayName);
    }
  ...
  fromJSON(object: any): Asset_SecurityCenterProperties {
    return {
      ...
      resourceOwners: globalThis.Array.isArray(object?.resourceOwners)
        ...
        : [],
      resourceDisplayName: isSet(object.resourceDisplayName) ? globalThis.String(object.resourceDisplayName) : "",
      resourceParentDisplayName: isSet(object.resourceParentDisplayName)
        ? globalThis.String(object.resourceParentDisplayName)
        : "",
      resourceProjectDisplayName: isSet(object.resourceProjectDisplayName)
        ? globalThis.String(object.resourceProjectDisplayName)
        : "",
  ...
  toJSON(message: Asset_SecurityCenterProperties): unknown {
    ...
    if (message.resourceDisplayName !== "") {
      obj.resourceDisplayName = message.resourceDisplayName;
    }
    if (message.resourceParentDisplayName !== "") {
      obj.resourceParentDisplayName = message.resourceParentDisplayName;
    }
    if (message.resourceProjectDisplayName !== "") {
      obj.resourceProjectDisplayName = message.resourceProjectDisplayName;
    }
  ...
  fromPartial(object: DeepPartial<Asset_SecurityCenterProperties>): Asset_SecurityCenterProperties {
    ...
    message.resourceDisplayName = object.resourceDisplayName ?? "";
    message.resourceParentDisplayName = object.resourceParentDisplayName ?? "";
    message.resourceProjectDisplayName = object.resourceProjectDisplayName ?? "";
    message.folders = object.folders?.map((e) => Folder.fromPartial(e)) || [];
    return message;
  },
};

function createBaseAsset_IamPolicy(): Asset_IamPolicy {
  return { policyBlob: "" };
}

export const Asset_IamPolicy: MessageFns<Asset_IamPolicy> = {
  encode(message: Asset_IamPolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.policyBlob !== "") {
      writer.uint32(10).string(message.policyBlob);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Asset_IamPolicy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAsset_IamPolicy();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): Asset_IamPolicy {
    return { policyBlob: isSet(object.policyBlob) ? globalThis.String(object.policyBlob) : "" };
  },

  toJSON(message: Asset_IamPolicy): unknown {
    const obj: any = {};
    if (message.policyBlob !== "") {
      obj.policyBlob = message.policyBlob;
    }
    return obj;
  },

  create(base?: DeepPartial<Asset_IamPolicy>): Asset_IamPolicy {
    return Asset_IamPolicy.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<Asset_IamPolicy>): Asset_IamPolicy {
    const message = createBaseAsset_IamPolicy();
    message.policyBlob = object.policyBlob ?? "";
    return message;
  },
};
