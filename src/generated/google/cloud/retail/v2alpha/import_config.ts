...
export interface ImportMetadata {
  ...
  transformedUserEventsMetadata: TransformedUserEventsMetadata | undefined;
}

/** Metadata related to transform user events operation. */
export interface TransformedUserEventsMetadata {
  /** Count of entries in the source user events BigQuery table. */
  sourceEventsCount: Long;
  /**
...
export const ImportProductsRequest: MessageFns<ImportProductsRequest> = {
  encode(message: ImportProductsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.skipDefaultBranchProtection !== false) {
      writer.uint32(64).bool(message.skipDefaultBranchProtection);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.skipDefaultBranchProtection = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ImportProductsRequest {
    return {
      ...
      notificationPubsubTopic: isSet(object.notificationPubsubTopic)
        ...
        : "",
      skipDefaultBranchProtection: isSet(object.skipDefaultBranchProtection)
        ? globalThis.Boolean(object.skipDefaultBranchProtection)
        : false,
    };
  },
  ...
  toJSON(message: ImportProductsRequest): unknown {
    ...
    if (message.skipDefaultBranchProtection !== false) {
      obj.skipDefaultBranchProtection = message.skipDefaultBranchProtection;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ImportProductsRequest>): ImportProductsRequest {
    ...
    message.skipDefaultBranchProtection = object.skipDefaultBranchProtection ?? false;
    return message;
  },
};
...
function createBaseImportMetadata(): ImportMetadata {
  return {
    ...
    requestId: "",
    notificationPubsubTopic: "",
    transformedUserEventsMetadata: undefined,
  };
}
...
export const ImportMetadata: MessageFns<ImportMetadata> = {
  encode(message: ImportMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.transformedUserEventsMetadata !== undefined) {
      TransformedUserEventsMetadata.encode(message.transformedUserEventsMetadata, writer.uint32(58).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.transformedUserEventsMetadata = TransformedUserEventsMetadata.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ImportMetadata {
    return {
      ...
      notificationPubsubTopic: isSet(object.notificationPubsubTopic)
        ? globalThis.String(object.notificationPubsubTopic)
        : "",
      transformedUserEventsMetadata: isSet(object.transformedUserEventsMetadata)
        ? TransformedUserEventsMetadata.fromJSON(object.transformedUserEventsMetadata)
        : undefined,
    };
  },
  ...
  toJSON(message: ImportMetadata): unknown {
    ...
    if (message.transformedUserEventsMetadata !== undefined) {
      obj.transformedUserEventsMetadata = TransformedUserEventsMetadata.toJSON(message.transformedUserEventsMetadata);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ImportMetadata>): ImportMetadata {
    ...
    message.transformedUserEventsMetadata =
      (object.transformedUserEventsMetadata !== undefined && object.transformedUserEventsMetadata !== null)
        ? TransformedUserEventsMetadata.fromPartial(object.transformedUserEventsMetadata)
        : undefined;
    return message;
  },
};

function createBaseTransformedUserEventsMetadata(): TransformedUserEventsMetadata {
  return { sourceEventsCount: Long.ZERO, transformedEventsCount: Long.ZERO };
}

export const TransformedUserEventsMetadata: MessageFns<TransformedUserEventsMetadata> = {
  encode(message: TransformedUserEventsMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.sourceEventsCount.equals(Long.ZERO)) {
      writer.uint32(8).int64(message.sourceEventsCount.toString());
    }
    if (!message.transformedEventsCount.equals(Long.ZERO)) {
      writer.uint32(16).int64(message.transformedEventsCount.toString());
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TransformedUserEventsMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTransformedUserEventsMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.sourceEventsCount = Long.fromString(reader.int64().toString());
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.transformedEventsCount = Long.fromString(reader.int64().toString());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): TransformedUserEventsMetadata {
    return {
      sourceEventsCount: isSet(object.sourceEventsCount) ? Long.fromValue(object.sourceEventsCount) : Long.ZERO,
      transformedEventsCount: isSet(object.transformedEventsCount)
        ? Long.fromValue(object.transformedEventsCount)
        : Long.ZERO,
    };
  },

  toJSON(message: TransformedUserEventsMetadata): unknown {
    const obj: any = {};
    if (!message.sourceEventsCount.equals(Long.ZERO)) {
      obj.sourceEventsCount = (message.sourceEventsCount || Long.ZERO).toString();
    }
    if (!message.transformedEventsCount.equals(Long.ZERO)) {
      obj.transformedEventsCount = (message.transformedEventsCount || Long.ZERO).toString();
    }
    return obj;
  },

  create(base?: DeepPartial<TransformedUserEventsMetadata>): TransformedUserEventsMetadata {
    return TransformedUserEventsMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TransformedUserEventsMetadata>): TransformedUserEventsMetadata {
    const message = createBaseTransformedUserEventsMetadata();
    message.sourceEventsCount = (object.sourceEventsCount !== undefined && object.sourceEventsCount !== null)
      ? Long.fromValue(object.sourceEventsCount)
      : Long.ZERO;
    message.transformedEventsCount =
      (object.transformedEventsCount !== undefined && object.transformedEventsCount !== null)
        ? Long.fromValue(object.transformedEventsCount)
        : Long.ZERO;
    return message;
  },
