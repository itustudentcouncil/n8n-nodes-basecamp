...
function createBaseInputAudioConfig(): InputAudioConfig {
  return {
    ...
    defaultNoSpeechTimeout: undefined,
...
export const InputAudioConfig: MessageFns<InputAudioConfig> = {
  encode(message: InputAudioConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.defaultNoSpeechTimeout !== undefined) {
      Duration.encode(message.defaultNoSpeechTimeout, writer.uint32(146).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 18:
          ...
          message.defaultNoSpeechTimeout = Duration.decode(reader, reader.uint32());
          continue;
        case 26:
          if (tag !== 208) {
            break;
  ...
  fromJSON(object: any): InputAudioConfig {
    return {
      ...
      enableAutomaticPunctuation: isSet(object.enableAutomaticPunctuation)
        ...
        : false,
      defaultNoSpeechTimeout: isSet(object.defaultNoSpeechTimeout)
        ? Duration.fromJSON(object.defaultNoSpeechTimeout)
        : undefined,
  ...
  toJSON(message: InputAudioConfig): unknown {
    ...
    if (message.defaultNoSpeechTimeout !== undefined) {
      obj.defaultNoSpeechTimeout = Duration.toJSON(message.defaultNoSpeechTimeout);
    }
    if (message.optOutConformerModelMigration !== false) {
  ...
  fromPartial(object: DeepPartial<InputAudioConfig>): InputAudioConfig {
    ...
    message.defaultNoSpeechTimeout =
      (object.defaultNoSpeechTimeout !== undefined && object.defaultNoSpeechTimeout !== null)
        ? Duration.fromPartial(object.defaultNoSpeechTimeout)
        : undefined;
