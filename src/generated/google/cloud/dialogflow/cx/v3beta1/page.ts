...
export interface EventHandler {
   ...
   */
  targetPlaybook?: string | undefined;
}
...
export const EventHandler: MessageFns<EventHandler> = {
  encode(message: EventHandler, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.targetPlaybook !== undefined) {
      writer.uint32(58).string(message.targetPlaybook);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.targetPlaybook = reader.string();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): EventHandler {
    return {
      ...
      targetPlaybook: isSet(object.targetPlaybook) ? globalThis.String(object.targetPlaybook) : undefined,
    };
  },
  ...
  toJSON(message: EventHandler): unknown {
    ...
    if (message.targetPlaybook !== undefined) {
      obj.targetPlaybook = message.targetPlaybook;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<EventHandler>): EventHandler {
    ...
    message.targetPlaybook = object.targetPlaybook ?? undefined;
    return message;
  },
};
