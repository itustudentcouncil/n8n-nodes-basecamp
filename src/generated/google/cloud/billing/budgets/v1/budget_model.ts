 ...
 * and thresholds.
 */
export interface NotificationsRule {
  /**
...
export const Budget: MessageFns<Budget> = {
  encode(message: Budget, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.notificationsRule !== undefined) {
      NotificationsRule.encode(message.notificationsRule, writer.uint32(50).fork()).join();
    }
    if (message.etag !== "") {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.notificationsRule = NotificationsRule.decode(reader, reader.uint32());
          continue;
        case 7:
          if (tag !== 58) {
            break;
  ...
  fromJSON(object: any): Budget {
    return {
      ...
      thresholdRules: globalThis.Array.isArray(object?.thresholdRules)
        ...
        : [],
      notificationsRule: isSet(object.notificationsRule)
        ? NotificationsRule.fromJSON(object.notificationsRule)
        : undefined,
  ...
  toJSON(message: Budget): unknown {
    ...
    if (message.notificationsRule !== undefined) {
      obj.notificationsRule = NotificationsRule.toJSON(message.notificationsRule);
    }
    if (message.etag !== "") {
  ...
  fromPartial(object: DeepPartial<Budget>): Budget {
    ...
    message.notificationsRule = (object.notificationsRule !== undefined && object.notificationsRule !== null)
      ? NotificationsRule.fromPartial(object.notificationsRule)
      : undefined;
...
function createBaseNotificationsRule(): NotificationsRule {
  return {
    pubsubTopic: "",
    schemaVersion: "",
...
export const NotificationsRule: MessageFns<NotificationsRule> = {
  encode(message: NotificationsRule, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): NotificationsRule {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseNotificationsRule();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): NotificationsRule {
    return {
  ...
  toJSON(message: NotificationsRule): unknown {
    const obj: any = {};
    if (message.pubsubTopic !== "") {
  ...
  create(base?: DeepPartial<NotificationsRule>): NotificationsRule {
    return NotificationsRule.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<NotificationsRule>): NotificationsRule {
    const message = createBaseNotificationsRule();
