...
export function processorIOSpec_DataTypeFromJSON(object: any): ProcessorIOSpec_DataType {
  switch (object) {
    case 0:
    case "DATA_TYPE_UNSPECIFIED":
      return ProcessorIOSpec_DataType.DATA_TYPE_UNSPECIFIED;
    case 1:
    case "VIDEO":
      return ProcessorIOSpec_DataType.VIDEO;
    case 2:
    case "PROTO":
      return ProcessorIOSpec_DataType.PROTO;
    case -1:
    case "UNRECOGNIZED":
    default:
      return ProcessorIOSpec_DataType.UNRECOGNIZED;
  }
}

export function processorIOSpec_DataTypeToJSON(object: ProcessorIOSpec_DataType): string {
  switch (object) {
    case ProcessorIOSpec_DataType.DATA_TYPE_UNSPECIFIED:
      return "DATA_TYPE_UNSPECIFIED";
    case ProcessorIOSpec_DataType.VIDEO:
      return "VIDEO";
    case ProcessorIOSpec_DataType.PROTO:
      return "PROTO";
    case ProcessorIOSpec_DataType.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const ProcessorIOSpec_GraphInputChannelSpec: MessageFns<ProcessorIOSpec_GraphInputChannelSpec> = {
  ...
  fromJSON(object: any): ProcessorIOSpec_GraphInputChannelSpec {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      dataType: isSet(object.dataType) ? processorIOSpec_DataTypeFromJSON(object.dataType) : 0,
  ...
  toJSON(message: ProcessorIOSpec_GraphInputChannelSpec): unknown {
    ...
    if (message.dataType !== 0) {
      obj.dataType = processorIOSpec_DataTypeToJSON(message.dataType);
    }
