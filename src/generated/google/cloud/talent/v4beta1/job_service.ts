...
export interface JobOperationResult_JobResult {
  /**
...
export const SearchJobsRequest: MessageFns<SearchJobsRequest> = {
  encode(message: SearchJobsRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.requirePreciseResultSize !== false) {
      writer.uint32(48).bool(message.requirePreciseResultSize);
    }
...
export const SearchJobsResponse: MessageFns<SearchJobsResponse> = {
  encode(message: SearchJobsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.estimatedTotalSize !== 0) {
      writer.uint32(40).int32(message.estimatedTotalSize);
    }
  ...
  fromJSON(object: any): SearchJobsResponse {
    return {
      ...
      locationFilters: globalThis.Array.isArray(object?.locationFilters)
        ...
        : [],
      estimatedTotalSize: isSet(object.estimatedTotalSize) ? globalThis.Number(object.estimatedTotalSize) : 0,
  ...
  toJSON(message: SearchJobsResponse): unknown {
    ...
    if (message.estimatedTotalSize !== 0) {
      obj.estimatedTotalSize = Math.round(message.estimatedTotalSize);
    }
    if (message.totalSize !== 0) {
...
function createBaseJobOperationResult(): JobOperationResult {
  return { jobResults: [] };
}

export const JobOperationResult: MessageFns<JobOperationResult> = {
  encode(message: JobOperationResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.jobResults) {
      JobOperationResult_JobResult.encode(v!, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): JobOperationResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseJobOperationResult();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.jobResults.push(JobOperationResult_JobResult.decode(reader, reader.uint32()));
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): JobOperationResult {
    return {
      jobResults: globalThis.Array.isArray(object?.jobResults)
        ? object.jobResults.map((e: any) => JobOperationResult_JobResult.fromJSON(e))
        : [],
    };
  },

  toJSON(message: JobOperationResult): unknown {
    const obj: any = {};
    if (message.jobResults?.length) {
      obj.jobResults = message.jobResults.map((e) => JobOperationResult_JobResult.toJSON(e));
    }
    return obj;
  },

  create(base?: DeepPartial<JobOperationResult>): JobOperationResult {
    return JobOperationResult.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<JobOperationResult>): JobOperationResult {
    const message = createBaseJobOperationResult();
    message.jobResults = object.jobResults?.map((e) => JobOperationResult_JobResult.fromPartial(e)) || [];
    return message;
  },
};

function createBaseJobOperationResult_JobResult(): JobOperationResult_JobResult {
  return { job: undefined, status: undefined };
}

export const JobOperationResult_JobResult: MessageFns<JobOperationResult_JobResult> = {
  encode(message: JobOperationResult_JobResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.job !== undefined) {
      Job.encode(message.job, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): JobOperationResult_JobResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseJobOperationResult_JobResult();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): JobOperationResult_JobResult {
    return {
      job: isSet(object.job) ? Job.fromJSON(object.job) : undefined,
  ...
  toJSON(message: JobOperationResult_JobResult): unknown {
    const obj: any = {};
    if (message.job !== undefined) {
      obj.job = Job.toJSON(message.job);
    }
  ...
  create(base?: DeepPartial<JobOperationResult_JobResult>): JobOperationResult_JobResult {
    return JobOperationResult_JobResult.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<JobOperationResult_JobResult>): JobOperationResult_JobResult {
    const message = createBaseJobOperationResult_JobResult();
    message.job = (object.job !== undefined && object.job !== null) ? Job.fromPartial(object.job) : undefined;
...
export interface JobServiceImplementation<CallContextExt = {}> {
  ...
  /** Deletes a list of [Job][google.cloud.talent.v4beta1.Job]s by filter. */
  batchDeleteJobs(request: BatchDeleteJobsRequest, context: CallContext & CallContextExt): Promise<DeepPartial<Empty>>;
  /** Lists jobs by filter. */
...
export interface JobServiceClient<CallOptionsExt = {}> {
  ...
  /** Deletes a list of [Job][google.cloud.talent.v4beta1.Job]s by filter. */
  batchDeleteJobs(request: DeepPartial<BatchDeleteJobsRequest>, options?: CallOptions & CallOptionsExt): Promise<Empty>;
  /** Lists jobs by filter. */
