...
export interface ReportTaskProgressRequest {
  ...
  applyConfigTaskProgress?: ApplyConfigTaskProgress | undefined;
}
...
export interface ReportTaskCompleteRequest {
  ...
  applyConfigTaskOutput?: ApplyConfigTaskOutput | undefined;
}
...
export interface ReportInventoryRequest {
  /**
   * Required. This is the Compute Engine instance identity token described in
   * https://cloud.google.com/compute/docs/instances/verifying-instance-identity
   * where the audience is 'osconfig.googleapis.com' and the format is 'full'.
...
function createBaseReportTaskProgressRequest(): ReportTaskProgressRequest {
  return {
    ...
    applyConfigTaskProgress: undefined,
  };
}
...
export const ReportTaskProgressRequest: MessageFns<ReportTaskProgressRequest> = {
  encode(message: ReportTaskProgressRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.applyConfigTaskProgress !== undefined) {
      ApplyConfigTaskProgress.encode(message.applyConfigTaskProgress, writer.uint32(50).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.applyConfigTaskProgress = ApplyConfigTaskProgress.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ReportTaskProgressRequest {
    return {
      ...
      execStepTaskProgress: isSet(object.execStepTaskProgress)
        ...
        : undefined,
      applyConfigTaskProgress: isSet(object.applyConfigTaskProgress)
        ? ApplyConfigTaskProgress.fromJSON(object.applyConfigTaskProgress)
        : undefined,
    };
  },
  ...
  toJSON(message: ReportTaskProgressRequest): unknown {
    ...
    if (message.applyConfigTaskProgress !== undefined) {
      obj.applyConfigTaskProgress = ApplyConfigTaskProgress.toJSON(message.applyConfigTaskProgress);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ReportTaskProgressRequest>): ReportTaskProgressRequest {
    ...
    message.applyConfigTaskProgress =
      (object.applyConfigTaskProgress !== undefined && object.applyConfigTaskProgress !== null)
        ? ApplyConfigTaskProgress.fromPartial(object.applyConfigTaskProgress)
        : undefined;
    return message;
  },
};
...
function createBaseReportTaskCompleteRequest(): ReportTaskCompleteRequest {
  return {
    ...
    applyConfigTaskOutput: undefined,
  };
}
...
export const ReportTaskCompleteRequest: MessageFns<ReportTaskCompleteRequest> = {
  encode(message: ReportTaskCompleteRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.applyConfigTaskOutput !== undefined) {
      ApplyConfigTaskOutput.encode(message.applyConfigTaskOutput, writer.uint32(58).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.applyConfigTaskOutput = ApplyConfigTaskOutput.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ReportTaskCompleteRequest {
    return {
      ...
      execStepTaskOutput: isSet(object.execStepTaskOutput)
        ...
        : undefined,
      applyConfigTaskOutput: isSet(object.applyConfigTaskOutput)
        ? ApplyConfigTaskOutput.fromJSON(object.applyConfigTaskOutput)
        : undefined,
    };
  },
  ...
  toJSON(message: ReportTaskCompleteRequest): unknown {
    ...
    if (message.applyConfigTaskOutput !== undefined) {
      obj.applyConfigTaskOutput = ApplyConfigTaskOutput.toJSON(message.applyConfigTaskOutput);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ReportTaskCompleteRequest>): ReportTaskCompleteRequest {
    ...
    message.applyConfigTaskOutput =
      (object.applyConfigTaskOutput !== undefined && object.applyConfigTaskOutput !== null)
        ? ApplyConfigTaskOutput.fromPartial(object.applyConfigTaskOutput)
        : undefined;
    return message;
  },
};
...
function createBaseReportInventoryRequest(): ReportInventoryRequest {
  return { instanceIdToken: "", inventoryChecksum: "", inventory: undefined };
}

export const ReportInventoryRequest: MessageFns<ReportInventoryRequest> = {
  encode(message: ReportInventoryRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.instanceIdToken !== "") {
      writer.uint32(10).string(message.instanceIdToken);
    }
    if (message.inventoryChecksum !== "") {
      writer.uint32(18).string(message.inventoryChecksum);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReportInventoryRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseReportInventoryRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.inventoryChecksum = reader.string();
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): ReportInventoryRequest {
    return {
      instanceIdToken: isSet(object.instanceIdToken) ? globalThis.String(object.instanceIdToken) : "",
      inventoryChecksum: isSet(object.inventoryChecksum) ? globalThis.String(object.inventoryChecksum) : "",
      inventory: isSet(object.inventory) ? Inventory.fromJSON(object.inventory) : undefined,
    };
  },

  toJSON(message: ReportInventoryRequest): unknown {
    const obj: any = {};
    if (message.instanceIdToken !== "") {
      obj.instanceIdToken = message.instanceIdToken;
    }
    if (message.inventoryChecksum !== "") {
      obj.inventoryChecksum = message.inventoryChecksum;
    }
    if (message.inventory !== undefined) {
  ...
  create(base?: DeepPartial<ReportInventoryRequest>): ReportInventoryRequest {
    return ReportInventoryRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ReportInventoryRequest>): ReportInventoryRequest {
    const message = createBaseReportInventoryRequest();
    message.instanceIdToken = object.instanceIdToken ?? "";
    message.inventoryChecksum = object.inventoryChecksum ?? "";
...
function createBaseReportInventoryResponse(): ReportInventoryResponse {
  return { reportFullInventory: false };
}

export const ReportInventoryResponse: MessageFns<ReportInventoryResponse> = {
  encode(message: ReportInventoryResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.reportFullInventory !== false) {
      writer.uint32(8).bool(message.reportFullInventory);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ReportInventoryResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseReportInventoryResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.reportFullInventory = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ReportInventoryResponse {
    return {
      reportFullInventory: isSet(object.reportFullInventory) ? globalThis.Boolean(object.reportFullInventory) : false,
    };
  },

  toJSON(message: ReportInventoryResponse): unknown {
    const obj: any = {};
    if (message.reportFullInventory !== false) {
      obj.reportFullInventory = message.reportFullInventory;
    }
    return obj;
  },

  create(base?: DeepPartial<ReportInventoryResponse>): ReportInventoryResponse {
    return ReportInventoryResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ReportInventoryResponse>): ReportInventoryResponse {
    const message = createBaseReportInventoryResponse();
    message.reportFullInventory = object.reportFullInventory ?? false;
    return message;
  },
};
...
export const AgentEndpointServiceDefinition = {
  ...
  methods: {
    ...
    reportInventory: {
      ...
      requestType: ReportInventoryRequest,
      requestStream: false,
      responseType: ReportInventoryResponse,
      responseStream: false,
      options: {
        _unknownFields: {
          8410: [
...
export interface AgentEndpointServiceImplementation<CallContextExt = {}> {
  ...
  /** Reports the VMs current inventory. */
  reportInventory(
    request: ReportInventoryRequest,
    context: CallContext & CallContextExt,
  ): Promise<DeepPartial<ReportInventoryResponse>>;
}
...
export interface AgentEndpointServiceClient<CallOptionsExt = {}> {
  ...
  /** Reports the VMs current inventory. */
  reportInventory(
    request: DeepPartial<ReportInventoryRequest>,
    options?: CallOptions & CallOptionsExt,
