...
export const protobufPackage = "google.cloud.vision.v1";
...
export function faceAnnotation_Landmark_TypeFromJSON(object: any): FaceAnnotation_Landmark_Type {
  switch (object) {
    ...
    case "LEFT_CHEEK_CENTER":
      return FaceAnnotation_Landmark_Type.LEFT_CHEEK_CENTER;
    case 36:
    case "RIGHT_CHEEK_CENTER":
      return FaceAnnotation_Landmark_Type.RIGHT_CHEEK_CENTER;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function faceAnnotation_Landmark_TypeToJSON(object: FaceAnnotation_Landmark_Type): string {
  switch (object) {
    ...
    case FaceAnnotation_Landmark_Type.LEFT_CHEEK_CENTER:
      return "LEFT_CHEEK_CENTER";
    case FaceAnnotation_Landmark_Type.RIGHT_CHEEK_CENTER:
...
export interface BatchAnnotateImagesRequest_LabelsEntry {
  key: string;
  value: string;
}
...
export interface BatchAnnotateFilesRequest_LabelsEntry {
  key: string;
  value: string;
}
...
export interface AsyncBatchAnnotateImagesRequest_LabelsEntry {
  key: string;
  value: string;
}
...
export interface AsyncBatchAnnotateFilesRequest_LabelsEntry {
  key: string;
  value: string;
}
...
export const BatchAnnotateImagesRequest: MessageFns<BatchAnnotateImagesRequest> = {
  encode(message: BatchAnnotateImagesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      BatchAnnotateImagesRequest_LabelsEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          const entry5 = BatchAnnotateImagesRequest_LabelsEntry.decode(reader, reader.uint32());
...
function createBaseBatchAnnotateImagesRequest_LabelsEntry(): BatchAnnotateImagesRequest_LabelsEntry {
  return { key: "", value: "" };
}

export const BatchAnnotateImagesRequest_LabelsEntry: MessageFns<BatchAnnotateImagesRequest_LabelsEntry> = {
  encode(message: BatchAnnotateImagesRequest_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BatchAnnotateImagesRequest_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBatchAnnotateImagesRequest_LabelsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BatchAnnotateImagesRequest_LabelsEntry {
    return {
  ...
  toJSON(message: BatchAnnotateImagesRequest_LabelsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<BatchAnnotateImagesRequest_LabelsEntry>): BatchAnnotateImagesRequest_LabelsEntry {
    return BatchAnnotateImagesRequest_LabelsEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchAnnotateImagesRequest_LabelsEntry>): BatchAnnotateImagesRequest_LabelsEntry {
    const message = createBaseBatchAnnotateImagesRequest_LabelsEntry();
...
export const BatchAnnotateFilesRequest: MessageFns<BatchAnnotateFilesRequest> = {
  encode(message: BatchAnnotateFilesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      BatchAnnotateFilesRequest_LabelsEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          const entry5 = BatchAnnotateFilesRequest_LabelsEntry.decode(reader, reader.uint32());
          if (entry5.value !== undefined) {
            message.labels[entry5.key] = entry5.value;
          }
          continue;
...
function createBaseBatchAnnotateFilesRequest_LabelsEntry(): BatchAnnotateFilesRequest_LabelsEntry {
  return { key: "", value: "" };
}

export const BatchAnnotateFilesRequest_LabelsEntry: MessageFns<BatchAnnotateFilesRequest_LabelsEntry> = {
  encode(message: BatchAnnotateFilesRequest_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BatchAnnotateFilesRequest_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBatchAnnotateFilesRequest_LabelsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BatchAnnotateFilesRequest_LabelsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: BatchAnnotateFilesRequest_LabelsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<BatchAnnotateFilesRequest_LabelsEntry>): BatchAnnotateFilesRequest_LabelsEntry {
    return BatchAnnotateFilesRequest_LabelsEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchAnnotateFilesRequest_LabelsEntry>): BatchAnnotateFilesRequest_LabelsEntry {
    const message = createBaseBatchAnnotateFilesRequest_LabelsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
function createBaseAsyncBatchAnnotateImagesRequest(): AsyncBatchAnnotateImagesRequest {
  return { requests: [], outputConfig: undefined, parent: "", labels: {} };
}
...
export const AsyncBatchAnnotateImagesRequest: MessageFns<AsyncBatchAnnotateImagesRequest> = {
  encode(message: AsyncBatchAnnotateImagesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      AsyncBatchAnnotateImagesRequest_LabelsEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          const entry5 = AsyncBatchAnnotateImagesRequest_LabelsEntry.decode(reader, reader.uint32());
          if (entry5.value !== undefined) {
            message.labels[entry5.key] = entry5.value;
          }
          continue;
...
function createBaseAsyncBatchAnnotateImagesRequest_LabelsEntry(): AsyncBatchAnnotateImagesRequest_LabelsEntry {
  return { key: "", value: "" };
}

export const AsyncBatchAnnotateImagesRequest_LabelsEntry: MessageFns<AsyncBatchAnnotateImagesRequest_LabelsEntry> = {
  encode(
    message: AsyncBatchAnnotateImagesRequest_LabelsEntry,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AsyncBatchAnnotateImagesRequest_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAsyncBatchAnnotateImagesRequest_LabelsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): AsyncBatchAnnotateImagesRequest_LabelsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: AsyncBatchAnnotateImagesRequest_LabelsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<AsyncBatchAnnotateImagesRequest_LabelsEntry>): AsyncBatchAnnotateImagesRequest_LabelsEntry {
    return AsyncBatchAnnotateImagesRequest_LabelsEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<AsyncBatchAnnotateImagesRequest_LabelsEntry>,
  ): AsyncBatchAnnotateImagesRequest_LabelsEntry {
    const message = createBaseAsyncBatchAnnotateImagesRequest_LabelsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
...
export const AsyncBatchAnnotateFilesRequest: MessageFns<AsyncBatchAnnotateFilesRequest> = {
  encode(message: AsyncBatchAnnotateFilesRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      AsyncBatchAnnotateFilesRequest_LabelsEntry.encode({ key: key as any, value }, writer.uint32(42).fork()).join();
    });
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          const entry5 = AsyncBatchAnnotateFilesRequest_LabelsEntry.decode(reader, reader.uint32());
          if (entry5.value !== undefined) {
            message.labels[entry5.key] = entry5.value;
          }
          continue;
...
function createBaseAsyncBatchAnnotateFilesRequest_LabelsEntry(): AsyncBatchAnnotateFilesRequest_LabelsEntry {
  return { key: "", value: "" };
}

export const AsyncBatchAnnotateFilesRequest_LabelsEntry: MessageFns<AsyncBatchAnnotateFilesRequest_LabelsEntry> = {
  encode(message: AsyncBatchAnnotateFilesRequest_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AsyncBatchAnnotateFilesRequest_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAsyncBatchAnnotateFilesRequest_LabelsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): AsyncBatchAnnotateFilesRequest_LabelsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: AsyncBatchAnnotateFilesRequest_LabelsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<AsyncBatchAnnotateFilesRequest_LabelsEntry>): AsyncBatchAnnotateFilesRequest_LabelsEntry {
    return AsyncBatchAnnotateFilesRequest_LabelsEntry.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<AsyncBatchAnnotateFilesRequest_LabelsEntry>,
  ): AsyncBatchAnnotateFilesRequest_LabelsEntry {
    const message = createBaseAsyncBatchAnnotateFilesRequest_LabelsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
