...
import { CreateModelMonitoringJobRequest } from "./model_monitoring_service.js";
...
function createBaseSchedule(): Schedule {
  return {
    ...
    createModelMonitoringJobRequest: undefined,
...
export const Schedule: MessageFns<Schedule> = {
  encode(message: Schedule, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.createModelMonitoringJobRequest !== undefined) {
      CreateModelMonitoringJobRequest.encode(message.createModelMonitoringJobRequest, writer.uint32(122).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 15:
          ...
          message.createModelMonitoringJobRequest = CreateModelMonitoringJobRequest.decode(reader, reader.uint32());
          continue;
        case 20:
          if (tag !== 162) {
            break;
  ...
  fromJSON(object: any): Schedule {
    return {
      ...
      createPipelineJobRequest: isSet(object.createPipelineJobRequest)
        ...
        : undefined,
      createModelMonitoringJobRequest: isSet(object.createModelMonitoringJobRequest)
        ? CreateModelMonitoringJobRequest.fromJSON(object.createModelMonitoringJobRequest)
        : undefined,
  ...
  toJSON(message: Schedule): unknown {
    ...
    if (message.createModelMonitoringJobRequest !== undefined) {
      obj.createModelMonitoringJobRequest = CreateModelMonitoringJobRequest.toJSON(
  ...
  fromPartial(object: DeepPartial<Schedule>): Schedule {
    ...
    message.createPipelineJobRequest =
      (object.createPipelineJobRequest !== undefined && object.createPipelineJobRequest !== null)
        ...
        : undefined;
    message.createModelMonitoringJobRequest =
      (object.createModelMonitoringJobRequest !== undefined && object.createModelMonitoringJobRequest !== null)
        ? CreateModelMonitoringJobRequest.fromPartial(object.createModelMonitoringJobRequest)
        : undefined;
    message.createNotebookExecutionJobRequest =
