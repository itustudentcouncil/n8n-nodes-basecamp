...
export interface VideoObjectTrackingPredictionInstance {
  /**
...
function createBaseVideoObjectTrackingPredictionInstance(): VideoObjectTrackingPredictionInstance {
  return { content: "", mimeType: "", timeSegmentStart: "", timeSegmentEnd: "" };
}

export const VideoObjectTrackingPredictionInstance: MessageFns<VideoObjectTrackingPredictionInstance> = {
  encode(message: VideoObjectTrackingPredictionInstance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.content !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VideoObjectTrackingPredictionInstance {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseVideoObjectTrackingPredictionInstance();
  ...
  fromJSON(object: any): VideoObjectTrackingPredictionInstance {
    return {
  ...
  toJSON(message: VideoObjectTrackingPredictionInstance): unknown {
    const obj: any = {};
    if (message.content !== "") {
  ...
  create(base?: DeepPartial<VideoObjectTrackingPredictionInstance>): VideoObjectTrackingPredictionInstance {
    return VideoObjectTrackingPredictionInstance.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<VideoObjectTrackingPredictionInstance>): VideoObjectTrackingPredictionInstance {
    const message = createBaseVideoObjectTrackingPredictionInstance();
