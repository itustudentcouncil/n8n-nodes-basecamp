...
export interface ImageObjectDetectionPredictionParams {
  /**
...
function createBaseImageObjectDetectionPredictionParams(): ImageObjectDetectionPredictionParams {
  return { confidenceThreshold: 0, maxPredictions: 0 };
}

export const ImageObjectDetectionPredictionParams: MessageFns<ImageObjectDetectionPredictionParams> = {
  encode(message: ImageObjectDetectionPredictionParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ImageObjectDetectionPredictionParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseImageObjectDetectionPredictionParams();
  ...
  fromJSON(object: any): ImageObjectDetectionPredictionParams {
    return {
  ...
  toJSON(message: ImageObjectDetectionPredictionParams): unknown {
    const obj: any = {};
    if (message.confidenceThreshold !== 0) {
  ...
  create(base?: DeepPartial<ImageObjectDetectionPredictionParams>): ImageObjectDetectionPredictionParams {
    return ImageObjectDetectionPredictionParams.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ImageObjectDetectionPredictionParams>): ImageObjectDetectionPredictionParams {
    const message = createBaseImageObjectDetectionPredictionParams();
