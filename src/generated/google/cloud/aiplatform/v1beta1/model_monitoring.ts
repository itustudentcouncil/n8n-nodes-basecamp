...
export interface ModelMonitoringConfig {
   ...
   */
  statsAnomaliesBaseDirectory: GcsDestination | undefined;
}
...
function createBaseModelMonitoringConfig(): ModelMonitoringConfig {
  return {
    objectiveConfigs: [],
...
export const ModelMonitoringConfig: MessageFns<ModelMonitoringConfig> = {
  encode(message: ModelMonitoringConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.objectiveConfigs) {
      ModelMonitoringObjectiveConfig.encode(v!, writer.uint32(26).fork()).join();
    }
    if (message.alertConfig !== undefined) {
      ModelMonitoringAlertConfig.encode(message.alertConfig, writer.uint32(18).fork()).join();
    }
    if (message.analysisInstanceSchemaUri !== "") {
      writer.uint32(34).string(message.analysisInstanceSchemaUri);
    }
    if (message.statsAnomaliesBaseDirectory !== undefined) {
      GcsDestination.encode(message.statsAnomaliesBaseDirectory, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ModelMonitoringConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseModelMonitoringConfig();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 3:
          ...
          message.objectiveConfigs.push(ModelMonitoringObjectiveConfig.decode(reader, reader.uint32()));
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.alertConfig = ModelMonitoringAlertConfig.decode(reader, reader.uint32());
          continue;
        case 4:
          if (tag !== 34) {
            break;
  ...
  fromJSON(object: any): ModelMonitoringConfig {
    return {
      objectiveConfigs: globalThis.Array.isArray(object?.objectiveConfigs)
        ? object.objectiveConfigs.map((e: any) => ModelMonitoringObjectiveConfig.fromJSON(e))
        : [],
      alertConfig: isSet(object.alertConfig) ? ModelMonitoringAlertConfig.fromJSON(object.alertConfig) : undefined,
  ...
  toJSON(message: ModelMonitoringConfig): unknown {
    const obj: any = {};
    if (message.objectiveConfigs?.length) {
      obj.objectiveConfigs = message.objectiveConfigs.map((e) => ModelMonitoringObjectiveConfig.toJSON(e));
    }
    if (message.alertConfig !== undefined) {
      obj.alertConfig = ModelMonitoringAlertConfig.toJSON(message.alertConfig);
    }
    if (message.analysisInstanceSchemaUri !== "") {
  ...
  create(base?: DeepPartial<ModelMonitoringConfig>): ModelMonitoringConfig {
    return ModelMonitoringConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ModelMonitoringConfig>): ModelMonitoringConfig {
    const message = createBaseModelMonitoringConfig();
    message.objectiveConfigs = object.objectiveConfigs?.map((e) => ModelMonitoringObjectiveConfig.fromPartial(e)) || [];
    message.alertConfig = (object.alertConfig !== undefined && object.alertConfig !== null)
      ? ModelMonitoringAlertConfig.fromPartial(object.alertConfig)
      : undefined;
