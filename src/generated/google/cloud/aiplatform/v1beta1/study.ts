 ...
 * @deprecated
 */
export interface StudySpec_ConvexStopConfig {
  /**
   * Steps used in predicting the final objective for early stopped trials. In
   * general, it's set to be the same as the defined steps in training /
 ...
 */
export interface StudySpec_TransferLearningConfig {
  /**
...
function createBaseStudySpec(): StudySpec {
  return {
    ...
    transferLearningConfig: undefined,
...
export const StudySpec: MessageFns<StudySpec> = {
  encode(message: StudySpec, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.convexStopConfig !== undefined) {
      StudySpec_ConvexStopConfig.encode(message.convexStopConfig, writer.uint32(66).fork()).join();
    }
    ...
    if (message.transferLearningConfig !== undefined) {
      StudySpec_TransferLearningConfig.encode(message.transferLearningConfig, writer.uint32(82).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.convexStopConfig = StudySpec_ConvexStopConfig.decode(reader, reader.uint32());
          continue;
        case 9:
          if (tag !== 74) {
            break;
        ...
        case 10:
          ...
          message.transferLearningConfig = StudySpec_TransferLearningConfig.decode(reader, reader.uint32());
          continue;
        case 11:
          if (tag !== 90) {
            break;
  ...
  fromJSON(object: any): StudySpec {
    return {
      ...
      medianAutomatedStoppingSpec: isSet(object.medianAutomatedStoppingSpec)
        ...
        : undefined,
      convexStopConfig: isSet(object.convexStopConfig)
        ? StudySpec_ConvexStopConfig.fromJSON(object.convexStopConfig)
        : undefined,
      ...
      measurementSelectionType: isSet(object.measurementSelectionType)
        ...
        : 0,
      transferLearningConfig: isSet(object.transferLearningConfig)
        ? StudySpec_TransferLearningConfig.fromJSON(object.transferLearningConfig)
        : undefined,
  ...
  toJSON(message: StudySpec): unknown {
    ...
    if (message.convexStopConfig !== undefined) {
      obj.convexStopConfig = StudySpec_ConvexStopConfig.toJSON(message.convexStopConfig);
    }
    if (message.convexAutomatedStoppingSpec !== undefined) {
    ...
    if (message.transferLearningConfig !== undefined) {
      obj.transferLearningConfig = StudySpec_TransferLearningConfig.toJSON(message.transferLearningConfig);
    }
    if (message.studyStoppingConfig !== undefined) {
  ...
  fromPartial(object: DeepPartial<StudySpec>): StudySpec {
    ...
    message.medianAutomatedStoppingSpec =
      (object.medianAutomatedStoppingSpec !== undefined && object.medianAutomatedStoppingSpec !== null)
        ...
        : undefined;
    message.convexStopConfig = (object.convexStopConfig !== undefined && object.convexStopConfig !== null)
      ? StudySpec_ConvexStopConfig.fromPartial(object.convexStopConfig)
      : undefined;
    message.convexAutomatedStoppingSpec =
    ...
    message.transferLearningConfig =
      (object.transferLearningConfig !== undefined && object.transferLearningConfig !== null)
        ? StudySpec_TransferLearningConfig.fromPartial(object.transferLearningConfig)
        : undefined;
...
function createBaseStudySpec_ConvexStopConfig(): StudySpec_ConvexStopConfig {
  return {
    maxNumSteps: Long.ZERO,
    minNumSteps: Long.ZERO,
    autoregressiveOrder: Long.ZERO,
    learningRateParameterName: "",
    useSeconds: false,
  };
}

export const StudySpec_ConvexStopConfig: MessageFns<StudySpec_ConvexStopConfig> = {
  encode(message: StudySpec_ConvexStopConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (!message.maxNumSteps.equals(Long.ZERO)) {
      writer.uint32(8).int64(message.maxNumSteps.toString());
    }
    if (!message.minNumSteps.equals(Long.ZERO)) {
      writer.uint32(16).int64(message.minNumSteps.toString());
    }
    if (!message.autoregressiveOrder.equals(Long.ZERO)) {
      writer.uint32(24).int64(message.autoregressiveOrder.toString());
    }
    if (message.learningRateParameterName !== "") {
      writer.uint32(34).string(message.learningRateParameterName);
    }
    if (message.useSeconds !== false) {
      writer.uint32(40).bool(message.useSeconds);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StudySpec_ConvexStopConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStudySpec_ConvexStopConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.maxNumSteps = Long.fromString(reader.int64().toString());
          continue;
        case 2:
          if (tag !== 16) {
            break;
          ...
          message.minNumSteps = Long.fromString(reader.int64().toString());
          continue;
        case 3:
          if (tag !== 24) {
            break;
          ...
          message.autoregressiveOrder = Long.fromString(reader.int64().toString());
          continue;
        case 4:
          if (tag !== 34) {
            break;
        ...
        case 5:
          ...
          message.useSeconds = reader.bool();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): StudySpec_ConvexStopConfig {
    return {
      maxNumSteps: isSet(object.maxNumSteps) ? Long.fromValue(object.maxNumSteps) : Long.ZERO,
      minNumSteps: isSet(object.minNumSteps) ? Long.fromValue(object.minNumSteps) : Long.ZERO,
      autoregressiveOrder: isSet(object.autoregressiveOrder) ? Long.fromValue(object.autoregressiveOrder) : Long.ZERO,
      learningRateParameterName: isSet(object.learningRateParameterName)
        ? globalThis.String(object.learningRateParameterName)
        : "",
      useSeconds: isSet(object.useSeconds) ? globalThis.Boolean(object.useSeconds) : false,
    };
  },

  toJSON(message: StudySpec_ConvexStopConfig): unknown {
    const obj: any = {};
    if (!message.maxNumSteps.equals(Long.ZERO)) {
      obj.maxNumSteps = (message.maxNumSteps || Long.ZERO).toString();
    }
    if (!message.minNumSteps.equals(Long.ZERO)) {
      obj.minNumSteps = (message.minNumSteps || Long.ZERO).toString();
    }
    if (!message.autoregressiveOrder.equals(Long.ZERO)) {
      obj.autoregressiveOrder = (message.autoregressiveOrder || Long.ZERO).toString();
    }
    if (message.learningRateParameterName !== "") {
      obj.learningRateParameterName = message.learningRateParameterName;
    }
    if (message.useSeconds !== false) {
      obj.useSeconds = message.useSeconds;
    }
    return obj;
  },

  create(base?: DeepPartial<StudySpec_ConvexStopConfig>): StudySpec_ConvexStopConfig {
    return StudySpec_ConvexStopConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<StudySpec_ConvexStopConfig>): StudySpec_ConvexStopConfig {
    const message = createBaseStudySpec_ConvexStopConfig();
    message.maxNumSteps = (object.maxNumSteps !== undefined && object.maxNumSteps !== null)
      ? Long.fromValue(object.maxNumSteps)
      : Long.ZERO;
    message.minNumSteps = (object.minNumSteps !== undefined && object.minNumSteps !== null)
      ? Long.fromValue(object.minNumSteps)
      : Long.ZERO;
    message.autoregressiveOrder = (object.autoregressiveOrder !== undefined && object.autoregressiveOrder !== null)
      ? Long.fromValue(object.autoregressiveOrder)
      : Long.ZERO;
    message.learningRateParameterName = object.learningRateParameterName ?? "";
    message.useSeconds = object.useSeconds ?? false;
    return message;
  },
};

function createBaseStudySpec_TransferLearningConfig(): StudySpec_TransferLearningConfig {
  return { disableTransferLearning: false, priorStudyNames: [] };
}

export const StudySpec_TransferLearningConfig: MessageFns<StudySpec_TransferLearningConfig> = {
  encode(message: StudySpec_TransferLearningConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.disableTransferLearning !== false) {
      writer.uint32(8).bool(message.disableTransferLearning);
    }
    for (const v of message.priorStudyNames) {
      writer.uint32(18).string(v!);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StudySpec_TransferLearningConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStudySpec_TransferLearningConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.disableTransferLearning = reader.bool();
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.priorStudyNames.push(reader.string());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): StudySpec_TransferLearningConfig {
    return {
      disableTransferLearning: isSet(object.disableTransferLearning)
        ? globalThis.Boolean(object.disableTransferLearning)
        : false,
      priorStudyNames: globalThis.Array.isArray(object?.priorStudyNames)
        ? object.priorStudyNames.map((e: any) => globalThis.String(e))
        : [],
    };
  },

  toJSON(message: StudySpec_TransferLearningConfig): unknown {
    const obj: any = {};
    if (message.disableTransferLearning !== false) {
      obj.disableTransferLearning = message.disableTransferLearning;
    }
    if (message.priorStudyNames?.length) {
      obj.priorStudyNames = message.priorStudyNames;
    }
    return obj;
  },

  create(base?: DeepPartial<StudySpec_TransferLearningConfig>): StudySpec_TransferLearningConfig {
    return StudySpec_TransferLearningConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<StudySpec_TransferLearningConfig>): StudySpec_TransferLearningConfig {
    const message = createBaseStudySpec_TransferLearningConfig();
    message.disableTransferLearning = object.disableTransferLearning ?? false;
    message.priorStudyNames = object.priorStudyNames?.map((e) => e) || [];
    return message;
  },
};
