...
import { ModelMonitoringStatsAnomalies } from "./model_deployment_monitoring_job.js";
import { ModelMonitoringConfig } from "./model_monitoring.js";
...
function createBaseBatchPredictionJob(): BatchPredictionJob {
  return {
    ...
    modelMonitoringConfig: undefined,
    modelMonitoringStatsAnomalies: [],
    modelMonitoringStatus: undefined,
...
export const BatchPredictionJob: MessageFns<BatchPredictionJob> = {
  encode(message: BatchPredictionJob, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.modelMonitoringConfig !== undefined) {
      ModelMonitoringConfig.encode(message.modelMonitoringConfig, writer.uint32(210).fork()).join();
    }
    for (const v of message.modelMonitoringStatsAnomalies) {
      ModelMonitoringStatsAnomalies.encode(v!, writer.uint32(250).fork()).join();
    }
    if (message.modelMonitoringStatus !== undefined) {
      Status.encode(message.modelMonitoringStatus, writer.uint32(258).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 26:
          ...
          message.modelMonitoringConfig = ModelMonitoringConfig.decode(reader, reader.uint32());
          continue;
        case 31:
          if (tag !== 250) {
            break;
          ...
          message.modelMonitoringStatsAnomalies.push(ModelMonitoringStatsAnomalies.decode(reader, reader.uint32()));
          continue;
        case 32:
          if (tag !== 258) {
            break;
          ...
          message.modelMonitoringStatus = Status.decode(reader, reader.uint32());
          continue;
        case 34:
          if (tag !== 272) {
            break;
  ...
  fromJSON(object: any): BatchPredictionJob {
    return {
      ...
      modelMonitoringConfig: isSet(object.modelMonitoringConfig)
        ? ModelMonitoringConfig.fromJSON(object.modelMonitoringConfig)
        : undefined,
      modelMonitoringStatsAnomalies: globalThis.Array.isArray(object?.modelMonitoringStatsAnomalies)
        ? object.modelMonitoringStatsAnomalies.map((e: any) => ModelMonitoringStatsAnomalies.fromJSON(e))
        : [],
      modelMonitoringStatus: isSet(object.modelMonitoringStatus)
        ? Status.fromJSON(object.modelMonitoringStatus)
        : undefined,
  ...
  toJSON(message: BatchPredictionJob): unknown {
    ...
    if (message.modelMonitoringConfig !== undefined) {
      obj.modelMonitoringConfig = ModelMonitoringConfig.toJSON(message.modelMonitoringConfig);
    }
    if (message.modelMonitoringStatsAnomalies?.length) {
      obj.modelMonitoringStatsAnomalies = message.modelMonitoringStatsAnomalies.map((e) =>
        ModelMonitoringStatsAnomalies.toJSON(e)
      );
    }
    if (message.modelMonitoringStatus !== undefined) {
      obj.modelMonitoringStatus = Status.toJSON(message.modelMonitoringStatus);
    }
    if (message.disableContainerLogging !== false) {
  ...
  fromPartial(object: DeepPartial<BatchPredictionJob>): BatchPredictionJob {
    ...
    message.modelMonitoringConfig =
      (object.modelMonitoringConfig !== undefined && object.modelMonitoringConfig !== null)
        ? ModelMonitoringConfig.fromPartial(object.modelMonitoringConfig)
        : undefined;
    message.modelMonitoringStatsAnomalies =
      object.modelMonitoringStatsAnomalies?.map((e) => ModelMonitoringStatsAnomalies.fromPartial(e)) || [];
    message.modelMonitoringStatus =
      (object.modelMonitoringStatus !== undefined && object.modelMonitoringStatus !== null)
        ? Status.fromPartial(object.modelMonitoringStatus)
        : undefined;
