 ...
 * @deprecated
 */
export interface FeatureOnlineStore_EmbeddingManagement {
  /**
...
export const FeatureOnlineStore: MessageFns<FeatureOnlineStore> = {
  encode(message: FeatureOnlineStore, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.embeddingManagement !== undefined) {
      FeatureOnlineStore_EmbeddingManagement.encode(message.embeddingManagement, writer.uint32(90).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.embeddingManagement = FeatureOnlineStore_EmbeddingManagement.decode(reader, reader.uint32());
          continue;
        case 13:
          if (tag !== 106) {
            break;
  ...
  fromJSON(object: any): FeatureOnlineStore {
    return {
      ...
      dedicatedServingEndpoint: isSet(object.dedicatedServingEndpoint)
        ...
        : undefined,
      embeddingManagement: isSet(object.embeddingManagement)
        ? FeatureOnlineStore_EmbeddingManagement.fromJSON(object.embeddingManagement)
        : undefined,
  ...
  toJSON(message: FeatureOnlineStore): unknown {
    ...
    if (message.embeddingManagement !== undefined) {
      obj.embeddingManagement = FeatureOnlineStore_EmbeddingManagement.toJSON(message.embeddingManagement);
    }
    if (message.encryptionSpec !== undefined) {
  ...
  fromPartial(object: DeepPartial<FeatureOnlineStore>): FeatureOnlineStore {
    ...
    message.dedicatedServingEndpoint =
      (object.dedicatedServingEndpoint !== undefined && object.dedicatedServingEndpoint !== null)
        ...
        : undefined;
    message.embeddingManagement = (object.embeddingManagement !== undefined && object.embeddingManagement !== null)
      ? FeatureOnlineStore_EmbeddingManagement.fromPartial(object.embeddingManagement)
      : undefined;
...
function createBaseFeatureOnlineStore_EmbeddingManagement(): FeatureOnlineStore_EmbeddingManagement {
  return { enabled: false };
}

export const FeatureOnlineStore_EmbeddingManagement: MessageFns<FeatureOnlineStore_EmbeddingManagement> = {
  encode(message: FeatureOnlineStore_EmbeddingManagement, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FeatureOnlineStore_EmbeddingManagement {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFeatureOnlineStore_EmbeddingManagement();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): FeatureOnlineStore_EmbeddingManagement {
    return { enabled: isSet(object.enabled) ? globalThis.Boolean(object.enabled) : false };
  },

  toJSON(message: FeatureOnlineStore_EmbeddingManagement): unknown {
    const obj: any = {};
    if (message.enabled !== false) {
  ...
  create(base?: DeepPartial<FeatureOnlineStore_EmbeddingManagement>): FeatureOnlineStore_EmbeddingManagement {
    return FeatureOnlineStore_EmbeddingManagement.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<FeatureOnlineStore_EmbeddingManagement>): FeatureOnlineStore_EmbeddingManagement {
    const message = createBaseFeatureOnlineStore_EmbeddingManagement();
