...
export interface VideoClassificationPredictionInstance {
  /**
...
function createBaseVideoClassificationPredictionInstance(): VideoClassificationPredictionInstance {
  return { content: "", mimeType: "", timeSegmentStart: "", timeSegmentEnd: "" };
}

export const VideoClassificationPredictionInstance: MessageFns<VideoClassificationPredictionInstance> = {
  encode(message: VideoClassificationPredictionInstance, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.content !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): VideoClassificationPredictionInstance {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseVideoClassificationPredictionInstance();
  ...
  fromJSON(object: any): VideoClassificationPredictionInstance {
    return {
  ...
  toJSON(message: VideoClassificationPredictionInstance): unknown {
    const obj: any = {};
    if (message.content !== "") {
  ...
  create(base?: DeepPartial<VideoClassificationPredictionInstance>): VideoClassificationPredictionInstance {
    return VideoClassificationPredictionInstance.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<VideoClassificationPredictionInstance>): VideoClassificationPredictionInstance {
    const message = createBaseVideoClassificationPredictionInstance();
