...
function createBaseAttestor(): Attestor {
  return { name: "", description: "", userOwnedDrydockNote: undefined, updateTime: undefined };
}
...
export const Attestor: MessageFns<Attestor> = {
  encode(message: Attestor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.userOwnedDrydockNote !== undefined) {
      UserOwnedDrydockNote.encode(message.userOwnedDrydockNote, writer.uint32(26).fork()).join();
    }
    if (message.updateTime !== undefined) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.userOwnedDrydockNote = UserOwnedDrydockNote.decode(reader, reader.uint32());
          continue;
        case 4:
          if (tag !== 34) {
            break;
  ...
  fromJSON(object: any): Attestor {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      description: isSet(object.description) ? globalThis.String(object.description) : "",
      userOwnedDrydockNote: isSet(object.userOwnedDrydockNote)
        ? UserOwnedDrydockNote.fromJSON(object.userOwnedDrydockNote)
        : undefined,
      updateTime: isSet(object.updateTime) ? fromJsonTimestamp(object.updateTime) : undefined,
    };
  },
  ...
  toJSON(message: Attestor): unknown {
    ...
    if (message.userOwnedDrydockNote !== undefined) {
      obj.userOwnedDrydockNote = UserOwnedDrydockNote.toJSON(message.userOwnedDrydockNote);
    }
    if (message.updateTime !== undefined) {
      obj.updateTime = message.updateTime.toISOString();
    }
  ...
  fromPartial(object: DeepPartial<Attestor>): Attestor {
    ...
    message.name = object.name ?? "";
    message.description = object.description ?? "";
    message.userOwnedDrydockNote = (object.userOwnedDrydockNote !== undefined && object.userOwnedDrydockNote !== null)
      ? UserOwnedDrydockNote.fromPartial(object.userOwnedDrydockNote)
      : undefined;
    message.updateTime = object.updateTime ?? undefined;
    return message;
  },
...
function createBaseUserOwnedDrydockNote(): UserOwnedDrydockNote {
  return { noteReference: "", publicKeys: [], delegationServiceAccountEmail: "" };
}

export const UserOwnedDrydockNote: MessageFns<UserOwnedDrydockNote> = {
  encode(message: UserOwnedDrydockNote, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): UserOwnedDrydockNote {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUserOwnedDrydockNote();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): UserOwnedDrydockNote {
    return {
  ...
  toJSON(message: UserOwnedDrydockNote): unknown {
    const obj: any = {};
    if (message.noteReference !== "") {
  ...
  create(base?: DeepPartial<UserOwnedDrydockNote>): UserOwnedDrydockNote {
    return UserOwnedDrydockNote.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<UserOwnedDrydockNote>): UserOwnedDrydockNote {
    const message = createBaseUserOwnedDrydockNote();
