...
export interface CostProjection {
  ...
  costInLocalCurrency: Money | undefined;
}
...
export enum ReliabilityProjection_RiskType {
  ...
  DATA_LOSS = 2,
  /**
   * ACCESS_DENY - Potential access denial. The service is still up but some or all clients
   * can't access it.
   */
  ACCESS_DENY = 3,
  UNRECOGNIZED = -1,
...
export function reliabilityProjection_RiskTypeFromJSON(object: any): ReliabilityProjection_RiskType {
  switch (object) {
    case 0:
    case "RISK_TYPE_UNSPECIFIED":
      return ReliabilityProjection_RiskType.RISK_TYPE_UNSPECIFIED;
    case 1:
    case "SERVICE_DISRUPTION":
      return ReliabilityProjection_RiskType.SERVICE_DISRUPTION;
    case 2:
    case "DATA_LOSS":
      return ReliabilityProjection_RiskType.DATA_LOSS;
    case 3:
    case "ACCESS_DENY":
      return ReliabilityProjection_RiskType.ACCESS_DENY;
    case -1:
    case "UNRECOGNIZED":
    default:
      return ReliabilityProjection_RiskType.UNRECOGNIZED;
  }
}

export function reliabilityProjection_RiskTypeToJSON(object: ReliabilityProjection_RiskType): string {
  switch (object) {
    case ReliabilityProjection_RiskType.RISK_TYPE_UNSPECIFIED:
      return "RISK_TYPE_UNSPECIFIED";
    case ReliabilityProjection_RiskType.SERVICE_DISRUPTION:
      return "SERVICE_DISRUPTION";
    case ReliabilityProjection_RiskType.DATA_LOSS:
      return "DATA_LOSS";
    case ReliabilityProjection_RiskType.ACCESS_DENY:
      return "ACCESS_DENY";
    case ReliabilityProjection_RiskType.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface Impact {
  ...
  reliabilityProjection?: ReliabilityProjection | undefined;
}
...
export function impact_CategoryFromJSON(object: any): Impact_Category {
  switch (object) {
    ...
    case 6:
    case "RELIABILITY":
      return Impact_Category.RELIABILITY;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function impact_CategoryToJSON(object: Impact_Category): string {
  switch (object) {
    ...
    case Impact_Category.RELIABILITY:
      return "RELIABILITY";
...
function createBaseCostProjection(): CostProjection {
  return { cost: undefined, duration: undefined, costInLocalCurrency: undefined };
}
...
export const CostProjection: MessageFns<CostProjection> = {
  encode(message: CostProjection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.costInLocalCurrency !== undefined) {
      Money.encode(message.costInLocalCurrency, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.costInLocalCurrency = Money.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CostProjection {
    return {
      ...
      costInLocalCurrency: isSet(object.costInLocalCurrency) ? Money.fromJSON(object.costInLocalCurrency) : undefined,
    };
  },
  ...
  toJSON(message: CostProjection): unknown {
    ...
    if (message.costInLocalCurrency !== undefined) {
      obj.costInLocalCurrency = Money.toJSON(message.costInLocalCurrency);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<CostProjection>): CostProjection {
    ...
    message.duration = (object.duration !== undefined && object.duration !== null)
      ...
      : undefined;
    message.costInLocalCurrency = (object.costInLocalCurrency !== undefined && object.costInLocalCurrency !== null)
      ? Money.fromPartial(object.costInLocalCurrency)
      : undefined;
    return message;
  },
};
...
function createBaseReliabilityProjection(): ReliabilityProjection {
  return { risks: [], details: undefined };
}

export const ReliabilityProjection: MessageFns<ReliabilityProjection> = {
  encode(message: ReliabilityProjection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReliabilityProjection {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseReliabilityProjection();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          if (tag === 8) {
            message.risks.push(reader.int32() as any);
  ...
  fromJSON(object: any): ReliabilityProjection {
    return {
      risks: globalThis.Array.isArray(object?.risks)
        ? object.risks.map((e: any) => reliabilityProjection_RiskTypeFromJSON(e))
        : [],
      details: isObject(object.details) ? object.details : undefined,
    };
  },

  toJSON(message: ReliabilityProjection): unknown {
    const obj: any = {};
    if (message.risks?.length) {
      obj.risks = message.risks.map((e) => reliabilityProjection_RiskTypeToJSON(e));
    }
    if (message.details !== undefined) {
      obj.details = message.details;
    }
  ...
  create(base?: DeepPartial<ReliabilityProjection>): ReliabilityProjection {
    return ReliabilityProjection.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ReliabilityProjection>): ReliabilityProjection {
    const message = createBaseReliabilityProjection();
    message.risks = object.risks?.map((e) => e) || [];
    message.details = object.details ?? undefined;
    return message;
  },
};
...
function createBaseImpact(): Impact {
  return {
    category: 0,
    costProjection: undefined,
    securityProjection: undefined,
    sustainabilityProjection: undefined,
    reliabilityProjection: undefined,
  };
}
...
export const Impact: MessageFns<Impact> = {
  encode(message: Impact, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.reliabilityProjection !== undefined) {
      ReliabilityProjection.encode(message.reliabilityProjection, writer.uint32(826).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 103:
          ...
          message.reliabilityProjection = ReliabilityProjection.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Impact {
    return {
      ...
      sustainabilityProjection: isSet(object.sustainabilityProjection)
        ...
        : undefined,
      reliabilityProjection: isSet(object.reliabilityProjection)
        ? ReliabilityProjection.fromJSON(object.reliabilityProjection)
        : undefined,
    };
  },
  ...
  toJSON(message: Impact): unknown {
    ...
    if (message.reliabilityProjection !== undefined) {
      obj.reliabilityProjection = ReliabilityProjection.toJSON(message.reliabilityProjection);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<Impact>): Impact {
    ...
    message.reliabilityProjection =
      (object.reliabilityProjection !== undefined && object.reliabilityProjection !== null)
        ? ReliabilityProjection.fromPartial(object.reliabilityProjection)
        : undefined;
    return message;
  },
};
