...
export const protobufPackage = "google.cloud.metastore.v1alpha";
...
export interface MetadataIntegration {
  ...
  dataplexConfig: DataplexConfig | undefined;
}
...
export interface DataplexConfig_LakeResourcesEntry {
  key: string;
  value: Lake | undefined;
}
...
export const Service: MessageFns<Service> = {
  encode(message: Service, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.metadataIntegration !== undefined) {
      MetadataIntegration.encode(message.metadataIntegration, writer.uint32(114).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14:
          ...
          message.metadataIntegration = MetadataIntegration.decode(reader, reader.uint32());
          continue;
        case 15:
          if (tag !== 122) {
            break;
  ...
  fromJSON(object: any): Service {
    return {
      ...
      metadataIntegration: isSet(object.metadataIntegration)
        ? MetadataIntegration.fromJSON(object.metadataIntegration)
        : undefined,
  ...
  toJSON(message: Service): unknown {
    ...
    if (message.metadataIntegration !== undefined) {
      obj.metadataIntegration = MetadataIntegration.toJSON(message.metadataIntegration);
    }
    if (message.maintenanceWindow !== undefined) {
  ...
  fromPartial(object: DeepPartial<Service>): Service {
    ...
    message.metadataIntegration = (object.metadataIntegration !== undefined && object.metadataIntegration !== null)
      ? MetadataIntegration.fromPartial(object.metadataIntegration)
      : undefined;
...
function createBaseMetadataIntegration(): MetadataIntegration {
  return { dataCatalogConfig: undefined, dataplexConfig: undefined };
}

export const MetadataIntegration: MessageFns<MetadataIntegration> = {
  encode(message: MetadataIntegration, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dataCatalogConfig !== undefined) {
      DataCatalogConfig.encode(message.dataCatalogConfig, writer.uint32(10).fork()).join();
    }
    if (message.dataplexConfig !== undefined) {
      DataplexConfig.encode(message.dataplexConfig, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MetadataIntegration {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMetadataIntegration();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          message.dataCatalogConfig = DataCatalogConfig.decode(reader, reader.uint32());
          continue;
        case 2:
          if (tag !== 18) {
            break;
          ...
          message.dataplexConfig = DataplexConfig.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): MetadataIntegration {
    return {
      dataCatalogConfig: isSet(object.dataCatalogConfig)
        ? DataCatalogConfig.fromJSON(object.dataCatalogConfig)
        : undefined,
      dataplexConfig: isSet(object.dataplexConfig) ? DataplexConfig.fromJSON(object.dataplexConfig) : undefined,
    };
  },

  toJSON(message: MetadataIntegration): unknown {
    const obj: any = {};
    if (message.dataCatalogConfig !== undefined) {
      obj.dataCatalogConfig = DataCatalogConfig.toJSON(message.dataCatalogConfig);
    }
    if (message.dataplexConfig !== undefined) {
      obj.dataplexConfig = DataplexConfig.toJSON(message.dataplexConfig);
    }
    return obj;
  },

  create(base?: DeepPartial<MetadataIntegration>): MetadataIntegration {
    return MetadataIntegration.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<MetadataIntegration>): MetadataIntegration {
    const message = createBaseMetadataIntegration();
    message.dataCatalogConfig = (object.dataCatalogConfig !== undefined && object.dataCatalogConfig !== null)
      ? DataCatalogConfig.fromPartial(object.dataCatalogConfig)
      : undefined;
    message.dataplexConfig = (object.dataplexConfig !== undefined && object.dataplexConfig !== null)
      ? DataplexConfig.fromPartial(object.dataplexConfig)
      : undefined;
    return message;
  },
};

function createBaseDataCatalogConfig(): DataCatalogConfig {
  return { enabled: false };
}

export const DataCatalogConfig: MessageFns<DataCatalogConfig> = {
  encode(message: DataCatalogConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DataCatalogConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDataCatalogConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
  ...
  fromJSON(object: any): DataCatalogConfig {
    return { enabled: isSet(object.enabled) ? globalThis.Boolean(object.enabled) : false };
  },

  toJSON(message: DataCatalogConfig): unknown {
    const obj: any = {};
    if (message.enabled !== false) {
  ...
  create(base?: DeepPartial<DataCatalogConfig>): DataCatalogConfig {
    return DataCatalogConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DataCatalogConfig>): DataCatalogConfig {
    const message = createBaseDataCatalogConfig();
...
function createBaseDataplexConfig(): DataplexConfig {
  return { lakeResources: {} };
}

export const DataplexConfig: MessageFns<DataplexConfig> = {
  encode(message: DataplexConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    Object.entries(message.lakeResources).forEach(([key, value]) => {
      DataplexConfig_LakeResourcesEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DataplexConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDataplexConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          const entry1 = DataplexConfig_LakeResourcesEntry.decode(reader, reader.uint32());
          if (entry1.value !== undefined) {
            message.lakeResources[entry1.key] = entry1.value;
          }
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DataplexConfig {
    return {
      lakeResources: isObject(object.lakeResources)
        ? Object.entries(object.lakeResources).reduce<{ [key: string]: Lake }>((acc, [key, value]) => {
          acc[key] = Lake.fromJSON(value);
          return acc;
        }, {})
        : {},
    };
  ...
  toJSON(message: DataplexConfig): unknown {
    const obj: any = {};
    if (message.lakeResources) {
      const entries = Object.entries(message.lakeResources);
      if (entries.length > 0) {
        obj.lakeResources = {};
        entries.forEach(([k, v]) => {
          obj.lakeResources[k] = Lake.toJSON(v);
        });
      }
    }
    return obj;
  ...
  create(base?: DeepPartial<DataplexConfig>): DataplexConfig {
    return DataplexConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DataplexConfig>): DataplexConfig {
    const message = createBaseDataplexConfig();
    message.lakeResources = Object.entries(object.lakeResources ?? {}).reduce<{ [key: string]: Lake }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = Lake.fromPartial(value);
        }
        return acc;
      },
      {},
...
function createBaseDataplexConfig_LakeResourcesEntry(): DataplexConfig_LakeResourcesEntry {
  return { key: "", value: undefined };
}

export const DataplexConfig_LakeResourcesEntry: MessageFns<DataplexConfig_LakeResourcesEntry> = {
  encode(message: DataplexConfig_LakeResourcesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      Lake.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DataplexConfig_LakeResourcesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDataplexConfig_LakeResourcesEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
        ...
        case 2:
          ...
          message.value = Lake.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DataplexConfig_LakeResourcesEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? Lake.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: DataplexConfig_LakeResourcesEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
    if (message.value !== undefined) {
      obj.value = Lake.toJSON(message.value);
    }
    return obj;
  },

  create(base?: DeepPartial<DataplexConfig_LakeResourcesEntry>): DataplexConfig_LakeResourcesEntry {
    return DataplexConfig_LakeResourcesEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<DataplexConfig_LakeResourcesEntry>): DataplexConfig_LakeResourcesEntry {
    const message = createBaseDataplexConfig_LakeResourcesEntry();
    message.key = object.key ?? "";
    message.value = (object.value !== undefined && object.value !== null) ? Lake.fromPartial(object.value) : undefined;
    return message;
  },
};
...
function createBaseNetworkConfig(): NetworkConfig {
  return { consumers: [], customRoutesEnabled: false };
}
...
export const NetworkConfig: MessageFns<NetworkConfig> = {
  encode(message: NetworkConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.customRoutesEnabled !== false) {
      writer.uint32(16).bool(message.customRoutesEnabled);
    }
    return writer;
  },
  ...
  fromJSON(object: any): NetworkConfig {
    return {
      consumers: globalThis.Array.isArray(object?.consumers)
        ...
        : [],
      customRoutesEnabled: isSet(object.customRoutesEnabled) ? globalThis.Boolean(object.customRoutesEnabled) : false,
    };
  },
  ...
  toJSON(message: NetworkConfig): unknown {
    ...
    if (message.customRoutesEnabled !== false) {
      obj.customRoutesEnabled = message.customRoutesEnabled;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<NetworkConfig>): NetworkConfig {
    ...
    message.customRoutesEnabled = object.customRoutesEnabled ?? false;
    return message;
  },
};
...
function createBaseRemoveIamPolicyRequest(): RemoveIamPolicyRequest {
  return { resource: "", asynchronous: false };
}
...
export const RemoveIamPolicyRequest: MessageFns<RemoveIamPolicyRequest> = {
  encode(message: RemoveIamPolicyRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.asynchronous !== false) {
      writer.uint32(16).bool(message.asynchronous);
    }
    return writer;
  },
  ...
  fromJSON(object: any): RemoveIamPolicyRequest {
    return {
      ...
      asynchronous: isSet(object.asynchronous) ? globalThis.Boolean(object.asynchronous) : false,
    };
  },
  ...
  toJSON(message: RemoveIamPolicyRequest): unknown {
    ...
    if (message.asynchronous !== false) {
      obj.asynchronous = message.asynchronous;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<RemoveIamPolicyRequest>): RemoveIamPolicyRequest {
    ...
    message.asynchronous = object.asynchronous ?? false;
    return message;
  },
};
...
export const RemoveIamPolicyResponse: MessageFns<RemoveIamPolicyResponse> = {
  encode(message: RemoveIamPolicyResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  fromJSON(object: any): RemoveIamPolicyResponse {
    return { success: isSet(object.success) ? globalThis.Boolean(object.success) : false };
  },

  toJSON(message: RemoveIamPolicyResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
  ...
  fromPartial(object: DeepPartial<RemoveIamPolicyResponse>): RemoveIamPolicyResponse {
    const message = createBaseRemoveIamPolicyResponse();
