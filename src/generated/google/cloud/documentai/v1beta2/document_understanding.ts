...
export interface ProcessDocumentRequest {
   ...
   */
  automlParams: AutoMlParams | undefined;
}
...
export const ProcessDocumentRequest: MessageFns<ProcessDocumentRequest> = {
  encode(message: ProcessDocumentRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.automlParams !== undefined) {
      AutoMlParams.encode(message.automlParams, writer.uint32(66).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.automlParams = AutoMlParams.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ProcessDocumentRequest {
    return {
      ...
      automlParams: isSet(object.automlParams) ? AutoMlParams.fromJSON(object.automlParams) : undefined,
    };
  },
  ...
  toJSON(message: ProcessDocumentRequest): unknown {
    ...
    if (message.automlParams !== undefined) {
      obj.automlParams = AutoMlParams.toJSON(message.automlParams);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ProcessDocumentRequest>): ProcessDocumentRequest {
    ...
    message.ocrParams = (object.ocrParams !== undefined && object.ocrParams !== null)
      ...
      : undefined;
    message.automlParams = (object.automlParams !== undefined && object.automlParams !== null)
      ? AutoMlParams.fromPartial(object.automlParams)
      : undefined;
    return message;
  },
};
...
function createBaseAutoMlParams(): AutoMlParams {
  return { model: "" };
}

export const AutoMlParams: MessageFns<AutoMlParams> = {
  encode(message: AutoMlParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.model !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AutoMlParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAutoMlParams();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): AutoMlParams {
    return { model: isSet(object.model) ? globalThis.String(object.model) : "" };
  },

  toJSON(message: AutoMlParams): unknown {
    const obj: any = {};
    if (message.model !== "") {
  ...
  create(base?: DeepPartial<AutoMlParams>): AutoMlParams {
    return AutoMlParams.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<AutoMlParams>): AutoMlParams {
    const message = createBaseAutoMlParams();
...
function createBaseInputConfig(): InputConfig {
  return { gcsSource: undefined, contents: undefined, mimeType: "" };
}
...
export const InputConfig: MessageFns<InputConfig> = {
  ...
  fromJSON(object: any): InputConfig {
    return {
      ...
      contents: isSet(object.contents) ? Buffer.from(bytesFromBase64(object.contents)) : undefined,
...
export const DocumentUnderstandingServiceDefinition = {
  ...
  methods: {
    ...
    processDocument: {
      ...
      requestType: ProcessDocumentRequest,
      requestStream: false,
...
export interface DocumentUnderstandingServiceClient<CallOptionsExt = {}> {
  ...
  /** Processes a single document. */
  processDocument(
    request: DeepPartial<ProcessDocumentRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Document>;
}
