...
export function summaryOptions_LengthFromJSON(object: any): SummaryOptions_Length {
  switch (object) {
    case 0:
    case "LENGTH_UNSPECIFIED":
      return SummaryOptions_Length.LENGTH_UNSPECIFIED;
    case 1:
    case "BRIEF":
      return SummaryOptions_Length.BRIEF;
    case 2:
    case "MODERATE":
      return SummaryOptions_Length.MODERATE;
    case 3:
    case "COMPREHENSIVE":
      return SummaryOptions_Length.COMPREHENSIVE;
    case -1:
    case "UNRECOGNIZED":
    default:
      return SummaryOptions_Length.UNRECOGNIZED;
  }
}

export function summaryOptions_LengthToJSON(object: SummaryOptions_Length): string {
  switch (object) {
    case SummaryOptions_Length.LENGTH_UNSPECIFIED:
      return "LENGTH_UNSPECIFIED";
    case SummaryOptions_Length.BRIEF:
      return "BRIEF";
    case SummaryOptions_Length.MODERATE:
      return "MODERATE";
    case SummaryOptions_Length.COMPREHENSIVE:
      return "COMPREHENSIVE";
    case SummaryOptions_Length.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function summaryOptions_FormatFromJSON(object: any): SummaryOptions_Format {
  switch (object) {
    case 0:
    case "FORMAT_UNSPECIFIED":
      return SummaryOptions_Format.FORMAT_UNSPECIFIED;
    case 1:
    case "PARAGRAPH":
      return SummaryOptions_Format.PARAGRAPH;
    case 2:
    case "BULLETS":
      return SummaryOptions_Format.BULLETS;
    case -1:
    case "UNRECOGNIZED":
    default:
      return SummaryOptions_Format.UNRECOGNIZED;
  }
}

export function summaryOptions_FormatToJSON(object: SummaryOptions_Format): string {
  switch (object) {
    case SummaryOptions_Format.FORMAT_UNSPECIFIED:
      return "FORMAT_UNSPECIFIED";
    case SummaryOptions_Format.PARAGRAPH:
      return "PARAGRAPH";
    case SummaryOptions_Format.BULLETS:
      return "BULLETS";
    case SummaryOptions_Format.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export interface PropertyMetadata {
  ...
  fieldExtractionMetadata: FieldExtractionMetadata | undefined;
}
...
export interface DocumentSchema_EntityType {
  ...
  entityTypeMetadata: EntityTypeMetadata | undefined;
}
...
function createBaseSummaryOptions(): SummaryOptions {
  return { length: 0, format: 0 };
}

export const SummaryOptions: MessageFns<SummaryOptions> = {
  encode(message: SummaryOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.length !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SummaryOptions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSummaryOptions();
  ...
  fromJSON(object: any): SummaryOptions {
    return {
      length: isSet(object.length) ? summaryOptions_LengthFromJSON(object.length) : 0,
      format: isSet(object.format) ? summaryOptions_FormatFromJSON(object.format) : 0,
    };
  },

  toJSON(message: SummaryOptions): unknown {
    const obj: any = {};
    if (message.length !== 0) {
      obj.length = summaryOptions_LengthToJSON(message.length);
    }
    if (message.format !== 0) {
      obj.format = summaryOptions_FormatToJSON(message.format);
    }
    return obj;
  },

  create(base?: DeepPartial<SummaryOptions>): SummaryOptions {
    return SummaryOptions.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<SummaryOptions>): SummaryOptions {
    const message = createBaseSummaryOptions();
...
function createBaseFieldExtractionMetadata(): FieldExtractionMetadata {
  return { summaryOptions: undefined };
}

export const FieldExtractionMetadata: MessageFns<FieldExtractionMetadata> = {
  encode(message: FieldExtractionMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.summaryOptions !== undefined) {
      SummaryOptions.encode(message.summaryOptions, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FieldExtractionMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFieldExtractionMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
          ...
          message.summaryOptions = SummaryOptions.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): FieldExtractionMetadata {
    return {
      summaryOptions: isSet(object.summaryOptions) ? SummaryOptions.fromJSON(object.summaryOptions) : undefined,
    };
  },

  toJSON(message: FieldExtractionMetadata): unknown {
    const obj: any = {};
    if (message.summaryOptions !== undefined) {
      obj.summaryOptions = SummaryOptions.toJSON(message.summaryOptions);
    }
    return obj;
  },

  create(base?: DeepPartial<FieldExtractionMetadata>): FieldExtractionMetadata {
    return FieldExtractionMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<FieldExtractionMetadata>): FieldExtractionMetadata {
    const message = createBaseFieldExtractionMetadata();
    message.summaryOptions = (object.summaryOptions !== undefined && object.summaryOptions !== null)
      ? SummaryOptions.fromPartial(object.summaryOptions)
      : undefined;
    return message;
  },
};

function createBasePropertyMetadata(): PropertyMetadata {
  return { inactive: false, fieldExtractionMetadata: undefined };
}

export const PropertyMetadata: MessageFns<PropertyMetadata> = {
  encode(message: PropertyMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.inactive !== false) {
      writer.uint32(24).bool(message.inactive);
    }
    if (message.fieldExtractionMetadata !== undefined) {
      FieldExtractionMetadata.encode(message.fieldExtractionMetadata, writer.uint32(74).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PropertyMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBasePropertyMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 3:
        ...
        case 9:
          ...
          message.fieldExtractionMetadata = FieldExtractionMetadata.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): PropertyMetadata {
    return {
      ...
      fieldExtractionMetadata: isSet(object.fieldExtractionMetadata)
        ? FieldExtractionMetadata.fromJSON(object.fieldExtractionMetadata)
        : undefined,
    };
  },
  ...
  toJSON(message: PropertyMetadata): unknown {
    ...
    if (message.fieldExtractionMetadata !== undefined) {
      obj.fieldExtractionMetadata = FieldExtractionMetadata.toJSON(message.fieldExtractionMetadata);
    }
    return obj;
  },

  create(base?: DeepPartial<PropertyMetadata>): PropertyMetadata {
    return PropertyMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<PropertyMetadata>): PropertyMetadata {
    ...
    message.fieldExtractionMetadata =
      (object.fieldExtractionMetadata !== undefined && object.fieldExtractionMetadata !== null)
        ? FieldExtractionMetadata.fromPartial(object.fieldExtractionMetadata)
        : undefined;
    return message;
  },
};

function createBaseEntityTypeMetadata(): EntityTypeMetadata {
  return { inactive: false };
}

export const EntityTypeMetadata: MessageFns<EntityTypeMetadata> = {
  encode(message: EntityTypeMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.inactive !== false) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EntityTypeMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEntityTypeMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 5:
  ...
  fromJSON(object: any): EntityTypeMetadata {
    return { inactive: isSet(object.inactive) ? globalThis.Boolean(object.inactive) : false };
  },

  toJSON(message: EntityTypeMetadata): unknown {
    const obj: any = {};
    if (message.inactive !== false) {
      obj.inactive = message.inactive;
    }
  ...
  create(base?: DeepPartial<EntityTypeMetadata>): EntityTypeMetadata {
    return EntityTypeMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<EntityTypeMetadata>): EntityTypeMetadata {
    const message = createBaseEntityTypeMetadata();
    message.inactive = object.inactive ?? false;
    return message;
  },
...
export const DocumentSchema_EntityType: MessageFns<DocumentSchema_EntityType> = {
  encode(message: DocumentSchema_EntityType, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.entityTypeMetadata !== undefined) {
      EntityTypeMetadata.encode(message.entityTypeMetadata, writer.uint32(90).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11:
          ...
          message.entityTypeMetadata = EntityTypeMetadata.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DocumentSchema_EntityType {
    return {
      ...
      properties: globalThis.Array.isArray(object?.properties)
        ...
        : [],
      entityTypeMetadata: isSet(object.entityTypeMetadata)
        ? EntityTypeMetadata.fromJSON(object.entityTypeMetadata)
        : undefined,
    };
  },
  ...
  toJSON(message: DocumentSchema_EntityType): unknown {
    ...
    if (message.entityTypeMetadata !== undefined) {
      obj.entityTypeMetadata = EntityTypeMetadata.toJSON(message.entityTypeMetadata);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<DocumentSchema_EntityType>): DocumentSchema_EntityType {
    ...
    message.entityTypeMetadata = (object.entityTypeMetadata !== undefined && object.entityTypeMetadata !== null)
      ? EntityTypeMetadata.fromPartial(object.entityTypeMetadata)
      : undefined;
    return message;
  },
};
...
function createBaseDocumentSchema_EntityType_Property(): DocumentSchema_EntityType_Property {
  return { name: "", description: "", displayName: "", valueType: "", occurrenceType: 0, propertyMetadata: undefined };
}
...
export const DocumentSchema_EntityType_Property: MessageFns<DocumentSchema_EntityType_Property> = {
  encode(message: DocumentSchema_EntityType_Property, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.propertyMetadata !== undefined) {
      PropertyMetadata.encode(message.propertyMetadata, writer.uint32(42).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          message.propertyMetadata = PropertyMetadata.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DocumentSchema_EntityType_Property {
    return {
      ...
      occurrenceType: isSet(object.occurrenceType)
        ...
        : 0,
      propertyMetadata: isSet(object.propertyMetadata) ? PropertyMetadata.fromJSON(object.propertyMetadata) : undefined,
    };
  },
  ...
  toJSON(message: DocumentSchema_EntityType_Property): unknown {
    ...
    if (message.propertyMetadata !== undefined) {
      obj.propertyMetadata = PropertyMetadata.toJSON(message.propertyMetadata);
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<DocumentSchema_EntityType_Property>): DocumentSchema_EntityType_Property {
    ...
    message.propertyMetadata = (object.propertyMetadata !== undefined && object.propertyMetadata !== null)
      ? PropertyMetadata.fromPartial(object.propertyMetadata)
      : undefined;
    return message;
  },
};
