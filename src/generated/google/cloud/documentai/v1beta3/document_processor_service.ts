...
export interface BatchProcessRequest {
   ...
   */
  outputConfig:
    | BatchProcessRequest_BatchOutputConfig
    | undefined;
  /**
 ...
 * @deprecated
 */
export interface BatchProcessRequest_BatchInputConfig {
 ...
 * @deprecated
 */
export interface BatchProcessRequest_BatchOutputConfig {
...
export function reviewDocumentOperationMetadata_StateFromJSON(object: any): ReviewDocumentOperationMetadata_State {
  switch (object) {
    case 0:
    case "STATE_UNSPECIFIED":
      return ReviewDocumentOperationMetadata_State.STATE_UNSPECIFIED;
    case 1:
    case "RUNNING":
      return ReviewDocumentOperationMetadata_State.RUNNING;
    case 2:
    case "CANCELLING":
      return ReviewDocumentOperationMetadata_State.CANCELLING;
    case 3:
    case "SUCCEEDED":
      return ReviewDocumentOperationMetadata_State.SUCCEEDED;
    case 4:
    case "FAILED":
      return ReviewDocumentOperationMetadata_State.FAILED;
    case 5:
    case "CANCELLED":
      return ReviewDocumentOperationMetadata_State.CANCELLED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return ReviewDocumentOperationMetadata_State.UNRECOGNIZED;
  }
}

export function reviewDocumentOperationMetadata_StateToJSON(object: ReviewDocumentOperationMetadata_State): string {
  switch (object) {
    case ReviewDocumentOperationMetadata_State.STATE_UNSPECIFIED:
      return "STATE_UNSPECIFIED";
    case ReviewDocumentOperationMetadata_State.RUNNING:
      return "RUNNING";
    case ReviewDocumentOperationMetadata_State.CANCELLING:
      return "CANCELLING";
    case ReviewDocumentOperationMetadata_State.SUCCEEDED:
      return "SUCCEEDED";
    case ReviewDocumentOperationMetadata_State.FAILED:
      return "FAILED";
    case ReviewDocumentOperationMetadata_State.CANCELLED:
      return "CANCELLED";
    case ReviewDocumentOperationMetadata_State.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
 ...
 * field.
 */
export interface ImportProcessorVersionRequest {
  /**
...
export interface ImportProcessorVersionRequest_ExternalProcessorVersionSource {
  /**
 ...
 * method.
 */
export interface ImportProcessorVersionResponse {
 ...
 * method.
 */
export interface ImportProcessorVersionMetadata {
...
function createBaseProcessOptions_LayoutConfig_ChunkingConfig(): ProcessOptions_LayoutConfig_ChunkingConfig {
  return {
    ...
    semanticChunkingGroupSize: false,
...
export const ProcessOptions_LayoutConfig_ChunkingConfig: MessageFns<ProcessOptions_LayoutConfig_ChunkingConfig> = {
  encode(message: ProcessOptions_LayoutConfig_ChunkingConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.semanticChunkingGroupSize !== false) {
      writer.uint32(24).bool(message.semanticChunkingGroupSize);
    }
    if (message.breakpointPercentileThreshold !== 0) {
      writer.uint32(32).int32(message.breakpointPercentileThreshold);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.semanticChunkingGroupSize = reader.bool();
          continue;
        case 4:
          if (tag !== 32) {
            break;
          ...
          message.breakpointPercentileThreshold = reader.int32();
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): ProcessOptions_LayoutConfig_ChunkingConfig {
    return {
      ...
      includeAncestorHeadings: isSet(object.includeAncestorHeadings)
        ...
        : false,
      semanticChunkingGroupSize: isSet(object.semanticChunkingGroupSize)
        ? globalThis.Boolean(object.semanticChunkingGroupSize)
        : false,
      breakpointPercentileThreshold: isSet(object.breakpointPercentileThreshold)
        ? globalThis.Number(object.breakpointPercentileThreshold)
        : 0,
    };
  },
  ...
  toJSON(message: ProcessOptions_LayoutConfig_ChunkingConfig): unknown {
    ...
    if (message.semanticChunkingGroupSize !== false) {
      obj.semanticChunkingGroupSize = message.semanticChunkingGroupSize;
    }
    if (message.breakpointPercentileThreshold !== 0) {
      obj.breakpointPercentileThreshold = Math.round(message.breakpointPercentileThreshold);
    }
    return obj;
  },
  ...
  fromPartial(
    ...
    message.semanticChunkingGroupSize = object.semanticChunkingGroupSize ?? false;
    message.breakpointPercentileThreshold = object.breakpointPercentileThreshold ?? 0;
    return message;
  },
};
...
function createBaseProcessResponse(): ProcessResponse {
  return { document: undefined, humanReviewOperation: "", humanReviewStatus: undefined };
}
...
export const ProcessResponse: MessageFns<ProcessResponse> = {
  encode(message: ProcessResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.humanReviewOperation !== "") {
      writer.uint32(18).string(message.humanReviewOperation);
    }
...
export const BatchProcessRequest: MessageFns<BatchProcessRequest> = {
  encode(message: BatchProcessRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.inputConfigs) {
      BatchProcessRequest_BatchInputConfig.encode(v!, writer.uint32(18).fork()).join();
    }
    if (message.outputConfig !== undefined) {
      BatchProcessRequest_BatchOutputConfig.encode(message.outputConfig, writer.uint32(26).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.inputConfigs.push(BatchProcessRequest_BatchInputConfig.decode(reader, reader.uint32()));
          continue;
        case 3:
          if (tag !== 26) {
            break;
          ...
          message.outputConfig = BatchProcessRequest_BatchOutputConfig.decode(reader, reader.uint32());
          continue;
        case 5:
          if (tag !== 42) {
            break;
  ...
  fromJSON(object: any): BatchProcessRequest {
    return {
      ...
      inputConfigs: globalThis.Array.isArray(object?.inputConfigs)
        ? object.inputConfigs.map((e: any) => BatchProcessRequest_BatchInputConfig.fromJSON(e))
        : [],
      outputConfig: isSet(object.outputConfig)
        ? BatchProcessRequest_BatchOutputConfig.fromJSON(object.outputConfig)
        : undefined,
  ...
  toJSON(message: BatchProcessRequest): unknown {
    ...
    if (message.inputConfigs?.length) {
      obj.inputConfigs = message.inputConfigs.map((e) => BatchProcessRequest_BatchInputConfig.toJSON(e));
    }
    if (message.outputConfig !== undefined) {
      obj.outputConfig = BatchProcessRequest_BatchOutputConfig.toJSON(message.outputConfig);
    }
    if (message.inputDocuments !== undefined) {
  ...
  fromPartial(object: DeepPartial<BatchProcessRequest>): BatchProcessRequest {
    const message = createBaseBatchProcessRequest();
    message.name = object.name ?? "";
    message.inputConfigs = object.inputConfigs?.map((e) => BatchProcessRequest_BatchInputConfig.fromPartial(e)) || [];
    message.outputConfig = (object.outputConfig !== undefined && object.outputConfig !== null)
      ? BatchProcessRequest_BatchOutputConfig.fromPartial(object.outputConfig)
      : undefined;
...
function createBaseBatchProcessRequest_BatchInputConfig(): BatchProcessRequest_BatchInputConfig {
  return { gcsSource: "", mimeType: "" };
}

export const BatchProcessRequest_BatchInputConfig: MessageFns<BatchProcessRequest_BatchInputConfig> = {
  encode(message: BatchProcessRequest_BatchInputConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.gcsSource !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BatchProcessRequest_BatchInputConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBatchProcessRequest_BatchInputConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BatchProcessRequest_BatchInputConfig {
    return {
      gcsSource: isSet(object.gcsSource) ? globalThis.String(object.gcsSource) : "",
      mimeType: isSet(object.mimeType) ? globalThis.String(object.mimeType) : "",
    };
  },

  toJSON(message: BatchProcessRequest_BatchInputConfig): unknown {
    const obj: any = {};
    if (message.gcsSource !== "") {
  ...
  create(base?: DeepPartial<BatchProcessRequest_BatchInputConfig>): BatchProcessRequest_BatchInputConfig {
    return BatchProcessRequest_BatchInputConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchProcessRequest_BatchInputConfig>): BatchProcessRequest_BatchInputConfig {
    const message = createBaseBatchProcessRequest_BatchInputConfig();
    message.gcsSource = object.gcsSource ?? "";
    message.mimeType = object.mimeType ?? "";
    return message;
  },
};

function createBaseBatchProcessRequest_BatchOutputConfig(): BatchProcessRequest_BatchOutputConfig {
  return { gcsDestination: "" };
}

export const BatchProcessRequest_BatchOutputConfig: MessageFns<BatchProcessRequest_BatchOutputConfig> = {
  encode(message: BatchProcessRequest_BatchOutputConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): BatchProcessRequest_BatchOutputConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseBatchProcessRequest_BatchOutputConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): BatchProcessRequest_BatchOutputConfig {
    return { gcsDestination: isSet(object.gcsDestination) ? globalThis.String(object.gcsDestination) : "" };
  },

  toJSON(message: BatchProcessRequest_BatchOutputConfig): unknown {
    const obj: any = {};
    if (message.gcsDestination !== "") {
  ...
  create(base?: DeepPartial<BatchProcessRequest_BatchOutputConfig>): BatchProcessRequest_BatchOutputConfig {
    return BatchProcessRequest_BatchOutputConfig.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<BatchProcessRequest_BatchOutputConfig>): BatchProcessRequest_BatchOutputConfig {
    const message = createBaseBatchProcessRequest_BatchOutputConfig();
...
export const BatchProcessMetadata_IndividualProcessStatus: MessageFns<BatchProcessMetadata_IndividualProcessStatus> = {
  encode(
    ...
    if (message.humanReviewOperation !== "") {
      writer.uint32(34).string(message.humanReviewOperation);
    }
    if (message.humanReviewStatus !== undefined) {
...
export const ReviewDocumentOperationMetadata: MessageFns<ReviewDocumentOperationMetadata> = {
  ...
  fromJSON(object: any): ReviewDocumentOperationMetadata {
    return {
      state: isSet(object.state) ? reviewDocumentOperationMetadata_StateFromJSON(object.state) : 0,
      stateMessage: isSet(object.stateMessage) ? globalThis.String(object.stateMessage) : "",
      createTime: isSet(object.createTime) ? fromJsonTimestamp(object.createTime) : undefined,
      updateTime: isSet(object.updateTime) ? fromJsonTimestamp(object.updateTime) : undefined,
      commonMetadata: isSet(object.commonMetadata)
  ...
  toJSON(message: ReviewDocumentOperationMetadata): unknown {
    const obj: any = {};
    if (message.state !== 0) {
      obj.state = reviewDocumentOperationMetadata_StateToJSON(message.state);
    }
    if (message.stateMessage !== "") {
      obj.stateMessage = message.stateMessage;
    }
...
function createBaseImportProcessorVersionRequest(): ImportProcessorVersionRequest {
  return { processorVersionSource: undefined, externalProcessorVersionSource: undefined, parent: "" };
}

export const ImportProcessorVersionRequest: MessageFns<ImportProcessorVersionRequest> = {
  encode(message: ImportProcessorVersionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.processorVersionSource !== undefined) {
      writer.uint32(18).string(message.processorVersionSource);
    }
    if (message.externalProcessorVersionSource !== undefined) {
      ImportProcessorVersionRequest_ExternalProcessorVersionSource.encode(
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ImportProcessorVersionRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseImportProcessorVersionRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
          ...
          message.processorVersionSource = reader.string();
          continue;
        case 3:
          if (tag !== 26) {
            break;
          ...
          message.externalProcessorVersionSource = ImportProcessorVersionRequest_ExternalProcessorVersionSource.decode(
            reader,
            reader.uint32(),
          );
          continue;
  ...
  fromJSON(object: any): ImportProcessorVersionRequest {
    return {
      processorVersionSource: isSet(object.processorVersionSource)
        ? globalThis.String(object.processorVersionSource)
        : undefined,
      externalProcessorVersionSource: isSet(object.externalProcessorVersionSource)
        ? ImportProcessorVersionRequest_ExternalProcessorVersionSource.fromJSON(object.externalProcessorVersionSource)
        : undefined,
      parent: isSet(object.parent) ? globalThis.String(object.parent) : "",
    };
  },

  toJSON(message: ImportProcessorVersionRequest): unknown {
    const obj: any = {};
    if (message.processorVersionSource !== undefined) {
      obj.processorVersionSource = message.processorVersionSource;
    }
    if (message.externalProcessorVersionSource !== undefined) {
      obj.externalProcessorVersionSource = ImportProcessorVersionRequest_ExternalProcessorVersionSource.toJSON(
        message.externalProcessorVersionSource,
      );
    }
    if (message.parent !== "") {
  ...
  create(base?: DeepPartial<ImportProcessorVersionRequest>): ImportProcessorVersionRequest {
    return ImportProcessorVersionRequest.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ImportProcessorVersionRequest>): ImportProcessorVersionRequest {
    const message = createBaseImportProcessorVersionRequest();
    message.processorVersionSource = object.processorVersionSource ?? undefined;
    message.externalProcessorVersionSource =
      (object.externalProcessorVersionSource !== undefined && object.externalProcessorVersionSource !== null)
        ? ImportProcessorVersionRequest_ExternalProcessorVersionSource.fromPartial(
...
function createBaseImportProcessorVersionRequest_ExternalProcessorVersionSource(): ImportProcessorVersionRequest_ExternalProcessorVersionSource {
  return { processorVersion: "", serviceEndpoint: "" };
}

export const ImportProcessorVersionRequest_ExternalProcessorVersionSource: MessageFns<
  ImportProcessorVersionRequest_ExternalProcessorVersionSource
> = {
  encode(
    message: ImportProcessorVersionRequest_ExternalProcessorVersionSource,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.processorVersion !== "") {
      writer.uint32(10).string(message.processorVersion);
  ...
  decode(
    ...
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseImportProcessorVersionRequest_ExternalProcessorVersionSource();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ImportProcessorVersionRequest_ExternalProcessorVersionSource {
    return {
      processorVersion: isSet(object.processorVersion) ? globalThis.String(object.processorVersion) : "",
  ...
  toJSON(message: ImportProcessorVersionRequest_ExternalProcessorVersionSource): unknown {
    const obj: any = {};
    if (message.processorVersion !== "") {
      obj.processorVersion = message.processorVersion;
    }
  ...
  create(
    base?: DeepPartial<ImportProcessorVersionRequest_ExternalProcessorVersionSource>,
  ): ImportProcessorVersionRequest_ExternalProcessorVersionSource {
    return ImportProcessorVersionRequest_ExternalProcessorVersionSource.fromPartial(base ?? {});
  },
  fromPartial(
    object: DeepPartial<ImportProcessorVersionRequest_ExternalProcessorVersionSource>,
  ): ImportProcessorVersionRequest_ExternalProcessorVersionSource {
    const message = createBaseImportProcessorVersionRequest_ExternalProcessorVersionSource();
    message.processorVersion = object.processorVersion ?? "";
...
function createBaseImportProcessorVersionResponse(): ImportProcessorVersionResponse {
  return { processorVersion: "" };
}

export const ImportProcessorVersionResponse: MessageFns<ImportProcessorVersionResponse> = {
  encode(message: ImportProcessorVersionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.processorVersion !== "") {
      writer.uint32(10).string(message.processorVersion);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ImportProcessorVersionResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseImportProcessorVersionResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ImportProcessorVersionResponse {
    return { processorVersion: isSet(object.processorVersion) ? globalThis.String(object.processorVersion) : "" };
  },

  toJSON(message: ImportProcessorVersionResponse): unknown {
    const obj: any = {};
    if (message.processorVersion !== "") {
      obj.processorVersion = message.processorVersion;
    }
  ...
  create(base?: DeepPartial<ImportProcessorVersionResponse>): ImportProcessorVersionResponse {
    return ImportProcessorVersionResponse.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ImportProcessorVersionResponse>): ImportProcessorVersionResponse {
    const message = createBaseImportProcessorVersionResponse();
    message.processorVersion = object.processorVersion ?? "";
    return message;
  },
...
function createBaseImportProcessorVersionMetadata(): ImportProcessorVersionMetadata {
  return { commonMetadata: undefined };
}

export const ImportProcessorVersionMetadata: MessageFns<ImportProcessorVersionMetadata> = {
  encode(message: ImportProcessorVersionMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.commonMetadata !== undefined) {
      CommonOperationMetadata.encode(message.commonMetadata, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ImportProcessorVersionMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseImportProcessorVersionMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): ImportProcessorVersionMetadata {
    return {
      commonMetadata: isSet(object.commonMetadata)
        ? CommonOperationMetadata.fromJSON(object.commonMetadata)
        : undefined,
  ...
  toJSON(message: ImportProcessorVersionMetadata): unknown {
    const obj: any = {};
    if (message.commonMetadata !== undefined) {
      obj.commonMetadata = CommonOperationMetadata.toJSON(message.commonMetadata);
    }
  ...
  create(base?: DeepPartial<ImportProcessorVersionMetadata>): ImportProcessorVersionMetadata {
    return ImportProcessorVersionMetadata.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<ImportProcessorVersionMetadata>): ImportProcessorVersionMetadata {
    const message = createBaseImportProcessorVersionMetadata();
    message.commonMetadata = (object.commonMetadata !== undefined && object.commonMetadata !== null)
      ? CommonOperationMetadata.fromPartial(object.commonMetadata)
      : undefined;
...
export interface DocumentProcessorServiceClient<CallOptionsExt = {}> {
  ...
  /** Imports a processor version from source processor version. */
  importProcessorVersion(
    request: DeepPartial<ImportProcessorVersionRequest>,
    options?: CallOptions & CallOptionsExt,
  ): Promise<Operation>;
}
