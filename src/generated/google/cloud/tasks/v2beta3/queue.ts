...
import { AppEngineHttpQueue, HttpTarget } from "./target.js";

export const protobufPackage = "google.cloud.tasks.v2beta3";
...
export function queue_TypeFromJSON(object: any): Queue_Type {
  switch (object) {
    case 0:
    case "TYPE_UNSPECIFIED":
      return Queue_Type.TYPE_UNSPECIFIED;
    case 1:
    case "PULL":
      return Queue_Type.PULL;
    case 2:
    case "PUSH":
      return Queue_Type.PUSH;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Queue_Type.UNRECOGNIZED;
  }
}

export function queue_TypeToJSON(object: Queue_Type): string {
  switch (object) {
    case Queue_Type.TYPE_UNSPECIFIED:
      return "TYPE_UNSPECIFIED";
    case Queue_Type.PULL:
      return "PULL";
    case Queue_Type.PUSH:
      return "PUSH";
    case Queue_Type.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const Queue: MessageFns<Queue> = {
  encode(message: Queue, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.appEngineHttpQueue !== undefined) {
      AppEngineHttpQueue.encode(message.appEngineHttpQueue, writer.uint32(26).fork()).join();
    }
    if (message.httpTarget !== undefined) {
      HttpTarget.encode(message.httpTarget, writer.uint32(106).fork()).join();
    }
    if (message.rateLimits !== undefined) {
      RateLimits.encode(message.rateLimits, writer.uint32(34).fork()).join();
    }
    ...
    if (message.purgeTime !== undefined) {
      Timestamp.encode(toTimestamp(message.purgeTime), writer.uint32(58).fork()).join();
    }
    if (message.taskTtl !== undefined) {
      Duration.encode(message.taskTtl, writer.uint32(66).fork()).join();
    }
    if (message.tombstoneTtl !== undefined) {
      Duration.encode(message.tombstoneTtl, writer.uint32(74).fork()).join();
    }
    if (message.stackdriverLoggingConfig !== undefined) {
      StackdriverLoggingConfig.encode(message.stackdriverLoggingConfig, writer.uint32(82).fork()).join();
    }
    if (message.type !== 0) {
      writer.uint32(88).int32(message.type);
    }
    if (message.stats !== undefined) {
      QueueStats.encode(message.stats, writer.uint32(98).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.appEngineHttpQueue = AppEngineHttpQueue.decode(reader, reader.uint32());
          continue;
        case 13:
          if (tag !== 106) {
            break;
  ...
  fromJSON(object: any): Queue {
    return {
      ...
      appEngineHttpQueue: isSet(object.appEngineHttpQueue)
        ? AppEngineHttpQueue.fromJSON(object.appEngineHttpQueue)
        : undefined,
      ...
      stackdriverLoggingConfig: isSet(object.stackdriverLoggingConfig)
        ...
        : undefined,
      type: isSet(object.type) ? queue_TypeFromJSON(object.type) : 0,
  ...
  toJSON(message: Queue): unknown {
    ...
    if (message.appEngineHttpQueue !== undefined) {
      obj.appEngineHttpQueue = AppEngineHttpQueue.toJSON(message.appEngineHttpQueue);
    }
    if (message.httpTarget !== undefined) {
    ...
    if (message.type !== 0) {
      obj.type = queue_TypeToJSON(message.type);
    }
    if (message.stats !== undefined) {
  ...
  fromPartial(object: DeepPartial<Queue>): Queue {
    ...
    message.appEngineHttpQueue = (object.appEngineHttpQueue !== undefined && object.appEngineHttpQueue !== null)
      ? AppEngineHttpQueue.fromPartial(object.appEngineHttpQueue)
      : undefined;
