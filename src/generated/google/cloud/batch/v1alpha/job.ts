...
export function job_SchedulingPolicyFromJSON(object: any): Job_SchedulingPolicy {
  switch (object) {
    case 0:
    case "SCHEDULING_POLICY_UNSPECIFIED":
      return Job_SchedulingPolicy.SCHEDULING_POLICY_UNSPECIFIED;
    case 1:
    case "AS_SOON_AS_POSSIBLE":
      return Job_SchedulingPolicy.AS_SOON_AS_POSSIBLE;
    case -1:
    case "UNRECOGNIZED":
    default:
      return Job_SchedulingPolicy.UNRECOGNIZED;
  }
}

export function job_SchedulingPolicyToJSON(object: Job_SchedulingPolicy): string {
  switch (object) {
    case Job_SchedulingPolicy.SCHEDULING_POLICY_UNSPECIFIED:
      return "SCHEDULING_POLICY_UNSPECIFIED";
    case Job_SchedulingPolicy.AS_SOON_AS_POSSIBLE:
      return "AS_SOON_AS_POSSIBLE";
    case Job_SchedulingPolicy.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function jobDependency_TypeFromJSON(object: any): JobDependency_Type {
  switch (object) {
    case 0:
    case "TYPE_UNSPECIFIED":
      return JobDependency_Type.TYPE_UNSPECIFIED;
    case 1:
    case "SUCCEEDED":
      return JobDependency_Type.SUCCEEDED;
    case 2:
    case "FAILED":
      return JobDependency_Type.FAILED;
    case 3:
    case "FINISHED":
      return JobDependency_Type.FINISHED;
    case -1:
    case "UNRECOGNIZED":
    default:
      return JobDependency_Type.UNRECOGNIZED;
  }
}

export function jobDependency_TypeToJSON(object: JobDependency_Type): string {
  switch (object) {
    case JobDependency_Type.TYPE_UNSPECIFIED:
      return "TYPE_UNSPECIFIED";
    case JobDependency_Type.SUCCEEDED:
      return "SUCCEEDED";
    case JobDependency_Type.FAILED:
      return "FAILED";
    case JobDependency_Type.FINISHED:
      return "FINISHED";
    case JobDependency_Type.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}

export interface JobDependency_ItemsEntry {
  key: string;
  value: JobDependency_Type;
}
...
export enum JobStatus_State {
  ...
  /**
   * CANCELLATION_IN_PROGRESS - The Job cancellation is in progress, this is because the resources used
   * by the Job are still being cleaned up.
   */
  CANCELLATION_IN_PROGRESS = 7,
  /**
   * CANCELLED - The Job has been cancelled, the task executions were stopped and the
...
export function jobStatus_StateFromJSON(object: any): JobStatus_State {
  switch (object) {
    ...
    case "CANCELLATION_IN_PROGRESS":
      return JobStatus_State.CANCELLATION_IN_PROGRESS;
    case 8:
    case "CANCELLED":
...
export function jobStatus_StateToJSON(object: JobStatus_State): string {
  switch (object) {
    ...
    case JobStatus_State.CANCELLATION_IN_PROGRESS:
...
export interface TaskGroup_LabelsEntry {
  key: string;
  value: string;
}
...
export const Job: MessageFns<Job> = {
  encode(message: Job, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.schedulingPolicy !== 0) {
      writer.uint32(40).int32(message.schedulingPolicy);
    }
    for (const v of message.dependencies) {
      JobDependency.encode(v!, writer.uint32(50).fork()).join();
    }
    ...
    if (message.notification !== undefined) {
      JobNotification.encode(message.notification, writer.uint32(82).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          message.dependencies.push(JobDependency.decode(reader, reader.uint32()));
          continue;
        case 7:
          if (tag !== 58) {
            break;
        ...
        case 10:
          ...
          message.notification = JobNotification.decode(reader, reader.uint32());
          continue;
        case 11:
          if (tag !== 90) {
            break;
  ...
  fromJSON(object: any): Job {
    return {
      ...
      taskGroups: globalThis.Array.isArray(object?.taskGroups)
        ...
        : [],
      schedulingPolicy: isSet(object.schedulingPolicy) ? job_SchedulingPolicyFromJSON(object.schedulingPolicy) : 0,
      dependencies: globalThis.Array.isArray(object?.dependencies)
        ? object.dependencies.map((e: any) => JobDependency.fromJSON(e))
        : [],
      ...
      notification: isSet(object.notification) ? JobNotification.fromJSON(object.notification) : undefined,
  ...
  toJSON(message: Job): unknown {
    ...
    if (message.schedulingPolicy !== 0) {
      obj.schedulingPolicy = job_SchedulingPolicyToJSON(message.schedulingPolicy);
    }
    if (message.dependencies?.length) {
      obj.dependencies = message.dependencies.map((e) => JobDependency.toJSON(e));
    }
    if (message.allocationPolicy !== undefined) {
    ...
    if (message.notification !== undefined) {
      obj.notification = JobNotification.toJSON(message.notification);
    }
    if (message.createTime !== undefined) {
  ...
  fromPartial(object: DeepPartial<Job>): Job {
    ...
    message.dependencies = object.dependencies?.map((e) => JobDependency.fromPartial(e)) || [];
    ...
    message.notification = (object.notification !== undefined && object.notification !== null)
      ? JobNotification.fromPartial(object.notification)
      : undefined;
...
function createBaseJobDependency(): JobDependency {
  return { items: {} };
}

export const JobDependency: MessageFns<JobDependency> = {
  encode(message: JobDependency, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    Object.entries(message.items).forEach(([key, value]) => {
      JobDependency_ItemsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): JobDependency {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseJobDependency();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          const entry1 = JobDependency_ItemsEntry.decode(reader, reader.uint32());
  ...
  fromJSON(object: any): JobDependency {
    return {
      items: isObject(object.items)
        ? Object.entries(object.items).reduce<{ [key: string]: JobDependency_Type }>((acc, [key, value]) => {
          acc[key] = jobDependency_TypeFromJSON(value);
          return acc;
        }, {})
        : {},
    };
  ...
  toJSON(message: JobDependency): unknown {
    const obj: any = {};
    if (message.items) {
      ...
      if (entries.length > 0) {
        obj.items = {};
        entries.forEach(([k, v]) => {
          obj.items[k] = jobDependency_TypeToJSON(v);
        });
      }
    }
    return obj;
  ...
  create(base?: DeepPartial<JobDependency>): JobDependency {
    return JobDependency.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<JobDependency>): JobDependency {
    const message = createBaseJobDependency();
    message.items = Object.entries(object.items ?? {}).reduce<{ [key: string]: JobDependency_Type }>(
      (acc, [key, value]) => {
        if (value !== undefined) {
          acc[key] = value as JobDependency_Type;
        }
        return acc;
      },
      {},
...
function createBaseJobDependency_ItemsEntry(): JobDependency_ItemsEntry {
  return { key: "", value: 0 };
}

export const JobDependency_ItemsEntry: MessageFns<JobDependency_ItemsEntry> = {
  encode(message: JobDependency_ItemsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): JobDependency_ItemsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseJobDependency_ItemsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): JobDependency_ItemsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? jobDependency_TypeFromJSON(object.value) : 0,
    };
  },

  toJSON(message: JobDependency_ItemsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
    if (message.value !== 0) {
      obj.value = jobDependency_TypeToJSON(message.value);
    }
    return obj;
  },

  create(base?: DeepPartial<JobDependency_ItemsEntry>): JobDependency_ItemsEntry {
    return JobDependency_ItemsEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<JobDependency_ItemsEntry>): JobDependency_ItemsEntry {
    const message = createBaseJobDependency_ItemsEntry();
    message.key = object.key ?? "";
...
function createBaseJobStatus(): JobStatus {
  return { state: 0, statusEvents: [], taskGroups: {}, runDuration: undefined, resourceUsage: undefined };
}
...
export const JobStatus: MessageFns<JobStatus> = {
  encode(message: JobStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.resourceUsage !== undefined) {
      ResourceUsage.encode(message.resourceUsage, writer.uint32(50).fork()).join();
    }
    return writer;
  },
...
export const ResourceUsage: MessageFns<ResourceUsage> = {
  encode(message: ResourceUsage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.coreHours !== 0) {
      writer.uint32(9).double(message.coreHours);
    }
    return writer;
  },
  ...
  fromJSON(object: any): ResourceUsage {
    return { coreHours: isSet(object.coreHours) ? globalThis.Number(object.coreHours) : 0 };
  },

  toJSON(message: ResourceUsage): unknown {
    const obj: any = {};
    if (message.coreHours !== 0) {
      obj.coreHours = message.coreHours;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<ResourceUsage>): ResourceUsage {
    const message = createBaseResourceUsage();
    message.coreHours = object.coreHours ?? 0;
    return message;
  },
};
...
export const AllocationPolicy: MessageFns<AllocationPolicy> = {
  encode(message: AllocationPolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.instance !== undefined) {
      AllocationPolicy_InstancePolicy.encode(message.instance, writer.uint32(18).fork()).join();
    }
    for (const v of message.instances) {
      AllocationPolicy_InstancePolicyOrTemplate.encode(v!, writer.uint32(66).fork()).join();
    }
    for (const v of message.instanceTemplates) {
      writer.uint32(26).string(v!);
    }
    writer.uint32(34).fork();
    for (const v of message.provisioningModels) {
      writer.int32(v);
    }
    writer.join();
    if (message.serviceAccountEmail !== "") {
      writer.uint32(42).string(message.serviceAccountEmail);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.instance = AllocationPolicy_InstancePolicy.decode(reader, reader.uint32());
          continue;
        case 8:
          if (tag !== 66) {
            break;
        ...
        case 4:
          if (tag === 32) {
            message.provisioningModels.push(reader.int32() as any);
  ...
  fromJSON(object: any): AllocationPolicy {
    return {
      ...
      instance: isSet(object.instance) ? AllocationPolicy_InstancePolicy.fromJSON(object.instance) : undefined,
      instances: globalThis.Array.isArray(object?.instances)
        ? object.instances.map((e: any) => AllocationPolicy_InstancePolicyOrTemplate.fromJSON(e))
        : [],
      instanceTemplates: globalThis.Array.isArray(object?.instanceTemplates)
        ? object.instanceTemplates.map((e: any) => globalThis.String(e))
        : [],
      provisioningModels: globalThis.Array.isArray(object?.provisioningModels)
        ? object.provisioningModels.map((e: any) => allocationPolicy_ProvisioningModelFromJSON(e))
        : [],
  ...
  toJSON(message: AllocationPolicy): unknown {
    ...
    if (message.instance !== undefined) {
      obj.instance = AllocationPolicy_InstancePolicy.toJSON(message.instance);
    }
    if (message.instances?.length) {
      obj.instances = message.instances.map((e) => AllocationPolicy_InstancePolicyOrTemplate.toJSON(e));
    }
    if (message.instanceTemplates?.length) {
      obj.instanceTemplates = message.instanceTemplates;
    }
    if (message.provisioningModels?.length) {
      obj.provisioningModels = message.provisioningModels.map((e) => allocationPolicy_ProvisioningModelToJSON(e));
    }
    if (message.serviceAccountEmail !== "") {
  ...
  fromPartial(object: DeepPartial<AllocationPolicy>): AllocationPolicy {
    ...
    message.instance = (object.instance !== undefined && object.instance !== null)
      ? AllocationPolicy_InstancePolicy.fromPartial(object.instance)
      : undefined;
    message.instances = object.instances?.map((e) => AllocationPolicy_InstancePolicyOrTemplate.fromPartial(e)) || [];
    message.instanceTemplates = object.instanceTemplates?.map((e) => e) || [];
    message.provisioningModels = object.provisioningModels?.map((e) => e) || [];
...
function createBaseAllocationPolicy_LocationPolicy(): AllocationPolicy_LocationPolicy {
  return { allowedLocations: [], deniedLocations: [] };
}
...
export const AllocationPolicy_LocationPolicy: MessageFns<AllocationPolicy_LocationPolicy> = {
  encode(message: AllocationPolicy_LocationPolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.deniedLocations) {
  ...
  fromJSON(object: any): AllocationPolicy_LocationPolicy {
    return {
      allowedLocations: globalThis.Array.isArray(object?.allowedLocations)
        ...
        : [],
      deniedLocations: globalThis.Array.isArray(object?.deniedLocations)
        ? object.deniedLocations.map((e: any) => globalThis.String(e))
        : [],
    };
  },
  ...
  toJSON(message: AllocationPolicy_LocationPolicy): unknown {
    ...
    if (message.deniedLocations?.length) {
      obj.deniedLocations = message.deniedLocations;
    }
    return obj;
  },
  ...
  fromPartial(object: DeepPartial<AllocationPolicy_LocationPolicy>): AllocationPolicy_LocationPolicy {
    ...
    message.deniedLocations = object.deniedLocations?.map((e) => e) || [];
    return message;
  },
};
...
export const AllocationPolicy_InstancePolicy: MessageFns<AllocationPolicy_InstancePolicy> = {
  encode(message: AllocationPolicy_InstancePolicy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.allowedMachineTypes) {
      writer.uint32(10).string(v!);
    }
    if (message.machineType !== "") {
  ...
  fromJSON(object: any): AllocationPolicy_InstancePolicy {
    return {
      allowedMachineTypes: globalThis.Array.isArray(object?.allowedMachineTypes)
        ? object.allowedMachineTypes.map((e: any) => globalThis.String(e))
        : [],
      machineType: isSet(object.machineType) ? globalThis.String(object.machineType) : "",
  ...
  toJSON(message: AllocationPolicy_InstancePolicy): unknown {
    const obj: any = {};
    if (message.allowedMachineTypes?.length) {
      obj.allowedMachineTypes = message.allowedMachineTypes;
    }
    if (message.machineType !== "") {
      obj.machineType = message.machineType;
    }
  ...
  fromPartial(object: DeepPartial<AllocationPolicy_InstancePolicy>): AllocationPolicy_InstancePolicy {
    const message = createBaseAllocationPolicy_InstancePolicy();
    message.allowedMachineTypes = object.allowedMachineTypes?.map((e) => e) || [];
    message.machineType = object.machineType ?? "";
...
export const TaskGroup: MessageFns<TaskGroup> = {
  encode(message: TaskGroup, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      TaskGroup_LabelsEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).join();
    });
    ...
    if (message.serviceAccount !== undefined) {
      ServiceAccount.encode(message.serviceAccount, writer.uint32(122).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          const entry8 = TaskGroup_LabelsEntry.decode(reader, reader.uint32());
          if (entry8.value !== undefined) {
            message.labels[entry8.key] = entry8.value;
          }
          continue;
...
function createBaseTaskGroup_LabelsEntry(): TaskGroup_LabelsEntry {
  return { key: "", value: "" };
}

export const TaskGroup_LabelsEntry: MessageFns<TaskGroup_LabelsEntry> = {
  encode(message: TaskGroup_LabelsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TaskGroup_LabelsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseTaskGroup_LabelsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): TaskGroup_LabelsEntry {
    return {
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? globalThis.String(object.value) : "",
    };
  ...
  toJSON(message: TaskGroup_LabelsEntry): unknown {
    const obj: any = {};
    if (message.key !== "") {
      obj.key = message.key;
    }
  ...
  create(base?: DeepPartial<TaskGroup_LabelsEntry>): TaskGroup_LabelsEntry {
    return TaskGroup_LabelsEntry.fromPartial(base ?? {});
  },
  fromPartial(object: DeepPartial<TaskGroup_LabelsEntry>): TaskGroup_LabelsEntry {
    const message = createBaseTaskGroup_LabelsEntry();
    message.key = object.key ?? "";
    message.value = object.value ?? "";
    return message;
